...
| [005-SessionsWeb](005-SessionsWeb/) | ✅ `./phpc run` / `phpc serve` | ✅ `session_start` JIT ([#1882](https://github.com/PurHur/php-compiler/issues/1882)) | ✅ `phpc build` | `$_SESSION` flash across requests — [#1881](https://github.com/PurHur/php-compiler/issues/1881); AOT execute [#1891](https://github.com/PurHur/php-compiler/issues/1891) (`SESSIONS_WEB_AOT_SMOKE_GATE=1`) |
