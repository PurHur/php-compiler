...
Gate: `php script/check-bench-readme-sync.php` (also in `check-generated-docs.sh`) — v2 table
must match `RESULTS.json`; timing decimals / `Nx faster` claims outside the markers fail.
