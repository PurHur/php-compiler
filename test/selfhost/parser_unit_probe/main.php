...
/**
 * M3 parser unit probe: compiler_minimal-scale bundle + CFG parse front-end slice (#2409).
 * Gate: php bin/compile.php -l test/selfhost/parser_unit_probe/main.php
 * Native: ./script/bootstrap-selfhost-parser-unit-probe.sh
 * Zend parse: parser_unit_probe_parse_smoke() in parser_unit_probe_parse.php (PHPUnit).
 */
...
// Native link-only: Runtime::parse on fixture under Zend (parser_unit_probe_parse.php; #2409).
echo "parser_unit_probe bundle OK\n";
