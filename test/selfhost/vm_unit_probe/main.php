...
/**
 * M3 VM unit probe: compiler_minimal-scale bundle with lib/VM.php interpreter spine (#2354).
 * Gate: php bin/compile.php -l test/selfhost/vm_unit_probe/main.php
 * Native: ./script/bootstrap-selfhost-vm-unit-probe.sh
 */
