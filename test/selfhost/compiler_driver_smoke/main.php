 ...
 * Native: ./script/bootstrap-selfhost-compiler-driver-smoke.sh
 */
...
require_once __DIR__.'/../../bootstrap-aot/compile_driver_smoke.php';

echo "compiler_driver_smoke bundle OK\n";
