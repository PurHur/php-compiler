...
/**
 * AOT lint gate for full M3 HelloWorld compile driver (not yet in linkable selfhost bundle).
 * Gate: php bin/compile.php -l test/selfhost/compiler_helloworld_smoke/driver_lint.php
 */
