 ...
 * Native: ./script/bootstrap-selfhost-compiler-unit-probe.sh
 * Zend CFG smoke: compiler_unit_probe_compile_smoke() in compiler_unit_probe_compile.php (PHPUnit).
 */
...
if (!class_exists(\PHPCompiler\Compiler::class)) {
    throw new \RuntimeException('compiler_unit_probe: missing PHPCompiler\\Compiler');
}

echo "compiler_unit_probe bundle OK\n";
