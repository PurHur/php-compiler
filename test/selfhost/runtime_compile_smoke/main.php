...
/**
 * M3 Runtime compile smoke bundle — minimal lib/ closure with Runtime.php (#2294).
 * Gate: php bin/compile.php -l test/selfhost/runtime_compile_smoke/main.php
 */
...
echo "runtime_compile_smoke bundle OK\n";
