...
/**
 * Self-host compile smoke: compiler_minimal bundle + literal compile of compiler_smoke.php.
 * Gate: php bin/compile.php -l test/selfhost/compiler_compile_smoke/main.php
 */
...
echo "compiler_compile_smoke bundle OK\n";
