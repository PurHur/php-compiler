...
final class ReadonlyPropertyAotTest extends AotTest
{
    ...
    {
        foreach (['readonly_property_write.phpt', 'readonly_property_unset.phpt', 'readonly_property_inc.phpt', 'readonly_property_dec.phpt', 'readonly_property_compound_assign.phpt', 'readonly_property_dot_assign.phpt', 'readonly_property_promoted.phpt', 'readonly_property_promoted_catch.phpt', 'readonly_property_coalesce_assign.phpt'] as $basename) {
