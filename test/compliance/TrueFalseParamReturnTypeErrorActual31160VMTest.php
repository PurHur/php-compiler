...
/**
 * VM: true/false param+return TypeError actual is bool on default 8.2 profile (#31160).
 *
 * Dedicated provider — path-slash data-set names break --filter on full VMTest.
 */
final class TrueFalseParamReturnTypeErrorActual31160VMTest extends BaseTest
{
