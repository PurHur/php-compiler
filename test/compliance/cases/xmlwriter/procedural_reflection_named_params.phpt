--TEST--
Procedural xmlwriter_* Reflection/named params match php-src stubs (#23608)
--FILE--
<?php
...
write_attribute=writer,name,value
write_element=writer,name,content
open_uri=uri
start_document_req=1
start_dtd=writer,qualifiedName,publicId,systemId
writer=OK
value=OK
legacy-writer-reject
legacy-content-reject
ok
