--TEST--
language: Generator getReturn/throw excess argc → ArgumentCountError (#30866, zend_generators.c)
--FILE--
<?php
function gen_argc_return() { yield 1; return 2; }
$g = gen_argc_return();
$g->next();
try {
...
function gen_argc_throw() { try { yield 1; } catch (Throwable $e) { echo "caught\n"; } }
$h = gen_argc_throw();
$h->current();
try {
