--TEST--
language: ReflectionEnum getCases/hasCase/getCase excess argc → ArgumentCountError (#30865, php_reflection.c)
--FILE--
<?php
enum ReflEnumArgcE { case A; }
$r = new ReflectionEnum('ReflEnumArgcE');
try {
