--TEST--
language: ReflectionEnum isBacked/getBackingType excess argc → ArgumentCountError (#30929, php_reflection.c)
--FILE--
<?php
enum ReflEnumIsBackedArgcE: int { case A = 1; }
$r = new ReflectionEnum('ReflEnumIsBackedArgcE');
try {
