--TEST--
Language: public private(set) rejected on default 8.4.0-dev reference profile (#24819, re-#24720, Zend/zend_compile.c)
--SKIPIF--
<?php
// Key off PROFILE env — not supportsAsymmetricVisibility(). If the gate wrongly
// returns true on the reference profile, skipping would hide the regression (#24819).
