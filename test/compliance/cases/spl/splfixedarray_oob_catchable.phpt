--TEST--
SplFixedArray OOB dim write/get/unset catchable RuntimeException (#21994)
--FILE--
<?php
...
get:RuntimeException:Index invalid or out of range
unset:RuntimeException:Index invalid or out of range
method:RuntimeException:Index invalid or out of range
ok:9
