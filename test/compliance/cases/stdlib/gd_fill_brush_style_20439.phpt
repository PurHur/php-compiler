--TEST--
stdlib gd imagefilltoborder/imagesetbrush/imagesetstyle (#20439, ext/gd/gd.c)
--FILE--
<?php
...
echo 'fill=', (int) ((imagecolorat($im, 5, 5) & 0xFFFFFF) === ($fl & 0xFFFFFF)), "\n";
echo 'border=', (int) ((imagecolorat($im, 1, 1) & 0xFFFFFF) === ($bd & 0xFFFFFF)), "\n";
echo 'outside=', (int) ((imagecolorat($im, 0, 0) & 0xFFFFFF) === ($bg & 0xFFFFFF)), "\n";
...
echo 'style_ink=', (int) ($ink > 0), "\n";
echo 'style_gap=', (int) ($gap > 0), "\n";
