--TEST--
stdlib date()/gmdate() — ArgumentCountError/TypeError + format coercion (#4496, ext/date/php_date.c)
--FILE--
<?php
...
try { date([]); } catch (TypeError $e) { echo $e->getMessage(), "\n"; }
...
date(): Argument #1 ($format) must be of type string, array given
gmdate_null_ok
2000-01-01
