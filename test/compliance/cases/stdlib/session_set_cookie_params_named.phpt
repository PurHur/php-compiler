--TEST--
stdlib session_set_cookie_params Zend stub named params (#23846 / #24533, ext/session/session.stub.php)
--FILE--
<?php
...
lifetime:3600
path:/app
params:lifetime_or_options,path,domain,secure,httponly
Unknown named parameter $lifetime
