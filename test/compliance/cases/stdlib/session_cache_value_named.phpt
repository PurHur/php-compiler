--TEST--
session_cache_limiter/expire Reflection value + named value: (#24583, ext/session/session.stub.php)
--FILE--
<?php
...
limiter_value_ok
expire=240
Unknown named parameter $new_cache_limiter
Unknown named parameter $new_cache_expire
