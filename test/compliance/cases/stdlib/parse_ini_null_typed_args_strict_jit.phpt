--TEST--
stdlib parse_ini_string/file null process_sections/scanner_mode under strict_types TypeError JIT (#31264, ext/standard/basic_functions.c)
--FILE--
<?php
...
$f = sys_get_temp_dir().'/php_compiler_31264_parse_ini_strict_jit.ini';
