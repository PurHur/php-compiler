--TEST--
ReflectionProperty::setValue() rejects readonly instance properties (#15749, ext/reflection/php_reflection.c)
--FILE--
<?php
class C {
...
value=1
promoted_error: Cannot modify readonly property D::$x
promoted_value=1
direct_error: Cannot modify readonly property C::$x
