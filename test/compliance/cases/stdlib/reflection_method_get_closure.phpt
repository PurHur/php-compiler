--TEST--
ReflectionMethod::getClosure() — instance and static method binding (#6663, ext/reflection/php_reflection.c)
--FILE--
<?php
class C {
...
--EXPECT--
instance method_exists=true
bound=42
static method_exists=true
static bound=21
