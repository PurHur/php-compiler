--TEST--
stdlib SoapClient features SOAP_SINGLE_ELEMENT_ARRAYS (#20367)
--FILE--
<?php
$resp = __DIR__ . '/test/fixtures/soap/single_element.response.xml';
if (!is_file($resp)) {
    $resp = dirname(__DIR__, 3) . '/fixtures/soap/single_element.response.xml';
}
