--TEST--
stdlib PharFileInfo compress/decompress (#21653)
--INI--
phar.readonly=0
--FILE--
<?php
...
$dir = sys_get_temp_dir() . '/pfi21653c_' . getmypid() . '_' . mt_rand();
@mkdir($dir, 0777, true);
...
reopen=Y gz=Y
dec=N
bad=BadMethodCallException:Unknown compression type specified
bz2=missing
