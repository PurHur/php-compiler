--TEST--
password_hash/password_verify named password/algo/hash arguments (VM, issue #23207)
--FILE--
<?php
...
$rf = new ReflectionFunction('password_hash');
foreach ($rf->getParameters() as $p) {
    echo $p->getName(), PHP_EOL;
}
$rf = new ReflectionFunction('password_verify');
foreach ($rf->getParameters() as $p) {
    echo $p->getName(), PHP_EOL;
}
--EXPECT--
