--TEST--
stdlib str_replace family: null array elements no parameter DEP on 8.4 (#29309)
--ENV--
PHP_COMPILER_PROFILE=8.4
--FILE--
<?php
// #29309 — null elements in search/replace arrays: no parameter-level DEP (Zend convert_to_string)
