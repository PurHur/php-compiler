...
/**
 * JIT compile (lint) echo for array/object/null (issue #71).
 *
 * @group llvm
 * @group jit
 */
final class EchoArrayObjectJITTest extends BaseTest
{
    ...
    /**
     * @dataProvider echoFixtureBasenameProvider
     */
    public function testJitLintEchoFixture(string $basename): void
    {
