...
/**
 * JIT: new self/parent/static in a free function is Zend compile fatal (#32252, zend_compile.c).
 *
 * Dedicated provider — path-slash data-set names break --filter on full JITTest.
 *
 * @group llvm
 */
final class PseudoClassNewNoScope32252JITTest extends BaseTest
{
