    ...
    public static function providePHPTests(): \Generator
    {
        foreach (
            [
                ...
                'enum_from_null_coerce.phpt',
                'enum_from_null_deprecation.phpt',
                'enum_try_from.phpt',
                'enum_tryfrom_from.phpt',
                'enum_tryfrom_strict_types.phpt',
                'enum_instanceof.phpt',
                'instanceof_enum_case.phpt',
                'enum_case_class_const.phpt',
                'enum_case_class_constant.phpt',
                ...
                'class_const_enum_case.phpt',
                'compile_unit_const_enum_case.phpt',
                'enum_typed_class_constant_forward83.phpt',
                'enum_typed_class_const_forward83.phpt',
                ...
                'enum_loose_compare.phpt',
                'enum_const_fetch_object.phpt',
                'enum_dynamic_case_fetch.phpt',
                ...
                'unit_enum_case_identity.phpt',
                'unit_enum_value_undefined_property.phpt',
                'enum_case_paren_invoke.phpt',
                'enum_user_method.phpt',
                'enum_dynamic_property_write.phpt',
