...
/**
 * JIT: self/parent/static::method in a free function is Zend compile fatal (#32227, zend_compile.c).
 *
 * Dedicated provider — path-slash data-set names break --filter on full JITTest.
 *
 * @group llvm
 */
final class PseudoClassCallNoScope32227JITTest extends BaseTest
{
