...
/**
 * VM: optional-before-required E_DEPRECATED (#31904).
 *
 * Dedicated provider — path-slash data-set names break --filter on full VMTest.
 */
final class OptionalBeforeRequiredDeprecated31904VMTest extends BaseTest
{
    ...
    public static function providePHPTests(): \Generator
    {
        ...
        yield 'optional_before_required_deprecated_profile84.phpt' => self::parsePHPT(
            __DIR__.'/cases/language/optional_before_required_deprecated_profile84.phpt',
            'optional_before_required_deprecated_profile84.phpt'
        );
