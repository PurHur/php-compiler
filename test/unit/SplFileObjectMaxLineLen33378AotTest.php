...
/**
 * AOT: SplFileObject setMaxLineLen/getMaxLineLen + fgets cap (#33378).
 *
...
final class SplFileObjectMaxLineLen33378AotTest extends TestCase
{
    ...
    public function testProxiesAndNoNewRuntimeC(): void
    {
        ...
        $this->assertStringContainsString("'setMaxLineLen'", $ctx);
        $this->assertStringContainsString("'getMaxLineLen'", $ctx);
