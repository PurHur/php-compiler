...
/**
 * AOT: ZipArchive unchangeAll / unchangeArchive NestedJIT (#35489 leftover of #35486).
 *
 * @see php-src ext/zip/php_zip.c zim_ZipArchive_unchangeAll / zim_ZipArchive_unchangeArchive
 *
 * @group llvm
 * @group aot
 */
final class ZipArchiveUnchange35489AotTest extends TestCase
{
    public function testUnchangeAotMatchesVm(): void
    {
        ...
        $src = __DIR__.'/../repro/ziparchive_unchange_aot.php';
    ...
    public function testProxyRegisteredForUnchange(): void
    {
        ...
        $this->assertStringContainsString("'ua'", $helper);
        $this->assertStringContainsString("'uar'", $helper);
    }
    ...
    {
        $root = dirname(__DIR__, 2);
        $bin = sys_get_temp_dir().'/zip_ua_'.getmypid().'_'.md5($src);
