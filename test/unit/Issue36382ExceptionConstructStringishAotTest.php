...
/**
 * #36382 — Exception::__construct must not readObject(__string__*).
 *
 * @group aot
 */
final class Issue36382ExceptionConstructStringishAotTest extends TestCase
{
    public function testExceptionConstructAotVerifiesAndRuns(): void
    {
        $repo = dirname(__DIR__, 2);
        $src = $repo.'/test/repro/issue_36382_exception_construct_stringish.php';
        $this->assertFileExists($src);
        $out = tempnam(sys_get_temp_dir(), 'exc36382_');
        ...
        $this->assertSame('boom', trim(implode("\n", $runLines)));
    }
}
