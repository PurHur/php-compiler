...
final class TypeDeadStrptimeAbiRuntimeShrinkTest extends TestCase
{
    public function testTypeBuiltinDropsLeftoverAlwaysOnStrptimeAbi(): void
    {
        ...
        $this->assertStringContainsString('StringStrptime::ensureLinked', $type);
    }
    ...
    public function testStringBuiltinStillImplementsStrptimeOnFullLoad(): void
    {
        $string = (string) file_get_contents(__DIR__.'/../../lib/JIT/Builtin/Type/String_.php');
        $this->assertStringContainsString('StringStrptime::implement($this->context)', $string);
    }
