...
/**
 * AOT: mb_detect_encoding() via MbDetectEncodingJitHelper (#34358 leftover of #3075).
 *
...
final class MbDetectEncodingRuntimeAotTest extends TestCase
{
    ...
    public function testHelperAndLoweringPresent(): void
    {
        ...
        $this->assertStringNotContainsString(
            'mb_detect_encoding() JIT requires a compile-time string literal',
            $src
        );
    ...
    {
        $root = dirname(__DIR__, 2);
        $bin = sys_get_temp_dir().'/mb_detect_encoding_'.getmypid().'_'.md5($src);
