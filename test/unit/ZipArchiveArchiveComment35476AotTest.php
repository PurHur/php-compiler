...
/**
 * AOT: ZipArchive setArchiveComment / getArchiveComment NestedJIT (#35476 leftover of #35472).
 *
 * @see php-src ext/zip/php_zip.c zim_ZipArchive_setArchiveComment / zim_ZipArchive_getArchiveComment
 *
 * @group llvm
 * @group aot
 */
final class ZipArchiveArchiveComment35476AotTest extends TestCase
{
    public function testArchiveCommentAotMatchesVm(): void
    {
        ...
        $src = __DIR__.'/../repro/ziparchive_archive_comment_aot.php';
    ...
    public function testProxyRegisteredForArchiveComment(): void
    {
        ...
        $this->assertStringContainsString("'sac'", $helper);
        $this->assertStringContainsString("'gac'", $helper);
    }
    ...
    {
        $root = dirname(__DIR__, 2);
        $bin = sys_get_temp_dir().'/zip_ac_'.getmypid().'_'.md5($src);
