...
final class Issue35043DomImportNodeTextAotTest extends TestCase
{
    public function testAotImportNodeTextMatchesZend(): void
    {
        ...
        $this->assertStringContainsString('createText nodeName=#text', $zend);
        $this->assertStringContainsString('createText xml=<r>hi</r>', $zend);
        $this->assertStringContainsString('firstChildText nodeName=#text', $zend);
        $this->assertStringContainsString('nextSiblingText nodeName=#text', $zend);
