...
/**
 * Drop leftover always-on stream_socket ABI shells from Builtin\Type (#32807).
 *
...
final class TypeDeadStreamSocketAbiRuntimeShrinkTest extends TestCase
{
    ...
    public function testTypeBuiltinDropsLeftoverAlwaysOnStreamSocketAbis(): void
    {
        ...
        $this->assertStringContainsString("registerFunction('__compiler_ftruncate'", $type);
    ...
    public function testTypeRegisterStillEnsureLinksStreamSocketRuntimes(): void
    {
        $type = (string) file_get_contents(__DIR__.'/../../lib/JIT/Builtin/Type.php');
    ...
    public function testPhpHelpersRemainForDroppedUserScriptBuiltins(): void
    {
        ...
        $this->assertStringContainsString(
            'StreamSocketGetNameJitHelper',
            (string) file_get_contents(__DIR__.'/../../ext/standard/StreamSocketGetNameJitHelper.php')
        );
        $this->assertFileDoesNotExist(
            dirname(__DIR__, 2).'/lib/AOT/runtime/phpc_stream_socket_get_name.c'
        );
        $this->assertFileDoesNotExist(
            dirname(__DIR__, 2).'/lib/AOT/runtime/phpc_stream_socket_accept.c'
        );
    }
}
