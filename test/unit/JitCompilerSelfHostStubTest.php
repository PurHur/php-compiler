...
final class JitCompilerSelfHostStubTest extends TestCase
{
    ...
    /** @var list<string> */
    private const M3_COMPILER_PHP_LOWERING_ISSET_CHAIN_SUFFIXES = [
        'compileisset',
        'compilecoalesce',
        'resolveisset',
        'requireoperandslot',
    ...
    /** @var list<string> */
    private const M3_COMPILER_PHP_LOWERING_DEFINE_SUFFIXES = [
        'trycompiledefineasglobalconst',
        'compileclassconstfetch',
        'getopcodetype',
        'markcallerlocalsusedbyliteralinclude',
    ...
    /**
     * @dataProvider m3CompilerPhpLoweringIssetChainSuffixProvider
     */
    public function testM3CompileDriverCompilerIssetChainLoweringIsNotStubbed(string $suffix): void
    {
        $prevSelfHost = getenv('PHP_COMPILER_SELFHOST_AOT');
        $prevM3 = getenv('PHP_COMPILER_M3_COMPILE_DRIVER');
        putenv('PHP_COMPILER_SELFHOST_AOT=1');
    ...
    /**
     * @dataProvider m3CompilerPhpLoweringDefineSuffixProvider
     */
    public function testM3CompileDriverCompilerDefineLoweringIsNotStubbed(string $suffix): void
    {
        $prevSelfHost = getenv('PHP_COMPILER_SELFHOST_AOT');
        $prevM3 = getenv('PHP_COMPILER_M3_COMPILE_DRIVER');
        putenv('PHP_COMPILER_SELFHOST_AOT=1');
    ...
    /** @return iterable<string, array{0: string}> */
    public static function m3CompilerPhpLoweringDefineSuffixProvider(): iterable
    {
        foreach (self::M3_COMPILER_PHP_LOWERING_DEFINE_SUFFIXES as $suffix) {
            yield $suffix => [$suffix];
        }
    }
