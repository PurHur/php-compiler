...
/**
 * AOT: mb_encode_mimeheader()/mb_decode_mimeheader() via MbMimeheaderJitHelper (#34299 leftover of #6038).
 *
 * @see php-src ext/mbstring/mbstring.c PHP_FUNCTION(mb_encode_mimeheader) / mb_decode_mimeheader
 *
 * @group llvm
 * @group aot
 */
final class MbMimeheaderRuntimeAotTest extends TestCase
{
    ...
    public function testHelperAndLoweringPresent(): void
    {
        ...
        $this->assertStringNotContainsString('MimeHeaderConvert::', $helper);
        ...
        $this->assertFileDoesNotExist($root.'/lib/AOT/runtime/mb_decode_mimeheader.c');
    }
