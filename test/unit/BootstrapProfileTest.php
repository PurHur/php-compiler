...
final class BootstrapProfileTest extends TestCase
{
    public function testProfileScriptBuildsValidJson(): void
    {
        ...
        $this->assertContains('test/bootstrap-aot/nested_array_dim_mixed.php', $profile['aot_link_targets']);
        $this->assertContains('test/bootstrap-aot/nested_array_dim_write.php', $profile['aot_link_targets']);
        ...
        $this->assertNotContains('test/bootstrap-aot/deploy_path_fold.php', $profile['aot_link_targets']);
        ...
        $this->assertNotContains('lib/AOT/Linker.php', $profile['excluded_files']);
    }
