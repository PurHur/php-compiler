...
final class CompilerVersionGateTest extends TestCase
{
    ...
    /** Issue #29061: hex floats withheld on 8.4.0-dev reference (matches Zend 8.2). */
    public function testSupportsHexFloatLiteralsFalseOnDefault84DevProfile(): void
    {
        $prev = getenv('PHP_COMPILER_PROFILE');
        putenv('PHP_COMPILER_PROFILE');
        try {
            $this->assertFalse(CompilerVersion::supportsHexFloatLiterals());
        } finally {
            if (false === $prev) {
                putenv('PHP_COMPILER_PROFILE');
            } else {
    ...
    /** Issue #29061: PROFILE=8.2 must not enable hex float literals. */
    public function testSupportsHexFloatLiteralsFalseOnPhp82Profile(): void
    {
        $prev = getenv('PHP_COMPILER_PROFILE');
    ...
    /** Issue #29061: PROFILE=8.4 enables hex float literals. */
    public function testSupportsHexFloatLiteralsTrueOnForwardProfile84(): void
    {
        $prev = getenv('PHP_COMPILER_PROFILE');
        putenv('PHP_COMPILER_PROFILE=8.4');
        try {
            $this->assertTrue(CompilerVersion::supportsHexFloatLiterals());
        } finally {
            if (false === $prev) {
                putenv('PHP_COMPILER_PROFILE');
            } else {
    ...
    public function testSupportsGetObjectIdAlwaysFalse(): void
    {
    ...
    /** @covers issue #30856 / #24819 — must stay false on unset PROFILE (not isForwardProfileAtLeast) */
    ...
    /** Property hooks withheld on 8.4.0-dev reference profile — Zend 8.2 parity (#30483). */
    ...
    /** SplFixedArray OOB stays RuntimeException on 8.4.0-dev reference (#28819). */
    public function testSupportsSplFixedArrayOutOfBoundsExceptionFalseOnDefaultProfile(): void
    {
        $prev = getenv('PHP_COMPILER_PROFILE');
        putenv('PHP_COMPILER_PROFILE');
        try {
            $this->assertFalse(CompilerVersion::supportsSplFixedArrayOutOfBoundsException());
        } finally {
            if (false === $prev) {
                putenv('PHP_COMPILER_PROFILE');
            } else {
    ...
    public function testSupportsSplFixedArrayOutOfBoundsExceptionFalseWhenProfile82(): void
    {
        $prev = getenv('PHP_COMPILER_PROFILE');
        putenv('PHP_COMPILER_PROFILE=8.2');
        try {
    ...
    public function testSupportsSplFixedArrayOutOfBoundsExceptionTrueWhenProfile84(): void
    {
        $prev = getenv('PHP_COMPILER_PROFILE');
        putenv('PHP_COMPILER_PROFILE=8.4');
        try {
            $this->assertTrue(CompilerVersion::supportsSplFixedArrayOutOfBoundsException());
        } finally {
            if (false === $prev) {
                putenv('PHP_COMPILER_PROFILE');
            } else {
    ...
    public function testSupportsSplFixedArrayOutOfBoundsExceptionTrueWhenProfile85(): void
    {
        $prev = getenv('PHP_COMPILER_PROFILE');
        putenv('PHP_COMPILER_PROFILE=8.5');
        try {
    ...
    public function testSupportsTypedTraitConstantsFalseOnDefaultDevProfile(): void
    {
        $prev = getenv('PHP_COMPILER_PROFILE');
        putenv('PHP_COMPILER_PROFILE');
        try {
    ...
    public function testSupportsTypedClassConstantsFalseOnDefaultDevProfile(): void
    {
        ...
        putenv('PHP_COMPILER_PROFILE');
        try {
            // Withheld on 8.4.0-dev reference (Zend 8.2 parse error) — #24809 / #30857.
    ...
    public function testSupportsInterfaceTypedConstantsFalseOnDefaultDevProfile(): void
    {
        ...
        putenv('PHP_COMPILER_PROFILE');
        try {
            // Tracks supportsTypedClassConstants() — withheld on reference (#24917 / #30857).
