...
/**
 * AOT nullsafe ?-> after reassignment — issue #32749.
 *
 * @group llvm
 * @runInSeparateProcess
 * @preserveGlobalState disabled
 */
final class NullsafePropReassignAot32749Test extends TestCase
{
    public function testAotNullsafeAfterReassignPrintsN5(): void
    {
        ...
        if (!LlvmToolchain::isReady($repo)) {
            ...
            $this->markTestSkipped($reason.' — #32749 AOT nullsafe needs LLVM');
        }

        $source = $repo.'/test/repro/nullsafe_prop_reassign.php';
        $this->assertFileExists($source);
        $out = $repo.'/build/test-nullsafe-prop-reassign-aot-32749';
