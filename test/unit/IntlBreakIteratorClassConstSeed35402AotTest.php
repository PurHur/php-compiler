...
/**
 * AOT: IntlBreakIterator::* ClassConstFetch seeds (#35402 peer #35397).
 *
 * php-src: ext/intl/breakiterator/breakiterator_class.c — REGISTER_BREAKITERATOR_CLASS_CONST_LONG.
 *
 * @group llvm
 */
final class IntlBreakIteratorClassConstSeed35402AotTest extends TestCase
{
    public function testSeedHookExists(): void
    {
        ...
        $this->assertStringContainsString('#35402', $src);
    }

    public function testAotIntlBreakIteratorConstsMatch(): void
    {
        $repro = dirname(__DIR__).'/repro/aot_breakiterator_const_seed.php';
        $this->assertFileExists($repro);
        $bin = sys_get_temp_dir().'/ibi_cc_35402_'.getmypid();
        $compile = $this->runCmd([
            PHP_BINARY,
