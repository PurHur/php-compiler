...
/**
 * AOT: openssl_x509_free() leftover of #20272 (#33489).
 *
...
final class OpensslX509FreeAotTest extends TestCase
{
    ...
    {
        $runtime = new Runtime();
        $code = file_get_contents(dirname(__DIR__).'/repro/issue_33489_openssl_x509_free_aot.php');
        $this->assertNotFalse($code);
        ob_start();
        $runtime->run($runtime->parseAndCompile($code, 'issue_33489_openssl_x509_free_aot.php'));
    ...
    public function testAotTypeErrorAndArgcMatchVm(): void
    {
        ...
        $src = $root.'/test/repro/issue_33489_openssl_x509_free_aot.php';
        $runtime = new Runtime();
