...
/**
 * AOT: ReflectionClass::getTraitAliases matches Zend (#34129).
 *
 ...
 * @group aot
 */
final class Issue34129ReflectionClassGetTraitAliasesAotTest extends TestCase
{
    ...
    public function testVmTraitAliasesRun(): void
    {
        $root = dirname(__DIR__, 2);
        $src = $root.'/test/repro/issue_34129_reflection_trait_aliases_aot.php';
