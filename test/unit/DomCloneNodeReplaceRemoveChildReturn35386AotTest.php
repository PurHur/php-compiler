...
/**
 * AOT: cloneNode on replaceChild/removeChild DOMNode return (#35386 / leftover #35377).
 *
 * php-src: ext/dom/node.c — replaceChild returns oldChild; removeChild returns removed node.
 *
 * @group llvm
 */
