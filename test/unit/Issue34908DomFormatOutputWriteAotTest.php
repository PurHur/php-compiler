...
/**
 * AOT: DOMDocument option prop write+read must match Zend (#34908 leftover of #34899).
 *
 * @group llvm
 * @group aot
 */
final class Issue34908DomFormatOutputWriteAotTest extends TestCase
{
    public function testOptionPropWriteReadMatchZend(): void
    {
        $root = dirname(__DIR__, 2);
        $src = $root.'/test/repro/issue_34908_dom_formatoutput_write_aot.php';
    ...
    public function testOptionSlotsSeededNotMetaHardcoded(): void
    {
        ...
        $this->assertStringContainsString('LIBXML_OPTION_DEFAULTS', $construct);
        $this->assertStringContainsString('PROP_FORMAT_OUTPUT', $construct);
        $this->assertStringContainsString('#34908', $construct);
        // Option props must not be MetaProps-hardcoded (writes would be ignored).
