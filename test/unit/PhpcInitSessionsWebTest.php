...
final class PhpcInitSessionsWebTest extends TestCase
{
    public function testInitSessionsWebProfileLintClean(): void
    {
        ...
        try {
            ...
            $canonical = $repoRoot.'/examples/005-SessionsWeb';
            $this->assertSame(
    ...
    public function testInitRejectsSessionsWebTypoProfile(): void
    {
        $repoRoot = dirname(__DIR__, 2);
        $work = sys_get_temp_dir().'/phpc_init_sessionsweb_bad_'.bin2hex(random_bytes(6));
        $this->assertTrue(mkdir($work));
