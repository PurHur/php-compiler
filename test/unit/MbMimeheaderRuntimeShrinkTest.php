...
/**
 * mb_encode_mimeheader / mb_decode_mimeheader JIT routes through MbMimeheaderJitHelper PHP (#34299).
 *
...
{
    public function testMbMimeheaderCompilesHelper(): void
    {
        ...
        $this->assertStringNotContainsString('/ext/mbstring/MimeHeaderConvert.php', $source);
    }
