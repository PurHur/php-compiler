...
/**
 * AOT: ZipArchive::setExternalAttributesName/Index NestedJIT (#35515 leftover of #35500).
 *
 * @see php-src ext/zip/php_zip.c zim_ZipArchive_setExternalAttributesName / Index
 *
 * @group llvm
 * @group aot
 */
final class ZipArchiveSetExtAttr35515AotTest extends TestCase
{
    public function testSetExtAttrAotMatchesVm(): void
    {
        ...
        $src = __DIR__.'/../repro/ziparchive_setextattr_aot.php';
    ...
    public function testProxyAndHelperOpPresent(): void
    {
        ...
        $this->assertStringContainsString("'ean'", $helper);
    ...
    {
        $root = dirname(__DIR__, 2);
        $bin = sys_get_temp_dir().'/zip_ea_'.getmypid().'_'.md5($src);
