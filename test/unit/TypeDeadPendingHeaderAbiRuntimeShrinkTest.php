...
final class TypeDeadPendingHeaderAbiRuntimeShrinkTest extends TestCase
{
    public function testTypeBuiltinDropsLeftoverAlwaysOnPendingHeaderAbi(): void
    {
        ...
        $this->assertStringContainsString('PendingHeadersRuntime::ensureThinAotLinkStubs', $type);
    ...
    public function testRuntimeOwnerDeclaresPendingHeaderAbiModuleLocally(): void
    {
        ...
        $this->assertStringContainsString('ensureThinAotLinkStubs', $owner);
        ...
        foreach ([
            ...
            $this->assertStringContainsString($abi, $bridge);
        }
    }

    public function testTypeInitializeStillEnsureLinksPendingHeadersOnNonThinPath(): void
    {
        $type = (string) file_get_contents(__DIR__.'/../../lib/JIT/Builtin/Type.php');
