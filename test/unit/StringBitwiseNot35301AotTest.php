...
/**
 * AOT: unary ~ on string links __string__bitwiseNot and matches Zend (#35301).
 *
...
final class StringBitwiseNot35301AotTest extends TestCase
{
    ...
    public function testHelperUnaryOpEnsuresStringBitwiseNotLinked(): void
    {
        ...
        $this->assertStringContainsString('#35301', $chunk);
    }
    ...
    public function testVmStringBitwiseNotMatchesZend(): void
    {
        ...
        $code = file_get_contents(
            dirname(__DIR__).'/repro/issue_35301_string_bitwise_not.php'
        );
