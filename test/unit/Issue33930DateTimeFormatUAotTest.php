...
/**
 * AOT date/DateTime::format('u') and format('H:i:s.u') via civil specs (#33930).
 *
 * @group llvm
 * @group aot
 */
final class Issue33930DateTimeFormatUAotTest extends TestCase
{
    ...
    public function testAotFormatUAndHisUMatchZend(): void
    {
        ...
        $expected = "date_u=000000\nfmt_u=000000\nset_hisu=12:30:45.123456\nctor_hisu=12:30:45.123456\n";
        try {
            for ($i = 0; $i < 5; ++$i) {
                $runOut = [];
