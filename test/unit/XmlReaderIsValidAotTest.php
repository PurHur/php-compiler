...
/**
 * AOT: XMLReader::isValid leftover of fromString/read (#35960 / #27299).
 *
...
final class XmlReaderIsValidAotTest extends TestCase
{
    ...
    public function testRegisteredInUserScriptAot(): void
    {
        ...
        $this->assertFileDoesNotExist(dirname(__DIR__, 2).'/lib/AOT/runtime/xmlreader_isvalid.c');
        $this->assertFileDoesNotExist(dirname(__DIR__, 2).'/runtime/xmlreader_isvalid.c');
    }
}
