...
/**
 * AOT: (bool) on arrays is zend_hash_num_elements ? true : false (#32455).
 *
 * @see php-src Zend/zend_operators.c convert_to_boolean
 *
 * @group llvm
 * @group aot
 */
final class ArrayBoolCast32455AotTest extends TestCase
{
    ...
    public function testAotArrayBoolCastMatchesZend(): void
    {
        ...
        $bin = sys_get_temp_dir().'/phpc_issue_32455_bool_'.getmypid().'.bin';
