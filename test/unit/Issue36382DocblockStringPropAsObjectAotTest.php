...
/**
 * #36382 — docblock string prop as object arg must not readObject (__string__*).
 *
 * @group aot
 */
final class Issue36382DocblockStringPropAsObjectAotTest extends TestCase
{
    public function testDocblockStringPropAsObjectArgAotVerifiesAndRuns(): void
    {
        $repo = dirname(__DIR__, 2);
        $src = $repo.'/test/repro/issue_36382_docblock_string_prop_as_object.php';
        $this->assertFileExists($src);
        $out = tempnam(sys_get_temp_dir(), 'dspo36382_');
