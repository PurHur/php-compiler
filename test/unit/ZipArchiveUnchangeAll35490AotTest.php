...
/**
 * AOT: ZipArchive::unchangeAll NestedJIT (#35490 leftover of #35486).
 *
 * @see php-src ext/zip/php_zip.c zim_ZipArchive_unchangeAll
 *
 * @group llvm
 * @group aot
 */
final class ZipArchiveUnchangeAll35490AotTest extends TestCase
{
    public function testUnchangeAllAotMatchesVm(): void
    {
        ...
        $src = __DIR__.'/../repro/ziparchive_unchangeall_aot.php';
    ...
    public function testProxyAndHelperOpPresent(): void
    {
        ...
        $this->assertStringContainsString("'uca'", $helper);
        $jit = (string) file_get_contents($root.'/ext/zip/JitZipArchive.php');
        $this->assertStringContainsString('function unchangeAll', $jit);
    }
    ...
    {
        $root = dirname(__DIR__, 2);
        $bin = sys_get_temp_dir().'/zip_uca_'.getmypid().'_'.md5($src);
