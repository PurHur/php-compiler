...
{
    private const EXPECT = 'I34121=I34121,J34121=J34121|T34121=T34121|0,0';
    ...
    public function testZendClassMapsBaseline(): void
    {
        $root = dirname(__DIR__, 2);
        $src = $root.'/test/repro/issue_34121_reflection_class_maps_aot.php';
    ...
    public function testVmClassMapsMatchZend(): void
    {
        $root = dirname(__DIR__, 2);
        $src = $root.'/test/repro/issue_34121_reflection_class_maps_aot.php';
