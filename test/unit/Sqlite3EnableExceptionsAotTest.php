...
/**
 * AOT: SQLite3 enableExceptions NestedJIT (#35975 leftover of #35972).
 *
 * @see php-src ext/sqlite3/sqlite3.c zim_SQLite3_enableExceptions
 *
 * @group llvm
 * @group aot
 */
final class Sqlite3EnableExceptionsAotTest extends TestCase
{
    public function testEnableExceptionsAotMatchesVm(): void
    {
        if (!LlvmToolchain::hasLibrary(dirname(__DIR__, 2))) {
            $this->markTestSkipped('LLVM 9 toolchain not available');
        }

        $src = __DIR__.'/../repro/sqlite3_enableexceptions_aot.php';
    ...
    public function testProxyRegisteredForEnableExceptions(): void
    {
        ...
        $this->assertStringContainsString('function enableExceptions(', $jit);
    ...
    {
        $root = dirname(__DIR__, 2);
        $bin = sys_get_temp_dir().'/sq3_ee_'.getmypid().'_'.md5($src);
