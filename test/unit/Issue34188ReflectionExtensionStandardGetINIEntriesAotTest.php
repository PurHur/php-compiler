 ...
 * @group aot
 */
final class Issue34188ReflectionExtensionStandardGetINIEntriesAotTest extends TestCase
{
    private const EXPECT = 'type=array count=14 assert.active=1 user_agent=1 assert.callback=1 user_agent_null=1';
    ...
    public function testAotStandardGetINIEntriesMatchesZend(): void
    {
    ...
    public function testZendStandardGetINIEntriesBaseline(): void
    {
        $root = dirname(__DIR__, 2);
        $src = $root.'/test/repro/issue_34188_reflection_extension_standard_inientries_aot.php';
    ...
    public function testVmStandardGetINIEntriesMatchesZend(): void
    {
        $root = dirname(__DIR__, 2);
        $src = $root.'/test/repro/issue_34188_reflection_extension_standard_inientries_aot.php';
