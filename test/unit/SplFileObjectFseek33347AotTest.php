...
final class SplFileObjectFseek33347AotTest extends TestCase
{
    public function testAotMatchesZendFseek(): void
    {
        ...
        $cacheDir = sys_get_temp_dir().'/phpc_helper_cache_33347_'.getmypid();
        @mkdir($cacheDir, 0777, true);
        // Isolate from the shared helper-runtime cache — concurrent O=0 compiles
        // corrupt each other and yield main_before_php SIGSEGV (#33347).
