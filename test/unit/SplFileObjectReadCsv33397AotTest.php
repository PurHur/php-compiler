...
final class SplFileObjectReadCsv33397AotTest extends TestCase
{
    ...
    public function testHelperCachesLineNotHtForReadCsv(): void
    {
        ...
        // Must not alias CSV rows through construct-time __spl_ht (#33440 reopen SIGSEGV).
        $this->assertStringContainsString('Do not store the row HT into PROP_HT', $helper);
