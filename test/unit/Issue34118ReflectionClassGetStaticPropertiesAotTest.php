...
/**
 * AOT: ReflectionClass::getStaticProperties matches Zend (#34118).
 *
...
{
    /** parent private $b omitted; mutation of $c visible */
    private const EXPECT = '{"a":1,"c":3,"d":4,"e":5}|{"a":1,"c":99,"d":4,"e":5}';
    ...
    public function testContextRegistersGetStaticPropertiesProxy(): void
    {
        ...
        $this->assertFileExists(
            dirname(__DIR__, 2).'/lib/JIT/Builtin/ReflectionClassGetStaticPropertiesRuntime.php'
        );
    }
