...
{
    /** ChildGsp: skip parent-private $p; keep own private $t. */
    private const EXPECT_CHILD = '{"q":2,"r":3,"s":4,"t":5}';

    private const EXPECT_BASE = '{"p":1,"r":3,"s":4}';
    ...
    public function testVmGetStaticPropertiesMatchesZend(): void
    {
        ...
        $this->assertSame(0, $rc, $joined);
        $this->assertSame(self::EXPECT_CHILD."\n".self::EXPECT_BASE, $joined);
        $this->assertStringNotContainsString('"p":', explode("\n", $joined)[0]);
    }
}
