...
/**
 * AOT: mb_convert_case(TITLE) must substitute illegal UTF-8 with '?' (#34346).
 *
 ...
 * @group aot
 */
final class MbTitleIllegalUtf8AotTest extends TestCase
{
    public function testAotTitleIllegalUtf8MatchesZend(): void
    {
        ...
        $this->assertAotMatchesZend(__DIR__.'/../repro/aot_mb_title_illegal_utf8.php');
    }

    public function testHelperSubstitutesIllegalUtf8(): void
    {
        ...
        $this->assertStringContainsString('#34346', $helper);
