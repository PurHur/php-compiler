...
final class PhpcDoctorTest extends TestCase
{
    ...
    public function testDoctorSelfhostPrintsBootstrapGates(): void
    {
        ...
        $this->assertStringContainsString('NORTH_STAR4_VERIFY_GATE', $result['stdout']);
        ...
        $this->assertStringContainsString('phpc test --native', $result['stdout']);
        ...
        $this->assertStringContainsString('Bootstrap SDK onboarding (#15605)', $result['stdout']);
        $this->assertStringContainsString('Bootstrap SDK tiers', $result['stdout']);
        $this->assertStringContainsString('| 0 Harness (Zend) |', $result['stdout']);
        $this->assertStringContainsString('| 1 Daily compile |', $result['stdout']);
        $this->assertStringContainsString('| 2 Bootstrap verify |', $result['stdout']);
    ...
    public function testDoctorGatesPrintsMiniWebAppLadder(): void
    {
        ...
        $this->assertStringContainsString('NORTH_STAR3_VERIFY_GATE', $result['stdout']);
        $this->assertStringContainsString('NORTH_STAR4_VERIFY_GATE', $result['stdout']);
        $this->assertStringContainsString('M4 presenter', $result['stdout']);
        ...
        $this->assertStringContainsString('DEPLOY_SMOKE_ALL_GATE', $result['stdout']);
        $this->assertStringContainsString('#2085', $result['stdout']);
        ...
        $this->assertStringContainsString('THROWSWEB_SERVE_JIT_SMOKE_GATE', $result['stdout']);
        $this->assertStringContainsString('#2408', $result['stdout']);
