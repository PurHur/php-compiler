...
/**
 * #35118 — AOT importNode(DOMAttr) returns Attr (not dest Element / SIGSEGV).
 *
 * @group llvm
 */
final class Issue35118DomImportNodeAttrAotTest extends TestCase
{
    public function testAotImportNodeAttrMatchZend(): void
    {
        ...
        $this->assertStringContainsString('type=2 nodeName=a', $zend);
        $this->assertStringContainsString('name=a value=1', $zend);
