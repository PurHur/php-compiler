...
/**
 * AOT: hash() non-crypto digests match Zend (#34829).
 *
...
final class Issue34829HashNonCryptoAotTest extends TestCase
{
    ...
    public function testHelperRuntimeInlineOnlyListsHashCrypto(): void
    {
        $cache = (string) file_get_contents(__DIR__.'/../../lib/AOT/HelperRuntimeCache.php');
        $this->assertStringContainsString(
            'hashcryptojithelper::hash',
            $cache,
            'USER_SCRIPT_INLINE_ONLY must NestedJIT HashCryptoJitHelper::hash (#34829)'
        );
    }
    ...
    public function testAotHashNonCryptoMatchesZend(): void
    {
        ...
        $bin = sys_get_temp_dir().'/phpc_aot_hash_nc_34829_'.getmypid().'.bin';
