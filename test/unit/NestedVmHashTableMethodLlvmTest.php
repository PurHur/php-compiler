...
final class NestedVmHashTableMethodLlvmTest extends TestCase
{
    public function testRegistersPadCopyAndGetNumElements(): void
    {
        ...
        $this->assertTrue(NestedVmHashTableMethodLlvm::isNestedHashTableMethod('update'));
        ...
        $this->assertTrue(NestedVmHashTableMethodLlvm::isNestedHashTableMethod('poplast'));
        ...
        $this->assertTrue(NestedVmHashTableMethodLlvm::isNestedHashTableMethod('chunkcopy'));
