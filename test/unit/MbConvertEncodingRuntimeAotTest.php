...
final class MbConvertEncodingRuntimeAotTest extends TestCase
{
    ...
    public function testAotArrayStringOperandMatchesZend(): void
    {
        ...
        $this->assertAotMatchesZend(
            __DIR__.'/../repro/mb_convert_encoding_array_string_aot.php',
            []
        );
    }
    ...
    public function testAotRuntimeFromArrayMatchesZend(): void
    {
        ...
        $this->assertAotMatchesZend(
            __DIR__.'/../repro/aot_mb_convert_encoding_runtime_from_array.php',
            []
        );
    }
    ...
    public function testHelperAndLoweringPresent(): void
    {
        ...
        $this->assertStringContainsString('MbConvertVariablesRuntime::callConvertString', $fromList);
        ...
        $this->assertStringContainsString('MbConvertEncodingFromListLlvm', $jit);
        $this->assertStringContainsString('needsRuntimeFromEncodingList', $jit);
        $this->assertStringContainsString('MbConvertEncodingArrayLlvm', $jit);
