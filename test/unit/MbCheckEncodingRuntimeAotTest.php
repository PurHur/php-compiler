...
/**
 * AOT: mb_check_encoding() must not Fatal on TYPE_ARRAY (#34254 leftover of #4571).
 *
 ...
 * @group aot
 */
final class MbCheckEncodingRuntimeAotTest extends TestCase
{
    ...
    {
        $root = dirname(__DIR__, 2);
        $bin = sys_get_temp_dir().'/mb_ce_'.getmypid().'_'.md5($src);
