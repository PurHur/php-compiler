...
final class ArrayObjectUnserialize33636AotTest extends TestCase
{
    ...
    public function testHelperWired(): void
    {
        ...
        $bagFind = (string) file_get_contents($root.'/ext/standard/UnserializeSplArrayFindNestedJitHelper.php');
        $this->assertStringContainsString('findStorage', $bagFind);
        $bagFill = (string) file_get_contents($root.'/ext/standard/UnserializeSplArrayFillNestedJitHelper.php');
        $this->assertStringContainsString('fillAt', $bagFill);
    }
