...
/**
 * Drop leftover always-on __compiler_unserialize ABI shell from Builtin\Type (#33213).
 *
...
final class TypeDeadUnserializeAbiRuntimeShrinkTest extends TestCase
{
    public function testTypeBuiltinDropsLeftoverAlwaysOnUnserializeAbi(): void
    {
        ...
        $this->assertStringContainsString('#33213', $type);
        $this->assertDoesNotMatchRegularExpression(
            '/addFunction\(\s*[\'"]__compiler_unserialize[\'"]/',
            $type,
            'Builtin\\Type must not always-declare __compiler_unserialize (#33213)'
        );
    ...
    public function testRuntimeOwnerDeclaresUnserializeAbiModuleLocally(): void
    {
        ...
        $this->assertStringContainsString('#33213', $owner);
        ...
        $this->assertStringContainsString('#33213', $jit);
