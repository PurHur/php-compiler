...
{
    public function testAotMatchesZendFscanfArrayReturn(): void
    {
        ...
        $this->assertStringContainsString('eof=null', $zend);
    ...
    public function testProxiesAndNoNewRuntimeC(): void
    {
        ...
        $this->assertStringContainsString('JitVfscanf::parseFromHandle', $helper);
        ...
        $vfscanf = (string) file_get_contents($root.'/ext/standard/JitVfscanf.php');
        $this->assertStringContainsString('parseArrayFromHandle', $vfscanf);
        $this->assertStringContainsString('parseFromHandle', $vfscanf);
    }
}
