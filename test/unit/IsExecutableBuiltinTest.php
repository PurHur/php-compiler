...
/**
 * is_executable() VM/AOT smoke.
 */
final class IsExecutableBuiltinTest extends TestCase
{
...
PHP;
    ...
    private function runAotBinary(): string
    {
        ...
        $tmp = tempnam(sys_get_temp_dir(), 'phpc_is_executable_');
        $out = $tmp . '_bin';
