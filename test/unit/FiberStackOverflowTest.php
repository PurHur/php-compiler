...
/** FiberStackOverflow VM registration and stack guard (#7267). */
final class FiberStackOverflowTest extends TestCase
{
    ...
    public function testVmRegistersFiberStackOverflowClass(): void
    {
    ...
    public function testFiberStackOverflowClassVisibleOnVm(): void
    {
