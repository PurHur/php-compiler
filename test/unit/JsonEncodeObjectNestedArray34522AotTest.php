...
/**
 * AOT: json_encode(object) must not leak FORCE_OBJECT into nested array values (#34522).
 *
 * @see php-src ext/json/json_encoder.c php_json_encode_object
 *
 * @group llvm
 * @group aot
 */
final class JsonEncodeObjectNestedArray34522AotTest extends TestCase
{
    ...
    public function testChildFlagsStripForceObject(): void
    {
        ...
        $this->assertStringContainsString('encodeBoxedValue', $llvm);
    ...
    {
        $root = dirname(__DIR__, 2);
        $bin = sys_get_temp_dir().'/json_nested_34522_'.getmypid().'_'.md5($src);
