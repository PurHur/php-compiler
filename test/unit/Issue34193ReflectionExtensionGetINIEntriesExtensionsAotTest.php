 ...
 * @group aot
 */
final class Issue34193ReflectionExtensionGetINIEntriesExtensionsAotTest extends TestCase
{
    private const EXPECT = 'filter=2 openssl=2 mbstring=11 session=30';

    public function testRuntimeBakesExtensionModules(): void
    {
    ...
    public function testAotGetINIEntriesExtensionsMatchZend(): void
    {
        if (!LlvmToolchain::hasLibrary(dirname(__DIR__, 2))) {
            $this->markTestSkipped('LLVM 9 toolchain not available');
        }
        $root = dirname(__DIR__, 2);
        $src = $root.'/test/repro/issue_34193_reflection_extension_getinientries_extensions_aot.php';
    ...
    public function testZendGetINIEntriesExtensionsBaseline(): void
    {
        $root = dirname(__DIR__, 2);
        $src = $root.'/test/repro/issue_34193_reflection_extension_getinientries_extensions_aot.php';
    ...
    public function testVmGetINIEntriesExtensionsMatchZend(): void
    {
        $root = dirname(__DIR__, 2);
        $src = $root.'/test/repro/issue_34193_reflection_extension_getinientries_extensions_aot.php';
