...
/**
 * AOT: mb_chr()/mb_ord() runtime encoding via MbChrOrdJitHelper (#34870 leftover of #34250).
 *
 * @see php-src ext/mbstring/mbstring.c PHP_FUNCTION(mb_chr), PHP_FUNCTION(mb_ord)
 *
 * @group llvm
 * @group aot
 */
final class MbChrOrdRuntimeEncodingAotTest extends TestCase
{
    public function testAotRuntimeEncodingMatchesZend(): void
    {
        ...
        $this->assertAotMatchesZend(__DIR__.'/../repro/mb_chr_ord_runtime_encoding_aot.php');
    }
    ...
    public function testHelperAndLoweringPresent(): void
    {
        ...
        $this->assertStringContainsString('Argument #2 ($encoding)', $helper);
        $jit = (string) file_get_contents($root.'/ext/mbstring/JitMbChrOrd.php');
    ...
    {
        $root = dirname(__DIR__, 2);
        $bin = sys_get_temp_dir().'/mb_chr_ord_enc_'.getmypid().'_'.md5($src);
