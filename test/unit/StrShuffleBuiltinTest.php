...
/**
 * str_shuffle() VM/AOT smoke (issue #968).
 */
final class StrShuffleBuiltinTest extends TestCase
{
...
echo str_shuffle('z'), "\n";
if (shuffle_sig('hello') === shuffle_sig(str_shuffle('hello'))) {
    echo "perm\n";
} else {
    echo "bad\n";
}
...
TXT;
    ...
    private function runAotBinary(): string
    {
        ...
        $tmp = tempnam(sys_get_temp_dir(), 'phpc_shuf_');
        $out = $tmp . '_bin';
