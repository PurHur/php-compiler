...
/**
 * AOT: mb_trim() runtime encoding via NestedJIT assertEncodingArgv (#35199 leftover of #34379).
 *
...
final class MbTrimRuntimeEncodingAotTest extends TestCase
{
    public function testAotRuntimeEncodingMatchesVm(): void
    {
        ...
        $this->assertStringContainsString(
            'bad_enc=mb_trim(): Argument #3 ($encoding) must be a valid encoding, "nope" given',
            $vm
        );
    }
    ...
    public function testHelperAndLoweringPresent(): void
    {
        ...
        $this->assertStringContainsString('ASSERT_ENCODING', $runtime);
