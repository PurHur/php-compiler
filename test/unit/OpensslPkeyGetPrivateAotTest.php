...
/**
 * AOT: openssl_pkey_get_private() leftover of #6295 (#33510) — TypeError/argc gates.
 *
...
final class OpensslPkeyGetPrivateAotTest extends TestCase
{
    ...
    {
        $runtime = new Runtime();
        $code = file_get_contents(dirname(__DIR__).'/repro/issue_33510_openssl_pkey_get_private_aot.php');
        $this->assertNotFalse($code);
        ob_start();
        $runtime->run($runtime->parseAndCompile($code, 'issue_33510_openssl_pkey_get_private_aot.php'));
    ...
    public function testAotTypeErrorAndArgcMatchVm(): void
    {
        ...
        $src = $root.'/test/repro/issue_33510_openssl_pkey_get_private_aot.php';
        $runtime = new Runtime();
