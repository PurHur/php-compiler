...
{
    /** ChildGdp map — parent private $p omitted (Zend); own private $t kept. */
    private const EXPECT_CHILD = '{"q":2,"r":3,"s":4,"sq":20,"ss":40,"st":50,"t":5,"u":null}';

    /** SimpleGdp public defaults. */
    ...
    public function testZendGetDefaultPropertiesBaseline(): void
    {
        $root = dirname(__DIR__, 2);
        $src = $root.'/test/repro/issue_34091_reflection_get_default_properties_aot.php';
