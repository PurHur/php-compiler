...
/**
 * AOT: exact int division stays int; inexact stays float (#35337).
 *
...
{
    public function testVmExactIntDivMatchesZend(): void
    {
        $runtime = new Runtime();
    ...
    public function testAotExactIntDivMatchesZend(): void
    {
