...
/**
 * AOT: ZipArchive renameIndex NestedJIT (#35474 leftover of #35450).
 *
 ...
 * @group aot
 */
final class ZipArchiveRenameIndex35474AotTest extends TestCase
{
    ...
    public function testProxyRegisteredForRenameIndex(): void
    {
        ...
        $this->assertStringContainsString('function renameIndex', $jit);
    }
