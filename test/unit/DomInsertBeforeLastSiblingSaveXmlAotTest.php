...
/**
 * AOT: insertBefore before last sibling must not duplicate saveXML (#34428).
 *
 * LiveSlots rebuilds INNER_XML; compile-time splice must not overwrite that slot.
...
final class DomInsertBeforeLastSiblingSaveXmlAotTest extends TestCase
{
    ...
    public function testAotInsertBeforeLastSiblingSaveXml(): void
    {
        ...
        $bin = sys_get_temp_dir().'/phpc_dom_ib_last_sib_'.getmypid().'.bin';
    ...
    public function testRelocateOrInsertDoesNotDuplicateExistingChunk(): void
    {
