...
final class SpineChunkRuntimeMethodDemoteTest extends TestCase
{
    ...
    public function testShouldDemoteHubCapacityClassesUnderSpineChunk(): void
    {
        ...
        $this->assertTrue(SpineChunkRuntimeMethodDemote::shouldDemote('PHPCompiler\\AssignOperandValueAndCompileTimeMeta'));
        ...
        $this->assertTrue(SpineChunkRuntimeMethodDemote::isDemoteTarget('PHPCompiler\\AssignOperandValueAndCompileTimeMeta'));
        ...
        $this->assertTrue(SpineChunkRuntimeMethodDemote::oversizeSingletonCanEmit('lib/JIT/Concern/AssignOperandValueAndCompileTimeMeta.php'));
