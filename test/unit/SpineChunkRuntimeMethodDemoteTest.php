...
final class SpineChunkRuntimeMethodDemoteTest extends TestCase
{
    ...
    public function testShouldDemoteHubCapacityClassesUnderSpineChunk(): void
    {
        ...
        $this->assertTrue(SpineChunkRuntimeMethodDemote::shouldDemote('PHPCompiler\\ConstructMarkAndByRefOutParam'));
        ...
        $this->assertTrue(SpineChunkRuntimeMethodDemote::isDemoteTarget('PHPCompiler\\ConstructMarkAndByRefOutParam'));
        ...
        $this->assertTrue(SpineChunkRuntimeMethodDemote::oversizeSingletonCanEmit('lib/JIT/Concern/ConstructMarkAndByRefOutParam.php'));
