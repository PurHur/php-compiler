...
final class SpineChunkRuntimeMethodDemoteTest extends TestCase
{
    ...
    public function testShouldDemoteHubCapacityClassesUnderSpineChunk(): void
    {
        ...
        $this->assertTrue(SpineChunkRuntimeMethodDemote::shouldDemote('PHPCompiler\\M3EmitTuCompilerAndRuntimeMethodBodies'));
        ...
        $this->assertTrue(SpineChunkRuntimeMethodDemote::isDemoteTarget('PHPCompiler\\M3EmitTuCompilerAndRuntimeMethodBodies'));
        ...
        $this->assertTrue(SpineChunkRuntimeMethodDemote::oversizeSingletonCanEmit('lib/JIT/Concern/M3EmitTuCompilerAndRuntimeMethodBodies.php'));
