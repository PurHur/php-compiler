...
{
    public function testStringValueBagMatchesZend(): void
    {
        $this->assertAotMatchesZend(__DIR__.'/../repro/arrayobject_unserialize_string_value_33663.php');
    }

    public function testFillHelperAcceptsStringValues(): void
    {
        $fill = (string) file_get_contents(
            dirname(__DIR__, 2).'/ext/standard/UnserializeSplArrayFillNestedJitHelper.php'
        );
        $this->assertStringContainsString('phpc_native_ht_set_string_key(', $fill);
        $this->assertStringContainsString('#33663', $fill);
    }
    ...
    private function runAot(string $src): string
    {
        ...
        $bin = sys_get_temp_dir().'/ao_strval_33663_'.getmypid().'_'.md5($src);
