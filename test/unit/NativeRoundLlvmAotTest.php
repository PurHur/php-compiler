...
/**
 * round() places=0 directed modes via LLVM f64 intrinsics match Zend (#36386).
 *
 * php-src: ext/standard/math.c PHP_FUNCTION(round) / _php_math_round /
 * php_math_round_mode.h — HALF_UP≡round(3), CEILING≡ceil, FLOOR≡floor,
 * TOWARD_ZERO≡trunc. Compile-time scalar round() folds on the host — IR
 * checks use float formals.
 *
 * @group aot-lint
 */
