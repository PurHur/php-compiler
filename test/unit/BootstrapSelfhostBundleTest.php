...
final class BootstrapSelfhostBundleTest extends TestCase
{
    ...
    private const LIB_SPINE_SMOKE_NEW_UNITS = [
        ...
        'ext/standard/JitFtokKernel.php',
...
<<<<<<< HEAD
        $this->assertSame(8538, $count, 'M2 spine require_once units track Phase A inventory (#8559, #9234, #11629, #18550, #36079); coverage sync defers PregJitHelperThinAot (#24115) + NetworkServicesNameLookupThinAot (#27103)');
=======
        $this->assertSame(8537, $count, 'M2 spine require_once units track Phase A inventory (#8559, #9234, #11629, #18550, #36079); coverage sync defers PregJitHelperThinAot (#24115) + NetworkServicesNameLookupThinAot (#27103)');
>>>>>>> f4092bd05f (Split-TU: extract HelperRuntimeIndex (#36387))
