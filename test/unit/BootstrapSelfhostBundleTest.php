...
final class BootstrapSelfhostBundleTest extends TestCase
{
    ...
    public function testCompilerLibSpineSmokeBundleUnitCountAndKeyUnits(): void
    {
        ...
        // Spine ratio 4181/4182 — 1 deferred (TimezoneAbbreviationsData, #16866).
        $this->assertSame(4181, $count, 'M2 spine require_once units track Phase A inventory (#8559, #9234, #11629)');
