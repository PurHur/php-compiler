...
final class BootstrapSelfhostBundleTest extends TestCase
{
    ...
    public function testCompilerLibSpineSmokeBundleUnitCountAndKeyUnits(): void
    {
        ...
        // Spine ratio 6833/6835 — 2 deferred (ext/standard/PregJitHelperThinAot.php, #24115; ext/standard/NetworkServicesNameLookupThinAot.php, #27098).
        $this->assertSame(6833, $count, 'M2 spine require_once units track Phase A inventory (#8559, #9234, #11629, #18550); 2 deferred PregJitHelperThinAot (#24115) + NetworkServicesNameLookupThinAot (#27098)');
