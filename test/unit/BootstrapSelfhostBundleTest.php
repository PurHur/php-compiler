...
final class BootstrapSelfhostBundleTest extends TestCase
{
    ...
    public function testCompilerLibSpineSmokeBundleUnitCountAndKeyUnits(): void
    {
        ...
        // Spine ratio 6805/6805 — 1 deferred (ext/standard/PregJitHelperThinAot.php, #24115).
        $this->assertSame(6805, $count, 'M2 spine require_once units track Phase A inventory (#8559, #9234, #11629, #18550); 1 deferred PregJitHelperThinAot (#24115)');
