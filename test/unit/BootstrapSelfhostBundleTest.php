...
final class BootstrapSelfhostBundleTest extends TestCase
{
    ...
    public function testCompilerLibSpineSmokeBundleUnitCountAndKeyUnits(): void
    {
        ...
        // Spine ratio 7217/7219 — 2 deferred (PregJitHelperThinAot #24115, NetworkServicesNameLookupThinAot #27103).
        $this->assertSame(7217, $count, 'M2 spine require_once units track Phase A inventory (#8559, #9234, #11629, #18550); 2 deferred PregJitHelperThinAot (#24115) + NetworkServicesNameLookupThinAot (#27103)');
