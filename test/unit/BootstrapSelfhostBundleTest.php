...
final class BootstrapSelfhostBundleTest extends TestCase
{
    ...
    public function testCompilerLibSpineSmokeBundleUnitCountAndKeyUnits(): void
    {
        ...
        $count = substr_count($contents, 'require_once __DIR__');
                $this->assertSame(435, $count, '108 compiler_minimal units + 327 M2 spine units (#1745 tokenizer-compat); array_pop/shift/search + preg/array_combine wrappers skipped (AOT types); Vm* deferred #1467');
