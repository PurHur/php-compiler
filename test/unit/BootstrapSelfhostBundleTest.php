...
final class BootstrapSelfhostBundleTest extends TestCase
{
    ...
    public function testCompilerLibSpineSmokeBundleUnitCountAndKeyUnits(): void
    {
        ...
        // Spine ratio 6715/6716 — 1 deferred (ext/standard/PregJitHelperThinAot.php, #24115).
        $this->assertSame(6715, $count, 'M2 spine require_once units track Phase A inventory (#8559, #9234, #11629, #18550); 1 deferred PregJitHelperThinAot (#24115)');
