...
final class BootstrapSelfhostBundleTest extends TestCase
{
    ...
    public function testCompilerLibSpineSmokeBundleUnitCountAndKeyUnits(): void
    {
        ...
        // Spine ratio 4197/4198 — 1 deferred (TimezoneAbbreviationsData, #16866).
        $this->assertSame(4197, $count, 'M2 spine require_once units track Phase A inventory (#8559, #9234, #11629)');
