...
final class BootstrapSelfhostBundleTest extends TestCase
{
    ...
    public function testCompilerLibSpineSmokeBundleUnitCountAndKeyUnits(): void
    {
        ...
        // Spine ratio 4183/4184 — 1 deferred (TimezoneAbbreviationsData, #16866).
        $this->assertSame(4183, $count, 'M2 spine require_once units track Phase A inventory (#8559, #9234, #11629)');
