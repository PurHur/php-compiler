...
final class SplFileInfoOpenFile33305AotTest extends TestCase
{
    ...
    {
        $path = dirname(__DIR__).'/fixtures/aot/cases/splfileinfo_openfile_33305.phpt';
    ...
    public function testNoNewRuntimeC(): void
    {
        ...
        $this->assertStringContainsString('allocateInitialized', $sfo);
        $this->assertStringContainsString('#33305', $sfo);
    }
}
