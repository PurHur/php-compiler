...
final class SplFixedArrayUnserialize33640AotTest extends TestCase
{
    ...
    public function testHelperWired(): void
    {
        ...
        $this->assertStringContainsString('#33640', $helper);
        $fill = (string) file_get_contents($root.'/ext/standard/UnserializeSplFixedArrayFillNestedJitHelper.php');
        $this->assertStringContainsString('fillAt', $fill);
        $this->assertStringContainsString('phpc_native_ht_set_null_at', $fill);
        $find = (string) file_get_contents($root.'/ext/standard/UnserializeSplFixedArrayFindNestedJitHelper.php');
        $this->assertStringContainsString('afterBrace', $find);
    }
