...
/**
 * AOT: unserialize(serialize(DateTime*)) named zone format/getOffset (#34614).
 *
 * @see php-src ext/date/php_date.c — php_date_unserialize / DateTime::__unserialize
 *
 * @group llvm
 * @group aot
 */
...
{
    public function testAotNamedZoneFormatAndOffsetMatchZend(): void
    {
    ...
    public function testFoldPublishesConstructStyleStamps(): void
    {
