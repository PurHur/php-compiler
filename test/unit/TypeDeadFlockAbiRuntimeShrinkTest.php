 ...
 * StreamReadJitHelper. Runtime owner declares module-locally (getNamedFunction
 * first) so leftover Type empty decls cannot mint flock.1 (#31894 / #32122).
 */
final class TypeDeadFlockAbiRuntimeShrinkTest extends TestCase
{
    public function testTypeBuiltinDropsLeftoverAlwaysOnFlockAbi(): void
    {
        ...
        // Next leftover sentinel (fpassthru still Type always-on).
        $this->assertStringContainsString("registerFunction('__compiler_fpassthru'", $type);
    ...
    public function testRuntimeOwnerDeclaresFlockAbiModuleLocally(): void
    {
        ...
        $this->assertStringContainsString('#33104', $runtime);
        $this->assertStringContainsString("getNamedFunction('__compiler_flock')", $runtime);
        ...
        $this->assertFileExists(__DIR__.'/../../ext/standard/flock.php');
        $jitFlock = (string) file_get_contents(__DIR__.'/../../ext/standard/JitFlock.php');
        $this->assertStringContainsString('StreamReadRuntime::ensureLinked', $jitFlock);
    }
