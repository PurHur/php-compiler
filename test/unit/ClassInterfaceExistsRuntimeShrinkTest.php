...
final class ClassInterfaceExistsRuntimeShrinkTest extends TestCase
{
    ...
    public function testStringClassExistsUsesJitHelperNotStrcasecmpLoop(): void
    {
        ...
        $this->assertStringNotContainsString('emitNameMatchWalk', $source);
        $this->assertStringNotContainsString("lookupFunction('strcasecmp'", $source);
    }
    ...
    public function testJitHelpersDelegateToVmReflection(): void
    {
        ...
        $this->assertStringContainsString('isAStringArgv(Variable $childName, string $className): int', $classHelper);
        $this->assertStringContainsString('isSubclassOfStringArgv(Variable $childName, string $parentName): int', $classHelper);
