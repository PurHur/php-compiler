...
/**
 * AOT: `$r = &$obj->prop; $r = N` write-through (#35898).
 *
...
final class AotPropByrefAssignTest extends TestCase
{
    ...
    public function testVmPropByrefAssign(): void
    {
        $runtime = new Runtime();
    ...
    public function testAotPropByrefAssign(): void
    {
        ...
        $bin = sys_get_temp_dir().'/phpc_aot_prop_byref_'.getmypid().'.bin';
