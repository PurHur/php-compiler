...
/**
 * #35804 — AOT Dom\HTMLDocument / XMLDocument::createFromFile matches VM get_class.
 *
 * @group llvm
 */
final class DomCreateFromFileAotTest extends TestCase
{
    public function testAotCreateFromFileGetClassMatchesVm(): void
    {
        ...
        try {
            ...
            $bin = sys_get_temp_dir().'/phpc_35804_'.getmypid().'.bin';
