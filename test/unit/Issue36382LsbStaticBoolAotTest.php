...
/**
 * AOT: LSB typed static bool with two same-named properties must compile and match Zend (#36382).
 *
 * @group llvm
 * @group aot
 */
final class Issue36382LsbStaticBoolAotTest extends TestCase
{
    public function testAotLsbTypedStaticBoolMatchesZend(): void
    {
        $root = dirname(__DIR__, 2);
        $src = $root.'/test/repro/issue_36382_lsb_static_bool.php';
        ...
        $bin = sys_get_temp_dir().'/phpc_36382_lsb_bool_'.getmypid().'.bin';
        $env = $_ENV;
