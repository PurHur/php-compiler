...
final class Issue35866OpensslPkeyNewRuntimeOptsAotTest extends TestCase
{
    ...
    public function testNoCompileTimeOnlyLogicException(): void
    {
        ...
        $this->assertStringContainsString('lowerRuntimeOptions', $jit);
        $this->assertStringContainsString('__hashtable__readStringKeyValue', $jit);
