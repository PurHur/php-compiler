 ...
 *
 * @see php-src ext/spl/spl_directory.c zim_SplFileInfo_isFile / getSize / …
 *
 * @group llvm
 * @group aot
 */
final class SplFileObjectStatMethods33313AotTest extends TestCase
{
    ...
    public function testNoNewRuntimeC(): void
    {
        ...
        $this->assertStringContainsString('#33313', $ctx);
        $this->assertStringContainsString("'isFile'", $ctx);
        $this->assertStringContainsString("'SplFileObject'", $ctx);
    }
}
