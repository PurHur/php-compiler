...
/**
 * ArrayIterator::seek(null) — soft-null E_DEPRECATED then seek 0 (#31730).
 *
 * php-src: ext/spl/spl_array.c — SPL_METHOD(Array, seek)
 */
final class Issue31730ArrayIteratorSeekNullTest extends TestCase
{
    ...
    public function testVmStrictTypesSeekNullTypeError(): void
    {
        ...
        $this->assertSame(
            "TypeError: ArrayIterator::seek(): Argument #1 (\$offset) must be of type int, null given\n",
            $out
        );
    }
    ...
    {
        return "DEP:ArrayIterator::seek(): Passing null to parameter #1 (\$offset) of type int is deprecated\n"
            ."key=0 current=10\n";
    }
...
PHP;
    ...
    private function runBin(string $bin, string $code): string
    {
        ...
        $tmp = tempnam(sys_get_temp_dir(), 'phpc_31730_');
