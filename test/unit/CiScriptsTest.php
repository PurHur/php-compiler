...
final class CiScriptsTest extends TestCase
{
    ...
    public function testCiDefaultsEnvDefinesCapabilitiesThrowsSyncGateOff(): void
    {
        $defaults = (string) file_get_contents(dirname(__DIR__, 2).'/script/ci-defaults.env');
    ...
    public function testCiDockerRunPassesCapabilitiesThrowsSyncGateDefaultOff(): void
    {
        $body = (string) file_get_contents(dirname(__DIR__, 2).'/script/ci-docker-run.sh');
