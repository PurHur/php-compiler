...
/**
 * AOT: openssl_x509_read() leftover of #7268 (#33497).
 *
 * @see php-src ext/openssl/openssl.c / xp.c PHP_FUNCTION(openssl_x509_read)
 *
 * @group aot-lint
 */
final class OpensslX509ReadAotTest extends TestCase
{
    ...
    {
        $runtime = new Runtime();
        $code = file_get_contents(dirname(__DIR__).'/repro/issue_33497_openssl_x509_read_aot.php');
        $this->assertNotFalse($code);
        ob_start();
        $runtime->run($runtime->parseAndCompile($code, 'issue_33497_openssl_x509_read_aot.php'));
    ...
    public function testAotTypeErrorAndArgcMatchVm(): void
    {
        ...
        $src = $root.'/test/repro/issue_33497_openssl_x509_read_aot.php';
        $runtime = new Runtime();
        ...
        $bin = sys_get_temp_dir().'/phpc_ossl_x509_read_'.getmypid().'.bin';
    ...
    public function testCallEmitsCatchableTypeErrorNotOnlyLogicException(): void
    {
