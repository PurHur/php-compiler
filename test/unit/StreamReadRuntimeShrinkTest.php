...
final class StreamReadRuntimeShrinkTest extends TestCase
{
    public function testStreamReadRuntimeUsesJitHelperAlwaysNoThinFork(): void
    {
        ...
        // Thin AOT still NestedJITs the helper, then forceLibc* replaces FILE*-table ABIs (#27663, #27437, #33122).
        ...
        $this->assertStringContainsString('implementFlockForce', $source);
        $this->assertStringContainsString('implementFpassthruForce', $source);
