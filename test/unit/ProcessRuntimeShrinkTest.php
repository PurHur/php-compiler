...
/** ProcessRuntime routes standalone + embed through ProcessJitHelper PHP not libc LLVM (#9337, #12950, #19006, #19086). */
final class ProcessRuntimeShrinkTest extends TestCase
{
    public function testProcessRuntimeIsThinRouter(): void
    {
        ...
        $this->assertStringNotContainsString('ProcessShellExecLibc', $runtime);
        $this->assertFileDoesNotExist(__DIR__.'/../../lib/JIT/Builtin/ProcessShellExecLibc.php');
