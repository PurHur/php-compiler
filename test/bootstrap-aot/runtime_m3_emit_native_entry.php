...
/**
 * Native M3 compile-smoke emit binary (issue #2294).
 *
...
require_once __DIR__.'/runtime_compile_smoke_m3_emit.php';
...
if (!is_string($sourceFile) || '' === $sourceFile || !is_string($outFile) || '' === $outFile) {
    echo "runtime_compile_smoke_m3_emit_entry: set PHP_COMPILER_M3_SOURCE and PHP_COMPILER_M3_OUT\n";
    exit(1);
}
