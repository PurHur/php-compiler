...
/**
 * Native M3 JIT unit probe emit binary (issue #2778).
 *
 * Same emit spine as compiler_unit_probe_m3_emit_native_entry.php: Runtime parseAndCompileEmitSmoke
 * + standalone without bundling jit_unit_probe FUNCDEF (LLVM 9 link).
 *
...
if (!is_string($sourceFile) || '' === $sourceFile || !is_string($outFile) || '' === $outFile) {
    echo "jit_unit_probe_m3_emit_entry: set PHP_COMPILER_M3_SOURCE and PHP_COMPILER_M3_OUT\n";
    exit(1);
}
