 ...
 *
 * Same emit spine as compile_smoke_m3_emit_native_entry.php: Runtime parseAndCompileEmitSmoke
 * + standalone without bundling compiler_unit_probe FUNCDEF (LLVM 9 link).
 *
