 ...
 *
 * Same emit spine as compiler_unit_probe/main.php — Runtime parseAndCompile + standalone
 * via compiler_unit_probe_m3_emit (reuses compile_smoke_m3_emit lowering).
 *
