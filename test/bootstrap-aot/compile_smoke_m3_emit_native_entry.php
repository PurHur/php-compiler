...
/**
 * Native M3 compile-smoke emit binary (issue #1983).
 *
 * Full compiler/JIT spine (same as compiler_compile_smoke/compile_driver.php) but linked
 * without PHP_COMPILER_SELFHOST_AOT so Runtime::parseAndCompile lowers normally at link time.
 * The self-host compile_driver keeps emit FUNCDEF stubbed (LLVM 9); this entry is the runtime emit TU.
 *
