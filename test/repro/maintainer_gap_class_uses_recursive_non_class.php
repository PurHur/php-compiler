...
expect_type_error(static fn () => class_uses_recursive(123), 'class_uses_recursive(123)');
expect_type_error(static fn () => class_uses_recursive(false), 'class_uses_recursive(false)');
