...
// #33458 leftover of #20305 — compile-time PKCS#7 PEM (test/fixtures/openssl/cert.p7b)
$data = '-----BEGIN PKCS7-----
...
$certs = [];
var_export(openssl_pkcs7_read($data, $certs));
echo "|";
echo (isset($certs[0]) && str_starts_with($certs[0], "-----BEGIN CERTIFICATE-----")) ? "cert-ok" : "cert-bad";
echo "|";
$bad = [];
var_export(openssl_pkcs7_read("not-a-pkcs7", $bad));
echo "\n";