...
$checks = [
    ...
    'array_all_key' => 'array_all_key(): Argument #1 ($array) must be of type array, null given',
    'array_any' => 'array_any(): Argument #1 ($array) must be of type array, null given',
    'array_any_key' => 'array_any_key(): Argument #1 ($array) must be of type array, null given',
