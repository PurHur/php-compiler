...
# Inventory emit-helper AOT needs ≥16GiB PHP + Docker cgroup (#23970). When invoking
# via docker-exec from the host, set PHP_COMPILER_DOCKER_MEM=16g PHP_COMPILER_DOCKER_MEM_SWAP=16g
# (and preferably PHP_COMPILER_MEMORY_LIMIT=16384M) — the default 10g cgroup is too small.
