...
| **Inventory coverage** | **5289** / **5289** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5289/5289** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5289** / **5289** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5289** / **5289** (`php script/bootstrap-spine-count.php`) |
