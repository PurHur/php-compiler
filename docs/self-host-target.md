...
| **M4** | Self-host binary **rebuilds** the next compiler tree | 🚧 gen-2→gen-3 spine **725/725** ✅; full revision / argv CLI ✅ ([#2880](https://github.com/PurHur/php-compiler/issues/2880)) | **~80%** |
