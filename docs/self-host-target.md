...
| **Inventory coverage** | **8151** / **8151** ✅ | Full closure |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **8151** / **8151** (`php script/bootstrap-spine-count.php`) |
