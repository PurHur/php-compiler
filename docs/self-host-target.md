...
| **Inventory coverage** | **5784** / **5784** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5784/5784** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5784** / **5784** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5784** / **5784** (`php script/bootstrap-spine-count.php`) |
