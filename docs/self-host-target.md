...
| **Inventory coverage** | **5574** / **5574** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5574/5574** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5574** / **5574** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5574** / **5574** (`php script/bootstrap-spine-count.php`) |
