...
| **Inventory coverage** | **5213** / **5213** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5213/5213** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5213** / **5213** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5213** / **5213** (`php script/bootstrap-spine-count.php`) |
