...
| **Inventory coverage** | **5400** / **5400** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5400/5400** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5400** / **5400** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5400** / **5400** (`php script/bootstrap-spine-count.php`) |
