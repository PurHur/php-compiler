...
| **Inventory coverage** | **6030** / **6030** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **6030/6030** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **6030** / **6030** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **6030** / **6030** (`php script/bootstrap-spine-count.php`) |
