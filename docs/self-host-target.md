...
| **Inventory coverage** | **5357** / **5357** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5357/5357** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5357** / **5357** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5357** / **5357** (`php script/bootstrap-spine-count.php`) |
