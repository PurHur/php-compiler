...
| **Bundle size** | **419** curated `require_once` in spine smoke (108 minimal overlap + **311** M2-only) | **586** inventory files |
| **Inventory coverage** | **~72%** of vm.php path in spine smoke (**419/586**) | **100%** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | 🚧 **419/586** units | **~72%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **419 / 586 ≈ 72%** |
...
| `test/selfhost/compiler_lib_spine_smoke/main.php` | **419** | M2 growth ([#1056](https://github.com/PurHur/php-compiler/issues/1056) math/web batch) |
