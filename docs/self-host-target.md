...
| **Inventory coverage** | **4894** / **4896** ✅ | Full closure |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **4894** / **4896** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **4894** / **4896** (`php script/bootstrap-spine-count.php`) |
