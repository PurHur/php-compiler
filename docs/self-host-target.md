...
| **Inventory coverage** | **5666** / **5666** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5666/5666** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5666** / **5666** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5666** / **5666** (`php script/bootstrap-spine-count.php`) |
