...
| **Inventory coverage** | **5603** / **5603** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5603/5603** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5603** / **5603** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5603** / **5603** (`php script/bootstrap-spine-count.php`) |
