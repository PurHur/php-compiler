...
| **Full inventory** | Honest bundle covers the `bin/vm.php` path (~**586** files; [`bootstrap-inventory.md`](bootstrap-inventory.md)) |
...
| **Bundle size** | **447** curated `require_once` in spine smoke (108 minimal overlap + **339** M2-only) | **586** inventory files |
| **Inventory coverage** | **~76%** of vm.php path in spine smoke (**447/586**) | **100%** |
...
| `php script/bootstrap-inventory.php --check` | ✅ **586** files, **0** source blockers |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | 🚧 **447/586** units | **~76%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **447 / 586 ≈ 76%** |
...
| `test/selfhost/compiler_lib_spine_smoke/main.php` | **447** | M2 growth ([#1741](https://github.com/PurHur/php-compiler/issues/1741) Linker, [#1725](https://github.com/PurHur/php-compiler/issues/1725) tempnam, [#1726](https://github.com/PurHur/php-compiler/issues/1726) touch_, [#1687](https://github.com/PurHur/php-compiler/issues/1687) stat_, [#1701](https://github.com/PurHur/php-compiler/issues/1701) stream_context_create, [#1731](https://github.com/PurHur/php-compiler/issues/1731) unlink, [#1734](https://github.com/PurHur/php-compiler/issues/1734) usort_, [#1686](https://github.com/PurHur/php-compiler/issues/1686) sqrt, [#1728](https://github.com/PurHur/php-compiler/issues/1728) uasort_) |
