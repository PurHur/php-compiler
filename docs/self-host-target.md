...
| **Inventory coverage** | **7983** / **7983** ✅ | Full closure |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **7983** / **7983** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **7983** / **7983** (`php script/bootstrap-spine-count.php`) |
