...
| **Inventory coverage** | **5544** / **5544** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5544/5544** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5544** / **5544** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5544** / **5544** (`php script/bootstrap-spine-count.php`) |
