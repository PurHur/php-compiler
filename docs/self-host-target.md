...
| **Inventory coverage** | **5297** / **5297** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5297/5297** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5297** / **5297** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5297** / **5297** (`php script/bootstrap-spine-count.php`) |
