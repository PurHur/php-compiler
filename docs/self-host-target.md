...
| **Inventory coverage** | **5616** / **5616** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5616/5616** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5616** / **5616** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5616** / **5616** (`php script/bootstrap-spine-count.php`) |
