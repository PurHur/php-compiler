...
| **Inventory coverage** | **6228** / **6228** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **6228/6228** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **6228** / **6228** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **6228** / **6228** (`php script/bootstrap-spine-count.php`) |
