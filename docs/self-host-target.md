...
| **Inventory coverage** | **5004** / **5004** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5004/5004** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5004** / **5004** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5004** / **5004** (`php script/bootstrap-spine-count.php`) |
