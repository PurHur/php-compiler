...
| **Inventory coverage** | **5360** / **5360** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5360/5360** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5360** / **5360** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5360** / **5360** (`php script/bootstrap-spine-count.php`) |
