...
| **Inventory coverage** | **5171** / **5171** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5171/5171** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5171** / **5171** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5171** / **5171** (`php script/bootstrap-spine-count.php`) |
