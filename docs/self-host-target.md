...
| **Bundle size** | **6978/6980** literal Phase A inventory in spine smoke | Full vm.php closure |
| **Inventory coverage** | **6978** / **6980** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **6978/6980** |
| `make bootstrap-inventory-check` | ✅ **6978/6980** Phase A files, **0** source blockers |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **6978** / **6980** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **6978** / **6980** (2 deferred: `ext/standard/PregJitHelperThinAot.php` / #24115, `ext/standard/NetworkServicesNameLookupThinAot.php` / #27103) (`php script/bootstrap-spine-count.php`) |
...
| `test/selfhost/compiler_lib_spine_smoke/main.php` | **6978/6980** Phase A | M2 complete ([#8559](https://github.com/PurHur/php-compiler/issues/8559)) |
