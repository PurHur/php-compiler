...
| **Inventory coverage** | **6197** / **6197** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **6197/6197** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **6197** / **6197** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **6197** / **6197** (`php script/bootstrap-spine-count.php`) |
