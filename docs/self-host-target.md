...
| **Bundle size** | **582** curated `require_once` in spine smoke (108 minimal overlap + **474** M2-only) | **586** inventory files |
| **Inventory coverage** | **~99%** of vm.php path in spine smoke (**582/586**) | **100%*
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | 🚧 **582/586** units | **~99%*
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **582 / 586 ≈ 99%*
...
| `test/selfhost/compiler_lib_spine_smoke/main.php` | **582** | M2 growth (ext/standard + Vm* spine batch
