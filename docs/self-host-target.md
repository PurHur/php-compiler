...
| **Bundle size** | **573** curated `require_once` in spine smoke (108 minimal overlap + **465** M2-only) | **586** inventory files |
| **Inventory coverage** | **~98%** of vm.php path in spine smoke (**573/586**) | **100%** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | 🚧 **573/586** units | **~98%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **573 / 586 ≈ 98%** |
...
| `test/selfhost/compiler_lib_spine_smoke/main.php` | **573** | M2 growth (ext/standard + Vm* spine batch) |
