...
| **Bundle size** | **578** curated `require_once` in spine smoke (108 minimal overlap + **469** M2-only) | **586** inventory files |
| **Inventory coverage** | **~98%** of vm.php path in spine smoke (**578/586**) | **100%*
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | 🚧 **578/586** units | **~98%*
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **578 / 586 ≈ 98%*
...
| `test/selfhost/compiler_lib_spine_smoke/main.php` | **578** | M2 growth (ext/standard + Vm* spine batch
