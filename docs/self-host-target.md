...
| **Inventory coverage** | **8545** / **8545** ✅ | Full closure |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **8545** / **8545** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **8545** / **8545** (`php script/bootstrap-spine-count.php`) |
