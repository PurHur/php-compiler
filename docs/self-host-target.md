...
| **Inventory coverage** | **5673** / **5673** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5673/5673** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5673** / **5673** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5673** / **5673** (`php script/bootstrap-spine-count.php`) |
