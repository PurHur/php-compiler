...
| **Inventory coverage** | **5170** / **5170** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5170/5170** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5170** / **5170** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5170** / **5170** (`php script/bootstrap-spine-count.php`) |
