...
| **Inventory coverage** | **5290** / **5290** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5290/5290** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5290** / **5290** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5290** / **5290** (`php script/bootstrap-spine-count.php`) |
