...
| **Inventory coverage** | **5563** / **5563** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5563/5563** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5563** / **5563** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5563** / **5563** (`php script/bootstrap-spine-count.php`) |
