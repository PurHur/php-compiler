...
| **Inventory coverage** | **6011** / **6011** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **6011/6011** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **6011** / **6011** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **6011** / **6011** (`php script/bootstrap-spine-count.php`) |
