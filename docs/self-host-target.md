...
| **Inventory coverage** | **6170** / **6170** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **6170/6170** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **6170** / **6170** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **6170** / **6170** (`php script/bootstrap-spine-count.php`) |
