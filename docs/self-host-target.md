...
| **Inventory coverage** | **5640** / **5640** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5640/5640** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5640** / **5640** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5640** / **5640** (`php script/bootstrap-spine-count.php`) |
