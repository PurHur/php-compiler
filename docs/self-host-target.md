...
| **Inventory coverage** | **5081** / **5081** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5081/5081** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5081** / **5081** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5081** / **5081** (`php script/bootstrap-spine-count.php`) |
