...
| **Inventory coverage** | **8464** / **8464** ✅ | Full closure |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **8464** / **8464** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **8464** / **8464** (`php script/bootstrap-spine-count.php`) |
