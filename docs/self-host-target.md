...
| **Inventory coverage** | **5719** / **5719** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5719/5719** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5719** / **5719** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5719** / **5719** (`php script/bootstrap-spine-count.php`) |
