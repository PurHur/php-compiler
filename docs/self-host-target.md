...
| **Inventory coverage** | **5258** / **5258** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5258/5258** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5258** / **5258** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5258** / **5258** (`php script/bootstrap-spine-count.php`) |
