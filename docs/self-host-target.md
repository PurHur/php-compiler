...
| **Inventory coverage** | **5183** / **5183** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5183/5183** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5183** / **5183** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5183** / **5183** (`php script/bootstrap-spine-count.php`) |
