...
| **Inventory coverage** | **5391** / **5391** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5391/5391** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5391** / **5391** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5391** / **5391** (`php script/bootstrap-spine-count.php`) |
