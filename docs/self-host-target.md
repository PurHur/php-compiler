...
| **Bundle size** | **6517/6517** literal Phase A inventory in spine smoke | Full vm.php closure |
| **Inventory coverage** | **6517** / **6517** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **6517/6517** |
| `make bootstrap-inventory-check` | ✅ **6517/6517** Phase A files, **0** source blockers |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **6517** / **6517** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **6517** / **6517** (`php script/bootstrap-spine-count.php`) |
...
| `test/selfhost/compiler_lib_spine_smoke/main.php` | **6517/6517** Phase A | M2 complete ([#8559](https://github.com/PurHur/php-compiler/issues/8559)) |
