...
| **Inventory coverage** | **8541** / **8541** ✅ | Full closure |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **8541** / **8541** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **8541** / **8541** (`php script/bootstrap-spine-count.php`) |
