...
| **Bundle size** | **445** curated `require_once` in spine smoke (108 minimal overlap + **337** M2-only) | **586** inventory files |
| **Inventory coverage** | **~76%** of vm.php path in spine smoke (**445/586**) | **100%** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | 🚧 **445/586** units | **~76%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **445 / 586 ≈ 76%** |
...
| `test/selfhost/compiler_lib_spine_smoke/main.php` | **445** | M2 growth ([#1741](https://github.com/PurHur/php-compiler/issues/1741) Linker, [#1725](https://github.com/PurHur/php-compiler/issues/1725) tempnam, [#1701](https://github.com/PurHur/php-compiler/issues/1701) stream_context_create, [#1731](https://github.com/PurHur/php-compiler/issues/1731) unlink, [#1734](https://github.com/PurHur/php-compiler/issues/1734) usort_, [#1728](https://github.com/PurHur/php-compiler/issues/1728) uasort_, [#1686](https://github.com/PurHur/php-compiler/issues/1686) sqrt) |
