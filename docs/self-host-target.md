...
| **Inventory coverage** | **5471** / **5471** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5471/5471** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5471** / **5471** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5471** / **5471** (`php script/bootstrap-spine-count.php`) |
