...
| **Inventory coverage** | **5842** / **5842** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5842/5842** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5842** / **5842** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5842** / **5842** (`php script/bootstrap-spine-count.php`) |
