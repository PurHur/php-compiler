...
| **Bundle size** | **408** curated `require_once` in spine smoke (108 minimal overlap + **300** M2-only) | **586** inventory files |
| **Inventory coverage** | **~70%** of vm.php path in spine smoke (**408/586**) | **100%** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | 🚧 **408/586** units | **~70%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **408 / 586 ≈ 70%** |
...
| `test/selfhost/compiler_lib_spine_smoke/main.php` | **408** | M2 growth (string-format wrappers, [#1056](https://github.com/PurHur/php-compiler/issues/1056)) |
