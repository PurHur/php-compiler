...
| **Inventory coverage** | **6046** / **6046** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **6046/6046** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **6046** / **6046** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **6046** / **6046** (`php script/bootstrap-spine-count.php`) |
