...
| **Inventory coverage** | **5126** / **5126** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5126/5126** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5126** / **5126** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5126** / **5126** (`php script/bootstrap-spine-count.php`) |
