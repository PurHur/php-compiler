...
| **Inventory coverage** | **5294** / **5294** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5294/5294** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5294** / **5294** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5294** / **5294** (`php script/bootstrap-spine-count.php`) |
