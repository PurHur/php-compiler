...
| **Inventory coverage** | **4470** / **4474** ✅ | Full closure |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **4470** / **4474** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **4470** / **4474** (`php script/bootstrap-spine-count.php`) |
