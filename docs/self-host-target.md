...
| **Inventory coverage** | **5303** / **5303** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5303/5303** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5303** / **5303** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5303** / **5303** (`php script/bootstrap-spine-count.php`) |
