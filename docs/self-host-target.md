...
| **Inventory coverage** | **5653** / **5653** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5653/5653** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5653** / **5653** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5653** / **5653** (`php script/bootstrap-spine-count.php`) |
