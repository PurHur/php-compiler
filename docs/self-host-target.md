...
| **Inventory coverage** | **5905** / **5905** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5905/5905** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5905** / **5905** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5905** / **5905** (`php script/bootstrap-spine-count.php`) |
