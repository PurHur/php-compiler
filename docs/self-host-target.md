...
| **Inventory coverage** | **5801** / **5801** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5801/5801** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5801** / **5801** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5801** / **5801** (`php script/bootstrap-spine-count.php`) |
