...
| **Inventory coverage** | **5831** / **5831** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5831/5831** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5831** / **5831** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5831** / **5831** (`php script/bootstrap-spine-count.php`) |
