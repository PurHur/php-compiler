...
| **Inventory coverage** | **5951** / **5951** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5951/5951** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5951** / **5951** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5951** / **5951** (`php script/bootstrap-spine-count.php`) |
