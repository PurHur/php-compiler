...
| **Inventory coverage** | **5641** / **5641** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5641/5641** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5641** / **5641** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5641** / **5641** (`php script/bootstrap-spine-count.php`) |
