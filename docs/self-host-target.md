...
| **Bundle size** | **585** curated `require_once` in spine smoke (108 minimal overlap + **476** M2-only) | **588** inventory files |
| **Inventory coverage** | **~99%** of vm.php path in spine smoke (**585/588**) | **100%*
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | 🚧 **585/588** units | **~99%*
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **585 / 588 ≈ 99%*
...
| `test/selfhost/compiler_lib_spine_smoke/main.php` | **585** | M2 growth (ext/standard + Vm* spine batch
