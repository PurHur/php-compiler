...
| **Inventory coverage** | **5277** / **5277** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5277/5277** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5277** / **5277** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5277** / **5277** (`php script/bootstrap-spine-count.php`) |
