...
| **Inventory coverage** | **5996** / **5996** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5996/5996** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5996** / **5996** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5996** / **5996** (`php script/bootstrap-spine-count.php`) |
