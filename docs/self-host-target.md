...
| **Inventory coverage** | **3772** / **3772** ✅ | Full closure |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **3772** / **3772** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **3772 / 3772** (`php script/bootstrap-spine-count.php`) |
