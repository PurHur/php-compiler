...
| **Inventory coverage** | **5384** / **5384** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5384/5384** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5384** / **5384** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5384** / **5384** (`php script/bootstrap-spine-count.php`) |
