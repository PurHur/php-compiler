...
| **Inventory coverage** | **4996** / **4996** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **4996/4996** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **4996** / **4996** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **4996** / **4996** (`php script/bootstrap-spine-count.php`) |
