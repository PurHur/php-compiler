...
| **Inventory coverage** | **8574** / **8574** ✅ | Full closure |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **8574** / **8574** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **8574** / **8574** (`php script/bootstrap-spine-count.php`) |
