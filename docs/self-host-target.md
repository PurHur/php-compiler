...
| **Bundle size** | **716** curated `require_once` in spine smoke (108 minimal overlap + **562** M2-only) | **717** Phase A inventory files (SSOT) |
| **Inventory coverage** | **716/717** in spine smoke with real **`bin/vm.php`** ([#2134](https://github.com/PurHur/php-compiler/issues/2134); **#2652** emit-TU JIT batch) | **100%**
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **716** units (link; **`bin/vm.php`** [#2134](https://github.com/PurHur/php-compiler/issues/2134)) | **~93%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **716 / 717** (`bin/vm.php` promoted [#2134](https://github.com/PurHur/php-compiler/issues/2134); **#2632** Phase A coverage) |
...
| `test/selfhost/compiler_lib_spine_smoke/main.php` | **716** | M2 growth (emit-TU JIT batch #2652) |
