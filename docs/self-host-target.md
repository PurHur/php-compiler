...
| **Inventory coverage** | **5799** / **5799** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5799/5799** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5799** / **5799** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5799** / **5799** (`php script/bootstrap-spine-count.php`) |
