...
| **Inventory coverage** | **5737** / **5737** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5737/5737** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5737** / **5737** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5737** / **5737** (`php script/bootstrap-spine-count.php`) |
