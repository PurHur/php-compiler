...
| **Bundle size** | **6874/6876** literal Phase A inventory in spine smoke | Full vm.php closure |
| **Inventory coverage** | **6874** / **6876** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **6874/6876** |
| `make bootstrap-inventory-check` | ✅ **6874/6876** Phase A files, **0** source blockers |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **6874** / **6876** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **6874** / **6876** (2 deferred: `ext/standard/PregJitHelperThinAot.php` / #24115, `ext/standard/NetworkServicesNameLookupThinAot.php` / #27103) (`php script/bootstrap-spine-count.php`) |
...
| `test/selfhost/compiler_lib_spine_smoke/main.php` | **6874/6876** Phase A | M2 complete ([#8559](https://github.com/PurHur/php-compiler/issues/8559)) |
