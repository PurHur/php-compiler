...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **4196** / **4197** (1 deferred: #16866) (`php script/bootstrap-spine-count.php`) |
