...
| **Inventory coverage** | **5343** / **5343** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5343/5343** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5343** / **5343** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5343** / **5343** (`php script/bootstrap-spine-count.php`) |
