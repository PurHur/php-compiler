...
| **Inventory coverage** | **5660** / **5660** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5660/5660** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5660** / **5660** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5660** / **5660** (`php script/bootstrap-spine-count.php`) |
