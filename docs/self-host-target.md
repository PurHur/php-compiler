...
| **Inventory coverage** | **5529** / **5529** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5529/5529** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5529** / **5529** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5529** / **5529** (`php script/bootstrap-spine-count.php`) |
