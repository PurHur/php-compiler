...
| **Inventory coverage** | **5364** / **5364** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5364/5364** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5364** / **5364** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5364** / **5364** (`php script/bootstrap-spine-count.php`) |
