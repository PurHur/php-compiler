...
| **Inventory coverage** | **6174** / **6174** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **6174/6174** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **6174** / **6174** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **6174** / **6174** (`php script/bootstrap-spine-count.php`) |
