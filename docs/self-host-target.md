...
| **Inventory coverage** | **4851** / **4852** (1 deferred: `lib/JIT/Builtin/ParseStrRuntimeUserScriptCstr.php`, #18855) ✅ | Full closure |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **4851** / **4852** (1 deferred: `lib/JIT/Builtin/ParseStrRuntimeUserScriptCstr.php`, #18855) | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **4851** / **4852** (1 deferred: `lib/JIT/Builtin/ParseStrRuntimeUserScriptCstr.php`, #18855) (`php script/bootstrap-spine-count.php`) |
