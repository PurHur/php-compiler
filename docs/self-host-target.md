...
| **Inventory coverage** | **6172** / **6172** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **6172/6172** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **6172** / **6172** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **6172** / **6172** (`php script/bootstrap-spine-count.php`) |
