...
| **Inventory coverage** | **5448** / **5448** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5448/5448** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5448** / **5448** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5448** / **5448** (`php script/bootstrap-spine-count.php`) |
