...
| **Inventory coverage** | **4551** / **4555** ✅ | Full closure |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **4551** / **4555** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **4551** / **4555** (`php script/bootstrap-spine-count.php`) |
