...
| **Inventory coverage** | **8316** / **8316** ✅ | Full closure |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **8316** / **8316** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **8316** / **8316** (`php script/bootstrap-spine-count.php`) |
