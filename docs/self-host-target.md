...
| **Inventory coverage** | **5450** / **5450** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5450/5450** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5450** / **5450** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5450** / **5450** (`php script/bootstrap-spine-count.php`) |
