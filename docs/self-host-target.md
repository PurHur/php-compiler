...
| **Inventory coverage** | **5378** / **5378** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5378/5378** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5378** / **5378** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5378** / **5378** (`php script/bootstrap-spine-count.php`) |
