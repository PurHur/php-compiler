...
| **Bundle size** | **594** curated `require_once` in spine smoke (108 minimal overlap + **486** M2-only) | **606** inventory files |
| **Inventory coverage** | **~99%** of vm.php path in spine smoke (**594/606**) | **100%*
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | 🚧 **594/606** units | **~99%*
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **594 / 606 ≈ 98%*
