...
| **Inventory coverage** | **6101** / **6101** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **6101/6101** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **6101** / **6101** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **6101** / **6101** (`php script/bootstrap-spine-count.php`) |
