...
| **Inventory coverage** | **8460** / **8460** ✅ | Full closure |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **8460** / **8460** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **8460** / **8460** (`php script/bootstrap-spine-count.php`) |
