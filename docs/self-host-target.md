...
| **Inventory coverage** | **7981** / **7981** ✅ | Full closure |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **7981** / **7981** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **7981** / **7981** (`php script/bootstrap-spine-count.php`) |
