...
| **Inventory coverage** | **5907** / **5907** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5907/5907** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5907** / **5907** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5907** / **5907** (`php script/bootstrap-spine-count.php`) |
