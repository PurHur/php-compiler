...
| **Inventory coverage** | **5715** / **5715** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5715/5715** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5715** / **5715** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5715** / **5715** (`php script/bootstrap-spine-count.php`) |
