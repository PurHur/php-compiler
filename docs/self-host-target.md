...
| **Inventory coverage** | **5679** / **5679** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5679/5679** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5679** / **5679** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5679** / **5679** (`php script/bootstrap-spine-count.php`) |
