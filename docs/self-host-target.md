...
| **Inventory coverage** | **5339** / **5339** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5339/5339** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5339** / **5339** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5339** / **5339** (`php script/bootstrap-spine-count.php`) |
