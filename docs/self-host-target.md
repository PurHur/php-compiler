...
| **Inventory coverage** | **5043** / **5043** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5043/5043** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5043** / **5043** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5043** / **5043** (`php script/bootstrap-spine-count.php`) |
