...
| **Inventory coverage** | **5020** / **5020** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5020/5020** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5020** / **5020** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5020** / **5020** (`php script/bootstrap-spine-count.php`) |
