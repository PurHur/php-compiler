...
| **Inventory coverage** | **5130** / **5130** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5130/5130** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5130** / **5130** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5130** / **5130** (`php script/bootstrap-spine-count.php`) |
