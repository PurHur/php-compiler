...
| **Inventory coverage** | **5945** / **5945** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5945/5945** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5945** / **5945** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5945** / **5945** (`php script/bootstrap-spine-count.php`) |
