...
| **Inventory coverage** | **5764** / **5764** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5764/5764** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5764** / **5764** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5764** / **5764** (`php script/bootstrap-spine-count.php`) |
