...
| **Inventory coverage** | **5940** / **5940** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5940/5940** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5940** / **5940** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5940** / **5940** (`php script/bootstrap-spine-count.php`) |
