...
| **Inventory coverage** | **7849** / **7849** ✅ | Full closure |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **7849** / **7849** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **7849** / **7849** (`php script/bootstrap-spine-count.php`) |
