...
| **Inventory coverage** | **8534** / **8534** ✅ | Full closure |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **8534** / **8534** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **8534** / **8534** (`php script/bootstrap-spine-count.php`) |
