...
| **Inventory coverage** | **5121** / **5121** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5121/5121** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5121** / **5121** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5121** / **5121** (`php script/bootstrap-spine-count.php`) |
