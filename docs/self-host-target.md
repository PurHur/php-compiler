...
| **Inventory coverage** | **5310** / **5310** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5310/5310** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5310** / **5310** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5310** / **5310** (`php script/bootstrap-spine-count.php`) |
