...
| **Inventory coverage** | **5454** / **5454** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5454/5454** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5454** / **5454** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5454** / **5454** (`php script/bootstrap-spine-count.php`) |
