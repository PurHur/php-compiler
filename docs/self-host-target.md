...
| **Inventory coverage** | **5257** / **5257** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5257/5257** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5257** / **5257** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5257** / **5257** (`php script/bootstrap-spine-count.php`) |
