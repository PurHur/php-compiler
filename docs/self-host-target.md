...
| **Inventory coverage** | **5515** / **5515** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5515/5515** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5515** / **5515** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5515** / **5515** (`php script/bootstrap-spine-count.php`) |
