...
| **Inventory coverage** | **5964** / **5964** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5964/5964** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5964** / **5964** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5964** / **5964** (`php script/bootstrap-spine-count.php`) |
