...
| **Inventory coverage** | **5503** / **5503** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5503/5503** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5503** / **5503** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5503** / **5503** (`php script/bootstrap-spine-count.php`) |
