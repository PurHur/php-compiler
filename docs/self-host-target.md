...
| **Inventory coverage** | **5269** / **5269** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5269/5269** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5269** / **5269** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5269** / **5269** (`php script/bootstrap-spine-count.php`) |
