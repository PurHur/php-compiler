...
| **Inventory coverage** | **5519** / **5519** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5519/5519** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5519** / **5519** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5519** / **5519** (`php script/bootstrap-spine-count.php`) |
