...
| **Inventory coverage** | **5674** / **5674** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5674/5674** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5674** / **5674** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5674** / **5674** (`php script/bootstrap-spine-count.php`) |
