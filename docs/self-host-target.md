...
| **Inventory coverage** | **5388** / **5388** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5388/5388** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5388** / **5388** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5388** / **5388** (`php script/bootstrap-spine-count.php`) |
