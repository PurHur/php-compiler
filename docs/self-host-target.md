...
| **Inventory coverage** | **5662** / **5662** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5662/5662** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5662** / **5662** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5662** / **5662** (`php script/bootstrap-spine-count.php`) |
