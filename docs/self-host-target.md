...
| **Inventory coverage** | **8394** / **8394** ✅ | Full closure |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **8394** / **8394** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **8394** / **8394** (`php script/bootstrap-spine-count.php`) |
