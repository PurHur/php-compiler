...
| **Inventory coverage** | **2910** / **2910** ✅ | Full closure |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **2910** / **2910** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **2910 / 2910** (`php script/bootstrap-spine-count.php`) |
