...
| **Inventory coverage** | **5507** / **5507** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5507/5507** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5507** / **5507** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5507** / **5507** (`php script/bootstrap-spine-count.php`) |
