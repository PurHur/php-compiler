...
| **Inventory coverage** | **5508** / **5508** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5508/5508** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5508** / **5508** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5508** / **5508** (`php script/bootstrap-spine-count.php`) |
