...
| **Inventory coverage** | **5250** / **5250** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5250/5250** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5250** / **5250** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5250** / **5250** (`php script/bootstrap-spine-count.php`) |
