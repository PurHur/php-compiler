...
| **Inventory coverage** | **6189** / **6189** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **6189/6189** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **6189** / **6189** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **6189** / **6189** (`php script/bootstrap-spine-count.php`) |
