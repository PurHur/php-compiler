...
| **Inventory coverage** | **5871** / **5871** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5871/5871** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5871** / **5871** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5871** / **5871** (`php script/bootstrap-spine-count.php`) |
