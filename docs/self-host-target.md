...
| **Inventory coverage** | **8457** / **8457** ✅ | Full closure |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **8457** / **8457** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **8457** / **8457** (`php script/bootstrap-spine-count.php`) |
