...
| **Inventory coverage** | **6037** / **6037** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **6037/6037** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **6037** / **6037** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **6037** / **6037** (`php script/bootstrap-spine-count.php`) |
