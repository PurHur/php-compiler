...
| **Inventory coverage** | **5765** / **5765** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5765/5765** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5765** / **5765** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5765** / **5765** (`php script/bootstrap-spine-count.php`) |
