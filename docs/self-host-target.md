...
| **Inventory coverage** | **6166** / **6163** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **6166/6163** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **6166** / **6163** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **6166** / **6163** (`php script/bootstrap-spine-count.php`) |
