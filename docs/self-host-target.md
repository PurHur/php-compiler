...
| **Inventory coverage** | **5356** / **5356** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5356/5356** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5356** / **5356** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5356** / **5356** (`php script/bootstrap-spine-count.php`) |
