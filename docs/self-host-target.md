...
| **Bundle size** | **594** curated `require_once` in spine smoke (108 minimal overlap + **486** M2-only) | **605** inventory files |
| **Inventory coverage** | **~99%** of vm.php path in spine smoke (**594/605**) | **100%*
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | 🚧 **594/605** units | **~99%*
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **594 / 605 ≈ 98%*
...
| `test/selfhost/compiler_lib_spine_smoke/main.php` | **594** | M2 growth (ext/standard + Vm* spine batch
