...
| **Inventory coverage** | **8016** / **8016** ✅ | Full closure |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **8016** / **8016** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **8016** / **8016** (`php script/bootstrap-spine-count.php`) |
