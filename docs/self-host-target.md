...
| **Inventory coverage** | **6080** / **6080** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **6080/6080** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **6080** / **6080** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **6080** / **6080** (`php script/bootstrap-spine-count.php`) |
