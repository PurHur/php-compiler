...
| **Inventory coverage** | **5623** / **5623** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5623/5623** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5623** / **5623** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5623** / **5623** (`php script/bootstrap-spine-count.php`) |
