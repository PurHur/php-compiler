...
| **Inventory coverage** | **5931** / **5931** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5931/5931** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5931** / **5931** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5931** / **5931** (`php script/bootstrap-spine-count.php`) |
