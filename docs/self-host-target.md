...
| **Inventory coverage** | **7965** / **7965** ✅ | Full closure |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **7965** / **7965** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **7965** / **7965** (`php script/bootstrap-spine-count.php`) |
