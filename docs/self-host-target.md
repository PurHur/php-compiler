...
| **Inventory coverage** | **5682** / **5682** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5682/5682** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5682** / **5682** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5682** / **5682** (`php script/bootstrap-spine-count.php`) |
