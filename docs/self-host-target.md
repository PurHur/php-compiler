...
| **Inventory coverage** | **5447** / **5447** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5447/5447** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5447** / **5447** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5447** / **5447** (`php script/bootstrap-spine-count.php`) |
