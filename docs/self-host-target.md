...
| **Inventory coverage** | **5524** / **5524** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5524/5524** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5524** / **5524** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5524** / **5524** (`php script/bootstrap-spine-count.php`) |
