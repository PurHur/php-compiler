...
| **Inventory coverage** | **5841** / **5841** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5841/5841** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5841** / **5841** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5841** / **5841** (`php script/bootstrap-spine-count.php`) |
