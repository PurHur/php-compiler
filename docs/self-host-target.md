...
| **Inventory coverage** | **5853** / **5853** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5853/5853** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5853** / **5853** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5853** / **5853** (`php script/bootstrap-spine-count.php`) |
