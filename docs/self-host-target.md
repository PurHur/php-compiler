...
| **Inventory coverage** | **4966** / **4966** ✅ | Full closure |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **4966** / **4966** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **4966** / **4966** (`php script/bootstrap-spine-count.php`) |
