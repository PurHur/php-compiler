...
| **Inventory coverage** | **5758** / **5758** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5758/5758** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5758** / **5758** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5758** / **5758** (`php script/bootstrap-spine-count.php`) |
