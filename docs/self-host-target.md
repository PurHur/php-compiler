...
| **Inventory coverage** | **6250** / **6250** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **6250/6250** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **6250** / **6250** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **6250** / **6250** (`php script/bootstrap-spine-count.php`) |
