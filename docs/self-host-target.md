...
| **Inventory coverage** | **6176** / **6176** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **6176/6176** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **6176** / **6176** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **6176** / **6176** (`php script/bootstrap-spine-count.php`) |
