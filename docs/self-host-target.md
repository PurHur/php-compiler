...
| **Bundle size** | **412** curated `require_once` in spine smoke (108 minimal overlap + **304** M2-only) | **586** inventory files |
| **Inventory coverage** | **~70%** of vm.php path in spine smoke (**412/586**) | **100%** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | 🚧 **412/586** units | **~70%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **412 / 586 ≈ 70%** |
...
| `test/selfhost/compiler_lib_spine_smoke/main.php` | **412** | M2 growth ([#1743](https://github.com/PurHur/php-compiler/issues/1743) llvm-env) |
