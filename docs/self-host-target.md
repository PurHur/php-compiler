...
| **Inventory coverage** | **5295** / **5295** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5295/5295** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5295** / **5295** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5295** / **5295** (`php script/bootstrap-spine-count.php`) |
