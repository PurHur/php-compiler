...
| **Inventory coverage** | **4726** / **4726** ✅ | Full closure |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **4726** / **4726** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **4726** / **4726** (`php script/bootstrap-spine-count.php`) |
