...
| **Inventory coverage** | **5899** / **5899** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5899/5899** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5899** / **5899** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5899** / **5899** (`php script/bootstrap-spine-count.php`) |
