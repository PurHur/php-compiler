...
| **Inventory coverage** | **5562** / **5562** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5562/5562** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5562** / **5562** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5562** / **5562** (`php script/bootstrap-spine-count.php`) |
