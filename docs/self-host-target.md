...
| **Inventory coverage** | **5234** / **5234** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5234/5234** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5234** / **5234** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5234** / **5234** (`php script/bootstrap-spine-count.php`) |
