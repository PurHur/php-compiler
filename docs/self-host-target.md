...
| `make bootstrap-aot-link` | ✅ **6365/6365** |
| `make bootstrap-inventory-check` | ✅ **6365/6365** Phase A files, **0** source blockers |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **6365** / **6365** (`php script/bootstrap-spine-count.php`) |
...
| `test/selfhost/compiler_lib_spine_smoke/main.php` | **6365/6365** Phase A | M2 complete ([#8559](https://github.com/PurHur/php-compiler/issues/8559)) |
