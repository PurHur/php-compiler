...
| **Inventory coverage** | **6034** / **6034** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **6034/6034** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **6034** / **6034** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **6034** / **6034** (`php script/bootstrap-spine-count.php`) |
