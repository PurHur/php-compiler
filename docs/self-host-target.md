...
| **Inventory coverage** | **5023** / **5023** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5023/5023** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5023** / **5023** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5023** / **5023** (`php script/bootstrap-spine-count.php`) |
