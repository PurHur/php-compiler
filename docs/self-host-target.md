...
| **Inventory coverage** | **5510** / **5510** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5510/5510** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5510** / **5510** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5510** / **5510** (`php script/bootstrap-spine-count.php`) |
