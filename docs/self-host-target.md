...
| **Bundle size** | **436** curated `require_once` in spine smoke (108 minimal overlap + **328** M2-only) | **586** inventory files |
| **Inventory coverage** | **~74%** of vm.php path in spine smoke (**436/586**) | **100%** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | 🚧 **436/586** units | **~74%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **436 / 586 ≈ 74%** |
...
| `test/selfhost/compiler_lib_spine_smoke/main.php` | **436** | M2 growth ([#1745](https://github.com/PurHur/php-compiler/issues/1745) tokenizer-compat) |
