...
| **Inventory coverage** | **8445** / **8445** ✅ | Full closure |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **8445** / **8445** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **8445** / **8445** (`php script/bootstrap-spine-count.php`) |
