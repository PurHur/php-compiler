...
| **Inventory coverage** | **6212** / **6212** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **6212/6212** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **6212** / **6212** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **6212** / **6212** (`php script/bootstrap-spine-count.php`) |
