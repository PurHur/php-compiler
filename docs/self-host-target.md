...
| **Inventory coverage** | **5374** / **5374** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5374/5374** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5374** / **5374** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5374** / **5374** (`php script/bootstrap-spine-count.php`) |
