...
| **Inventory coverage** | **8558** / **8558** ✅ | Full closure |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **8558** / **8558** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **8558** / **8558** (`php script/bootstrap-spine-count.php`) |
...
| `test/selfhost/compiler_lib_spine_smoke/main.php` | **7410/7412** Phase A | M2 complete ([#8558](https://github.com/PurHur/php-compiler/issues/8558)) |
