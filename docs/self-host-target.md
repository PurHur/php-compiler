...
| **Inventory coverage** | **5332** / **5332** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5332/5332** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5332** / **5332** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5332** / **5332** (`php script/bootstrap-spine-count.php`) |
