...
| **Inventory coverage** | **4998** / **4998** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **4998/4998** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **4998** / **4998** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **4998** / **4998** (`php script/bootstrap-spine-count.php`) |
