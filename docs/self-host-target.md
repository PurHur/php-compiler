...
| **Inventory coverage** | **5987** / **5987** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5987/5987** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5987** / **5987** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5987** / **5987** (`php script/bootstrap-spine-count.php`) |
