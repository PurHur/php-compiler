...
| **Bundle size** | **589** curated `require_once` in spine smoke (108 minimal overlap + **476** M2-only) | **601** inventory files |
| **Inventory coverage** | **~99%** of vm.php path in spine smoke (**589/601**) | **100%*
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | 🚧 **589/601** units | **~99%*
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **589 / 601 ≈ 99%*
