...
| **Inventory coverage** | **5414** / **5414** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5414/5414** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5414** / **5414** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5414** / **5414** (`php script/bootstrap-spine-count.php`) |
