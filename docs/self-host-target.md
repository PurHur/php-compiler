...
| **Inventory coverage** | **5543** / **5543** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5543/5543** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5543** / **5543** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5543** / **5543** (`php script/bootstrap-spine-count.php`) |
