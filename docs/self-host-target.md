...
| **Bundle size** | **441** curated `require_once` in spine smoke (108 minimal overlap + **333** M2-only) | **586** inventory files |
| **Inventory coverage** | **~75%** of vm.php path in spine smoke (**441/586**) | **100%** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | 🚧 **441/586** units | **~75%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **441 / 586 ≈ 75%** |
...
| `test/selfhost/compiler_lib_spine_smoke/main.php` | **441** | M2 growth ([#1741](https://github.com/PurHur/php-compiler/issues/1741) Linker, [#1725](https://github.com/PurHur/php-compiler/issues/1725) tempnam, [#1701](https://github.com/PurHur/php-compiler/issues/1701) stream_context_create) |
