...
| **Inventory coverage** | **5856** / **5856** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5856/5856** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5856** / **5856** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5856** / **5856** (`php script/bootstrap-spine-count.php`) |
