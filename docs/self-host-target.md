...
| **Inventory coverage** | **2868** / **2847** ✅ | Full closure |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **2868** / **2847** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **2868 / 2847** (`php script/bootstrap-spine-count.php`) |
