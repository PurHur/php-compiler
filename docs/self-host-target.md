...
| **Inventory coverage** | **5306** / **5306** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5306/5306** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5306** / **5306** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5306** / **5306** (`php script/bootstrap-spine-count.php`) |
