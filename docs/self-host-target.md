...
| **Inventory coverage** | **5352** / **5352** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5352/5352** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5352** / **5352** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5352** / **5352** (`php script/bootstrap-spine-count.php`) |
