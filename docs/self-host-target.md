...
| **Inventory coverage** | **5012** / **5012** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5012/5012** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5012** / **5012** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5012** / **5012** (`php script/bootstrap-spine-count.php`) |
