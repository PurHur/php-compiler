...
| **Inventory coverage** | **8523** / **8523** ✅ | Full closure |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **8523** / **8523** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **8523** / **8523** (`php script/bootstrap-spine-count.php`) |
