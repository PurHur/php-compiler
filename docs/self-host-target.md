...
| **Bundle size** | **313** spine units + **109** minimal = **422** curated `require_once` | ~**584** inventory files |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | 🚧 **313/584** units | **~54%** |
...
| `test/selfhost/compiler_lib_spine_smoke/main.php` | **313** | M2 growth ([#1497](https://github.com/PurHur/php-compiler/issues/1497) wave 2 batch 1) |
