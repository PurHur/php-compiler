...
| **Inventory coverage** | **5783** / **5783** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5783/5783** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5783** / **5783** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5783** / **5783** (`php script/bootstrap-spine-count.php`) |
