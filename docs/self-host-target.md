...
| **Inventory coverage** | **6164** / **6164** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **6164/6164** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **6164** / **6164** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **6164** / **6164** (`php script/bootstrap-spine-count.php`) |
