...
| **Bundle size** | **437** curated `require_once` in spine smoke (108 minimal overlap + **329** M2-only) | **586** inventory files |
| **Inventory coverage** | **~75%** of vm.php path in spine smoke (**437/586**) | **100%** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | 🚧 **437/586** units | **~75%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **437 / 586 ≈ 75%** |
...
| `test/selfhost/compiler_lib_spine_smoke/main.php` | **437** | M2 growth ([#1744](https://github.com/PurHur/php-compiler/issues/1744) macro_functions) |
