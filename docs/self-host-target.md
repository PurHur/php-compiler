...
| **Inventory coverage** | **5441** / **5441** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5441/5441** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5441** / **5441** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5441** / **5441** (`php script/bootstrap-spine-count.php`) |
