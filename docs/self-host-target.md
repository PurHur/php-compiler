...
| **Inventory coverage** | **3529** / **3527** ✅ | Full closure |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **3529** / **3527** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **3529 / 3527** (`php script/bootstrap-spine-count.php`) |
