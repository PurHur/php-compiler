...
| **Inventory coverage** | **5463** / **5463** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5463/5463** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5463** / **5463** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5463** / **5463** (`php script/bootstrap-spine-count.php`) |
