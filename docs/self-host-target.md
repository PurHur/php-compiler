...
| **Inventory coverage** | **5379** / **5379** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5379/5379** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5379** / **5379** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5379** / **5379** (`php script/bootstrap-spine-count.php`) |
