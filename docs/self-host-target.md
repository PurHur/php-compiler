...
| **Inventory coverage** | **5259** / **5259** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5259/5259** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5259** / **5259** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5259** / **5259** (`php script/bootstrap-spine-count.php`) |
