...
| **Inventory coverage** | **5181** / **5181** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5181/5181** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5181** / **5181** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5181** / **5181** (`php script/bootstrap-spine-count.php`) |
