...
| **Inventory coverage** | **5779** / **5779** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5779/5779** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5779** / **5779** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5779** / **5779** (`php script/bootstrap-spine-count.php`) |
