...
| **Inventory coverage** | **5304** / **5304** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5304/5304** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5304** / **5304** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5304** / **5304** (`php script/bootstrap-spine-count.php`) |
