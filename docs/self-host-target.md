...
| **Inventory coverage** | **4705** / **4705** ✅ | Full closure |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **4705** / **4705** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **4705** / **4705** (`php script/bootstrap-spine-count.php`) |
