...
| **Inventory coverage** | **5718** / **5718** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5718/5718** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5718** / **5718** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5718** / **5718** (`php script/bootstrap-spine-count.php`) |
