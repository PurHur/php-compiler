...
| **Inventory coverage** | **5514** / **5514** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5514/5514** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5514** / **5514** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5514** / **5514** (`php script/bootstrap-spine-count.php`) |
