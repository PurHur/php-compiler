...
| **Inventory coverage** | **5664** / **5664** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5664/5664** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5664** / **5664** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5664** / **5664** (`php script/bootstrap-spine-count.php`) |
