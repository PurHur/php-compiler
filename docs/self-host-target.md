...
| **Bundle size** | **440** curated `require_once` in spine smoke (108 minimal overlap + **332** M2-only) | **586** inventory files |
| **Inventory coverage** | **~75%** of vm.php path in spine smoke (**440/586**) | **100%** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | 🚧 **440/586** units | **~75%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **440 / 586 ≈ 75%** |
...
2. M2 finish — spine → full inventory (or honest closure)
   └─ Remaining lib/ + Jit* on vm.php path
...
| `test/selfhost/compiler_lib_spine_smoke/main.php` | **440** | M2 growth ([#1742](https://github.com/PurHur/php-compiler/issues/1742) cli_driver, [#1744](https://github.com/PurHur/php-compiler/issues/1744) macro_functions, [#1725](https://github.com/PurHur/php-compiler/issues/1725) tempnam, [#1741](https://github.com/PurHur/php-compiler/issues/1741) Linker) |
