...
| **Inventory coverage** | **5061** / **5061** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5061/5061** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5061** / **5061** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5061** / **5061** (`php script/bootstrap-spine-count.php`) |
