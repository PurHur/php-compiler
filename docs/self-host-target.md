...
| **Inventory coverage** | **5545** / **5545** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5545/5545** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5545** / **5545** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5545** / **5545** (`php script/bootstrap-spine-count.php`) |
