...
| **Inventory coverage** | **6159** / **6159** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **6159/6159** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **6159** / **6159** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **6159** / **6159** (`php script/bootstrap-spine-count.php`) |
