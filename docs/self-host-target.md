...
| **Inventory coverage** | **5518** / **5518** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5518/5518** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5518** / **5518** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5518** / **5518** (`php script/bootstrap-spine-count.php`) |
