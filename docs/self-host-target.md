...
| **Inventory coverage** | **5977** / **5977** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5977/5977** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5977** / **5977** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5977** / **5977** (`php script/bootstrap-spine-count.php`) |
