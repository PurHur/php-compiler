...
| **Inventory coverage** | **3940** / **3975** ✅ | Full closure |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **3940** / **3975** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **4201** / **4203** (1 deferred: #16866) (`php script/bootstrap-spine-count.php`) |
