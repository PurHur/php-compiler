...
| **Inventory coverage** | **5273** / **5273** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5273/5273** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5273** / **5273** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5273** / **5273** (`php script/bootstrap-spine-count.php`) |
