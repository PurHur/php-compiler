...
| **Inventory coverage** | **5843** / **5843** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5843/5843** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5843** / **5843** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5843** / **5843** (`php script/bootstrap-spine-count.php`) |
