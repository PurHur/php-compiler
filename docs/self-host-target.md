...
| **Inventory coverage** | **5512** / **5512** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5512/5512** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5512** / **5512** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5512** / **5512** (`php script/bootstrap-spine-count.php`) |
