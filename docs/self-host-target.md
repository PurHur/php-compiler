...
| **Inventory coverage** | **6149** / **6149** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **6149/6149** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **6149** / **6149** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **6149** / **6149** (`php script/bootstrap-spine-count.php`) |
