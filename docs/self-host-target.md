...
| **Inventory coverage** | **5851** / **5851** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5851/5851** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5851** / **5851** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5851** / **5851** (`php script/bootstrap-spine-count.php`) |
