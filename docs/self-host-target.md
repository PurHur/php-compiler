...
| **Inventory coverage** | **5113** / **5113** ✅ | Full closure |
...
| `make bootstrap-aot-link` | ✅ **5113/5113** |
...
| **M2** | Spine grows toward full `bin/vm.php` inventory | ✅ **5113** / **5113** | **100%** |
...
|-----------|---------|----------|
| **M2 spine progress** | `require_once` units in `compiler_lib_spine_smoke` ÷ Phase A inventory file count | **5113** / **5113** (`php script/bootstrap-spine-count.php`) |
