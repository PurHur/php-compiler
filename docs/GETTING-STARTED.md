...
| `make north-star5-verify-fast` | M5 fast presenter (~1–2 min) — read-only prelink + VM driver probe + spine bundle OK without relink ([#8683](https://github.com/PurHur/php-compiler/issues/8683)); default tail of `ci-fast.sh` |
