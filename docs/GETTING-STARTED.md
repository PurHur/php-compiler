...
| `make north-star3-verify` | M3 native unit probe bundle — 008 + compiler/JIT/VM probes ([#2360](https://github.com/PurHur/php-compiler/issues/2360); probe scripts opt-in until [#2216](https://github.com/PurHur/php-compiler/issues/2216) / [#2332](https://github.com/PurHur/php-compiler/issues/2332) / [#2354](https://github.com/PurHur/php-compiler/issues/2354)) |
