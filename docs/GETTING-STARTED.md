...
# Slim+nyholm graph (php://memory Stream::create + IncludeHelper; full: slim-hello-36382-smoke.sh)
...
```bash
php script/bootstrap-gen0-staleness.php          # exit 0 fresh / 1 stale / 2 unknown
php script/bootstrap-gen0-staleness.php --json   # also in release-readiness --json as gen0_provenance
```
