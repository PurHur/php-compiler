...
| compile_smoke_m3_emit | Native emit TU allow (#1983); real-lowering via `compile_smoke_m3_emit_native_entry.php` with `PHP_COMPILER_SELFHOST_AOT=1` `PHP_COMPILER_M3_COMPILE_DRIVER=1` `PHP_COMPILER_EMIT_HELPER_LINK=1` (tracked outside compile_driver snapshot) |
