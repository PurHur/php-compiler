...
| `SESSIONS_WEB_AOT_SMOKE_GATE` | `0` | `ci-local.sh` (`ci_run_sessions_web_aot_execute`), `examples-aot-smoke.sh` | PHPUnit `@group sessionsweb-aot-execute` / `SessionsWebAotExecuteTest`; `EXAMPLES_AOT_SMOKE_ONLY=005` ([#1891](https://github.com/PurHur/php-compiler/issues/1891), default `1` when stable [#1923](https://github.com/PurHur/php-compiler/issues/1923)) |
