...
| `EXAMPLES_SELFHOSTPROBE_SMOKE_GATE` | `0` | `ci-fast.sh` | `examples-selfhostprobe-smoke.sh` — 008 VM lint + run ([#2302](https://github.com/PurHur/php-compiler/issues/2302), [#2240](https://github.com/PurHur/php-compiler/issues/2240)); set `1` to opt in |
