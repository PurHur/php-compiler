...
| `BOOTSTRAP_PHPTYPES_UNIT_PROBE_GATE` | `0` | `ci-local.sh` (LLVM tail, after VM unit probe) | `bootstrap-selfhost-types-unit-probe.sh` — M3 `types_unit_probe` native link + run ([#2430](https://github.com/PurHur/php-compiler/issues/2430), opt-in wiring [#2433](https://github.com/PurHur/php-compiler/issues/2433)); set `1` for opt-in gate; default-on follow-up [#2436](https://github.com/PurHur/php-compiler/issues/2436) |
