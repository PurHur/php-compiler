...
| `DEVELOPMENT_STATUS_007_SYNC_GATE` | `0` | `ci-fast.sh` (`ci_run_inventory_checks`) | `script/check-development-status-sync.php` — **007-ThrowsWeb** row + `THROWS_WEB_SMOKE_GATE` / `#2093` / `#2101` needles ([#2145](https://github.com/PurHur/php-compiler/issues/2145)); set `1` after 007 row lands; flip default-on in follow-up |
