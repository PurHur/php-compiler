...
| `COMPILER_DRIVER_SMOKE_GATE` | `0` | `ci-local.sh` (LLVM tail, after lib-spine VM smoke) | `bootstrap-selfhost-compiler-driver-smoke.sh` — M3 `compiler_driver_smoke` native link + run ([#2136](https://github.com/PurHur/php-compiler/issues/2136), [#2137](https://github.com/PurHur/php-compiler/issues/2137)) |
