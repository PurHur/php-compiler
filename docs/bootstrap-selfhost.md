...
| M2 lib spine smoke lint | `php bin/compile.php -l test/selfhost/compiler_lib_spine_smoke/main.php` | ✅ **435** units (`compiler_minimal` **109** + **327** M2 spine; [#1056](https://github.com/PurHur/php-compiler/issues/1056), [#1745](https://github.com/PurHur/php-compiler/issues/1745)) |
