...
| M2 lib spine smoke lint | `php bin/compile.php -l test/selfhost/compiler_lib_spine_smoke/main.php` | ✅ **603/606** units ([#1492](https://github.com/PurHur/php-compiler/issues/1492), [#2001](https://github.com/PurHur/php-compiler/issues/2001))
| M2 spine coverage drift | `php script/check-selfhost-spine-coverage-sync.php` | ✅ 603/606 in spine; **5** deferred (5 native-link [#1960](https://github.com/PurHur/php-compiler/issues/1960), [#2001](https://github.com/PurHur/php-compiler/issues/2001)); `SELFHOST_SPINE_COVERAGE_SYNC_GATE=1` ([#1945](https://github.com/PurHur/php-compiler/issues/1945))
...
| North Star 2 presenter bundle | `make north-star2-verify` or `./script/north-star2-verify.sh` | ✅ doctor + inventory + wave-check + M2 spine (LLVM) + optional M3/M4 tail ([#1865](https://github.com/PurHur/php-compiler/issues/1865), [#1492](https://github.com/PurHur/php-compiler/issues/1492)) |
| North Star 2 presenter in fast CI | `NORTH_STAR2_VERIFY_GATE=1 ./script/ci-fast.sh` | opt-in runs `make north-star2-verify` ([#1928](https://github.com/PurHur/php-compiler/issues/1928)) |
