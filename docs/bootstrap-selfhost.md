...
| M2 spine coverage drift | `php script/check-selfhost-spine-coverage-sync.php` | ✅ 606/611 inventory (**5** deferred native-link [#1960](https://github.com/PurHur/php-compiler/issues/1960), [#2066](https://github.com/PurHur/php-compiler/issues/2066)); `SELFHOST_SPINE_COVERAGE_SYNC_GATE=1` ([#1945](https://github.com/PurHur/php-compiler/issues/1945))
