...
| M4 gen-2→gen-3 bin/compile.php revision | `./script/bootstrap-loop-gen2-recompile-bin-compile.sh` or `make bootstrap-loop-gen2-recompile-bin-compile` | ✅ gen-2 argv-compiles `bin/compile.php` → `build/bootstrap-loop-gen3-bin-compile-aot` + native smoke compile/run ([#2880](https://github.com/PurHur/php-compiler/issues/2880)) |
