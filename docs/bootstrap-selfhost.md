...
| M2 lib spine smoke lint | `php bin/compile.php -l test/selfhost/compiler_lib_spine_smoke/main.php` | ✅ **594/606** units ([#1492](https://github.com/PurHur/php-compiler/issues/1492), [#1419](https://github.com/PurHur/php-compiler/issues/1419))
| M2 spine coverage drift | `php script/check-selfhost-spine-coverage-sync.php` | ✅ 594/606 in spine; **9** deferred (7 native-link [#1960](https://github.com/PurHur/php-compiler/issues/1960), 2 inventory-ahead [#1922](https://github.com/PurHur/php-compiler/issues/1922)); `SELFHOST_SPINE_COVERAGE_SYNC_GATE=1` ([#1945](https://github.com/PurHur/php-compiler/issues/1945))
