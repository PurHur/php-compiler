...
| M2 lib spine smoke lint | `php bin/compile.php -l test/selfhost/compiler_lib_spine_smoke/main.php` | ✅ **437** units (`compiler_minimal` **109** + **329** M2 spine; [#1056](https://github.com/PurHur/php-compiler/issues/1056), [#1744](https://github.com/PurHur/php-compiler/issues/1744)) |
