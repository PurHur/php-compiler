...
| Compiler driver smoke native run | `./script/bootstrap-selfhost-compiler-driver-smoke.sh` or `BOOTSTRAP_COMPILER_DRIVER_SMOKE=1 make bootstrap-selfhost-compiler-driver-smoke` | ✅ `build/selfhost-compiler-driver-smoke` prints `compiler_driver_smoke bundle OK` ([#2136](https://github.com/PurHur/php-compiler/issues/2136); `COMPILER_DRIVER_SMOKE_GATE=1` opt-in in `ci-local.sh`, default **off** ([#2137](https://github.com/PurHur/php-compiler/issues/2137))) |
