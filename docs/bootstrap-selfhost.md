...
| M3 HelloWorld self-host probe | `./script/bootstrap-selfhost-helloworld-probe.sh` or `make bootstrap-selfhost-helloworld` | ✅ strict `emit_path=native` via `helloworld_m3_emit_native_entry.php` + HelloWorld AOT run ([#1768](https://github.com/PurHur/php-compiler/issues/1768), [#2822](https://github.com/PurHur/php-compiler/pull/2822)); inventory-scale `bin/compile.php` emit-TU still tracked in [#2827](https://github.com/PurHur/php-compiler/issues/2827) |
