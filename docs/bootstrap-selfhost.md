...
| Phase B lib AOT lint | `php bin/compile.php -l lib/*.php` (with `script/php-env.sh`) | ✅ **6989/6991** top-level `lib/*.php` units ([#534](https://github.com/PurHur/php-compiler/pull/534)) |
...
| Phase C native run | `make bootstrap-aot-link` or `./script/bootstrap-aot-link.sh` | ✅ **6989/6991** link targets OK |
