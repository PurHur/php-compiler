...
| M2 lib spine smoke lint | `php bin/compile.php -l test/selfhost/compiler_lib_spine_smoke/main.php` | 🚧 **1298/1681** literal units ([#2868](https://github.com/PurHur/php-compiler/issues/2868)) |
