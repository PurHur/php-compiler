...
| M2 spine coverage drift | `php script/check-selfhost-spine-coverage-sync.php` | ✅ **605/605** inventory paths on spine; CI default `SELFHOST_SPINE_COVERAGE_SYNC_GATE=1` in `ci-fast.sh` ([#1955](https://github.com/PurHur/php-compiler/issues/1955), [#1945](https://github.com/PurHur/php-compiler/issues/1945), [#1922](https://github.com/PurHur/php-compiler/issues/1922))
