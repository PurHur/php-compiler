...
| M2 lib spine smoke lint | `php bin/compile.php -l test/selfhost/compiler_lib_spine_smoke/main.php` | 🚧 **1257/1322** literal units ([#2868](https://github.com/PurHur/php-compiler/issues/2868)) |
| M2 spine coverage drift | `php script/check-selfhost-spine-coverage-sync.php` | ✅ **1322** Phase A inventory files covered (no ratio-deferred); `SELFHOST_SPINE_COVERAGE_SYNC_GATE=1` ([#1945](https://github.com/PurHur/php-compiler/issues/1945), [#2840](https://github.com/PurHur/php-compiler/issues/2840))
...
| M4 gen-1 full-spine emit | `./script/bootstrap-loop-gen1-full-spine-emit.sh` or `make bootstrap-loop-gen1-full-spine-emit` | 🚧 gen-1→gen-2 **1257/1322** spine (`build/bootstrap-loop-gen2-full-spine`) — heavy; may need Docker + patches |
