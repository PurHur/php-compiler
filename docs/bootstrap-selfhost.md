...
| M2 spine coverage drift | `php script/check-selfhost-spine-coverage-sync.php` | ✅ spine covers **662**/717 Phase A inventory units; `bin/vm.php` promoted (#2134); `SELFHOST_SPINE_COVERAGE_SYNC_GATE=1` ([#1945](https://github.com/PurHur/php-compiler/issues/1945))
