...
| M2 lib spine smoke lint | `php bin/compile.php -l test/selfhost/compiler_lib_spine_smoke/main.php` | ✅ **606/606** units ([#1492](https://github.com/PurHur/php-compiler/issues/1492), [#2001](https://github.com/PurHur/php-compiler/issues/2001))
| M2 spine coverage drift | `php script/check-selfhost-spine-coverage-sync.php` | ✅ 606/606 in spine; **5** deferred (5 native-link [#1960](https://github.com/PurHur/php-compiler/issues/1960), [#2001](https://github.com/PurHur/php-compiler/issues/2001)); `SELFHOST_SPINE_COVERAGE_SYNC_GATE=1` ([#1945](https://github.com/PurHur/php-compiler/issues/1945))
...
| North Star 2 presenter in fast CI | `./script/ci-fast.sh` (default) or `make north-star2-verify` | ✅ default-on in ci-fast ([#1928](https://github.com/PurHur/php-compiler/issues/1928), [#2051](https://github.com/PurHur/php-compiler/issues/2051)); opt-out `NORTH_STAR2_VERIFY_GATE=0` |
...
Default CI: `./script/ci-fast.sh` runs vendor inventory `--check` (`BOOTSTRAP_VENDOR_INVENTORY_SYNC_GATE=1`, [#2040](https://github.com/PurHur/php-compiler/issues/2040)). Opt out with `BOOTSTRAP_VENDOR_INVENTORY_SYNC_GATE=0` for vendor-only iteration. See [`bootstrap-vendor-inventory.md`](bootstrap-vendor-inventory.md).
