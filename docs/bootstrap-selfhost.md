...
| M2 lib spine smoke lint | `php bin/compile.php -l test/selfhost/compiler_lib_spine_smoke/main.php` | ✅ **594/605** units ([#1492](https://github.com/PurHur/php-compiler/issues/1492), [#1419](https://github.com/PurHur/php-compiler/issues/1419)
| M2 spine coverage drift | `php script/check-selfhost-spine-coverage-sync.php` | 🚧 lists inventory paths missing from spine until [#1922](https://github.com/PurHur/php-compiler/issues/1922); CI opt-in `SELFHOST_SPINE_COVERAGE_SYNC_GATE=1` ([#1945](https://github.com/PurHur/php-compiler/issues/1945))
