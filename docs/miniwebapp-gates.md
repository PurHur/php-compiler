...
| 1c | VM OOP serve e2e | `MINIWEBAPP_VM_OOP_GATE=1` (default) | ✅ | `ci-fast.sh`, `ci-local.sh` → `script/check-miniwebapp-vm-oop.sh` | [#2189](https://github.com/PurHur/php-compiler/issues/2189), [#2059](https://github.com/PurHur/php-compiler/issues/2059), [#2293](https://github.com/PurHur/php-compiler/issues/2293) |
...
| 4c | AOT shell smoke (003 slice) | `EXAMPLES_AOT_SMOKE_GATE=1` (default), `EXAMPLES_AOT_SMOKE_ONLY=003` | ✅ probe when LLVM + execute green ([#764](https://github.com/PurHur/php-compiler/issues/764) closed) | `ci-local.sh` → `examples-aot-smoke.sh`; `miniwebapp-gates.sh` probe | [#683](https://github.com/PurHur/php-compiler/issues/683), [#881](https://github.com/PurHur/php-compiler/issues/881), [#485](https://github.com/PurHur/php-compiler/issues/485) |
...
MINIWEBAPP_VM_OOP_GATE=0 ./script/ci-local.sh     # opt-out VM serve OOP e2e (#2293)
./script/check-miniwebapp-vm-oop.sh               # lint zero + PATH_INFO curls (#2059)
```

VM OOP acceptance ([#2059](https://github.com/PurHur/php-compiler/issues/2059) closed): default-on `MINIWEBAPP_VM_OOP_GATE=1` in ci-fast and ci-local ([#2293](https://github.com/PurHur/php-compiler/issues/2293)); skipped when `PHP_COMPILER_SKIP_SERVE_TESTS=1`.
...
# Stage 4b2 execute (default on; skip with MINIWEBAPP_AOT_EXECUTE_GATE=0)
