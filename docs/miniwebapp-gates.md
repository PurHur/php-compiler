...
| 3c | AOT web-smoke (003 slice) | `examples-web-smoke.sh --aot` | 🚧 | Home + hello PATH_INFO when `.phpc/bin/app` exists; skips on empty stdout (#764) | [#833](https://github.com/PurHur/php-compiler/issues/833) |
...
- [miniwebapp-aot-unskip-matrix.md](miniwebapp-aot-unskip-matrix.md) — [#676](https://github.com/PurHur/php-compiler/issues/676) ordered unskip checklist (#747, #738, #754, #745, #478, #610, #833)
