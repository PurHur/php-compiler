...
## Generation ladder (verified Jul 2026, LLVM 9)
...
| **2 (spine)** | Gen-1 full-spine emit | `build/bootstrap-loop-gen2-full-spine` | Gen-1 **native-emits** the **6335/6335** spine bundle |
| **3** | Gen-2 native driver | `build/bootstrap-loop-gen3-full-spine` | Gen-2 **recompiles** the **6335/6335** spine via argv `-o` (no `PHP_COMPILER_M3_*` on compile; [#2866](https://github.com/PurHur/php-compiler/issues/2866)) |
...
| `build/bootstrap-loop-gen2-full-spine` | Gen-2 full spine (6335/6335) |
| `build/bootstrap-loop-gen3-full-spine` | Gen-3 full spine (6335/6335) — **gen-2 output** |
...
make bootstrap-loop-gen1-full-spine-emit       # gen-1 → gen-2 spine (6335/6335)
make bootstrap-loop-gen2-recompile-spine       # gen-2 → gen-3 spine (6335/6335, argv -o)
```
...
- `BOOTSTRAP_M4_GEN2_STRICT=1` — **default-on** ([#8711](https://github.com/PurHur/php-compiler/issues/8711)): refuse Zend fallback (`emit_path=zend_fallback_would_be_used`); opt-in bisect: `BOOTSTRAP_M4_GEN2_ZEND_FALLBACK=1`
