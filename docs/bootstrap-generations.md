...
| **2 (spine)** | Gen-1 full-spine emit | `build/bootstrap-loop-gen2-full-spine` | Gen-1 **native-emits** the **6344/6344** spine bundle |
| **3** | Gen-2 native driver | `build/bootstrap-loop-gen3-full-spine` | Gen-2 **recompiles** the **6344/6344** spine via argv `-o` (no `PHP_COMPILER_M3_*` on compile; [#2866](https://github.com/PurHur/php-compiler/issues/2866)) |
...
| `build/bootstrap-loop-gen2-full-spine` | Gen-2 full spine (6344/6344) |
| `build/bootstrap-loop-gen3-full-spine` | Gen-3 full spine (6344/6344) — **gen-2 output** |
...
make bootstrap-loop-gen1-full-spine-emit       # gen-1 → gen-2 spine (6344/6344)
make bootstrap-loop-gen2-recompile-spine       # gen-2 → gen-3 spine (6344/6344, argv -o)
```
