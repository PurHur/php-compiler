...
| Metric | Count |
|--------|------:|
| PHP files on vm.php path | 4682 |
| Phase A inventory files (M2 ratio SSOT) | 4682 |
...
- new Error (line 401)
- new Variable (line 483)
- new AttributeEntry (line 1375)
- new Variable (line 2016)
- new ObjectEntry (line 2131)
- new ObjectEntry (line 2223)
- new ObjectEntry (line 2236)
- new Variable (line 2316)
- new ObjectEntry (line 2421)
