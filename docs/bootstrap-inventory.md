...
| Source constructs flagged (warnings) | 760 |
...
| `ext/standard/JitHeader.php` | 0 | 2 |
...
| `lib/JIT/Builtin/ResponseHeaders.php` | 0 | 4 |
...
### `lib/JIT/Builtin/ResponseHeaders.php`
