...
| Metric | Count |
|--------|------:|
| PHP files on vm.php path | 4637 |
| Phase A inventory files (M2 ratio SSOT) | 4637 |
| Phase A ratio-deferred paths | 0 |
| Source constructs flagged (blockers) | 0 |
| Source constructs flagged (warnings) | 12555 |
...
- new Variable (line 3761)
- new Variable (line 3777)
- new Variable (line 3825)
- new Variable (line 4130)
- new Variable (line 4139)
- new Variable (line 4625)
- new Variable (line 4641)
- new Variable (line 4691)
- new Variable (line 5197)
