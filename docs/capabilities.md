...
| `array_multisort` | yes | no | no | standard | not implemented for JIT in this compiler build; use bin/vm.php (issue #1212) |
...
| `array_reduce` | yes | no | no | standard | callbacks: string user functions VM-only; closures deferred (#1213, #142); not implemented for JIT in this compiler build; |
...
| `array_splice` | yes | no | no | standard | not implemented for JIT in this compiler build |
...
| `array_walk` | yes | no | no | standard | not implemented for JIT in this compiler build (issue #1209) |
...
| `func_get_args` | yes | no | no | standard | not implemented for JIT in this compiler build; use VM (issue #197) |
| `func_num_args` | yes | no | no | standard | not implemented for JIT in this compiler build; use VM (issue #197) |
...
| `preg_replace_callback` | yes | no | no | standard | not implemented for JIT in this compiler build (issue #1177); |
...
| `session_name` | yes | no | no | standard | not implemented for JIT in this compiler build (issue #1184) |
