...
| `move_uploaded_file` | yes | yes | yes | standard | nested $_FILES + multipart web runtime (#52, #87); 006-FileUploadWeb; opt-in FILE_UPLOAD_WEB_AOT_SMOKE_GATE (#2012); JIT PHPT; AOT PHPT |
