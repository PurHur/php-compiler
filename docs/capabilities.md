Wrote /compiler/docs/capabilities.md (271 builtins).
Wrote /compiler/docs/stdlib-jit-audit.md (missing=1, deferred=14, present=242)
# Capability matrix
...
| `debug_backtrace` | yes | no | no | standard | not implemented for JIT in this compiler build (#1378) |
...
| `restore_error_handler` | yes | no | no | standard | not implemented for JIT in this compiler build (#1379) |
...
| `session_destroy` | yes | no | no | standard | not implemented for JIT in this compiler build (issue #1182) |
| `session_id` | yes | yes | yes | standard | JIT PHPT; AOT PHPT |
| `session_name` | yes | yes | yes | standard | JIT PHPT; AOT PHPT |
| `session_regenerate_id` | yes | no | no | standard | not implemented for JIT in this compiler build (issue #1186) |
| `session_start` | yes | no | no | standard | not implemented for JIT in this compiler build (issues #64, #1182–#1186) |
| `session_write_close` | yes | no | no | standard | not implemented for JIT in this compiler build (issue #1185) |
| `set_error_handler` | yes | no | no | standard | not implemented for JIT in this compiler build (#1379) |
...
| `stream_context_create` | yes | no | no | standard | not implemented for JIT in this compiler build (issue #1377) |
