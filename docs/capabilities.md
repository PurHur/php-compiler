...
| `move_uploaded_file` | yes | yes | yes | standard | AOT PHPT; JIT via __compiler_move_uploaded_file |
...
| `spl_autoload_register` | yes | no | no | standard | not implemented for JIT in this compiler build |
