...
| `debug_backtrace` | yes | yes | yes | standard | compile-time frames only (#1378, #1870) |
...
| `ob_end_flush` | yes | yes | yes | standard | |
| `ob_get_clean` | yes | yes | yes | standard | |
| `ob_get_level` | yes | yes | yes | standard | |
| `ob_start` | yes | yes | yes | standard | callback args deferred (#118) |
