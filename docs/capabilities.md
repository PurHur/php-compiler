...
| `array_pop` | yes | no | no | standard | doc: VM only; not implemented for JIT in this compiler build |
...
| `array_shift` | yes | no | no | standard | doc: VM only; not implemented for JIT in this compiler build |
