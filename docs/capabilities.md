Wrote /compiler/docs/capabilities.md (210 builtins).
# Capability matrix
...
| `function_exists` | yes | yes | yes | standard | compliance + AOT PHPT (#1216) |
...
| `function_exists` | yes | yes | yes | standard | JIT PHPT |
