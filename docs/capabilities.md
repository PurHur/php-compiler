...
| `array_filter` | yes | no | no | standard | doc: VM only; not implemented for JIT in this compiler build |
...
| `file_exists` | yes | no | no | standard | doc: VM only; not implemented for JIT in this compiler build |
| `file_get_contents` | yes | no | no | standard | not implemented for JIT in this compiler build; JIT PHPT; AOT PHPT |
...
| `is_dir` | yes | no | no | standard | doc: VM only; not implemented for JIT in this compiler build |
| `is_double` | yes | yes | yes | types |  |
| `is_file` | yes | no | no | standard | doc: VM only; not implemented for JIT in this compiler build |
