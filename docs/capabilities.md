...
| `session_destroy` | yes | yes | partial | standard | AOT CGI file persistence (#1938); compile/link may pass; JIT PHPT |
| `session_id` | yes | yes | yes | standard | JIT PHPT; AOT PHPT |
| `session_name` | yes | yes | yes | standard | JIT PHPT; AOT PHPT |
| `session_regenerate_id` | yes | yes | partial | standard | AOT CGI file persistence (#1938); compile/link may pass; JIT PHPT |
| `session_start` | yes | yes | partial | standard | AOT CGI file persistence (#1938); compile/link may pass; JIT PHPT |
| `session_write_close` | yes | yes | partial | standard | AOT CGI file persistence (#1938); compile/link may pass; JIT PHPT |
