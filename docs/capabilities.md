...
User-defined classes, methods, property access, and `instanceof`. Tracking issues: [#58](https://github.com/PurHur/php-compiler/issues/58), [#145](https://github.com/PurHur/php-compiler/issues/145), [#138](https://github.com/PurHur/php-compiler/issues/138).
...
_Builtin AOT uses the same LLVM path as JIT unless noted otherwise. Syntax AOT column reflects `Runtime::MODE_AOT` compile probes._
