...
| `func_get_args` | yes | no | no | standard | doc: VM only; not implemented for JIT in this compiler build (issue #197) |
| `func_num_args` | yes | no | no | standard | doc: VM only; not implemented for JIT in this compiler build (issue #197) |
