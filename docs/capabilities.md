...
| `session_destroy` | yes | yes | yes | standard | JIT PHPT |
...
| `session_start` | yes | yes | yes | standard | JIT PHPT; AOT file persistence (#1938) |
| `session_write_close` | yes | yes | yes | standard | JIT PHPT; AOT file persistence (#1938) |
