...
| **Spine SSOT** | `php script/bootstrap-spine-count.php` → **4649** / **4649** |
...
- **Literal spine ratio** — **4649/4649** ✅ (Jul 2026)
...
- **Self-host M2** — spine **4649/4649** ✅; native link + lint ✅
...
| **M2** — Spine toward full inventory | ✅ **4649** / **4649** |
