...
| **Wave 3** | Language **5004/5004** · Stdlib **5004/5004** on master ([#1380](https://github.com/PurHur/php-compiler/issues/1380)) |
| **Spine SSOT** | `php script/bootstrap-spine-count.php` → **5004** / **5004** |
...
| Gen-0 refresh | [a8cffaa0e](https://github.com/PurHur/php-compiler/commit/a8cffaa0e) | Spine runtime probe + gen-0 sidecars (**5004/5004**); inventory argv spine-lint fallback ([#8559](https://github.com/PurHur/php-compiler/issues/8559)) |
...
- **Literal spine ratio** — **5004/5004** ✅ (Jul 2026)
...
- **Self-host M2** — spine **5004/5004** ✅; native link + lint ✅
...
| **M2** — Spine toward full inventory | ✅ **5004** / **5004** |
