...
| **Spine SSOT** | `php script/bootstrap-spine-count.php` → **4517** / **4517** |
...
- **Literal spine ratio** — **4517/4517** ✅ (Jul 2026)
...
- **Self-host M2** — spine **4517/4517** ✅; native link + lint ✅
...
| **M2** — Spine toward full inventory | ✅ **4517** / **4517** |
