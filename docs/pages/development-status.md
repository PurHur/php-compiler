...
| **Spine SSOT** | `php script/bootstrap-spine-count.php` → **8509** / **8509** |
...
- **Literal spine ratio** — **8509/8509** ✅ (Jul 2026)
...
- **Self-host M2** — spine **8509/8509** ✅; native link + lint ✅
...
| **M2** — Spine toward full inventory | ✅ **8509** / **8509** |
