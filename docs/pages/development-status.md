...
| **Spine SSOT** | `php script/bootstrap-spine-count.php` → **3989** / **3992** |
...
- **Literal spine ratio** — **3989/3992** ✅ (Jul 2026)
...
- **Self-host M2** — spine **3989/3992** ✅; native link + lint ✅
...
| **M2** — Spine toward full inventory | ✅ **3989** / **3992** |
