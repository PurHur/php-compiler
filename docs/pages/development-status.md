...
| **M2 — Lib spine growth** | `compiler_lib_spine_smoke` bundle toward full `bin/vm.php` inventory (**586** files) | 🚧 **435** / 586 units (~74%; [#1056](https://github.com/PurHur/php-compiler/issues/1056), [#1745](https://github.com/PurHur/php-compiler/issues/1745)) |
