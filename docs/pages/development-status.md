...
| **Spine SSOT** | `php script/bootstrap-spine-count.php` → **4183** / **4184** (1 deferred: #16866) |
...
- **Literal spine ratio** — **4183/4184 (1 deferred: #16866)** (1 deferred: #16866) ✅ (Jul 2026)
...
- **Self-host M2** — spine **4183/4184** ✅; native link + lint ✅
...
| **M2** — Spine toward full inventory | ✅ **4183** / **4184** |
