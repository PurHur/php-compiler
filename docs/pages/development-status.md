...
| **Spine SSOT** | `php script/bootstrap-spine-count.php` → **3336** / **3336** |
...
| Gen-0 refresh | [a8cffaa0e](https://github.com/PurHur/php-compiler/commit/a8cffaa0e) | Spine runtime probe + gen-0 sidecars (**3336/3336**); inventory argv spine-lint fallback ([#8559](https://github.com/PurHur/php-compiler/issues/8559)) |
...
- **Literal spine ratio** — **3336/3336** ✅ (Jun 2026)
...
- **Self-host M2** — spine **3336/3336** ✅; native link + lint ✅
