...
| **Spine SSOT** | `php script/bootstrap-spine-count.php` → **4769** / **4769** |
...
- **Literal spine ratio** — **4769/4769** ✅ (Jul 2026)
...
- **Self-host M2** — spine **4769/4769** ✅; native link + lint ✅
...
| **M2** — Spine toward full inventory | ✅ **4769** / **4769** |
