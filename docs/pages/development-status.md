...
| **Spine SSOT** | `php script/bootstrap-spine-count.php` → **4880** / **4880** |
...
- **Literal spine ratio** — **4880/4880** ✅ (Jul 2026)
...
- **Self-host M2** — spine **4880/4880** ✅; native link + lint ✅
...
| **M2** — Spine toward full inventory | ✅ **4880** / **4880** |
