...
| **Spine SSOT** | `php script/bootstrap-spine-count.php` → **4845** / **4845** |
...
- **Literal spine ratio** — **4845/4845** ✅ (Jul 2026)
...
- **Self-host M2** — spine **4845/4845** ✅; native link + lint ✅
...
| **M2** — Spine toward full inventory | ✅ **4845** / **4845** |
