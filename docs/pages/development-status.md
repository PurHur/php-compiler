...
| **Spine SSOT** | `php script/bootstrap-spine-count.php` → **4350** / **4350** |
...
- **Literal spine ratio** — **4350/4350** ✅ (Jul 2026)
...
- **Self-host M2** — spine **4350/4350** ✅; native link + lint ✅
...
| **M2** — Spine toward full inventory | ✅ **4350** / **4350** |
