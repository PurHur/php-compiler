...
| **Spine SSOT** | `php script/bootstrap-spine-count.php` → **8200** / **8200** |
...
- **Literal spine ratio** — **8200/8200** ✅ (Jul 2026)
...
- **Self-host M2** — spine **8200/8200** ✅; native link + lint ✅
...
| **M2** — Spine toward full inventory | ✅ **8200** / **8200** |
