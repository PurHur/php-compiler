...
| **M2 — Lib spine growth** | `compiler_lib_spine_smoke` bundle toward full `bin/vm.php` inventory (**586** files) | 🚧 **437** / 586 units (~75%; [#1056](https://github.com/PurHur/php-compiler/issues/1056), [#1744](https://github.com/PurHur/php-compiler/issues/1744)) |
