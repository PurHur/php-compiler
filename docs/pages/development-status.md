...
| **Spine SSOT** | `php script/bootstrap-spine-count.php` → **4828** / **4828** |
...
- **Literal spine ratio** — **4828/4828** ✅ (Jul 2026)
...
- **Self-host M2** — spine **4828/4828** ✅; native link + lint ✅
...
| **M2** — Spine toward full inventory | ✅ **4828** / **4828** |
