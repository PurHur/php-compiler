...
| **Spine SSOT** | `php script/bootstrap-spine-count.php` → **4851** / **4852** (1 deferred: `lib/JIT/Builtin/ParseStrRuntimeUserScriptCstr.php`, #18855) |
...
- **Literal spine ratio** — **4851/4852** (1 deferred) ✅ (Jul 2026)
...
- **Self-host M2** — spine **4851/4852** (1 deferred) ✅; native link + lint ✅
...
| **M2** — Spine toward full inventory | ✅ **4851** / **4852** (1 deferred: `lib/JIT/Builtin/ParseStrRuntimeUserScriptCstr.php`, #18855) |
