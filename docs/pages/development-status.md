...
| **Spine SSOT** | `php script/bootstrap-spine-count.php` → **4410** / **4410** |
...
- **Literal spine ratio** — **4410/4410** ✅ (Jul 2026)
...
- **Self-host M2** — spine **4410/4410** ✅; native link + lint ✅
...
| **M2** — Spine toward full inventory | ✅ **4410** / **4410** |
