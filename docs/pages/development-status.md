...
| **Wave 3** | Language **5441/5441** · Stdlib **5441/5441** on master ([#1380](https://github.com/PurHur/php-compiler/issues/1380)) |
| **Spine SSOT** | `php script/bootstrap-spine-count.php` → **5441** / **5441** |
...
| Gen-0 refresh | [a8cffaa0e](https://github.com/PurHur/php-compiler/commit/a8cffaa0e) | Spine runtime probe + gen-0 sidecars (**5441/5441**); inventory argv spine-lint fallback ([#8559](https://github.com/PurHur/php-compiler/issues/8559)) |
...
- **Literal spine ratio** — **5441/5441** ✅ (Jul 2026)
...
- **Self-host M2** — spine **5441/5441** ✅; native link + lint ✅
...
| **M2** — Spine toward full inventory | ✅ **5441** / **5441** |
