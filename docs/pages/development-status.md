...
| **Self-host** (North Star 2, M0–M5) | ~75% | M0–M1 ✅; M2 spine **441/586**; M3 partial (native run ✅, Zend emit); M4–M5 ⬜ — [self-host-target.md](https://github.com/PurHur/php-compiler/blob/master/docs/self-host-target.md) |
...
| **M2 — Lib spine growth** | `compiler_lib_spine_smoke` bundle toward full `bin/vm.php` inventory (**586** files) | 🚧 **441** / 586 units (~75%; [#1056](https://github.com/PurHur/php-compiler/issues/1056), [#1741](https://github.com/PurHur/php-compiler/issues/1741), [#1725](https://github.com/PurHur/php-compiler/issues/1725), [#1731](https://github.com/PurHur/php-compiler/issues/1731)) |
...
| `compiler_lib_spine_smoke` (M2) | **441** | vm.php-path lib/ + ext/standard growth bundle |
...
| M2 spine native link | `BOOTSTRAP_LIB_SPINE_SMOKE=1 make bootstrap-selfhost-lib-spine-smoke` | ✅ `compiler_lib_spine_smoke bundle OK` (**441** units) |
