...
| **Spine SSOT** | `php script/bootstrap-spine-count.php` → **4745** / **4745** |
...
- **Literal spine ratio** — **4745/4745** ✅ (Jul 2026)
...
- **Self-host M2** — spine **4745/4745** ✅; native link + lint ✅
...
| **M2** — Spine toward full inventory | ✅ **4745** / **4745** |
