...
| **Spine SSOT** | `php script/bootstrap-spine-count.php` → **4293** / **4283** |
...
- **Literal spine ratio** — **4293/4283** ✅ (Jul 2026)
...
- **Self-host M2** — spine **4293/4283** ✅; native link + lint ✅
...
| **M2** — Spine toward full inventory | ✅ **4293** / **4283** |
