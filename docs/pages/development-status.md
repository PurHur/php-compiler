...
| **Spine SSOT** | `php script/bootstrap-spine-count.php` → **8569** / **8569** |
...
- **Literal spine ratio** — **8569/8569** ✅ (Jul 2026)
...
- **Self-host M2** — spine **8569/8569** ✅; native link + lint ✅
...
| **M2** — Spine toward full inventory | ✅ **8569** / **8569** |
