...
| **Spine SSOT** | `php script/bootstrap-spine-count.php` → **4510** / **4511** |
...
- **Literal spine ratio** — **4510/4511** ✅ (Jul 2026)
...
- **Self-host M2** — spine **4510/4511** ✅; native link + lint ✅
...
| **M2** — Spine toward full inventory | ✅ **4510** / **4511** |
