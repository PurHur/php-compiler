...
| **Spine SSOT** | `php script/bootstrap-spine-count.php` → **4578** / **4578** |
...
- **Literal spine ratio** — **4578/4578** ✅ (Jul 2026)
...
- **Self-host M2** — spine **4578/4578** ✅; native link + lint ✅
...
| **M2** — Spine toward full inventory | ✅ **4578** / **4578** |
