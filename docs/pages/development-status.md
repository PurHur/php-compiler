...
| **Spine SSOT** | `php script/bootstrap-spine-count.php` → **4561** / **4561** |
...
- **Literal spine ratio** — **4561/4561** ✅ (Jul 2026)
...
- **Self-host M2** — spine **4561/4561** ✅; native link + lint ✅
...
| **M2** — Spine toward full inventory | ✅ **4561** / **4561** |
