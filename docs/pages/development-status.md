...
| **Spine SSOT** | `php script/bootstrap-spine-count.php` → **8151** / **8151** |
...
- **Literal spine ratio** — **8151/8151** ✅ (Jul 2026)
...
- **Self-host M2** — spine **8151/8151** ✅; native link + lint ✅
...
| **M2** — Spine toward full inventory | ✅ **8151** / **8151** |
