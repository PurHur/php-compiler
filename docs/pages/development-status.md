...
| **Spine SSOT** | `php script/bootstrap-spine-count.php` → **4669** / **4669** |
...
- **Literal spine ratio** — **4669/4669** ✅ (Jul 2026)
...
- **Self-host M2** — spine **4669/4669** ✅; native link + lint ✅
...
| **M2** — Spine toward full inventory | ✅ **4669** / **4669** |
