...
| **Spine SSOT** | `php script/bootstrap-spine-count.php` → **8016** / **8016** |
...
- **Literal spine ratio** — **8016/8016** ✅ (Jul 2026)
...
- **Self-host M2** — spine **8016/8016** ✅; native link + lint ✅
...
| **M2** — Spine toward full inventory | ✅ **8016** / **8016** |
