...
| **Spine SSOT** | `php script/bootstrap-spine-count.php` → **8567** / **8567** |
...
- **Literal spine ratio** — **8567/8567** ✅ (Jul 2026)
...
- **Self-host M2** — spine **8567/8567** ✅; native link + lint ✅
...
| **M2** — Spine toward full inventory | ✅ **8567** / **8567** |
