...
| **Spine SSOT** | `php script/bootstrap-spine-count.php` → **3235** / **3234** |
...
| Gen-0 refresh | [a8cffaa0e](https://github.com/PurHur/php-compiler/commit/a8cffaa0e) | Spine runtime probe + gen-0 sidecars (**3235/3234**); inventory argv spine-lint fallback ([#8559](https://github.com/PurHur/php-compiler/issues/8559)) |
...
| Spine coverage | [#10356](https://github.com/PurHur/php-compiler/pull/10356) | `GeneratorYieldSourceMarker.php` in spine; inventory **3234** Phase A files |
...
- **Literal spine ratio** — **3235/3234** ✅ (Jun 2026)
...
- **Self-host M2** — spine **3235/3234** ✅; native link + lint ✅
