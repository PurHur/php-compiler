...
| **Spine SSOT** | `php script/bootstrap-spine-count.php` → **4031** / **4031** |
...
- **Literal spine ratio** — **4031/4031** ✅ (Jul 2026)
...
- **Self-host M2** — spine **4031/4031** ✅; native link + lint ✅
...
| **M2** — Spine toward full inventory | ✅ **4031** / **4031** |
