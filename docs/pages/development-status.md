...
| **North Star 2** | Self-compile — M0–M1 ✅ · M2 spine **578/586** · M5 ⬜ ([#1492](https://github.com/PurHur/php-compiler/issues/1492)
...
| **Self-host** (North Star 2, M0–M5) | ~98% | M0–M1 ✅; M2 spine **578/586**; M3 partial (native run ✅, Zend emit); M4–M5 ⬜ — [self-host-target.md](https://github.com/PurHur/php-compiler/blob/master/docs/self-host-target.md
...
| **M2 — Lib spine growth** | `compiler_lib_spine_smoke` bundle toward full `bin/vm.php` inventory (**586** files) | 🚧 **578** / 586 units (~98%; [#1492](https://github.com/PurHur/php-compiler/issues/1492)
...
| `compiler_lib_spine_smoke` (M2) | **578** | vm.php-path lib/ + ext/standard growth bundl
...
| M2 spine native link | `BOOTSTRAP_LIB_SPINE_SMOKE=1 make bootstrap-selfhost-lib-spine-smoke` | ✅ `compiler_lib_spine_smoke bundle OK` (**578** units
