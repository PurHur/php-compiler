...
| **Spine SSOT** | `php script/bootstrap-spine-count.php` → **4599** / **4602** |
...
- **Literal spine ratio** — **4599/4602** ✅ (Jul 2026)
...
- **Self-host M2** — spine **4599/4602** ✅; native link + lint ✅
...
| **M2** — Spine toward full inventory | ✅ **4599** / **4602** |
