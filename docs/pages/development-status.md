...
| **Spine SSOT** | `php script/bootstrap-spine-count.php` → **4856** / **4856** |
...
- **Literal spine ratio** — **4856/4856** ✅ (Jul 2026)
...
- **Self-host M2** — spine **4856/4856** ✅; native link + lint ✅
...
| **M2** — Spine toward full inventory | ✅ **4856** / **4856** |
