...
| **Spine SSOT** | `php script/bootstrap-spine-count.php` → **8282** / **8282** |
...
- **Literal spine ratio** — **8282/8282** ✅ (Jul 2026)
...
- **Self-host M2** — spine **8282/8282** ✅; native link + lint ✅
...
| **M2** — Spine toward full inventory | ✅ **8282** / **8282** |
