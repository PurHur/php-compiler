...
| **Spine SSOT** | `php script/bootstrap-spine-count.php` → **5132** / **5132** |
...
- **Literal spine ratio** — **5132/5132** ✅ (Jul 2026)
...
- **Self-host M2** — spine **5132/5132** ✅; native link + lint ✅
...
| **M2** — Spine toward full inventory | ✅ **5132** / **5132** |
