...
| **Spine SSOT** | `php script/bootstrap-spine-count.php` → **1273** / **1433** |
...
- **Self-host M2** — spine **1273** / **1433** 🚧; native spine **link** ✅ when LLVM + patches wired
...
| **M2** — Spine toward full inventory | 🚧 **1273** / **1433** |
