...
| **Spine SSOT** | `php script/bootstrap-spine-count.php` → **4151** / **4151** |
...
- **Literal spine ratio** — **4151/4151** ✅ (Jul 2026)
...
- **Self-host M2** — spine **4151/4151** ✅; native link + lint ✅
...
| **M2** — Spine toward full inventory | ✅ **4151** / **4151** |
