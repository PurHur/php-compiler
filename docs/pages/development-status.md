...
| **Spine SSOT** | `php script/bootstrap-spine-count.php` → **4846** / **4846** |
...
- **Literal spine ratio** — **4846/4846** ✅ (Jul 2026)
...
- **Self-host M2** — spine **4846/4846** ✅; native link + lint ✅
...
| **M2** — Spine toward full inventory | ✅ **4846** / **4846** |
