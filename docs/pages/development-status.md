...
| **Spine SSOT** | `php script/bootstrap-spine-count.php` → **8510** / **8510** |
...
- **Literal spine ratio** — **8510/8510** ✅ (Jul 2026)
...
- **Self-host M2** — spine **8510/8510** ✅; native link + lint ✅
...
| **M2** — Spine toward full inventory | ✅ **8510** / **8510** |
