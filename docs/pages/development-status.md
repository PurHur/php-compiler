...
| **Spine SSOT** | `php script/bootstrap-spine-count.php` → **7906** / **7906** |
...
- **Literal spine ratio** — **7906/7906** ✅ (Jul 2026)
...
- **Self-host M2** — spine **7906/7906** ✅; native link + lint ✅
...
| **M2** — Spine toward full inventory | ✅ **7906** / **7906** |
