...
| **Spine SSOT** | `php script/bootstrap-spine-count.php` → **4181** / **4182** (1 deferred: #16866) |
...
- **Literal spine ratio** — **4181/4182 (1 deferred: #16866)** (1 deferred: #16866) ✅ (Jul 2026)
...
- **Self-host M2** — spine **4181/4182** ✅; native link + lint ✅
...
| **M2** — Spine toward full inventory | ✅ **4181** / **4182** |
