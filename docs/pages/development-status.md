...
| **Spine SSOT** | `php script/bootstrap-spine-count.php` → **4961** / **4961** |
...
- **Literal spine ratio** — **4961/4961** ✅ (Jul 2026)
...
- **Self-host M2** — spine **4961/4961** ✅; native link + lint ✅
...
| **M2** — Spine toward full inventory | ✅ **4961** / **4961** |
