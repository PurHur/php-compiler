...
| **North star (self-host)** | M0–M1 ✅ · M2 spine **661/664** native link ✅ ([#1960](https://github.com/PurHur/php-compiler/issues/1960)) · M3 partial (native run ✅, emit 🚧 [#1937](https://github.com/PurHur/php-compiler/issues/1937)) · M5 ⬜ ([#1492](https://github.com/PurHur/php-compiler/issues/1492)) |
...
| **Self-host** (north star, M0–M5) | ~58% | M0–M1 ✅; M2 spine **661/664** native link ✅ ([#1960](https://github.com/PurHur/php-compiler/issues/1960)); M3 partial — native **run** ✅, native **emit** 🚧 ([#1937](https://github.com/PurHur/php-compiler/issues/1937), [#1402](https://github.com/PurHur/php-compiler/issues/1402)); M4–M5 ⬜ — [self-host-target.md](https://github.com/PurHur/php-compiler/blob/master/docs/self-host-target.md)
...
- Honest AOT bundle toward the full `bin/vm.php` inventory (**664** files), with `PHP_COMPILER_SELFHOST_AOT` stub surface **shrinking** as lowering lands
...
| **M2 — Lib spine growth** | `compiler_lib_spine_smoke` bundle toward full `bin/vm.php` inventory (**664** files) | ✅ native link **661** / 664 units (~93%; **3 deferred** native-link units: `bin/vm.php`, `lib/AOT/Linker.php`, `lib/JIT/Builtin/StringPasswordCrypto.php`; [#2126](https://github.com/PurHur/php-compiler/issues/2126), [#1960](https://github.com/PurHur/php-compiler/issues/1960)) |
...
| Full vm.php inventory | **664** | Phase A inventory (`php script/bootstrap-inventory.php`) |
...
|-------|---------------|--------|
| **A — Inventory** | `php script/bootstrap-inventory.php --check` | ✅ **664** files; 0 source blockers |
...
| M2 spine native link | `BOOTSTRAP_LIB_SPINE_SMOKE=1 make bootstrap-selfhost-lib-spine-smoke` | ✅ `compiler_lib_spine_smoke bundle OK` (**661** / **664** units; [#2001](https://github.com/PurHur/php-compiler/issues/2001)) |
