...
| **Spine SSOT** | `php script/bootstrap-spine-count.php` → **3933** / **3933** |
...
- **Literal spine ratio** — **3933/3933** ✅ (Jul 2026)
...
- **Self-host M2** — spine **3933/3933** ✅; native link + lint ✅
...
| **M2** — Spine toward full inventory | ✅ **3933** / **3933** |
