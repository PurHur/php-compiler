...
| **Spine SSOT** | `php script/bootstrap-spine-count.php` → **2967** / **2968** |
...
| Gen-0 refresh | [a8cffaa0e](https://github.com/PurHur/php-compiler/commit/a8cffaa0e) | Spine runtime probe + gen-0 sidecars (**2967/2968**); inventory argv spine-lint fallback ([#8559](https://github.com/PurHur/php-compiler/issues/8559)) |
...
| Spine coverage | [#10356](https://github.com/PurHur/php-compiler/pull/10356) | `GeneratorYieldSourceMarker.php` in spine; inventory **2967** Phase A files |
...
- **Literal spine ratio** — **2967/2968** ✅ (Jun 2026)
...
- **Self-host M2** — spine **2967/2968** ✅; native link + lint ✅
...
| **M2** — Spine toward full inventory | ✅ **2869** / **2850** |
