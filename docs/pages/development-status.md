...
| **Spine SSOT** | `php script/bootstrap-spine-count.php` → **8031** / **8031** |
...
- **Literal spine ratio** — **8031/8031** ✅ (Jul 2026)
...
- **Self-host M2** — spine **8031/8031** ✅; native link + lint ✅
...
| **M2** — Spine toward full inventory | ✅ **8031** / **8031** |
