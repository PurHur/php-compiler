...
| **Spine SSOT** | `php script/bootstrap-spine-count.php` → **4397** / **4397** |
...
- **Literal spine ratio** — **4397/4397** ✅ (Jul 2026)
...
- **Self-host M2** — spine **4397/4397** ✅; native link + lint ✅
...
| **M2** — Spine toward full inventory | ✅ **4397** / **4397** |
