...
| **Spine SSOT** | `php script/bootstrap-spine-count.php` → **4094** / **4094** |
...
- **Literal spine ratio** — **4094/4094** ✅ (Jul 2026)
...
- **Self-host M2** — spine **4094/4094** ✅; native link + lint ✅
...
| **M2** — Spine toward full inventory | ✅ **4094** / **4094** |
