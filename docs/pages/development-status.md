...
| **Spine SSOT** | `php script/bootstrap-spine-count.php` → **4340** / **4339** |
...
- **Literal spine ratio** — **4340/4339** ✅ (Jul 2026)
...
- **Self-host M2** — spine **4340/4339** ✅; native link + lint ✅
...
| **M2** — Spine toward full inventory | ✅ **4340** / **4339** |
