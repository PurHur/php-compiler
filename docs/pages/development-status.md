...
| **Spine SSOT** | `php script/bootstrap-spine-count.php` → **4825** / **4825** |
...
- **Literal spine ratio** — **4825/4825** ✅ (Jul 2026)
...
- **Self-host M2** — spine **4825/4825** ✅; native link + lint ✅
...
| **M2** — Spine toward full inventory | ✅ **4825** / **4825** |
