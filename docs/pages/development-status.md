...
| **Spine SSOT** | `php script/bootstrap-spine-count.php` → **4197** / **4198** (1 deferred: #16866) |
...
- **Literal spine ratio** — **4197/4198 (1 deferred: #16866)** (1 deferred: #16866) ✅ (Jul 2026)
...
- **Self-host M2** — spine **4197/4198** ✅; native link + lint ✅
...
| **M2** — Spine toward full inventory | ✅ **4197** / **4198** |
