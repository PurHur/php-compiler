...
| **M2 — Lib spine growth** | `compiler_lib_spine_smoke` bundle toward full `bin/vm.php` inventory (**586** files) | 🚧 **579** / 586 units (~99%; [#1492](https://github.com/PurHur/php-compiler/issues/1492)
