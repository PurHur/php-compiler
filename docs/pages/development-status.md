...
| **Spine SSOT** | `php script/bootstrap-spine-count.php` → **4287** / **4288** |
...
- **Literal spine ratio** — **4287/4288** ✅ (Jul 2026)
...
- **Self-host M2** — spine **4287/4288** ✅; native link + lint ✅
...
| **M2** — Spine toward full inventory | ✅ **4287** / **4288** |
