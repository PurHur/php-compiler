...
| **Spine SSOT** | `php script/bootstrap-spine-count.php` → **7858** / **7858** |
...
- **Literal spine ratio** — **7858/7858** ✅ (Jul 2026)
...
- **Self-host M2** — spine **7858/7858** ✅; native link + lint ✅
...
| **M2** — Spine toward full inventory | ✅ **7858** / **7858** |
