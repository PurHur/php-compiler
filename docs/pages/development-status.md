...
| **Self-host bootstrap** | ~47% | M0 ✅ · M1 ✅ · M2 🚧 (179/532 spine) · M3 🚧 partial · M5 ⬜ ([#1056](https://github.com/PurHur/php-compiler/issues/1056)) |
...
| **M2 — Full top-level `lib/` + spine growth** | All 14 top-level `lib/*.php` lint ✅; **`compiler_lib_spine_smoke`** (179 units) native link ✅; grow toward 532-file `bin/vm.php` inventory | 🚧 ~**34%** of inventory ([#1056](https://github.com/PurHur/php-compiler/issues/1056)) |
...
| `compiler_lib_spine_smoke` (M2) | **179** | +71 vm.php-path lib/ + ext/standard JIT leaf units |
...
| M2 lib spine smoke link | `make bootstrap-selfhost-lib-spine-smoke` | ✅ **179** units (opt-in `BOOTSTRAP_LIB_SPINE_SMOKE=1`) |
