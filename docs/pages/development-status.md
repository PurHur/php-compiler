...
| **Spine SSOT** | `php script/bootstrap-spine-count.php` → **8001** / **8001** |
...
- **Literal spine ratio** — **8001/8001** ✅ (Jul 2026)
...
- **Self-host M2** — spine **8001/8001** ✅; native link + lint ✅
...
| **M2** — Spine toward full inventory | ✅ **8001** / **8001** |
