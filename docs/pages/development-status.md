...
| **Examples 000–007** | VM + AOT regression fixtures (not a product north star) |
...
- **Examples 000–007** — VM and AOT link/execute for the web subset (003–007 as CI fixtures)
- **Self-host M0–M2** — minimal bundle ✅; spine native link **655/657** ✅ ([#1960](https://github.com/PurHur/php-compiler/issues/1960))
...
| **M2** — Spine toward full inventory | ✅ **655/657** link |
...
`examples/003-MiniWebApp` and siblings exercise routing, templates, sessions, uploads, and throws in CI. They are **regression harnesses**, not the project north star ([#1044](https://github.com/PurHur/php-compiler/issues/1044) closed).
