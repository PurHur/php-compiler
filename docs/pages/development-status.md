...
| **Wave 3** | Language **5515/5515** · Stdlib **5515/5515** on master ([#1380](https://github.com/PurHur/php-compiler/issues/1380)) |
| **Spine SSOT** | `php script/bootstrap-spine-count.php` → **5515** / **5515** |
...
| Gen-0 refresh | [a8cffaa0e](https://github.com/PurHur/php-compiler/commit/a8cffaa0e) | Spine runtime probe + gen-0 sidecars (**5515/5515**); inventory argv spine-lint fallback ([#8559](https://github.com/PurHur/php-compiler/issues/8559)) |
...
- **Literal spine ratio** — **5515/5515** ✅ (Jul 2026)
...
- **Self-host M2** — spine **5515/5515** ✅; native link + lint ✅
...
| **M2** — Spine toward full inventory | ✅ **5515** / **5515** |
