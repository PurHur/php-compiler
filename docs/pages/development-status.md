...
| **Self-host bootstrap** | ~48% | M0 ✅ · M1 ✅ · M2 🚧 (222/532 spine) · M3 🚧 partial · M5 ⬜ ([#1056](https://github.com/PurHur/php-compiler/issues/1056)) |
...
| **M2 — Full top-level `lib/` + spine growth** | All 14 top-level `lib/*.php` lint ✅; **`compiler_lib_spine_smoke`** (198 units) native link ✅; grow toward 532-file `bin/vm.php` inventory | 🚧 ~**42%** of inventory ([#1056](https://github.com/PurHur/php-compiler/issues/1056)) |
...
| `compiler_lib_spine_smoke` (M2) | **222** | +114 vm.php-path lib/ + ext/standard JIT leaf units |
...
| M2 lib spine smoke link | `make bootstrap-selfhost-lib-spine-smoke` | ✅ **222** units (opt-in `BOOTSTRAP_LIB_SPINE_SMOKE=1`) |
