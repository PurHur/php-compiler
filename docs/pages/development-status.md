...
| **Spine SSOT** | `php script/bootstrap-spine-count.php` → **4222** / **4222** |
...
- **Literal spine ratio** — **4222/4222** ✅ (Jul 2026)
...
- **Self-host M2** — spine **4222/4222** ✅; native link + lint ✅
...
| **M2** — Spine toward full inventory | ✅ **4222** / **4222** |
