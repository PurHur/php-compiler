...
| **Spine SSOT** | `php script/bootstrap-spine-count.php` → **3992** / **3995** |
...
- **Literal spine ratio** — **3992/3995** ✅ (Jul 2026)
...
- **Self-host M2** — spine **3992/3995** ✅; native link + lint ✅
...
| **M2** — Spine toward full inventory | ✅ **3992** / **3995** |
