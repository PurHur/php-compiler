...
| **Spine SSOT** | `php script/bootstrap-spine-count.php` → **4403** / **4404** |
...
- **Literal spine ratio** — **4403/4404** ✅ (Jul 2026)
...
- **Self-host M2** — spine **4403/4404** ✅; native link + lint ✅
...
| **M2** — Spine toward full inventory | ✅ **4403** / **4404** |
