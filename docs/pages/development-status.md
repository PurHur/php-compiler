...
| **Spine SSOT** | `php script/bootstrap-spine-count.php` → **4154** / **4154** |
...
- **Literal spine ratio** — **4154/4154** ✅ (Jul 2026)
...
- **Self-host M2** — spine **4154/4154** ✅; native link + lint ✅
...
| **M2** — Spine toward full inventory | ✅ **4154** / **4154** |
