...
| **Spine SSOT** | `php script/bootstrap-spine-count.php` → **4223** / **4223** |
...
- **Literal spine ratio** — **4223/4223** ✅ (Jul 2026)
...
- **Self-host M2** — spine **4223/4223** ✅; native link + lint ✅
...
| **M2** — Spine toward full inventory | ✅ **4223** / **4223** |
