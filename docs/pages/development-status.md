...
| **Spine SSOT** | `php script/bootstrap-spine-count.php` → **7136** / **7138** (2 deferred: #24115, #27103) |
...
| Gen-0 refresh | [a8cffaa0e](https://github.com/PurHur/php-compiler/commit/a8cffaa0e) | Spine runtime probe + gen-0 sidecars (**7136/7138**); inventory argv spine-lint fallback ([#8559](https://github.com/PurHur/php-compiler/issues/8559)) |
...
- **Literal spine ratio** — **7136/7138** (2 deferred: #24115, #27103) ✅ (Jul 2026)
...
- **Self-host M2** — spine **7136/7138** (2 deferred: #24115, #27103) ✅; native link + lint ✅
...
| **M2** — Spine toward full inventory | ✅ **7136** / **7138** (2 deferred: #24115, #27103) |
