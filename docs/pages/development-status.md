...
| **Spine SSOT** | `php script/bootstrap-spine-count.php` → **4068** / **4068** |
...
- **Literal spine ratio** — **4068/4068** ✅ (Jul 2026)
...
- **Self-host M2** — spine **4068/4068** ✅; native link + lint ✅
...
| **M2** — Spine toward full inventory | ✅ **4068** / **4068** |
