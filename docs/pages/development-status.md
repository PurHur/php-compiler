...
| **Spine SSOT** | `php script/bootstrap-spine-count.php` → **7985** / **7985** |
...
- **Literal spine ratio** — **7985/7985** ✅ (Jul 2026)
...
- **Self-host M2** — spine **7985/7985** ✅; native link + lint ✅
...
| **M2** — Spine toward full inventory | ✅ **7985** / **7985** |
