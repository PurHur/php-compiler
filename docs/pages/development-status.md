...
| **Spine SSOT** | `php script/bootstrap-spine-count.php` → **4966** / **4966** |
...
- **Literal spine ratio** — **4966/4966** ✅ (Jul 2026)
...
- **Self-host M2** — spine **4966/4966** ✅; native link + lint ✅
...
| **M2** — Spine toward full inventory | ✅ **4966** / **4966** |
