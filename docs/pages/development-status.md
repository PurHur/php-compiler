...
| **Spine SSOT** | `php script/bootstrap-spine-count.php` → **4882** / **4882** |
...
- **Literal spine ratio** — **4882/4882** ✅ (Jul 2026)
...
- **Self-host M2** — spine **4882/4882** ✅; native link + lint ✅
...
| **M2** — Spine toward full inventory | ✅ **4882** / **4882** |
