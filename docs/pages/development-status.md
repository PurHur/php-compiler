...
| **Spine SSOT** | `php script/bootstrap-spine-count.php` → **8590** / **8590** |
...
- **Literal spine ratio** — **8590/8590** ✅ (Jul 2026)
...
- **Self-host M2** — spine **8590/8590** ✅; native link + lint ✅
...
| **M2** — Spine toward full inventory | ✅ **8590** / **8590** |
