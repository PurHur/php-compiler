...
| Keyed array destructuring (`["a" => $x]`) | yes | yes | yes | [#1234](https://github.com/PurHur/php-compiler/issues/1234) | Short-list with string keys; skip AOT CFG split for fetch+assign pairs (#1234) |
