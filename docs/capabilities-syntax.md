...
| Error-control operator `@` on expressions | yes | yes | yes | [#3546](https://github.com/PurHur/php-compiler/issues/3546) | php-cfg ErrorSuppressBlock + Simplifier preserve (#3546); VM masks error_reporting; JIT/AOT no-op until native silence |
