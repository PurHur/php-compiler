...
| DNF types (`(A&B)|null`, union of intersections) | yes | no | no | [#3094](https://github.com/PurHur/php-compiler/issues/3094) | php-cfg Union + Intersection; TypeReconstructor TYPE_INTERSECTION; VM DnfCheck on param/property; Parenthesized DNF only (php-parser 4.x); ref Zend/zend_compile.c; VM-only lowering |
