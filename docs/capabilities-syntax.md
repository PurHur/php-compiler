...
| try/catch/finally + `throw` | yes | yes | yes | [#57](https://github.com/PurHur/php-compiler/issues/57) | VM unwind via TYPE_TRY/CATCH/FINALLY/THROW; compliance PHPT pack #2084; Builtin Exception (#195) follow-up; user classes in PHPT today |
