...
| Magic constants `__DIR__`, `__FILE__` | yes | yes | yes | [#707](https://github.com/PurHur/php-compiler/issues/707) | Runtime script path stack; compile-time fold when path known (#85); compliance PHPT |
| Magic constant `__LINE__` | yes | yes | yes | [#707](https://github.com/PurHur/php-compiler/issues/707) | Lowered at parse time via php-cfg (best-effort line) |
