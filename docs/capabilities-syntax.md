...
| ArrayAccess interface — `$obj[$key]` read/write/isset/unset | yes | no | no | [#3331](https://github.com/PurHur/php-compiler/issues/3331) | VM dispatches offsetGet/Set/Exists/Unset (Zend zend_object_handlers.c read_dimension); Non-ArrayAccess objects keep Illegal offset; JIT VM fallback via requiresVmLowering; compliance PHPT; VM-only lowering |
