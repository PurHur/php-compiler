...
| Trait use adaptations (`as` rename, `insteadof` precedence) | yes | yes | yes | [#3238](https://github.com/PurHur/php-compiler/issues/3238) | Zend/zend_compile.c trait alias/precedence; VM applyTraitUsesWithAdaptations; JIT/AOT batch trait use with insteadof/as (#2483, #3238); Visibility `as private` deferred to #144 |
