...
| readonly properties (per-property) | yes | partial | yes | [#3149](https://github.com/PurHur/php-compiler/issues/3149) | php-cfg readonly / propertyFlags MODIFIER_READONLY; VM rejects writes after __construct; JIT ReadonlyClassGuard IR + ReadonlyPropertyTest; MCJIT execute raise path harness-deferred (JITTest skip); AOT default + link; php-src: Zend/zend_object_handlers.c zend_std_write_property |
