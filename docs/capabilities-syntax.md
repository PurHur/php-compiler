...
| `array_rand()` (packed list keys) | yes | yes | yes | [#2321](https://github.com/PurHur/php-compiler/issues/2321) | Packed lists without holes; CSPRNG via random_bytes lowering |
