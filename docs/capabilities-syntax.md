...
| Trait use adaptations (`as` rename, `insteadof` precedence) | yes | no | no | [#3238](https://github.com/PurHur/php-compiler/issues/3238) | Zend/zend_compile.c trait alias/precedence; VM applyTraitUsesWithAdaptations; Visibility `as private` deferred to #144; VM-only lowering |
