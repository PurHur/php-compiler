...
| Simple `use Trait;` in class body | yes | no | no | [#2314](https://github.com/PurHur/php-compiler/issues/2314) | php-cfg-trait-use.patch; VM merges trait methods into class; TraitUseAdaptation (alias/insteadof) is #144; Horizontal trait method collision fatals at compile time (#3416); VM-only lowering |
