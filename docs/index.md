...
Builtin matrix: [`capabilities.md`](capabilities.md) (`php script/capability-matrix.php`) — currently **4054** rows (**4021** VM / **1885** JIT / **1739** AOT yes). Extension manifests: [`extensions.md`](extensions.md).
...
[`architecture-review-2026-07.md`](architecture-review-2026-07.md) · [`self-host-target.md`](self-host-target.md) · [`bootstrap-m5-fast-path.md`](bootstrap-m5-fast-path.md) · ADRs under [`adr/`](adr/). Spine coverage **8149** / **8149**.
