...
**M2 spine:** **717/718** spine vs Phase A inventory (`717` `require_once` units in `compiler_lib_spine_smoke`; **`lib/VM/HashTable.php`** promoted [#2543](https://github.com/PurHur/php-compiler/issues/2543); **718** SSOT Phase A files in `bootstrap-inventory.md`). Native link ✅ with **`bin/vm.php`** [#2134](https://github.com/PurHur/php-compiler/issues/2134); emit-TU JIT batch [#2652](https://github.com/PurHur/php-compiler/issues/2652); [#1492](https://github.com/PurHur/php-compiler/issues/1492), M2 batches [#1419](https://github.com/PurHur/php-compiler/issues/1419), [#1497](https://github.com/PurHur/php-compiler/issues/1497). Target doc: [self-host-target.md](self-host-target.md)
