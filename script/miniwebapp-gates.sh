...
bootstrap_m5_doc_gate="${BOOTSTRAP_M5_DOC_SYNC_GATE:-1}"
echo "  BOOTSTRAP_M5_DOC_SYNC_GATE=${bootstrap_m5_doc_gate}  script/check-bootstrap-m5-doc-sync.php (#1984)"
echo "  Opt out: ROOT_README_SYNC_GATE=0 ./script/ci-fast.sh"
echo "  Opt out: BOOTSTRAP_M5_DOC_SYNC_GATE=0 ./script/ci-fast.sh"
