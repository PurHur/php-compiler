...
echo "       ${REPO_URL}/issues/2189"
echo "       ${REPO_URL}/issues/2059"
...
miniwebapp_jit_project_gate="${MINIWEBAPP_JIT_PROJECT_GATE:-0}"
echo "  MINIWEBAPP_JIT_PROJECT_GATE=${miniwebapp_jit_project_gate}  ci-local MiniWebAppJitProjectTest (#587, #2183)"
