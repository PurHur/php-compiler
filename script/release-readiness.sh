...
# Committed gen-0 argv driver must compile a never-seen script (#23468). Default-on
# behavioral gate — stamp/manifest sync alone is not sufficient (#36218).
run_gate gen0-driver-functional "bootstrap-gen0-driver-functional-smoke (#36218)" \
