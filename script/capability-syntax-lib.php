...
function syntaxRowDefinitions(): array
{
    return [
        ...
        [
            ...
            'issue' => 1356,
            'notes' => ['Backed enum cases as class constants; `Foo::Bar` const-like fetch; case `->name` / `->value` (#3420); `enum_exists` registry; `implements` metadata (#2299); static methods (#2299)'],
