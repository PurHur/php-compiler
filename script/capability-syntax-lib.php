    ...
    return [
        ...
        [
            ...
            'notes' => [
                ...
                'Read path: `getAttributes()` + `ReflectionAttribute::getName()` + VM `newInstance()` with compile-time ctor args (#3206); no parameter attributes; JIT `newInstance()` deferred (#2467)',
            ],
