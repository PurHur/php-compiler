#!/usr/bin/env bash
# Full PHPC_DEPLOY_ROOT deploy ladder 001–003 + opt-in 005/006 (issue #2077).
#
...
echo "deploy-smoke-all: ladder 001–003 (+ 005/006 when deploy gates=1; probe: ./phpc doctor --gates)"
