...
foreach ($archIds as $archId) {
    ...
    if ($allArches && CompileTarget::ID_AARCH64_LINUX === $r['arch'] && !$r['absent']) {
        ...
        // Ratchet with script/seed-aarch64-helper-runtime.sh SEED_UNITS (VM_*+lib_VM_*+ext/standard + ctype/calendar/posix/filter/hash/tokenizer/mbstring/iconv + compress/encode).
        $minSeed = 332;
