...
final class BuiltinInternalDefaultValues
{
    ...
    private const EXPLICIT = [
        ...
        // php-src ext/sodium/libsodium.stub.php — string $ignore = "" (#27778)
        'sodium_hex2bin' => [
            1 => ['kind' => 'string', 'value' => ''],
        ],
        ...
        // php-src ext/hash/hash.stub.php — binary=false, options=[] (#25068, #23507)
        'hash' => [
            2 => ['kind' => 'bool', 'value' => false],
            3 => ['kind' => 'array'],
        ],
        ...
        // php-src ext/standard/dir.stub.php — $dir_handle = null (#31450)
        'readdir' => [
            0 => ['kind' => 'null'],
        ],
        // php-src ext/standard/dir.stub.php — $dir_handle = null (#31451)
        'rewinddir' => [
            0 => ['kind' => 'null'],
        ],
