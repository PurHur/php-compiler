...
require_once __DIR__.'/Compiler/Concern/CompileTimeGlobalConstAndDefineFold.php';
require_once __DIR__.'/Compiler/Concern/CompileTimeUnaryBinaryAndCastFold.php';
require_once __DIR__.'/Compiler/Concern/CompileTimeParamDefaultAndExprFold.php';
require_once __DIR__.'/Compiler/Concern/ParameterAsserts.php';
require_once __DIR__.'/Compiler/Concern/CoalesceAndNullsafe.php';
require_once __DIR__.'/Compiler/Concern/NullsafePropertyAndMethodCompile.php';
require_once __DIR__.'/Compiler/Concern/NullsafeChainCompile.php';
...
require_once __DIR__.'/Compiler/Concern/CompileExprAssignDispatch.php';
require_once __DIR__.'/Compiler/Concern/CompileExprBinaryOpCastAndUnaryDispatch.php';
...
require_once __DIR__.'/Compiler/Concern/TernaryMergeAndLogicalShortCircuitSlots.php';
...
require_once __DIR__.'/Compiler/Concern/CallArgNestedAdjacentSiblingVarExportMergeForceConstPreludeValueSlots.php';
require_once __DIR__.'/Compiler/Concern/CallArgPostNestedFinalLiteralNamedLocalHaystackDimExactValueSlots.php';
...
require_once __DIR__.'/Compiler/Concern/ExplodeIteratorChunkWalkAndTrailingComparatorCallArgSends.php';
...
require_once __DIR__.'/Compiler/Concern/PrecedingInlineLeadingCallbackAndHaystackProducers.php';
...
require_once __DIR__.'/Compiler/Concern/HoistedMultiArgSiblingProducerTargetArgIndex.php';
...
require_once __DIR__.'/Compiler/Concern/RewireSiblingMultiArgInlineCallArgSendSlots.php';
...
require_once __DIR__.'/Compiler/Concern/InlineCallArgConcatArithmeticFold.php';
require_once __DIR__.'/Compiler/Concern/InlineCallArgUnaryBitmaskResolve.php';
require_once __DIR__.'/Compiler/Concern/CallArgCompileTimeValueAndProcOpenFold.php';
...
require_once __DIR__.'/Compiler/Concern/FinalizeArrayCombineColumnCallArgSlots.php';
...
require_once __DIR__.'/Compiler/Concern/StaticMethodAndFuncCallCompile.php';
require_once __DIR__.'/Compiler/Concern/SiblingInlineReturnSlotAndMethodDeadTempDetect.php';
...
require_once __DIR__.'/Compiler/Concern/ArrayDimFetchCallArgSlots.php';
...
use PHPCompiler\Compiler\Concern\CompileTimeGlobalConstAndDefineFold;
use PHPCompiler\Compiler\Concern\CompileTimeUnaryBinaryAndCastFold;
use PHPCompiler\Compiler\Concern\CompileTimeParamDefaultAndExprFold;
use PHPCompiler\Compiler\Concern\ParameterAsserts;
use PHPCompiler\Compiler\Concern\CoalesceAndNullsafe;
use PHPCompiler\Compiler\Concern\NullsafePropertyAndMethodCompile;
use PHPCompiler\Compiler\Concern\NullsafeChainCompile;
...
use PHPCompiler\Compiler\Concern\CompileExprAssignDispatch;
use PHPCompiler\Compiler\Concern\CompileExprBinaryOpCastAndUnaryDispatch;
...
use PHPCompiler\Compiler\Concern\CallArgNestedAdjacentSiblingVarExportMergeForceConstPreludeValueSlots;
use PHPCompiler\Compiler\Concern\CallArgPostNestedFinalLiteralNamedLocalHaystackDimExactValueSlots;
...
use PHPCompiler\Compiler\Concern\ExplodeIteratorChunkWalkAndTrailingComparatorCallArgSends;
...
use PHPCompiler\Compiler\Concern\PrecedingInlineLeadingCallbackAndHaystackProducers;
...
use PHPCompiler\Compiler\Concern\HoistedMultiArgSiblingProducerTargetArgIndex;
...
use PHPCompiler\Compiler\Concern\RewireSiblingMultiArgInlineCallArgSendSlots;
...
use PHPCompiler\Compiler\Concern\InlineCallArgConcatArithmeticFold;
use PHPCompiler\Compiler\Concern\InlineCallArgUnaryBitmaskResolve;
use PHPCompiler\Compiler\Concern\CallArgCompileTimeValueAndProcOpenFold;
...
use PHPCompiler\Compiler\Concern\FinalizeArrayCombineColumnCallArgSlots;
...
use PHPCompiler\Compiler\Concern\StaticMethodAndFuncCallCompile;
use PHPCompiler\Compiler\Concern\SiblingInlineReturnSlotAndMethodDeadTempDetect;
...
use PHPCompiler\Compiler\Concern\ArrayDimFetchCallArgSlots;
...
class Compiler {
    ...
    use CompileTimeGlobalConstAndDefineFold;
    use CompileTimeUnaryBinaryAndCastFold;
    use CompileTimeParamDefaultAndExprFold;
    use ParameterAsserts;
    use CoalesceAndNullsafe;
    use NullsafePropertyAndMethodCompile;
    use NullsafeChainCompile;
    ...
    use CompileExprAssignDispatch;
    use CompileExprBinaryOpCastAndUnaryDispatch;
    use WriteContextRejects;
    use TernaryAndLogicalShortCircuit;
    use TernaryMergeVarSlotCompile;
    use TernaryMergeAndLogicalShortCircuitSlots;
    ...
    use CallArgNestedAdjacentSiblingVarExportMergeForceConstPreludeValueSlots;
    use CallArgPostNestedFinalLiteralNamedLocalHaystackDimExactValueSlots;
    use CompileCallArgSends;
    use CompileInlineSpecializedCallArgSends;
    use ArrayPadUnpackExtractAndDateSunCallArgSends;
    use ExplodeIteratorChunkWalkAndTrailingComparatorCallArgSends;
    ...
    use PrecedingInlineLeadingCallbackAndHaystackProducers;
    ...
    use HoistedMultiArgSiblingProducerTargetArgIndex;
    ...
    use RewireSiblingMultiArgInlineCallArgSendSlots;
    ...
    use InlineCallArgConcatArithmeticFold;
    use InlineCallArgUnaryBitmaskResolve;
    use CallArgCompileTimeValueAndProcOpenFold;
    ...
    use FinalizeArrayCombineColumnCallArgSlots;
    ...
    use StaticMethodAndFuncCallCompile;
    use SiblingInlineReturnSlotAndMethodDeadTempDetect;
