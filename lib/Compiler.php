...
require_once __DIR__.'/Compiler/Concern/SiblingInlineNewAndDeferredProducers.php';
...
use PHPCompiler\Compiler\Concern\SiblingInlineNewAndDeferredProducers;
...
class Compiler {
    ...
    use SiblingInlineNewAndDeferredProducers;
