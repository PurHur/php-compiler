...
final class BuiltinParamNames
{
    ...
    public static function forClassMethod(string $qualifiedMethod): ?array
    {
        return match (strtolower($qualifiedMethod)) {
            ...
            // php-src ext/dom/php_dom.stub.php — optional ctor params (#31849)
            ...
            'domelement::insertadjacentelement' => ['where', 'element'],
            'domelement::insertadjacenttext' => ['where', 'data'],
            'domelement::insertadjacenthtml' => ['position', 'html'],
            ...
            'domtext::substringdata' => ['offset', 'count'],
            'domcomment::substringdata' => ['offset', 'count'],
            'domcdatasection::substringdata' => ['offset', 'count'],
            'domcharacterdata::appenddata' => ['data'],
            'domtext::appenddata' => ['data'],
            'domcomment::appenddata' => ['data'],
            'domcdatasection::appenddata' => ['data'],
            ...
            'xmlwriter::startdocument' => ['version=', 'encoding=', 'standalone='],
            'xmlwriter::startdtd' => ['qualifiedName', 'publicId=', 'systemId='],
            'xmlwriter::writedtd' => ['name', 'publicId=', 'systemId=', 'content='],
            'xmlwriter::startdtdelement' => ['qualifiedName'],
            'xmlwriter::startdtdentity' => ['name', 'isParam'],
            'xmlwriter::writedtdentity' => ['name', 'content', 'isParam=', 'publicId=', 'systemId=', 'notationData='],
    ...
    public static function forFunction(string $name): ?array
    {
        ...
        switch ($lc) {
            ...
            // ip_address/in_addr/proper_address (#28916, #23357)
            case 'inet_pton':
            case 'inet_ntop':
            case 'ip2long':
            case 'long2ip':
            ...
            case 'array_change_key_case':
                return ['array', 'case='];
            // php-src ext/standard/array.stub.php — array $array; InternalArgInfo still says input (#26171)
            ...
            // php-src ext/standard/array.stub.php — array $array, array ...$arrays (#23593)
            case 'array_diff':
            ...
            case 'array_intersect_key':
                return ['array', '...arrays'];
            // php-src ext/standard/array.stub.php — array $array, array ...$rest (callback in rest) (#23593, #23959)
            ...
            // php-src ext/standard/basic_functions.stub.php — chown(string $filename, string|int $user): bool (#27812)
            case 'chown':
            case 'lchown':
                return ['filename', 'user'];
            // php-src ext/standard/basic_functions.stub.php — chgrp(string $filename, string|int $group): bool (#28001)
            case 'chgrp':
            case 'lchgrp':
            ...
            // php-src ext/openssl/openssl.stub.php
            case 'openssl_x509_check_private_key':
                return ['certificate', 'private_key'];
            // php-src ext/openssl/openssl.stub.php
            case 'openssl_x509_verify':
            ...
            // php-src ext/curl/curl.stub.php — absent from InternalArgInfo (#27711)
            case 'curl_share_init_persistent':
            ...
            // php-src ext/sodium/libsodium.stub.php — absent from InternalArgInfo (#27778)
            case 'sodium_bin2hex':
                return ['string'];
            case 'sodium_hex2bin':
