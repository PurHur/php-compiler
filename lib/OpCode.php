...
class OpCode {
    ...
    /**
     * TYPE_CLASS_CONST_FETCH: lexical `self`/`parent`/`static` before FQCN rewrite
     * (MagicStringResolver phpcLexicalScopeKeyword; self-referencing Error messages #31837).
     */
    public ?string $classConstFetchLexicalScope = null;
