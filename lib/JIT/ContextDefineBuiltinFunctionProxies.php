 ...
 *
 * Extracted from {@see ContextDefineBuiltins} so the ~830-line SPL / DateTime /
 * XMLReader / PDO / finfo proxy wiring stays a separate TU from builtin
 * register/implement/initialize (split-TU / size-budget ratchet toward
 * ContextDefineBuiltins ≤ 200 lines, #36199 / #36403).
 *
