 ...
 * {@see ContextDefineBuiltinFunctionProxiesSplIterators}; SplObjectStorage /
 * SplPriorityQueue / SplDllist / SplFixedArray proxies live in
 * {@see ContextDefineBuiltinFunctionProxiesSplContainers}; Reflection /
...
trait ContextDefineBuiltinFunctionProxies
{
    private function defineBuiltinFunctionProxies(): void
    {
        ...
        // SplObjectStorage / SplPriorityQueue / SplDllist / SplFixedArray —
        // ContextDefineBuiltinFunctionProxiesSplContainers (#36387).
