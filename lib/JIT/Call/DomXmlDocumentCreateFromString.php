...
use PHPCompiler\ext\dom\JitDomXmlDocumentCreateFromString;
...
/**
 * Dom\XMLDocument::createFromString() — user-script AOT (#27108).
 *
 * Avoids ExternalMethod silent NULL on thin standalone AOT.
 */
final class DomXmlDocumentCreateFromString implements Call
{
    /** Qualified name for BuiltinParamNames / named-arg resolve. */
    public string $name = 'Dom\\XMLDocument::createFromString';
    ...
    {
        return JitDomXmlDocumentCreateFromString::invoke($context, ...$args);
    }
}
