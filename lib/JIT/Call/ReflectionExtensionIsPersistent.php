 ...
 * Bundled modules are MODULE_PERSISTENT (php-src); match loaded extension names.
 * Peer {@see ReflectionExtensionGetVersion} (#34016); VM #22247.
 */
final class ReflectionExtensionIsPersistent implements Call
{
    public function call(Context $context, Variable ...$args): Value
    {
        ...
        return ReflectionExtensionIsPersistentRuntime::emit($context, $cstr, $len);
    }
}
