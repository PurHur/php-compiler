...
/**
 * XMLReader::fromStream() — user-script AOT static factory (#35900 leftover of #27299).
 *
 * Host PHP 8.2 has no fromStream; fold via fopen literal path (peer XMLWriter::toStream #35895).
