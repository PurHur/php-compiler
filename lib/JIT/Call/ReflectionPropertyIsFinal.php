...
use PHPCompiler\JIT\Builtin\ReflectionPropertyIsFinalRuntime;
...
final class ReflectionPropertyIsFinal implements Call
{
    ...
    private static function readStoredStringBox(Context $context, Value $obj, string $propName): Value
    {
        ...
        $readBlock = $fn->appendBasicBlock('refl_prop_str_read');
        $emptyBlock = $fn->appendBasicBlock('refl_prop_str_empty');
        $doneBlock = $fn->appendBasicBlock('refl_prop_str_done');
