...
/**
 * ReflectionClassConstant::getAttributes() — JIT (#25963, #4136).
 *
 * Property layout differs from ReflectionConstant: `$class` + `$name` (#22503).
 * Attribute names share the method/property table keyed by class + member (#4136).
 */
final class ReflectionClassConstantGetAttributes implements Call
{
    public function call(Context $context, Variable ...$args): Value
    {
        ...
        [$constSafe, $constLen] = ReflectionSetup::stringPropertyAsCstr(
            $context,
            $obj,
            'ReflectionClassConstant',
        ...
        $done = BasicBlockHelper::append($context, 'refl_cc_attr_done');
        $head = BasicBlockHelper::append($context, 'refl_cc_attr_head');
        $body = BasicBlockHelper::append($context, 'refl_cc_attr_body');
