...
/** ReflectionProperty::getAttributes() — JIT (#4136). */
final class ReflectionPropertyGetAttributes implements Call
{
    public function call(Context $context, Variable ...$args): Value
    {
        ...
        // Construct seeds Zend `$class` / `$name` (#22504) — not obsolete `name`/`property` keys (#33990).
        ...
        $done = BasicBlockHelper::append($context, 'refl_p_attr_done');
        $head = BasicBlockHelper::append($context, 'refl_p_attr_head');
        $body = BasicBlockHelper::append($context, 'refl_p_attr_body');
