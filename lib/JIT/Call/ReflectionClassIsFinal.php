...
/**
 * ReflectionClass::isFinal() — JIT/AOT (#18297, #34043, ext/reflection/php_reflection.c).
 *
 * Thin AOT: broken __compiler_strcasecmp table always matched (#34043); pass cstr+len
 * like {@see ReflectionClassIsInstantiable}.
 */
