 ...
 * name=>value map via {@see GetClassVarsRuntime::emitStaticPropertiesForClassId}
 * (peer getDefaultProperties #34091 / VM #6948).
 *
...
final class ReflectionClassGetStaticProperties implements Call
{
    ...
    private function dispatchByClassId(Context $context, Value $classId): Value
    {
        ...
        if ([] === $ids) {
            return GetClassVarsRuntime::emitEmptyStaticProperties($context);
        }
        ...
        $empty = GetClassVarsRuntime::emitEmptyStaticProperties($context);
        $context->builder->store(
