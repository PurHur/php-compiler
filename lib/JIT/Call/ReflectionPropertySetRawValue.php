...
/** ReflectionProperty::setRawValue($object, $value) — JIT/AOT (#27598, #6451, php_reflection.c). */
final class ReflectionPropertySetRawValue implements Call
{
    public function call(Context $context, Variable ...$args): Value
    {
        ...
        ReflectionPropertyRawValueRuntime::invokeSet($context, $target, $classStr, $propStr, $args[2]);
    ...
    private static function readStoredStringBox(Context $context, Value $obj, string $propName): Value
    {
        ...
        $readBlock = $fn->appendBasicBlock('refl_prop_raw_set_str_read');
        $emptyBlock = $fn->appendBasicBlock('refl_prop_raw_set_str_empty');
        $doneBlock = $fn->appendBasicBlock('refl_prop_raw_set_str_done');
