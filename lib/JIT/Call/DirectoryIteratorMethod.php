...
final class DirectoryIteratorMethod implements Call
{
    ...
    public function call(Context $context, Variable ...$args): Value
    {
        ...
        return match (strtolower($this->method)) {
            ...
            // php-src zim_FilesystemIterator_getFlags — ZEND_PARSE_PARAMETERS_NONE (#34984).
            'getflags' => $this->compileExact(
                $context,
                $args,
                $this->className.'::getFlags',
                0,
                fn () => DirectoryIteratorJitHelper::compileGetFlags(
                    $context,
                    $args[0],
                    $this->className
                )
            ),
            // php-src zim_FilesystemIterator_setFlags — exactly 1 user arg (#34984).
    ...
    /**
     * php-src ZEND_PARSE_PARAMETERS_* — $args[0] is $this (#34984).
     *
