...
use PHPCompiler\JIT\Builtin\ReflectionPropertyGetMangledNameRuntime;
...
/** ReflectionProperty::getMangledName() — JIT/AOT (#27592, ext/reflection/php_reflection.c). */
final class ReflectionPropertyGetMangledName implements Call
{
    public function call(Context $context, Variable ...$args): Value
    {
        ...
        return ReflectionPropertyGetMangledNameRuntime::invoke($context, $classStr, $propStr);
    }
    ...
    private static function readStoredStringBox(Context $context, Value $obj, string $propName): Value
    {
        ...
        $readBlock = $fn->appendBasicBlock('refl_prop_mangled_str_read');
        $emptyBlock = $fn->appendBasicBlock('refl_prop_mangled_str_empty');
        $doneBlock = $fn->appendBasicBlock('refl_prop_mangled_str_done');
