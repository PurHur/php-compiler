...
/** ReflectionMethod::getNumberOfRequiredParameters() — JIT/AOT (#34216, ext/reflection/php_reflection.c). */
final class ReflectionMethodGetNumberOfRequiredParameters implements Call
{
    public function call(Context $context, Variable ...$args): Value
    {
        ...
        $count = ReflectionMethodQueryLookupHelper::lookupRequiredParameterCount($context, $args[0]);
