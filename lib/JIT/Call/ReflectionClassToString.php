...
/**
 * ReflectionClass::__toString() — JIT/AOT (#34135, #22379, ext/reflection/php_reflection.c).
 *
 * Thin AOT previously had no proxy; (string) cast fatals with
 * "Object of class ReflectionClass could not be converted to string".
...
final class ReflectionClassToString implements Call
{
    ...
    {
        // php-src: zim_ReflectionClass___toString — 0 args; $args[0] is $this
