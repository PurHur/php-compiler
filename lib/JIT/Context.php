...
class Context {
    ...
    private function defineBuiltins(int $loadType): void {
        ...
        // SplFileObject — line snapshot `__spl_ht` for foreach (#28709); path accessors (#33305).
        ...
        foreach (['getFilename', 'getPathname', 'getPath', '__toString'] as $sfoMethod) {
            $this->functionProxies['splfileobject::'.strtolower($sfoMethod)] = new Call\DirectoryIteratorMethod(
                $sfoMethod,
                'SplFileObject'
            );
        }
