...
class Context {
    ...
    private function ensureMinimalUserStandaloneBodies(): void
    {
        ...
        // ObOutputRuntime always-on removed (#34695): ValueEchoHelper / ValueEchoRuntime /
        // JIT ECHO/PRINT already ensureLinked before __phpc_ob_echo_* lookup (peer #34642).
        // Leftover Context NestedJIT vs Runtime ABI drift mints *.1 (#31894 / #32122).
        // Thin AOT hello-world must not NestedJIT ob_* ABI during init.
    ...
    private function ensureFullStandaloneBodies(): void
    {
        ...
        try {
            ...
            // ObOutput always-on before ValueEcho removed (#34695): ValueEchoRuntime::ensureLinked
            // already ObOutputRuntime::ensureLinked (peer #34642). Leftover Context NestedJIT vs
            // Runtime ABI drift mints *.1 (#31894 / #32122).
