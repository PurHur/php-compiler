...
class Context {
    ...
    private function defineBuiltins(int $loadType): void {
        ...
        // SQLite3 construct/exec/querySingle/lastInsertRowID/changes/lastError*/busyTimeout/enableExceptions/escapeString — NestedJIT leftover of advertise-only AOT (#35931 / #35966 / #35972 / #35975 / #35977 / #20565).
        if (CompilerVersion::supportsSqlite3()) {
            $this->type->object->lookup('SQLite3');
            foreach (['__construct', 'exec', 'querySingle', 'close', 'lastInsertRowID', 'changes', 'lastErrorCode', 'lastErrorMsg', 'busyTimeout', 'enableExceptions', 'escapeString'] as $sqliteMethod) {
