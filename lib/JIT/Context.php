...
class Context {
    ...
    private function defineBuiltins(int $loadType): void {
        ...
        // fseek (#33347); seek (#33364); setFlags/getFlags (#33368); setMaxLineLen/getMaxLineLen (#33377 / #33378);
        // setCsvControl/getCsvControl (#33371); inherited SplFileInfo stats (#33313).
