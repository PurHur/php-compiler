...
require_once __DIR__.'/NoThrowCallElisionRuntimeInfoOps.php';
 ...
 * Runtime-info / process / clock / civil-date / randmax proofs live in
 * {@see NoThrowCallElisionRuntimeInfoOps} (#36403).
 *
...
{
    use NoThrowCallElisionRuntimeInfoOps;
