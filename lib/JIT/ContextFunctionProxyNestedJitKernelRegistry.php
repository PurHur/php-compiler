...
/**
 * NestedJIT / SPINE_CHUNK kernel whitelist + VM-registry helpers for {@see Context} (#36387).
 *
 ...
 *
 * No new C ABI. php-src analogy: zend_function / internal function table lookup and the
 * executor's always-available kernel set live beside the compiler front-end
 * (Zend/zend_compile.c function_table, Zend/zend_execute_API.c, Zend/zend_builtin_functions.c).
 */
trait ContextFunctionProxyNestedJitKernelRegistry
{
