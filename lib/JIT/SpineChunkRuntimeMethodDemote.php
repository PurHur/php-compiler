...
final class SpineChunkRuntimeMethodDemote
{
    ...
    public static function isDemoteTarget(string $displayClassLc): bool
    {
        ...
        if (
            ...
            || 'phpcompiler\\m3emittucompilerandruntimemethodsources' === $lc
