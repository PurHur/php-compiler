 ...
 * - Top-level JIT Concern traits ({@see CompileBlockInternal}, CompilePropertyFetchReadAndWrite, CompileEchoAndPrint, CompileConcat, CompileFuncCallExecReturn, CompileFuncCallExecNoreturn, CompileFuncCallInit, CompileAssign, CompileReturn, CompileAssignRef, CompilePow, CompileCast, CompileIter, CompileEmptyIssetEval, CompileListUnpack, CompileBinaryAndUnary, CompileConstFetchBooleanNotAndInstanceof, CompileScriptMagicIncludeClone, CompileExitCaseAndJump, CompileDeclareGlobalStaticAndVarFetch, CompileFuncdefAndClosure, CompileDeclareClassLike, CompileMethodCallInit, CompileTryCatchThrow, CompileDeclareGlobalConst, CompileYield, CompileArgSend, CompileArgRecv, CompileInitArray, CompileCoalesce, CompileNullsafe, CompileFromCallable, CompileNew, CompileClassConstFetch, CompileStaticPropertyAndUnset, CompileArrayDimFetchReadAndWrite, AssignOperand, InitJitMethodCall, InitJitStaticCall, TernaryJumpIfEchoMerge, TernaryPhiReturnMerge, CompileIncDecAndConcatFlatten, CompileIncDecValueBoxAndWarnings, CompileObjectPropertyConcatPowAndFlatten, CompileTypeAssertAndErrorSilence, PropertyDeclaringClassResolve, CompileTraitUsesWithAdaptations, DateTimeConstructAndMutationMeta, DateTimeMutationAndUnserializeMeta, DomCompileTimeTagMeta, CoerceReturnPropertyDeclaringAndByRef, PropertyIncDecCompile, CallResultCompileTimePropagate, PropertyFetchCoalesceAndCompileTimeString, CompileTimeStringFoldAndPromote, CallResultOperandAssign, ByRefFormalAssignAndCallArgAdapt, ResolveJitOutgoingCall, VarFetchDestLvalueContext, LocalReleaseUnsetAndVarFetchDest, ScriptGlobalAssignAndLvalueResolve, AssignRefSharedBoxAndClosureInvoke, ClassConstEnumAndFunctionStatic, AssignOperandValueMetaAndGeneratorField, JitConstructAssignedAndNativeLongLocal, NestedVmHelperAndThisResolve, BoundMethodInstanceCallResolve, ParamConstraintsAndRuntimeNewInit, ClosureThisAndStaticScopeResolve, BinaryOpConcatAndTypeMapConstants, SubBlockCatchFinallyAndGeneratorResume, ListUnpackClassDeclareAndIncludeAssign, SkippedSplitCfgAndTernaryMergeHelpers, SkippedHotPathAndRealLoweringNames, M3EmitTuCompilerAndRuntimeVoidStubs, M3EmitTuAndCompileDriverMainNative, M3EmitTuRuntimeSpineDeclsAndCompileDeps, M3EmitTuRuntimeParseAndInitSpine, VmSmokeAndRuntimeM3NativeStubs, M3EmitTuCompilerRuntimeMethodCompile, M3EmitTuRuntimeSpineStubNative, ValueBoxCoalesceAndConcatHelpers, SkippedVmEmitHelperAndCompileDriverNames, CompileBlockPhpLoweringAndClosurePrep, CompileBlockDispatchAndReflectionMeta, JitCompileEntryRunQueueAndBlockStorage)
...
final class SpineChunkRuntimeMethodDemote
{
    ...
    public static function isDemoteTarget(string $displayClassLc): bool
    {
        ...
        if (
            ...
            || 'phpcompiler\\compiletraituseswithadaptations' === $lc
            || 'phpcompiler\\initjitstaticcall' === $lc
            || 'phpcompiler\\compileincdecandconcatflatten' === $lc
            || 'phpcompiler\\compileincdecvalueboxandwarnings' === $lc
            || 'phpcompiler\\compileobjectpropertyconcatpowandflatten' === $lc
            || 'phpcompiler\\ternaryjumpifechomerge' === $lc
            || 'phpcompiler\\ternaryphireturnmerge' === $lc
            || 'phpcompiler\\datetimeconstructandmutationmeta' === $lc
            || 'phpcompiler\\datetimemutationandunserializemeta' === $lc
            || 'phpcompiler\\domcompiletimetagmeta' === $lc
            || 'phpcompiler\\coercereturnpropertydeclaringandbyref' === $lc
            || 'phpcompiler\\propertydeclaringclassresolve' === $lc
            || 'phpcompiler\\propertyincdeccompile' === $lc
            || 'phpcompiler\\callresultcompiletimepropagate' === $lc
            || 'phpcompiler\\propertyfetchcoalesceandcompiletimestring' === $lc
            || 'phpcompiler\\compiletimestringfoldandpromote' === $lc
            ...
            || 'phpcompiler\\varfetchdestlvaluecontext' === $lc
            || 'phpcompiler\\localreleaseunsetandvarfetchdest' === $lc
            || 'phpcompiler\\scriptglobalassignandlvalueresolve' === $lc
            || 'phpcompiler\\assignrefsharedboxandclosureinvoke' === $lc
            || 'phpcompiler\\classconstenumandfunctionstatic' === $lc
            ...
            || 'phpcompiler\\binaryopconcatandtypemapconstants' === $lc
            || 'phpcompiler\\subblockcatchfinallyandgeneratorresume' === $lc
            || 'phpcompiler\\listunpackclassdeclareandincludeassign' === $lc
            ...
            || 'phpcompiler\\m3emitturuntimespinestubnative' === $lc
            ...
            || 'phpcompiler\\compileblockdispatchandreflectionmeta' === $lc
            || 'phpcompiler\\jitcompileentryrunqueueandblockstorage' === $lc
            || 'phpcompiler\\compilepropertyfetchreadandwrite' === $lc
            || 'phpcompiler\\compileechoandprint' === $lc
            || 'phpcompiler\\compilestaticpropertyandunset' === $lc
            || 'phpcompiler\\compileconcat' === $lc
            || 'phpcompiler\\compilefunccallexecreturn' === $lc
            || 'phpcompiler\\compilefunccallexecnoreturn' === $lc
            || 'phpcompiler\\compileargsend' === $lc
            || 'phpcompiler\\compilefunccallinit' === $lc
            || 'phpcompiler\\compileassign' === $lc
            || 'phpcompiler\\compilenew' === $lc
            || 'phpcompiler\\compilejumpif' === $lc
            || 'phpcompiler\\compileclassconstfetch' === $lc
            || 'phpcompiler\\compilereturn' === $lc
            || 'phpcompiler\\compileassignref' === $lc
            || 'phpcompiler\\compileargrecv' === $lc
            || 'phpcompiler\\compilepow' === $lc
            || 'phpcompiler\\compilecast' === $lc
            || 'phpcompiler\\compileinitarray' === $lc
            || 'phpcompiler\\compilecoalesce' === $lc
            || 'phpcompiler\\compilefromcallable' === $lc
            || 'phpcompiler\\compilenullsafe' === $lc
            || 'phpcompiler\\compileiter' === $lc
            || 'phpcompiler\\compileemptyisseteval' === $lc
            || 'phpcompiler\\compilelistunpack' === $lc
            || 'phpcompiler\\compilebinaryandunary' === $lc
            || 'phpcompiler\\compilescriptmagicincludeclone' === $lc
            || 'phpcompiler\\compileexitcaseandjump' === $lc
            || 'phpcompiler\\compileconstfetchbooleannotandinstanceof' === $lc
            || 'phpcompiler\\compiledeclareglobalstaticandvarfetch' === $lc
            || 'phpcompiler\\compilefuncdefandclosure' === $lc
            || 'phpcompiler\\compiledeclareclasslike' === $lc
            || 'phpcompiler\\compilemethodcallinit' === $lc
            || 'phpcompiler\\compiletrycatchthrow' === $lc
            || 'phpcompiler\\compiledeclareglobalconst' === $lc
            || 'phpcompiler\\compiletypeassertanderrorsilence' === $lc
            || 'phpcompiler\\compileyield' === $lc
            || 'phpcompiler\\compilearraydimfetchreadandwrite' === $lc
