 ...
 * so the throwable catalog stays a separate TU from Reflection* wiring
 ...
 *
 * No new C ABI. php-src analogy: zend_exception_* / Error / Throwable method
 * tables live in Zend/zend_exceptions.c beside the executor rather than inside
 * a monolithic MINIT catalog.
 */
