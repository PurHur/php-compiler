        ...
        switch (type_pair($leftType, $rightType)) {
            ...
            case TYPE_PAIR_NATIVE_LONG_NATIVE_LONG:
                switch ($opcode->type) {
                    ...
                    case OpCode::TYPE_DIV:
                        // Zend div_function: exact long÷long stays IS_LONG; else double (#35337).
                        // #31968 fixed 7/2 truncating via sdiv; always-fdiv overcorrected 10/2.
                        $folded = JitExactIntDiv::tryFoldBinary($this->context, $left, $right);
                        if (null !== $folded) {
                            return $folded;
                        }
                        $__right = $this->context->builder->intCast($rightValue, $leftValue->typeOf());

                        return JitExactIntDiv::binaryNativeLong(
                            $this->context,
                            $leftValue,
                            $__right
                        );
