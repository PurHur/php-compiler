...
restart:
        ...
        if (Variable::TYPE_VALUE === $leftType && Variable::TYPE_VALUE !== $rightType) {
            ...
            if (Variable::TYPE_NATIVE_LONG === $rightType && OpCode::TYPE_SPACESHIP === $opcode->type) {
        ...
        if (Variable::TYPE_VALUE === $rightType && Variable::TYPE_VALUE !== $leftType) {
            ...
            if (Variable::TYPE_NATIVE_LONG === $leftType && OpCode::TYPE_SPACESHIP === $opcode->type) {
        ...
        if (OpCode::TYPE_SPACESHIP === $opcode->type) {
            ...
            // Boxed float (e.g. NAN) <=> int literal: TYPE_VALUE⊙TYPE_NATIVE_LONG (#34542 / re-#31967).
