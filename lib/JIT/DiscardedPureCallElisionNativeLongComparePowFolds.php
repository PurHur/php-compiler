...
/**
 * Native-long pow / compare compile-time fold helpers (#36387).
 *
 ...
 *
 * Used via {@code use DiscardedPureCallElisionNativeLongComparePowFolds;} on
 ...
 * {@code is_equal_function} / {@code zend_compare_longs}; ext/standard/math.c
 * {@code PHP_FUNCTION(pow)}.
 */
trait DiscardedPureCallElisionNativeLongComparePowFolds
{
    /**
