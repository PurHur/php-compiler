...
/**
 * JIT LLVM bodies for stream_get_meta_data / stream_set_blocking (#6007, #19678, #33154, #33157).
 *
 * Owns `__compiler_stream_get_meta_data` / `__compiler_stream_set_blocking` (and peer
 * enable_crypto) ABI module-locally via {@see \PHPCompiler\ext\standard\JitStreamMetaKernel}
 ...
 * / stream_set_blocking.1 (#31894 / #32122).
 */
