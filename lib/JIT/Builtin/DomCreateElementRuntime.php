...
/** JIT/AOT link for DOMDocument::createElement($name, $value) (DomCreateElementJitHelper (#18938)) — DomExtensionHooks (#36204). */
final class DomCreateElementRuntime
{
    ...
    public static function ensureLinked(Context $context): void
    {
        if ($context->extensionLowering->shouldUseDomDocumentMethodKernel($context)) {
            $context->extensionLowering->requireDom()->ensureDocumentMethodBridge($context, 'CreateElement');
