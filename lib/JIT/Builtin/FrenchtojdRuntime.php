...
/**
 * JIT/AOT link for frenchtojd() via FrenchtojdJitHelper PHP (#27382).
 *
 ...
 */
final class FrenchtojdRuntime
{
    private const ABI = 'phpc_frenchtojd';

    private const HELPER_PATH = '/ext/calendar/FrenchtojdJitHelper.php';

    private const HELPER = 'PHPCompiler\\ext\\calendar\\FrenchtojdJitHelper::frenchtojdArgv';
