...
/**
 * Standalone AOT LLVM glob/scandir vec collectors (PHP-in-PHP; replaces apply-1153 C injection, #5459/#7405).
 *
 * php-src: ext/standard/dir.c — glob(), scandir()
 */
final class FsGlobVecStandaloneLlvm
{
    ...
    private static function emitGlobVec(Context $context, LlvmFunction $fn): void
    {
        ...
        $context->builder->branchIf($isDir, $dupBlock, $fn->appendBasicBlock('glob_next'));
