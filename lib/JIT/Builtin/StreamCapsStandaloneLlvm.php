...
/**
 * LLVM stream capability probes for standalone AOT (#5343, #11413).
 *
 * Embed JIT uses {@see StreamCapsRuntime} + {@see StreamCapsJitHelper} PHP instead.
 * php-src: ext/standard/streamsfuncs.c
 */
final class StreamCapsStandaloneLlvm
{
