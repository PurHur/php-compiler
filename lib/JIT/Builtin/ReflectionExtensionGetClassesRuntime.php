 ...
 *
 * Extension name (from ReflectionExtension::$name) → name → ReflectionClass map for that module, or empty array when unknown.
 *
 * Peer: {@see ReflectionExtensionGetClassNamesRuntime} (#34150); object map {@see ReflectionClassClassMapRuntime} (#34121).
 * VM: {@see \PHPCompiler\VM\Builtin\ReflectionExtensionGetClasses} /
 * {@see VmReflection::reflectionExtensionClassesTable} (#18326 / #22247).
 *
