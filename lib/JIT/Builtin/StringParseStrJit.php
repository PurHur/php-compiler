...
/**
 * LLVM __compiler_parse_str (mirrors phpc_parse_str.c / VmParseStr merge semantics, #6013).
 *
 * php-src: main/php_variables.c — php_default_treat_data()
 */
final class StringParseStrJit
{
