...
{
    private const ABI = 'phpc_finfo_file_mime';

    private const HELPER_PATH = '/ext/fileinfo/FinfoFileJitHelper.php';

    private const HELPER = 'PHPCompiler\\ext\\fileinfo\\FinfoFileJitHelper::mimeFromPath';

    private const BRIDGE_ENTRY = 'finfo_file_mime_bridge_entry';
