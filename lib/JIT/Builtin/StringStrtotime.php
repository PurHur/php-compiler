...
/**
 * JIT/AOT link for __compiler_strtotime via StrtotimeJitHelper PHP (#10742, #23832).
 *
 * Helper compile: {@see JitVmHelperLink::ensureCompiled} (peer ArrayDiffKey #23787).
...
final class StringStrtotime
{
    ...
    private static function helperFunction(Context $context, string $logical): LlvmFunction
    {
        ...
        return JitVmHelperLink::lookupCompiled($context, $logical, '#23832');
    }
