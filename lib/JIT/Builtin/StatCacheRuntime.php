...
/**
 * JIT/AOT link for stat cache via StatCacheJitHelper PHP (#9110, #9244, #25882).
 *
 * Helper compile: {@see JitVmHelperLink::ensureCompiled} (peer ResolveSidecar #25860 / StringUtf8 #25836).
...
final class StatCacheRuntime
{
    ...
    private static function helperFunction(Context $context, string $logical): LlvmFunction
    {
        ...
        return JitVmHelperLink::lookupCompiled($context, $logical, '#25882');
    }
