...
/**
 * JIT/AOT link for unitenum_exists() via UnitEnumExistsJitHelper PHP (#16169).
 *
 * Replaces inline strcasecmp LLVM loop in ext/standard/JitUnitEnumExists.php.
 * SSOT: {@see \PHPCompiler\ext\standard\UnitEnumExistsJitHelper}.
 * php-src: ext/standard/basic_functions.c — PHP_FUNCTION(unitenum_exists)
 */
final class StringUnitEnumExists
{
    private const ABI = '__phpc_jit_unitenum_exists';

    private const HELPER_PATH = '/ext/standard/UnitEnumExistsJitHelper.php';

    private const INVOKE_HELPER = 'PHPCompiler\\ext\\standard\\UnitEnumExistsJitHelper::existsArgv';
    ...
    private static function implement(Context $context): void
    {
        ...
        $entry = $fn->appendBasicBlock('unitenum_exists_bridge_entry');
