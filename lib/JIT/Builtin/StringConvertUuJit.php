 ...
 */
final class StringConvertUuJit
{
    private const UUDEC_ERR_MSG = 'convert_uudecode(): Argument #1 ($data) is not a valid uuencoded string';

    public static function implement(Context $context): void
    {
        self::implementIfMissing($context, '__compiler_convert_uuencode', self::implementEncode(...));
        self::implementIfMissing($context, '__compiler_convert_uudecode', self::implementDecode(...));
    }
