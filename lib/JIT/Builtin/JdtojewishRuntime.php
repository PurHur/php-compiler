...
/**
 * JIT/AOT link for jdtojewish() via JdtojewishJitHelper PHP (#27368).
 *
 * Helper compile: {@see JitVmHelperLink::ensureBridge} (peer jdtofrench #27383).
 * SSOT: {@see \PHPCompiler\ext\calendar\VmJewishFrenchCalendar}.
 * php-src: ext/calendar/calendar.c — PHP_FUNCTION(jdtojewish)
 */
final class JdtojewishRuntime
{
    private const ABI = 'phpc_jdtojewish';

    private const HELPER_PATH = '/ext/calendar/JdtojewishJitHelper.php';

    private const HELPER = 'PHPCompiler\\ext\\calendar\\JdtojewishJitHelper::jdtojewishArgv';
