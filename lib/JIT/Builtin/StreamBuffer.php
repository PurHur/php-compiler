 ...
 *
 * Owns `__compiler_stream_set_chunk_size` (and peer buffer/timeout ABIs) module-locally
 * via {@see StreamBufferRuntime} / {@see \PHPCompiler\ext\standard\JitStreamBufferKernel}
 * (getNamedFunction first). Do not re-add empty always-on shells in {@see Type} — leftover
 * decls mint stream_set_chunk_size.1 (#31894 / #32122).
 */
