...
/**
 * JIT/AOT link for stream_socket_get_name() via StreamSocketGetNameJitHelper (#12223, #24850, #32807).
 *
 * Helper compile: {@see JitVmHelperLink::ensureCompiled} (peer GetHeaders #24633 / SocketAtmark #24831).
 * Owns `__compiler_stream_socket_get_name` ABI module-locally (getNamedFunction first) after Type
 * always-on shells dropped (#32807 / #32122 name.1 class).
