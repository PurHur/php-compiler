...
/**
 * JIT/AOT link for jdtojulian() via JdtojulianJitHelper PHP (#27388).
 *
 ...
 */
final class JdtojulianRuntime
{
    private const ABI = 'phpc_jdtojulian';

    private const HELPER_PATH = '/ext/calendar/JdtojulianJitHelper.php';

    private const HELPER = 'PHPCompiler\\ext\\calendar\\JdtojulianJitHelper::jdtojulianArgv';
