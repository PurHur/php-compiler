...
/**
 * JIT/AOT link for bin2hex() via Bin2hexJitHelper PHP (#14603, #18884, #20452).
 *
 * Embed + thin standalone AOT: {@see Bin2hexJitHelper} via {@see JitVmHelperLink}
 * (Addslashes #18391 / FileGetContents #19339 shape — no hand-written hex kernel).
