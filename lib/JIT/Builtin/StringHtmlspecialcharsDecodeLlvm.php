...
/**
 * User-script standalone AOT: native LLVM htmlspecialchars_decode ABI (#17568).
 *
 * Nested {@see HtmlspecialcharsDecodeJitHelper} compile segfaults after minimal standalone init
 * (#15407). Mirrors VmString::htmlspecialchars_decode() entity subset; JIT embed path keeps
 * the PHP helper bridge (#14820).
 * php-src: ext/standard/html.c — PHP_FUNCTION(htmlspecialchars_decode)
 */
final class StringHtmlspecialcharsDecodeLlvm
{
    public static function implement(Context $context): void
    {
        $fn = $context->module->getNamedFunction('__string__htmlspecialchars_decode');
        if (null === $fn) {
            throw new \LogicException('__string__htmlspecialchars_decode missing from Type declarations (#17568)');
        }
        if (JitVmHelperLink::hasNamedBridgeEntry($fn, 'htmlspecialchars_decode_llvm_main')) {
            $context->registerFunction('__string__htmlspecialchars_decode', $fn);
        ...
        $entry = $fn->appendBasicBlock('htmlspecialchars_decode_llvm_main');
