...
class Type extends Builtin {
    ...
    public function register(): void {
        ...
        // Leftover Type empty decls vs Runtime ABI drift mint strptime.1
        // (#31894 / #32122). User-script strptime() stays JitStrptime /
        // StrptimeJitHelper (php-src ext/date/php_date.c).
