...
class Type extends Builtin {
    ...
    public function register(): void {
        ...
        // __compiler_unserialize always-on shell removed (#33214): StringUnserialize
        // owns the ABI (getNamedFunction first via bridges / JitVmHelperLink;
        // Type::initialize still StringUnserialize::ensureLinked on the full load path).
        // Leftover Type empty decls vs Runtime ABI drift mint unserialize.1
        // (#31894 / #32122). User-script unserialize() stays JitUnserialize /
        // UnserializeJitHelper (php-src ext/standard/var_unserializer.c).
