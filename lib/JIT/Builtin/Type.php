...
class Type extends Builtin {
    ...
    public function register(): void {
        ...
        // Type::initialize still StringStreamCsv::ensureLinked → StringStrGetcsv::ensureLinked).
        // Leftover Type empty decls vs Runtime ABI drift mint str_getcsv.1 (#31894 / #32122).
