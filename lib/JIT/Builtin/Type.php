...
class Type extends Builtin {
    ...
    public function register(): void {
        ...
        // __compiler_flock always-on shell removed (#33104): StreamReadRuntime /
        // JitStreamReadBridgeKernel owns the ABI (getNamedFunction first, then
        // addFunction if absent via implementI32Bridge; Type::initialize still
