...
class Type extends Builtin {
    ...
    public function register(): void {
        ...
        // __compiler_password_algos always-on shells removed (#32855): user-script
        // password_*/crypt() stay StringPasswordCrypto / PasswordJitHelper / VmPassword
        // (php-src ext/standard/password.c + crypt.c). NestedJIT/AOT bridge is
        // PasswordCryptoRuntime (getNamedFunction first; Type::initialize still
