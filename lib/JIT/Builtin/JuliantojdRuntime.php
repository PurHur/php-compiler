...
/**
 * JIT/AOT link for juliantojd() via JuliantojdJitHelper PHP (#27384).
 *
 ...
 */
final class JuliantojdRuntime
{
    private const ABI = 'phpc_juliantojd';

    private const HELPER_PATH = '/ext/calendar/JuliantojdJitHelper.php';

    private const HELPER = 'PHPCompiler\\ext\\calendar\\JuliantojdJitHelper::juliantojdArgv';
