 ...
 * (file_get_contents #29833 / sys_get_temp_dir #29433 shape — ABI returns `__string__*`,
 * call site boxes string|false; never return a stack {@see __value__} alloca).
...
final class StringTempnam
{
    ...
    /** @return Value `__string__*` — null when tempnam fails */
    public static function invoke(Context $context, Value $directory, Value $prefix): Value
    {
        if (NestedJitCompileScope::isActive()) {
            // NestedJIT leaf returns `__string__*` (null=fail) — crypt #29545 / fgc shape.
    ...
    private static function emitBridge(Context $context, LlvmFunction $fn): void
    {
        ...
        // Helper returns ?string — null on fail (file_get_contents #29833 shape).
        $context->builder->returnValue(
            JitNestedHelperCoerce::extractStringPtrFromHelperResult($context, $pathRaw)
        );
