...
final class WordwrapLlvmEmit
{
    ...
    public static function wrap(
        ...
        if (null !== $strArg) {
            ...
            if (null !== $literal) {
                ...
                $cut = self::compileTimeBool($context, $cutArg, false);
                if (null !== $w && null !== $brk) {
    ...
    private static function compileTimeBool(Context $context, ?JITVariable $arg, bool $default): bool
    {
        if (null === $arg) {
            return $default;
        }
        if (JITVariable::TYPE_NATIVE_BOOL === $arg->type && JITVariable::KIND_VALUE === $arg->kind) {
            $raw = $arg->value->value ?? null;
            if (null === $raw) {
                return $default;
            }
