...
/**
 * LLVM CGI superglobal refresh for JIT/AOT (issue #201, #5330).
 *
 * Replaces lib/AOT/runtime/superglobals_refresh.c. php-src: main/php_variables.c
 */
final class SuperglobalRefreshRuntime
{
    ...
    private static function registerLinkedRuntime(Context $context): void
    {
        ...
        if (null === $fn || 0 === $fn->countBasicBlocks()) {
            throw new \LogicException('__superglobals__refresh missing after SuperglobalRefreshRuntime LLVM implement');
        }
