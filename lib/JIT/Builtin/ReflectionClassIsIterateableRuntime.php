...
/** JIT/AOT link for ReflectionClass::isIterateable() (#18297). */
final class ReflectionClassIsIterateableRuntime
{
    private const ABI = '__phpc_refl_class_is_iterateable';

    private const HELPER_PATH = '/ext/standard/ReflectionClassIsIterateableJitHelper.php';

    private const HELPER = 'PHPCompiler\\ext\\standard\\ReflectionClassIsIterateableJitHelper::probe';
    ...
    public static function ensureLinked(Context $context): void
    {
        ...
        JitVmHelperLink::ensureBridge(
            $context,
            self::ABI,
            'refl_class_is_iterateable_bridge_entry',
            [$strPtr],
            $i1,
            self::HELPER,
            self::HELPER_PATH,
