...
/**
 * JIT/AOT stream read/position/lock helpers via StreamReadRuntime PHP (#5343, #12937, #33155, #33164, #33166, #33168).
 *
 * Owns `__compiler_ftell` / `__compiler_ftruncate` / `__compiler_fgetc` / `__compiler_fgets`
 * (and peer flock/fpassthru/…) ABI module-locally via {@see StreamReadRuntime} /
