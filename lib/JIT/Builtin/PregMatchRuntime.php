...
/**
 * JIT/AOT embed link for __compiler_preg_* via PregJitHelper PHP (#9542, #21212, #24943, #33187, #33188, #33192).
 *
 ...
 * `__compiler_preg_match_all_ex` / `__compiler_preg_last_error` (+ `_msg`) (and peer replace/…)
 * module-locally: {@see getNamedFunction} first, then {@see addFunction} if absent via
 * {@see implementI64PairBridge} / {@see implementMatchExBridge} / {@see implementLastErrorBridge}.
 * Do not re-add empty always-on shells in {@see Type} — leftover decls mint preg_match.1 /
 * preg_last_error.1 (#31894 / #32122).
