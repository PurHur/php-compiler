...
/**
 * JIT/AOT stream I/O ABI (#10326, #20943, #26929, #33048, #33049, #33055, #33067).
 *
 * Owns `__compiler_fwrite` / `__compiler_fopen` / `__compiler_fread` /
 * `__compiler_tmpfile` (and peer popen/stream_supports) ABI module-locally:
 ...
 * leftover decls mint fwrite.1 / fopen.1 / fread.1 / tmpfile.1 (#31894 / #32122).
