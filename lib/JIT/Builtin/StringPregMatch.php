...
/**
 * JIT MCJIT body for __compiler_preg_* — embed PHP helper vs standalone LLVM (#5289, #9542, #33187, #33188, #33192).
 *
 ...
 * `__compiler_preg_match_all_ex` / `__compiler_preg_last_error` (+ `_msg`) module-locally
 * (getNamedFunction first). Do not re-add empty always-on shells in {@see Type} — leftover
 * decls mint preg_match.1 / preg_last_error.1 (#31894 / #32122).
 *
