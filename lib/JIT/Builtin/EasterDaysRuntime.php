...
/**
 * JIT/AOT link for easter_days() via EasterDaysJitHelper PHP (#27358).
 *
 ...
 */
final class EasterDaysRuntime
{
    private const ABI = 'phpc_easter_days';

    private const ABI_NOW = 'phpc_easter_days_now';

    private const HELPER_PATH = '/ext/calendar/EasterDaysJitHelper.php';

    private const HELPER = 'PHPCompiler\\ext\\calendar\\EasterDaysJitHelper::easterDaysArgv';

    private const HELPER_NOW = 'PHPCompiler\\ext\\calendar\\EasterDaysJitHelper::easterDaysNowArgv';
