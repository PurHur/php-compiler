 ...
 *
 * alias => "Trait::method" from {@see Type\Object_} trait-alias table (peer
 * {@see ReflectionClassNameListRuntime} #34110). Unknown / internal → empty array.
 *
...
final class ReflectionClassTraitAliasesRuntime
{
    ...
    /**
     * @return Value __value__* result slot (array of strings keyed by alias)
     */
    ...
    /**
     * @return array<string, array<string, string>> lowercase class → alias => Trait::method
     */
    ...
    private static function storeAliasMap(
        ...
        foreach ($aliases as $alias => $source) {
            ...
            $parts[] = (string) $alias."\0".$source;
        }
        $cacheKey = 'refl_ta_'.md5($lcName.'|'.implode("\0", $parts));
