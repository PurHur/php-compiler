...
/**
 * JIT/AOT embed link for stream lifecycle ABI (#9442, #20966, #33073, #33084).
 *
 * Thin orchestrator — NestedJIT bridges live in {@see JitStreamLifecycleKernel}
 * (no deferred stub fork). Sole owner of `__compiler_fclose` / `__compiler_fflush`
 * after Type always-on drops.
 */
