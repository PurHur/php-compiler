...
final class StringUnserialize
{
    ...
    public static function implement(Context $context): void
    {
        ...
        $buffer = $context->llvm->createMemoryBufferWithString($data, 'phpc_unserialize.bc');
    ...
    private static function registerLinkedRuntime(Context $context): void
    {
        ...
        if (null === $fn) {
            throw new \LogicException('__compiler_unserialize missing after unserialize bitcode link');
        }
    ...
    private static function ensureBitcode(): string
    {
        ...
        $cache = $cacheDir.'/phpc_unserialize-'.substr(sha1($source.filemtime($source).$compiler), 0, 16).'.bc';
