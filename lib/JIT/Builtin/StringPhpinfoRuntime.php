...
/**
 * LLVM __compiler_phpinfo / __compiler_phpcredits (issue #5304 phase 2).
 *
 * Mirrors ext/standard/VmInfo.php HTML report assembly; replaces VM-only JIT throws.
...
final class StringPhpinfoRuntime
{
    ...
    private static function registerLinkedRuntime(Context $context): void
    {
        foreach (self::RUNTIME_FUNCTIONS as $name) {
            ...
            if (null === $fn) {
                throw new \LogicException($name.' missing after StringPhpinfoRuntime LLVM implement');
            }
            $context->registerFunction($name, $fn);
        }
    }
