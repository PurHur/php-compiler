...
/**
 * LLVM json_encode helpers for AOT standalone link (#6852, #9267).
 *
 * JIT embed routes through {@see StringJsonEncode} → {@see JsonEncodeJitHelper} PHP.
 */
...
final class StringJsonEncodeJit
{
