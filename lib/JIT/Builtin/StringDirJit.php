...
/**
 * LLVM directory handle runtime (mirrors phpc_dir.c / ext/standard/VmDir scandir listing, #5494).
 *
 * php-src: ext/standard/dir.c — opendir/readdir/closedir/rewinddir via scandir(3).
 */
final class StringDirJit
{
    ...
    private static function registerLinkedRuntime(Context $context): void
    {
        foreach (self::RUNTIME_FUNCTIONS as $name) {
            ...
            if (null === $fn) {
                throw new \LogicException($name.' missing after StringDirJit implement');
            }
            $context->registerFunction($name, $fn);
        }
    }
