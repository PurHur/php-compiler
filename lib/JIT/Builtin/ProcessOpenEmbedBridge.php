...
/**
 * JIT/AOT embed link for proc_open/close/status/terminate via ProcessOpenJitHelper PHP (#9408, #12958, #26269, #33105, #33118, #33121).
 *
 * Owns `__compiler_proc_open` / `__compiler_proc_close` /
 * `__compiler_is_process_resource` ABI module-locally (getNamedFunction first in
 * implementProcOpenBridge / implementI32Bridge) so leftover Type empty decls
 * cannot mint proc_open.1 / proc_close.1 / is_process_resource.1
