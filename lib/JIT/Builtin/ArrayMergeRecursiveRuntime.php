...
/**
 * JIT/AOT link for array_merge_recursive() via ArrayMergeRecursiveJitHelper PHP (#10183, #24107).
 *
 * Helper compile: {@see JitVmHelperLink::ensureCompiled} (peer ArrayReplaceRecursive #24077).
 * Standalone AOT compiles {@see ArrayMergeRecursiveJitHelper} via nested JIT bridges (#14423); embed uses same PHP path.
...
final class ArrayMergeRecursiveRuntime
{
    ...
    private static function helperFunction(Context $context, string $logical): LlvmFunction
    {
        ...
        return JitVmHelperLink::lookupCompiled($context, $logical, '#24107');
    }
