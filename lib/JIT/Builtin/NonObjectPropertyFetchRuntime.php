...
/**
 * JIT/AOT link for non-object property read warnings via NonObjectPropertyFetchJitHelper PHP (#10268, #24526).
 *
 * Helper compile: {@see JitVmHelperLink::ensureCompiled} (peer UndefinedPropertyFetchRuntime #23174).
 * SSOT: {@see \PHPCompiler\VM\NonObjectPropertyFetchJitHelper}, {@see \PHPCompiler\VM\ErrorReporter}
 * php-src: Zend/zend_object_handlers.c — non-object property read warning
 */
final class NonObjectPropertyFetchRuntime
{
    ...
    private static function helperFunction(Context $context, string $logical): LlvmFunction
    {
        ...
        return JitVmHelperLink::lookupCompiled($context, $logical, '#24526');
    }
