...
/**
 * JIT/AOT link for jdtogregorian() via JdtogregorianJitHelper PHP (#27355).
 *
 ...
 */
final class JdtogregorianRuntime
{
    private const ABI = 'phpc_jdtogregorian';

    private const HELPER_PATH = '/ext/calendar/JdtogregorianJitHelper.php';

    private const HELPER = 'PHPCompiler\\ext\\calendar\\JdtogregorianJitHelper::jdtogregorianArgv';
