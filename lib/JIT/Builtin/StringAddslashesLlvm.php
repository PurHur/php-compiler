 ...
 */
final class StringAddslashesLlvm
{
    /** @var list<int> */
    ...
    {
        $fn = $context->module->getNamedFunction('__string__addslashes');
        if (null === $fn) {
            throw new \LogicException('__string__addslashes missing from Type declarations (#14741)');
        }
        if (JitVmHelperLink::hasNamedBridgeEntry($fn, 'addslashes_llvm_main')) {
            $context->registerFunction('__string__addslashes', $fn);
        ...
        $entry = $fn->appendBasicBlock('addslashes_llvm_main');
