...
/**
 * LLVM body for __compiler_utf8_valid (mb_check_encoding UTF-8 path; issue #4571).
 *
 * php-src: ext/mbstring/mbstring.c — parity with ext/mbstring/VmMbstring::isValidUtf8().
 */
