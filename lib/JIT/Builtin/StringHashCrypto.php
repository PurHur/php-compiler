...
/**
 * JIT MCJIT bodies for __compiler_hash / __compiler_hash_hmac.
 *
 * Links {@see lib/AOT/runtime/hash_crypto.c}.
 */
final class StringHashCrypto
{
    private const RUNTIME_SOURCE = __DIR__.'/../../AOT/runtime/hash_crypto.c';
    ...
    {
        foreach (['__compiler_hash', '__compiler_hash_hmac'] as $name) {
