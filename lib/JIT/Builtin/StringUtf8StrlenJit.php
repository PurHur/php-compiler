...
/**
 * LLVM body for __compiler_utf8_strlen (former superglobals_refresh.c, issue #158).
 *
 * php-src: ext/mbstring/mbstring.c — parity with ext/standard/VmString::utf8CharLength().
 */
