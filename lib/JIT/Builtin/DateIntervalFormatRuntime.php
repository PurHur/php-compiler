...
/**
 * LLVM __compiler_date_interval_format — mirrors ext/standard/VmDateInterval::format() (#7278).
 *
...
final class DateIntervalFormatRuntime
{
    ...
    {
        $probe = $context->module->getNamedFunction('__compiler_date_interval_format');
        ...
        $fn = null !== $probe
            ? $probe
            : $context->module->addFunction('__compiler_date_interval_format', $ft);
    ...
    {
        $fn = $context->module->getNamedFunction('__compiler_date_interval_format');
        if (null === $fn) {
            throw new \LogicException('__compiler_date_interval_format missing after DateIntervalFormatRuntime LLVM implement');
        }
        $context->registerFunction('__compiler_date_interval_format', $fn);
    }
}
