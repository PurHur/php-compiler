 ...
 *
 * Standalone AOT keeps the LLVM format walk; embed/MCJIT routes through
 * {@see DateIntervalFormatJitHelper} PHP (#9499) until nested VmDateInterval JIT returns are green.
 *
...
final class DateIntervalFormatRuntime
{
    ...
    public static function implement(Context $context): void
    {
        ...
        if (\PHPCompiler\JIT\Builtin::LOAD_TYPE_STANDALONE === $context->loadType) {
            self::implementStandaloneLlvm($context);
    ...
    private static function implementStandaloneLlvm(Context $context): void
    {
    ...
    private static function registerLinkedRuntime(Context $context): void
    {
        ...
        if (null === $fn || 0 === $fn->countBasicBlocks()) {
            throw new \LogicException(self::ABI_NAME.' missing after DateIntervalFormatRuntime LLVM implement');
        }
        $context->registerFunction(self::ABI_NAME, $fn);
    }
}
