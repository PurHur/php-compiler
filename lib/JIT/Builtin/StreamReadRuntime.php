...
/**
 * JIT/AOT link for stream read ABI via StreamReadJitHelper PHP (#9393, #20982, #33104, #33106, #33155).
 *
 * Owns `__compiler_flock` / `__compiler_fpassthru` / `__compiler_ftruncate` (and peer fgetc/…) ABI
 ...
 * — leftover decls mint flock.1 / fpassthru.1 / ftruncate.1 (#31894 / #32122).
