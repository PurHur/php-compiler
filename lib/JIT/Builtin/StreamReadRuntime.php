...
final class StreamReadRuntime
{
     ...
     * fstat (#33359) is forced from {@see StreamFstatRuntime} when `__compiler_fstat` is linked —
     * not here — so unrelated StreamRead binaries do not emit filestat string globals.
     */
