...
/**
 * JIT/AOT link for stream read ABI via StreamReadJitHelper PHP (#9393, #20982, #33104, #33106, #33155, #33164, #33166, #33168, #33170, #33176, #33178, #33182).
 *
 ...
 * `__compiler_stream_get_contents` / `__compiler_stream_copy_to_stream` ABI module-locally:
 * {@see getNamedFunction} first, then {@see addFunction} if absent via
 * {@see JitStreamReadBridgeKernel}. Do not re-add empty always-on shells in {@see Type} — leftover
 * decls mint flock.1 / fpassthru.1 / ftruncate.1 / ftell.1 / fgetc.1 / fgets.1 / stream_get_line.1 /
 * fseek.1 / stream_get_contents.1 / stream_copy_to_stream.1 (#31894 / #32122).
...
final class StreamReadRuntime
{
    ...
    /**
     * Thin AOT: libc FILE* fgets/stream_get_line/fseek/ftell/stream_get_contents/flock/fpassthru/
     * fgetc/ftruncate/fflush matching JitStreamIoKernel fopen/fwrite (#27663, #27437, #33122,
     * #33133, #33354, #34835). NestedJIT StreamReadJitHelper→VmFs cannot see the libc handle
     * table (php://memory is tmpfile()), so force the ABI after NestedJIT.
     */
    public static function forceLibcStreamPositionAbis(Context $context): void
    {
        ...
        \PHPCompiler\ext\standard\JitStreamIoKernel::implementStreamGetLineForce($context);
