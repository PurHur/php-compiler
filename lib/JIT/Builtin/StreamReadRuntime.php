...
/**
 * JIT/AOT link for stream read ABI via StreamReadJitHelper PHP (#9393, #20982, #33104, #33106, #33155, #33164, #33166, #33168, #33170, #33176).
 *
 * Owns `__compiler_flock` / `__compiler_fpassthru` / `__compiler_ftruncate` / `__compiler_ftell` /
 * `__compiler_fgetc` / `__compiler_fgets` / `__compiler_stream_get_line` / `__compiler_fseek` ABI
