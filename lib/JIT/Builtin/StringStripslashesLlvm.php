 ...
 */
final class StringStripslashesLlvm
{
    public static function implement(Context $context): void
    {
        $fn = $context->module->getNamedFunction('__string__stripslashes');
        if (null === $fn) {
            throw new \LogicException('__string__stripslashes missing from Type declarations (#14742)');
        }
        if (JitVmHelperLink::hasNamedBridgeEntry($fn, 'stripslashes_llvm_main')) {
            $context->registerFunction('__string__stripslashes', $fn);
        ...
        $entry = $fn->appendBasicBlock('stripslashes_llvm_main');
