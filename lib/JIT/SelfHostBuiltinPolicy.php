...
final class SelfHostBuiltinPolicy
{
    ...
    private const CATEGORY_STRING = [
        ...
        'sizeof' => 'string', 'gettype' => 'string', 'var_export' => 'string',
        'str_replace' => 'string', 'str_ireplace' => 'string', 'strtr' => 'string', 'str_rot13' => 'string', 'strval' => 'string',
    ...
    private const CATEGORY_ARRAY = [
        ...
        'array_reverse' => 'array', 'array_filter' => 'array', 'array_walk' => 'array', 'array_reduce' => 'array', 'array_combine' => 'array', 'array_fill_keys' => 'array', 'array_pad' => 'array', 'array_flip' => 'array', 'array_change_key_case' => 'array',
