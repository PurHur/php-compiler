...
final class SelfHostBuiltinPolicy
{
    ...
    private const CATEGORY_FILESYSTEM = [
        ...
        'feof' => 'filesystem', 'fflush' => 'filesystem', 'fsync' => 'filesystem', 'ftruncate' => 'filesystem', 'rewind' => 'filesystem', 'fpassthru' => 'filesystem',
    ...
    private const CATEGORY_ARRAY = [
        ...
        'enum_exists' => 'array', 'unitenum_exists' => 'array', 'get_declared_enums' => 'array', 'function_exists' => 'array', 'method_exists' => 'array',
