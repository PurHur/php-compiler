...
final class SelfHostBuiltinPolicy
{
    ...
    private const CATEGORY_STRING = [
        ...
        'strip_tags' => 'string',         'sprintf' => 'string', 'printf' => 'string', 'vsprintf' => 'string', 'vprintf' => 'string', 'vfprintf' => 'string', 'sscanf' => 'long', 'vfscanf' => 'long',
    ...
    private const CATEGORY_ARRAY = [
        ...
        'enum_exists' => 'array', 'unitenum_exists' => 'array', 'get_declared_enums' => 'array', 'function_exists' => 'array', 'method_exists' => 'array', 'class_meth_exists' => 'array',
