...
final class SelfHostBuiltinPolicy
{
    ...
    private const CATEGORY_FILESYSTEM = [
        ...
        'chmod' => 'filesystem', 'umask' => 'filesystem',
    ...
    private const CATEGORY_STRING = [
        ...
        'strip_tags' => 'string',         'sprintf' => 'string', 'printf' => 'string', 'vprintf' => 'string', 'vfprintf' => 'string',
    ...
    private const CATEGORY_ARRAY = [
        ...
        'get_declared_classes' => 'array', 'get_declared_traits' => 'array', 'get_defined_functions' => 'array',
