...
/**
 * Discarded pure-call elision for runtime-info builtins (#36387 / #23483).
 *
 ...
 * stay on the hub class. Date/calendar / format-analyze / math-hash eliders live
 * in sibling traits.
 *
 * Covers zero-arg / defined-table / process / memory-ini / env-path / host-error /
 * json-preg / date-ob-http / clock / civil-date getters / randmax.
 *
 * Used via {@code use DiscardedPureCallElisionRuntimeInfoOps;} on
 * {@see DiscardedPureCallElision}.
 *
 * No new C ABI. php-src: ext/standard/basic_functions.c, ext/standard/info.c,
 * ext/date/php_date.c (getters), ext/random/random.c, Zend/zend.c.
 */
