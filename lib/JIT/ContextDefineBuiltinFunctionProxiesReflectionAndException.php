...
/**
 * Reflection* thin-AOT Call proxies for {@see Context} (#36387).
 *
 * Extracted from {@see ContextDefineBuiltinFunctionProxies}; Exception / Throwable /
 * Error peers live in {@see ContextDefineBuiltinFunctionProxiesExceptionAndError}
 * (split-TU / size-budget ratchet toward ReflectionAndException ≤ 400 lines,
 * #36199 / #36403).
 *
 ...
 * after WeakAndPhpToken, before ExceptionAndError.
 *
 * No new C ABI. php-src analogy: zim_Reflection* method tables live in
