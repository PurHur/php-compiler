 ...
 * string transforms / str_increment|decrement, and exists/introspect builtins (#36403).
 *
 ...
 *
 * Used via {@code use DiscardedPureCallElisionTypeExistsOps;} on
 * {@see DiscardedPureCallElision}.
 *
 * No new C ABI. php-src: ext/ctype/ctype.c; ext/standard/string.c, info.c,
 * basic_functions.c, array.c, class.c, var.c; Zend/zend_builtin_functions.c;
 * ext/spl/php_spl.c; ext/standard/url.c, md5.c, crc32.c, base64.c, quot_print.c,
 * basename.c, file.c.
 */
trait DiscardedPureCallElisionTypeExistsOps
{
    /**
