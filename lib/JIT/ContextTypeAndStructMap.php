 ...
 *
 * Extracted from {@see Context} so getTypeFromType / getStringFromType stay a
 * separate TU from the Context construction hub. Bool cast:
 * {@see ContextCastToBool}. String→LLVM types: {@see ContextTypeFromString}.
 * Struct field maps: {@see ContextStructFieldMap} (split-TU / size-budget ratchet).
 *
