 ...
 * string transforms, and str_increment/str_decrement (#36403).
 *
 * Extracted from {@see DiscardedPureCallElision} so the hub stays under the
 * size-budget ratchet / split-TU spine. Shared arg predicates
 * ({@code stringArgAllowsDiscardedElision}, {@code mathArgAllowsDiscardedElision})
 * stay on the hub class. Exists/introspect eliders live in
 * {@see DiscardedPureCallElisionIntrospectOps}.
 *
 * Used via {@code use DiscardedPureCallElisionTypeStringCoreOps;} on
 * {@see DiscardedPureCallElision}.
 *
 * No new C ABI. php-src: ext/ctype/ctype.c; ext/standard/string.c, url.c,
 * md5.c, crc32.c, base64.c, quot_print.c, basename.c, file.c; type.c /
 * basic_functions.c for is_* / gettype.
 */
