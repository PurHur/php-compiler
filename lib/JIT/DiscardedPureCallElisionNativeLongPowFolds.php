...
trait DiscardedPureCallElisionNativeLongPowFolds
{
     ...
     * - {@code $n ** 99} / {@code pow($n, 99)} → chained smul overflow→float (ninetyeighth × n)
     * - {@code $n ** 100} / {@code pow($n, 100)} → chained smul overflow→float (ninetyninth × n)
     *
