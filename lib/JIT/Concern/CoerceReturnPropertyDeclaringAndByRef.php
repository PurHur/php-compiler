...
/**
 * Return coercion, property declaring-class resolution, and by-ref callee meta (#36387).
 *
 * Extracted from {@see \PHPCompiler\JIT}: {@code jitDeclaredReturnTypeRequiresValue}
 * through {@code nativeOrVarargReturnsByRef} (contiguous pre-Dom type/meta cluster) so the
 * hub shrinks toward split-TU iterability under the size-budget ratchet.
 */
