...
/**
 * M3 emit-TU Compiler/Runtime method body lowering (#36387).
 *
 * Extracted from {@see \PHPCompiler\JIT}: {@code compileM3EmitTuCompilerSpineMethodsFromMainBlock}
 ...
 *
 * php-src: Zend/zend_compile.c / Zend/zend_execute.c — NestedJIT of selected Compiler/Runtime
 * methods from bundled emit-TU modules and declare-class blocks; move-only Concern extract;
 * no new C ABI and no opcode/IR shape change. Prior #1937 / #2967.
 */
trait M3EmitTuCompilerAndRuntimeMethodBodies
{
    /**
