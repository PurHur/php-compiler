...
/**
 * M3 emit-TU Compiler/Runtime method-from-source lowering (#36387).
 *
 ...
 * Compiler::compileEmitSmoke + Runtime method NestedJIT from modules/queue/declare-class —
 * move-only Concern extract; no new C ABI and no opcode/IR shape change. Prior #1937 / #2568.
 */
trait M3EmitTuCompilerAndRuntimeMethodSources
{
