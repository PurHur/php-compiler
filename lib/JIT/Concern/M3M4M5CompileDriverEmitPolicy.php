...
/**
 * M3/M4/M5 compile-driver emit-policy predicates and spine helpers (#36387).
 *
 ...
 *
 * php-src: Zend/zend_compile.c / Zend/zend_execute_API.c — self-host compile_driver /
 * inventory argv / M4 bin/compile / M5 parse-spine emit gates; move-only Concern extract;
 * no new C ABI and no opcode/IR shape change. Prior #1056 / #1768 / #26756 / #2848.
 */
