...
/**
 * Property-fetch / coalesce-merge binding and compile-time string fold (#36387).
 *
 * Extracted from {@see \PHPCompiler\JIT}: {@code ternaryEchoPhiPropertyFetchDest}
 * through {@code jitNamedScopeSlotAliases} so the hub shrinks toward split-TU
