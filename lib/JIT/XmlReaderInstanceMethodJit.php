...
final class XmlReaderInstanceMethodJit
{
    ...
    private const METHODS = [
        ...
        // leftover of fromString/read (#35962 / #27299) — php-src zim_XMLReader_getParserProperty
        'xmlreader::getparserproperty' => true,
    ];
