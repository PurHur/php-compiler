...
require_once __DIR__.'/DiscardedPureCallElisionNativeLongComparePowFolds.php';
 ...
 * Native-long/intdiv/mul fold helpers live in {@see DiscardedPureCallElisionNativeLongFolds} (#36403).
 * Native-long bit-shift / bitwise-logic folds live in {@see DiscardedPureCallElisionNativeLongBitwiseFolds} (#36387).
 * Native-long pow / compare folds live in {@see DiscardedPureCallElisionNativeLongComparePowFolds} (#36387).
 ...
 * {@see DiscardedPureCallElisionTypeStringCoreOps} (#36387).
 *
...
final class DiscardedPureCallElision
{
    ...
    use DiscardedPureCallElisionNativeLongComparePowFolds;
