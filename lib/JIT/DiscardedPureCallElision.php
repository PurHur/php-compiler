...
require_once __DIR__.'/DiscardedPureCallElisionTypeExistsOps.php';
 ...
 * Type/ctype/strlen/ord/chr/string-transform/str_incdec + exists/introspect eliders live in
 * {@see DiscardedPureCallElisionTypeExistsOps} (#36403).
 *
...
final class DiscardedPureCallElision
{
    ...
    use DiscardedPureCallElisionTypeExistsOps;
