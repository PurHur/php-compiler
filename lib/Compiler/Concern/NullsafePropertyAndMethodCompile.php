...
/**
 * Nullsafe (`?->`) property/method chain compile helpers (#36387 / #36230).
 *
 * Extracted from {@see CoalesceAndNullsafe} so gen-0 split-TU can hollow a
 * smaller Concern TU. Mirrors php-src Zend/zend_compile.c nullsafe compile.
