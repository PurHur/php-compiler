...
/**
 * compileOps dispatch + AOT string-dim CFG splits (#36387 / prior #36147).
 *
 * Extracted from {@see CompileOpsTicksAndCfgSplit} so gen-0 split-TU can hollow
 * a smaller Concern TU ({@see compileOps} through
 * {@see splitCfgBlockAfterStringKeyedArray}). Covers class/function/const hoist
 * + nullsafe/coalesce op dispatch in compileOps, and AOT CFG splits before
 * string-keyed ArrayDimFetch (#764 / #23354).
 *
 * Mirrors php-src Zend/zend_compile.c statement / ArrayDimFetch compile — move-only;
 * no behavior change intended.
 *
 * Note: no declare(strict_types=1) — parent Compiler.php is weak-types.
 */
trait CompileOpsAndStringDimCfgSplit
{
