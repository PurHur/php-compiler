 ...
 * {@see SlotForInlineClosureAndFirstClassCallableCallArgResolvers} (closure/FCC
 * tail) and the remaining SlotForCallArgResolvers front
 * (property/method/class-const/closure-bind).
 *
