...
/**
 * Hoisted property / ClassConstFetch / Closure::bind New_ this / inline-new enum-case
 * call-arg SEND slot resolvers (#36387 / prior #36147).
 *
 * Extracted from {@see SlotForCallArgResolvers} so gen-0 split-TU can hollow a smaller
 * Concern TU (`slotForImmediatePropertyOrMethodFetchBeforeCfgCall` →
 * `slotForInlineNewMethodCallEnumCaseArg`). Complementary to the assign/init-array/
 * arithmetic mid-hub and the closure/FCC tail left in {@see SlotForCallArgResolvers}.
 *
 ...
 */
trait SlotForPropertyClassConstAndClosureBindCallArgResolvers
{
    /**
