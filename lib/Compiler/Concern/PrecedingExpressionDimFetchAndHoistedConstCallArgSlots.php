...
/**
 * Preceding expression/dim-fetch call-arg slots and hoisted ConstFetch preludes (#36387).
 *
 ...
 *
 * Covers var_export/expression preludes, chained ArrayDimFetch producers, eval()
 * call-arg wiring, and hoisted scalar/enum ConstFetch dead-prelude matching used
 * from compileCallArgSends / InlineCallArgProducerMatch.
 *
 * Note: no declare(strict_types=1) — parent Compiler.php is weak-types.
 */
trait PrecedingExpressionDimFetchAndHoistedConstCallArgSlots
{
