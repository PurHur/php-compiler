...
/**
 * ArrayPad / unpack / extract / date_sun_* inline ARG_SEND compilers (#36387 / #36403).
 *
 * Extracted from {@see \PHPCompiler\Compiler} so the hub can shrink toward
 * host-CFG split-TU emit under SPINE_CHUNK (gen-0 <30m).
 *
 * Explode / iterator_to_array / array_chunk / array_walk / trailing-comparator
 * peers live in {@see ExplodeIteratorChunkWalkAndTrailingComparatorCallArgSends}.
 *
