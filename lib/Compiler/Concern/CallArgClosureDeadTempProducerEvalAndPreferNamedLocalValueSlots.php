...
/**
 * Closure / dead-temp / producer-remap / eval / prefer-named-local valueSlot
 * resolvers after residual dim/coalesce/New_ early slots (#36387 / #36403).
 *
 ...
 */
trait CallArgClosureDeadTempProducerEvalAndPreferNamedLocalValueSlots
{
    /**
     * @param list<\PHPCompiler\OpCode> $sends already-emitted ARG_SENDs (compileExpr may append)
     * @param-out mixed $valueSlot
     */
    private function resolveCallArgClosureDeadTempProducerEvalAndPreferNamedLocalValueSlots(
        mixed $arg,
        int $argIndex,
        Block $block,
        ?string $calleeName,
