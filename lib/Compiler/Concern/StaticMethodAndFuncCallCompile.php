 ...
 * folding and literal-include caller-local usage marking. Sibling EXEC_RETURN /
 * create* dead-temp predicates live in {@see SiblingInlineReturnSlotAndMethodDeadTempDetect}.
 *
