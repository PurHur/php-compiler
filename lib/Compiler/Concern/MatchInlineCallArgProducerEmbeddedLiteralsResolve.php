...
/**
 * Embedded-literal inline call-arg producer resolve (#36387 / #36403).
 *
 * Extracted from {@see MatchInlineCallArgProducerWithEmbeddedLiterals} so gen-0
 * split-TU can hollow the large matcher body; array_splice / mbstring / filter
 * extension helpers remain in the parent Concern.
 ...
 */
trait MatchInlineCallArgProducerEmbeddedLiteralsResolve
{
