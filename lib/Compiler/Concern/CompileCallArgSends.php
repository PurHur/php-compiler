 ...
 * residual closure / dead-temp / NullOperand / prefer-producer / eval / named-local in
 * {@see CallArgClosureDeadTempNullPreferProducerEvalAndNamedLocalValueSlots};
    ...
    ): array
    {
        ...
        foreach ($args as $argIndex => $arg) {
            ...
            if (!$tookDimOrInlineArrayBranch) {
                ...
                $this->resolveCallArgClosureDeadTempNullPreferProducerEvalAndNamedLocalValueSlots(
                    $arg,
                    (int) $argIndex,
                    $block,
                    $calleeName,
