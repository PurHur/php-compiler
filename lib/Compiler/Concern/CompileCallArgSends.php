 ...
 * residual direct-dim / coalesce / New_ / fold / enum / matched-producer early slots in
 * {@see CallArgDirectDimCoalesceNewFoldEnumAndMatchedProducerValueSlots};
    ...
    ): array
    {
        ...
        foreach ($args as $argIndex => $arg) {
            ...
            if (!$tookDimOrInlineArrayBranch) {
                ...
                $this->resolveCallArgDirectDimCoalesceNewFoldEnumAndMatchedProducerValueSlots(
                    $arg,
                    (int) $argIndex,
                    $block,
                    $calleeName,
