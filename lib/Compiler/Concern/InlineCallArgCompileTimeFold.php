 ...
 *
 * Covers {@see tryFoldHoistedBoolNullLiteralCallArg} and unary/bitmask resolvers.
 * Encapsed ConcatList / chained Concat / chained arithmetic resolvers live in
 * {@see InlineCallArgConcatArithmeticFold}. Compile-time value fold + proc_open/
 * array_slice helpers live in {@see CallArgCompileTimeValueAndProcOpenFold}.
 *
