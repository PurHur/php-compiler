...
/**
 * Hoisted bool/null scalar ConstFetch inline call-arg fold helpers (#36387 / #36403).
 *
 * Extracted from {@see \PHPCompiler\Compiler} so the hub can shrink toward
 * host-CFG split-TU emit under SPINE_CHUNK (gen-0 <30m).
 *
 * Covers {@see tryFoldHoistedBoolNullLiteralCallArg} and trailing hoisted
 * scalar ConstFetch wiring. Unary/bitmask resolvers live in
 * {@see InlineCallArgUnaryBitmaskResolve}. Encapsed ConcatList / chained Concat /
 * chained arithmetic resolvers live in {@see InlineCallArgConcatArithmeticFold}.
 * Compile-time value fold + proc_open/array_slice helpers live in
 * {@see CallArgCompileTimeValueAndProcOpenFold}.
 *
