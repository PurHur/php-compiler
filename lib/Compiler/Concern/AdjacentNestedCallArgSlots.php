 ...
 * adjacent-producer / prelude-separator peers it shares.
 * Assign-in-call RHS + dead-inline nested FuncCall feed / distinct-temp helpers
 * live in {@see AssignInCallRhsAndDeadInlineNestedFuncCallFeedSlots}.
 * Stmt-level side-effect / emitted-opcode guards live in
 * {@see StmtLevelSideEffectAndEmittedCallGuards}.
