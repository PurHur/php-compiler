...
/**
 * Dead-temp / haystack-family inline Array_ call-arg helpers (#36387 / prior #36147).
 *
 * Extracted from {@see FindInlineCallArgProducerSlot} so gen-0 split-TU can hollow
 * that Concern TU ({@see findUnassignedInlineArrayProducerForDeadCallArg} through
 * {@see callArgIsDeadInlineHaystackFamilySlot}).
 *
 * Mirrors php-src Zend/zend_execute.c ZEND_SEND_* adjacent call-arg wiring for
 * dead temps and haystack-family builtins — move-only; no behavior change intended.
 *
 * Note: no declare(strict_types=1) — parent Compiler.php is weak-types; call-arg
 * slot wiring relies on coercion (same as FindInlineCallArgProducerSlot).
 */
trait DeadTempInlineArrayAndHaystackCallArgHelpers
{
    /**
