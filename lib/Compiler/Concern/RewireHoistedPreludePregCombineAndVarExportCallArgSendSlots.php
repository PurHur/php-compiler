...
/**
 * register_shutdown / preg_replace_callback / array_combine / nested var_export call-arg
 * SEND rewires (#36387 / prior #36147).
 *
 * Extracted from {@see RewireInlineCallArgSendSlots} so gen-0 split-TU can hollow a smaller
 * Concern TU (`rewireRegisterShutdownFunctionClosureEnumCallArgSendSlots` →
 * `rewireVarExportNestedInlineCallArgSendSlots`). Complementary to
 * {@see RewireArithmeticBranchSubstrEnumAndSiblingMultiArgCallArgSendSlots} (#37050), which
 * already owns arithmetic→sibling multi-arg plus hoisted-prelude helpers.
 *
