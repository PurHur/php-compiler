...
/**
 * First-class callables and Closure::fromCallable lowering (#36387 / #36403).
 *
 * Extracted from {@see \PHPCompiler\Compiler} so the hub can shrink toward
 * host-CFG split-TU emit under SPINE_CHUNK (gen-0 <30m).
 *
 * Covers {@see compileFirstClassCallable} and Closure::fromCallable lowering
 * (php-src Zend/zend_compile.c / zend_closures.c). Invokable-receiver detection
 * and `(new C)(...)` __invoke gating live in {@see InvokableReceiverAndClosureDetect}.
 *
