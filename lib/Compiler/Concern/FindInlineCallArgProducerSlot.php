 ...
 *
 * Covers {@see findInlineArrayProducerForCallArg} and the intervening call-arg
 * coalesce / dead-temp helpers.
 * Inline expr producer discovery lives in
 * {@see FindInlineExprCallArgProducerSlot}.
 *
