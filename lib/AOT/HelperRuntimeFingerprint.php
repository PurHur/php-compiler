...
/**
 * Helper-runtime core / LLVM identity fingerprinting (#15889 / #23458 / #24381).
 *
 * Extracted from {@see HelperRuntimeCache} so the cache hub stays under the size-budget
 * ratchet (#36403). Per-unit deps / manifest v2 hashing lives in
 * {@see HelperRuntimeFingerprintUnit}. Callers keep using HelperRuntimeCache::* thin
 * delegates (and these methods as façades over the unit TU).
 */
final class HelperRuntimeFingerprint
{
    ...
    /** @see HelperRuntimeFingerprintUnit::repoRelPath() */
    public static function repoRelPath(string $absPath): ?string
    {
        return HelperRuntimeFingerprintUnit::repoRelPath($absPath);
    }
     ...
     *
     * @see HelperRuntimeFingerprintUnit::dependencyRelPathsForEmit()
     */
    public static function dependencyRelPathsForEmit(string $unitSourceAbsPath, array $compiledAbsPaths): array
    {
        return HelperRuntimeFingerprintUnit::dependencyRelPathsForEmit($unitSourceAbsPath, $compiledAbsPaths);
    }

    /**
     * @param list<string>|null $depsRelPaths repo-relative paths; null = v2 with unit-only + extras
     *
     * @see HelperRuntimeFingerprintUnit::unitFingerprint()
     */
    public static function unitFingerprint(string $unitSourceAbsPath, ?array $depsRelPaths = null): string
    {
        return HelperRuntimeFingerprintUnit::unitFingerprint($unitSourceAbsPath, $depsRelPaths);
    }

    /**
     * @param array{fingerprint?: string, unit?: string, deps?: list<string>|mixed} $manifest
     *
     * @see HelperRuntimeFingerprintUnit::expectedFingerprintForManifest()
     */
    public static function expectedFingerprintForManifest(array $manifest, string $unitSourceAbsPath): string
    {
        return HelperRuntimeFingerprintUnit::expectedFingerprintForManifest($manifest, $unitSourceAbsPath);
    }

    /** @see HelperRuntimeFingerprintUnit::manifestFingerprintMatches() */
    public static function manifestFingerprintMatches(array $manifest, string $unitSourceAbsPath): bool
    {
        return HelperRuntimeFingerprintUnit::manifestFingerprintMatches($manifest, $unitSourceAbsPath);
    }
     ...
     *
     * @see HelperRuntimeFingerprintUnit::migrateManifestToV2()
     */
    public static function migrateManifestToV2(array $manifest, string $unitSourceAbsPath): ?array
    {
        return HelperRuntimeFingerprintUnit::migrateManifestToV2($manifest, $unitSourceAbsPath);
    }

    /**
     * @param list<string> $depsRelPaths
     *
     * @see HelperRuntimeFingerprintUnit::fingerprintV2()
     */
    public static function fingerprintV2(string $unitSourceAbsPath, array $depsRelPaths): string
    {
        return HelperRuntimeFingerprintUnit::fingerprintV2($unitSourceAbsPath, $depsRelPaths);
    }

    /**
     * @param list<string> $depsRelPaths
     *
     * @see HelperRuntimeFingerprintUnit::fingerprintV2WithCore()
     */
    public static function fingerprintV2WithCore(string $unitSourceAbsPath, array $depsRelPaths, string $core): string
    {
        return HelperRuntimeFingerprintUnit::fingerprintV2WithCore($unitSourceAbsPath, $depsRelPaths, $core);
    }
}
