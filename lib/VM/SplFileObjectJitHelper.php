 ...
 * fpassthru on `__spl_fd` (#33360) via JitFpassthru (peer procedural #1194 / #33122).
...
final class SplFileObjectJitHelper
{
    ...
    /**
     * SplFileObject::fpassthru — php_stream_passthru on live handle (#33360).
     * php-src: zim_SplFileObject_fpassthru
     */
