...
/** ReflectionZendExtension::getURL() — VM (#22248, ext/reflection/php_reflection.c). */
final class ReflectionZendExtensionGetURL extends VmClassMethod
{
    ...
    public function execute(Frame $frame): void
    {
        ...
        if (null !== $frame->returnVar) {
            $frame->returnVar->string($meta['url']);
        }
    }
}
