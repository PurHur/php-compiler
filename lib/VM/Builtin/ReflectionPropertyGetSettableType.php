...
/** ReflectionProperty::getSettableType() — VM (#7053, ext/reflection/php_reflection.c). */
final class ReflectionPropertyGetSettableType extends VmClassMethod
{
    public function __construct()
    {
        parent::__construct('getSettableType');
    }
    ...
    public function execute(Frame $frame): void
    {
        ...
        if (null !== $frame->returnVar) {
            $declared = ReflectionPropertyTypeSupport::settableType($entry, $property, $meta, $ctx);
            if (null === $declared) {
