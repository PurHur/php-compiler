...
/**
 * ReflectionConstant::isDeprecated() — global + class-constant receivers (#21255,
 * ext/reflection/php_reflection.c reflection_constant_is_deprecated).
 */
final class ReflectionConstantIsDeprecated extends VmClassMethod
{
    ...
    public function execute(Frame $frame): void
    {
        ...
        if (ReflectionSupport::isGlobalReflectionConstant($receiver)) {
            $meta = ReflectionDeprecatedReturn::globalConstantMetadata($frame, $frame->calledArgs[0]);
