...
/** ReflectionZendExtension::getAuthor() — VM (#22248, ext/reflection/php_reflection.c). */
final class ReflectionZendExtensionGetAuthor extends VmClassMethod
{
    public function __construct()
    {
        parent::__construct('getAuthor');
    }
    ...
    public function execute(Frame $frame): void
    {
        ...
        if (null !== $frame->returnVar) {
            $frame->returnVar->string($meta['author']);
        }
    }
}
