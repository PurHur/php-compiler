...
/**
 * VM scalar cast / compare / arith / bitwise / unary / concat dispatch (#36403).
 *
 * Extracted from {@see \PHPCompiler\VM}::runFramesInner CAST_* through CONCAT
 * case bodies (php-src Zend/zend_vm_def.h ZEND_CAST / ZEND_IS_* / ZEND_ADD..POW /
...
{
    /**
     * Execute CAST_*, compare, inc/dec, arith, bitwise, unary, and CONCAT for the current opcode.
     *
