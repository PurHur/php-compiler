...
require_once __DIR__.'/JIT/Concern/CompileArgSend.php';
...
require_once __DIR__.'/JIT/Concern/CompileClassConstFetch.php';
require_once __DIR__.'/JIT/Concern/CompileReturn.php';
require_once __DIR__.'/JIT/Concern/CompileAssignRef.php';
require_once __DIR__.'/JIT/Concern/CompileArgRecv.php';
require_once __DIR__.'/JIT/Concern/CompilePow.php';
require_once __DIR__.'/JIT/Concern/CompileCast.php';
require_once __DIR__.'/JIT/Concern/CompileInitArray.php';
require_once __DIR__.'/JIT/Concern/CompileCoalesce.php';
require_once __DIR__.'/JIT/Concern/CompileFromCallable.php';
require_once __DIR__.'/JIT/Concern/CompileNullsafe.php';
...
require_once __DIR__.'/JIT/Concern/CompileDeclareGlobalConst.php';
require_once __DIR__.'/JIT/Concern/CompileTypeAssertAndErrorSilence.php';
require_once __DIR__.'/JIT/Concern/CompileYield.php';
...
require_once __DIR__.'/JIT/Concern/DateTimeMutationAndUnserializeMeta.php';
...
class JIT {
    ...
    use CompileNew;
    use CompileJumpIf;
    use CompileClassConstFetch;
    use CompileReturn;
    use CompileAssignRef;
    use CompileArgRecv;
    use CompilePow;
    use CompileCast;
    use CompileInitArray;
    use CompileCoalesce;
    use CompileFromCallable;
    use CompileNullsafe;
    use CompileIter;
    ...
    use CompileDeclareGlobalConst;
    use CompileTypeAssertAndErrorSilence;
    use CompileYield;
    ...
    use DateTimeMutationAndUnserializeMeta;
