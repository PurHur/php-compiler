...
final class ExtensionRegistry
{
    ...
    public static function advertisesExtensionFor(string $directory): bool
    {
        return match ($directory) {
            ...
            'brotli' => CompilerVersion::supportsBrotli(),
            'bz2' => \extension_loaded('bz2') || self::envFlagEnabled('PHP_COMPILER_ENABLE_BZ2'),
            'curl' => \extension_loaded('curl') || self::envFlagEnabled('PHP_COMPILER_ENABLE_CURL'),
            'dba' => \extension_loaded('dba') || self::envFlagEnabled('PHP_COMPILER_ENABLE_DBA'),
            'ds' => \extension_loaded('ds') || self::envFlagEnabled('PHP_COMPILER_ENABLE_DS'),
            'eio' => (CompilerVersion::supportsEio()) || self::envFlagEnabled('PHP_COMPILER_ENABLE_EIO'),
            'enchant' => \extension_loaded('enchant') || self::envFlagEnabled('PHP_COMPILER_ENABLE_ENCHANT'),
            'ffi' => \extension_loaded('ffi'),
            'ftp' => CompilerVersion::supportsFtpConnection(),
            'gd' => \extension_loaded('gd'),
            'gmp' => self::envFlagEnabled('PHP_COMPILER_ENABLE_GMP'),
            'gnupg' => \extension_loaded('gnupg') || self::envFlagEnabled('PHP_COMPILER_ENABLE_GNUPG'),
            'igbinary' => CompilerVersion::supportsIgbinary(),
            'imagick' => \extension_loaded('imagick') || self::envFlagEnabled('PHP_COMPILER_ENABLE_IMAGICK'),
            'imap' => (CompilerVersion::supportsImap()) || self::envFlagEnabled('PHP_COMPILER_ENABLE_IMAP'),
            'inotify' => false,
            'intl' => self::envFlagEnabled('PHP_COMPILER_ENABLE_INTL') && \extension_loaded('intl'),
            'ldap' => \extension_loaded('ldap') || self::envFlagEnabled('PHP_COMPILER_ENABLE_LDAP'),
            'lz4' => \extension_loaded('lz4') || self::envFlagEnabled('PHP_COMPILER_ENABLE_LZ4'),
            'lzf' => \extension_loaded('lzf') || self::envFlagEnabled('PHP_COMPILER_ENABLE_LZF'),
            'mailparse' => \extension_loaded('mailparse') || self::envFlagEnabled('PHP_COMPILER_ENABLE_MAILPARSE'),
            ...
            'mysqli' => \extension_loaded('mysqli') || self::envFlagEnabled('PHP_COMPILER_ENABLE_MYSQLI'),
            'oci8' => true,
            'odbc' => \extension_loaded('odbc') || self::envFlagEnabled('PHP_COMPILER_ENABLE_ODBC'),
            'openssl' => true,
            'pdo' => true,
            'pgsql' => \extension_loaded('pgsql') || self::envFlagEnabled('PHP_COMPILER_ENABLE_PGSQL'),
            'phar' => true,
            'pspell' => \extension_loaded('pspell') || self::envFlagEnabled('PHP_COMPILER_ENABLE_PSPELL'),
            'rar' => (CompilerVersion::supportsRar()) || self::envFlagEnabled('PHP_COMPILER_ENABLE_RAR'),
            ...
            'stats' => \extension_loaded('stats') || self::envFlagEnabled('PHP_COMPILER_ENABLE_STATS'),
            'tidy' => \extension_loaded('tidy'),
            'uploadprogress' => \extension_loaded('uploadprogress') || self::envFlagEnabled('PHP_COMPILER_ENABLE_UPLOADPROGRESS'),
            'uri' => CompilerVersion::supportsUri(),
            'uuid' => \extension_loaded('uuid') || CompilerVersion::supportsUuid(),
            ...
            'zip' => \extension_loaded('zip') || self::envFlagEnabled('PHP_COMPILER_ENABLE_ZIP'),
            'zmq' => \extension_loaded('zmq') || self::envFlagEnabled('PHP_COMPILER_ENABLE_ZMQ'),
            'zstd' => \extension_loaded('zstd') || self::envFlagEnabled('PHP_COMPILER_ENABLE_ZSTD'),
