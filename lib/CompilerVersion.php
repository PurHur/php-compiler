...
final class CompilerVersion
{
    ...
    /**
     * PHP 8.3+ typed class constants on classes/enums (Zend/zend_compile.c, #3592, #12798).
     *
     * Gated on stable 8.4.0 so 8.4.0-dev reference profile rejects like Zend 8.2 parse error.
     * Trait typed constants remain on supportsTypedTraitConstants() for 8.3+ dev target (#5993).
     */
     ...
     *
     * Enabled on the 8.4.0-dev forward line — version_compare treats -dev as ≥ 8.3 (#12940).
     * Reference profile reject tests skip when this returns true (see typed_class_const_reject.phpt).
     */
     ...
     *
     * Gated on stable 8.4.0 so 8.4.0-dev reference profile rejects like Zend 8.2 (#12986).
     ...
     * (ext/standard/http.c, issue #12855).
     *
     * Gated on stable 8.4.0 so 8.4.0-dev reference profile matches Zend 8.2 phantom gate.
     */
