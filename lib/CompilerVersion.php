...
final class CompilerVersion
{
    ...
    /**
     * PHP 8.3+ `new readonly class` anonymous readonly modifier (#6991, #16255, #16348).
     *
     * Enabled on the 8.4.0-dev compiler line (php-src 8.3+ ZEND_ACC_READONLY_ANON_CLASS).
