...
final class CompilerVersion
{
     ...
     *
     * Gated on stable 8.4.0 so 8.4.0-dev reference profile rejects like Zend 8.2 parse error (#14240, #13914).
     ...
     *
     * Forward profile on 8.4.0-dev — advertisesBuiltinSince treats -dev as 8.4.0 (#12993).
     * Legacy runs/collected/threshold/roots on Zend 8.2 reference via gc_status_reference_profile_82.phpt (#12790).
     */
    ...
    /**
     * PHP 8.4+ array_all/any/find/find_key/first/last (ext/standard/array.c, issue #11845, #12796, #14505, #14516).
     *
     * Forward profile on 8.4.0-dev — advertisesBuiltinSince treats -dev as 8.4.0.
    ...
    /**
     * PHP 8.4+ Closure::getCurrent() (Zend/zend_closures.c, issue #13981, #14061, #14188, #14221, #14371, #14433, #14515).
     *
     * Forward profile on 8.4.0-dev — advertisesBuiltinSince treats -dev as 8.4.0 (#14515).
     */
