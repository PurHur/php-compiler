...
final class CompilerVersion
{
     ...
     *
     * Gated on stable 8.4.0 so 8.4.0-dev reference profile rejects like Zend 8.2 (#13705).
     * Forward 8.4.0+ enables const-new parity (#12940, #13488).
     */
    ...
    /**
     * PHP 8.4+ exit()/die() as proper functions — FCC, named args, two-arg (#6975, #12413, #12414, #12435, #13650, #13885).
     *
     * Enabled on the 8.4.0-dev forward profile — version_compare treats -dev below stable 8.4.0 (#13674, #13885).
     ...
     *
     * Enabled on the 8.4.0-dev forward profile — version_compare treats -dev below stable 8.4.0 (#13914).
     ...
     *
     * Enabled on 8.4.0-dev forward profile — version_compare treats -dev below stable 8.4.0 (#13904).
     ...
     *
     * Forward 8.4.0-dev enables PHP 8.4 keys via {@see builtinAdvertisementVersion()} (#13913).
     */
     ...
     *
     * Enabled on the 8.4.0-dev forward line via builtinAdvertisementVersion — distinct from
     * stable-only gates that keep 8.4.0-dev matching Zend 8.2 phantom rejection (#11846).
     */
     ...
     *
     * Forward 8.4.0-dev registers the family via {@see builtinAdvertisementVersion()} (#13919).
     */
