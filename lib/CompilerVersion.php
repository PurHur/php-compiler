...
final class CompilerVersion
{
     ...
     *
     * Enabled on the 8.4.0-dev forward profile — version_compare treats -dev below stable 8.4.0 (#12940, #13488).
     */
     ...
     *
     * Enabled on the 8.4.0-dev forward profile — version_compare treats -dev below stable 8.4.0 (#13648).
    ...
    /**
     * PHP 8.4+ gc_status() schema (running/protected/full/buffer_size; ext/standard/php_gc.c, #12780, #13495).
     *
     * Gated on stable 8.4.0 so 8.4.0-dev reference profile matches Zend 8.2 legacy keys (#13495).
     */
