...
final class BuiltinInternalArgInfo
{
    ...
    public static function stubReturnTypeLabelForFunction(string $callableLc): ?string
    {
        ...
        return match ($callableLc) {
            ...
            'curl_upkeep' => 'bool',
            // ext/curl/curl.stub.php — InternalArgInfo empty return / untyped handle; Zend string|false (#27798)
            'curl_escape', 'curl_unescape' => 'string|false',
            // ext/curl/curl.stub.php — InternalArgInfo empty return; Zend mixed (#28369)
            'curl_getinfo' => 'mixed',
    ...
    public static function stubParamTypeOverride(string $callableLc, int $index): ?string
    {
        ...
        return match ($callableLc) {
            ...
            // ext/standard/array.stub.php — PHP 8.4; absent from InternalArgInfo (#25452)
            'array_find', 'array_find_key', 'array_any', 'array_all' => match ($index) {
                0 => 'array',
                1 => 'callable',
                default => null,
            },
            ...
            // ext/standard/array.stub.php — object|array $array (InternalArgInfo array only) (#25389, #26113)
            'current', 'end', 'reset', 'next', 'prev', 'key',
            ...
            'sodium_crypto_stream_xchacha20_xor_ic' => match ($index) {
                0, 1, 3 => 'string',
                2 => 'int',
                default => null,
            },
            ...
            // ext/curl/curl.stub.php — CurlHandle $handle, string $string; InternalArgInfo untyped handle (#27798)
            'curl_escape', 'curl_unescape' => match ($index) {
                0 => 'CurlHandle',
                1 => 'string',
                default => null,
            },
            // ext/curl/curl.stub.php — CurlHandle $handle, ?int $option = null (#28369)
            // InternalArgInfo still has untyped ch + int option (default inferred 0).
            'curl_getinfo' => match ($index) {
                0 => 'CurlHandle',
                1 => '?int',
                default => null,
            },
    ...
    public static function stubParamTypeOverrideForClassMethod(string $classLc, string $methodLc, int $index): ?string
    {
        return match ($classLc.'::'.$methodLc) {
            ...
            'random\\randomizer::getbytesfromstring' => match ($index) {
                0 => 'string',
                1 => 'int',
                default => null,
            },
