    ...
    public static function forFunction(string $name): array
    {
        switch (strtolower($name)) {
            ...
            case 'numberformatter::parsecurrency':
                // $this + $string + &$currency + &$offset = null — php-src formatter.stub.php (#20728, #21127)
                return [2, 3];
            case 'numfmt_parse_currency':
                // $formatter + $string + &$currency + &$offset = null — php-src formatter.stub.php (#20780, #21127)
                return [2, 3];
            case 'numberformatter::parse':
                // $this + $string + $type + &$offset — php-src formatter.stub.php (#20993)
                return [3];
