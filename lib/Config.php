...
final class Config
{
    ...
    private static function buildRegistry(): array
    {
        ...
        return [
            ...
            'PHP_COMPILER_RUNTIME_ASSERT' => $bool(self::SCOPE_DEBUG, 'Emit __ref__ M1 delref + M5 exclusive-write checks (hashtable grow/string-key writes); alias PHPC_RUNTIME_ASSERT', null, '#36397'),
            'PHP_COMPILER_RUNTIME_ASSERT_INJECT_DOUBLE_DELREF' => $bool(self::SCOPE_DEBUG, 'Call rc=0 delref probe at standalone main (unit test)', null, '#36397'),
            'PHP_COMPILER_RUNTIME_ASSERT_INJECT_SHARED_WRITE' => $bool(self::SCOPE_DEBUG, 'Call shared-rc assert_exclusive probe at standalone main (unit test M5)', null, '#36397'),
            'PHP_COMPILER_ASAN' => $bool(self::SCOPE_COMPILE, 'Link AOT binaries with -fsanitize=address,undefined', null, '#36397'),
            ...
            'PHP_COMPILER_EXTENSIONS' => $str(
                self::SCOPE_RUNTIME,
                'Extension load filter: only:a,b / a,b / +a,-b (ext/ directory names; pulls depends[]) (#36204)',
                null,
                '#36204'
            ),
