...
/**
 * VM lz4_compress()/lz4_uncompress() via liblz4 FFI (kjdev/php-ext-lz4; #22529).
 *
 * Wire format matches PECL: 4-byte little-endian uncompressed length + LZ4 block.
 * Thin FFI only — no codec logic in runtime/ C.
 */
