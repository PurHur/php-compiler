...
final class JitXmlWriterMethod
{
    public static function invoke(Context $context, string $methodLc, JITVariable ...$args): Value
    {
        $result = match ($methodLc) {
            ...
            // leftover of openMemory (#19551 / #35872) — php-src zim_XMLWriter_openUri
            'openuri' => JitXmlWriterUserScript::tryOpenUri($context, ...$args),
            // leftover of openMemory (#19606 / #35872) — php-src zim_XMLWriter_toMemory
            ...
            'startdtdentity' => JitXmlWriterUserScript::tryStartDtdEntity($context, ...$args),
            'enddtdentity' => JitXmlWriterUserScript::tryEndDtdEntity($context, ...$args),
            'writedtdentity' => JitXmlWriterUserScript::tryWriteDtdEntity($context, ...$args),
