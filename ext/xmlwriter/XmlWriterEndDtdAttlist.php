...
/** XMLWriter::endDtdAttlist() — close ATTLIST decl (php-src ext/xmlwriter/php_xmlwriter.c; #30818; #20025). */
final class XmlWriterEndDtdAttlist extends XmlWriterClassMethod
{
    ...
    public function execute(Frame $frame): void
    {
        ...
        $this->requireExactUserArgCount($frame, 'XMLWriter::endDtdAttlist', 0);
