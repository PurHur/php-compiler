...
final class xmlwriter_start_element_ns extends XmlWriterProceduralFunction
{
    ...
    public function execute(Frame $frame): void
    {
        ...
        $prefix = $this->nullableStringArgAt($frame, 1, 'xmlwriter_start_element_ns', 2, 'prefix');
        $name = $this->stringArgAt($frame, 2, 'xmlwriter_start_element_ns', 3, 'name');
        $uri = $this->nullableStringArgAt($frame, 3, 'xmlwriter_start_element_ns', 4, 'namespace');
