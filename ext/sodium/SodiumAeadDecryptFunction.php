...
/**
 * Shared VM wiring for sodium_crypto_aead_xchacha20poly1305_ietf_decrypt() (php-src ext/sodium/libsodium.c; #15429).
 */
abstract class SodiumAeadDecryptFunction extends Internal
{
    /**
     * @return string|false
     */
    abstract protected function invoke(string $ciphertext, string $additionalData, string $nonce, string $key): string|false;
    ...
    public function execute(Frame $frame): void
    {
        ...
        $result = $this->invoke($ciphertext, $additionalData, $nonce, $key);
