...
/**
 * sodium_increment() — little-endian increment by-ref (php-src ext/sodium/libsodium.c; #20081).
 *
 ...
 */
final class sodium_increment extends Internal
{
    public function __construct()
    {
        parent::__construct('sodium_increment');
    }

    public function execute(Frame $frame): void
    {
        $this->requireExactArgCount($frame, $this->getName(), 1);
        VmSodium::increment($frame->calledArgs[0]);
