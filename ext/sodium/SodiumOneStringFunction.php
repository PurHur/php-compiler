...
/**
 * Shared VM wiring for unary sodium string→string APIs (php-src ext/sodium/libsodium.c; #20084).
 */
abstract class SodiumOneStringFunction extends Internal
{
    abstract protected function argName(): string;

    abstract protected function invoke(string $value): string;
