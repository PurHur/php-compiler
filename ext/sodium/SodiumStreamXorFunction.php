...
/**
 * Shared VM/JIT wiring for sodium_crypto_stream*_xor() (php-src ext/sodium/libsodium.c; #15464, #15461).
 */
abstract class SodiumStreamXorFunction extends Internal
{
    ...
    public function call(Context $context, JITVariable ...$args): Value
    {
        ...
        return JitSodium::invokeStreamXor($context, $this->getName(), $message, $nonce, $key);
    }
}
