...
/**
 * ZipArchive NestedJIT helper (#35424 / #35437 / #35440 / #35449 / #35450 / #35455 / #35454 / #35465 / #35466 / #35467 / #35473) —
...
final class ZipArchiveJitHelper
{
    ...
    public static function exec(string $op, int $a, int $b, string $s1, string $s2): string
    {
        ...
        // renameName — name swap on either entry slot (#35450 leftover of #35424).
        if ('rename' === $op) {
            if ('' === $s2) {
        ...
        // renameIndex — rename slot 0/1 by index (#35473 leftover of #35450).
        if ('rename_index' === $op) {
            if ('' === $s2) {
                throw new \ValueError(
