...
/**
 * ZipArchive NestedJIT helper (#35424 / #35437 / #35440 / #35449 / #35450 / #35455 / #35454 / #35465 / #35466 / #35467 / #35474) —
...
final class ZipArchiveJitHelper
{
    ...
    public static function exec(string $op, int $a, int $b, string $s1, string $s2): string
    {
        ...
        // renameName — name swap on either slot (#35450 leftover of #35424).
        if ('rename' === $op) {
            if ('' === $s2) {
        ...
        // renameIndex — rename slot 0/1 by index (#35474 leftover of #35450 / #35424).
        // Empty $s2 rejected in IR (ExceptionBridge) — NestedJIT throw SIGSEGVs under thin AOT.
        if ('rename_index' === $op) {
            if (1 !== self::$h1open || '' === $s2) {
                self::$h1status = 9;
