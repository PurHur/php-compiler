...
final class JitXmlParserUserScript
{
     ...
     *
     * php-src ext/xml/xml.c PHP_FUNCTION(xml_parser_create_ns) — namespace-aware expat;
     * names expand as uri + separator + localname (default ":").
     */
    ...
    /**
     * Compile-time $separator for xml_parser_create_ns (php-src default ":").
     * Null matches VM execute() which keeps the default rather than coercing.
     */
