...
final class xml_get_current_column_number extends Internal
{
    ...
    public function execute(Frame $frame): void
    {
        ...
        if (Variable::TYPE_INTEGER !== $parserArg->type) {
            throw new \TypeError('xml_get_current_column_number(): Argument #1 ($parser) must be of type XMLParser');
        }

        $frame->returnVar->int(VmXml::getCurrentColumnNumber($parserArg->toInt()));
    }
