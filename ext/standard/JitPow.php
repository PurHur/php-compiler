...
require_once __DIR__.'/JitPowIntegerEmit.php';
...
final class JitPow
{
    ...
    private static function invokeBoxedIntAware(Context $context, JITVariable ...$args): Value
    {
        ...
        if (self::preferIntegerPowPath(...$args)) {
            ...
            JitPowIntegerEmit::emitIntegerPowViaMathFpow($context, $slotPtr, $args[0], $args[1]);
    ...
    private static function invokeBoxedRuntimeDispatch(
        ...
        JitPowIntegerEmit::emitIntegerPowViaMathFpow($context, $slotPtr, $base, $exp);
