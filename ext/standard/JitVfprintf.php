...
final class JitVfprintf
{
    ...
    /** @return Value */
    public static function loadArgsArray(Context $context, JITVariable $arg): JITVariable
    {
        ...
        throw new \LogicException('vfprintf() args must be an array in this compiler build');
    }
}
