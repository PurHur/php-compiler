...
final class function_exists_ extends Internal
{
    ...
    public function execute(Frame $frame): void
    {
        ...
        $name = VmReflection::stringArg($frame->calledArgs[0], 'function_exists() function name');
        $exists = VmReflection::functionExists($ctx, $name);
    ...
    public function call(Context $context, JITVariable ...$args): Value
    {
        ...
        return ReflectionBuiltinHelper::functionExistsLiteral($context, $name);
    }
}
