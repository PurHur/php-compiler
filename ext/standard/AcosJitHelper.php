...
final class AcosJitHelper
{
    public static function acosArgv(float $num): float
    {
        ...
        return $pio2 - self::asinCore($num);
    }

    /**
     * Inlined asin (same NestedJIT-safe algorithm as MathAsin #28263 helper).
     * Kept private — do not call the asin JIT helper class from this helper unit.
     */
    private static function asinCore(float $num): float
    {
        if ($num !== $num) {
            return $num;
        }
