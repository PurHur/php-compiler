...
final class strspn extends Internal
{
    public function execute(Frame $frame): void
    {
        ...
        $str = VmString::coerceTypedStringBuiltinArg($frame->calledArgs[0], 'strspn', 0, 'string');
        $mask = VmString::coerceTypedStringBuiltinArg($frame->calledArgs[1], 'strspn', 1, 'characters');
        $offset = 0;
        if ($argc >= 3) {
    ...
    public function call(Context $context, JITVariable ...$args): Value
    {
        ...
        JitInternalStrictArg::rejectNullString($context, $args[1], 'strspn', 'characters', 2);
