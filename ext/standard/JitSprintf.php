 ...
 *
 * Single/multi-arg values go through __compiler_sprintf (SprintfSnprintfRuntime for
 * argv==1) so %s coerces float/int like php-src formatted_print.c (#33010).
 * Direct libc snprintf with typed doubles was the #33010 SIGSEGV.
 */
final class JitSprintf
{
    ...
    public static function format(Context $context, JITVariable ...$args): Value
    {
        ...
        // Pack argv and call __compiler_sprintf — same shape as JitFprintf (#33010).
        // argv==1 uses SprintfSnprintfRuntime::formatOneArg (%s coerces float/int);
        // argv>1 uses NestedJIT SprintfJitHelper.
