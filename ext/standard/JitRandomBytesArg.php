...
/** LLVM lowering for random_bytes() length operand — Z_PARAM_LONG enum rejection (#6160). */
final class JitRandomBytesArg
{
    public static function lowerLength(Context $context, JITVariable $arg): Value
    {
        ...
        return JitLongArg::lower($context, $arg, 'random_bytes() argument #1');
    }
    ...
    private static function lowerBoxedOperand(Context $context, JITVariable $arg): Value
    {
        ...
        $nullBlock = BasicBlockHelper::append($context, 'random_bytes_box_null');
        $afterNull = BasicBlockHelper::append($context, 'random_bytes_box_after_null');
        $arrayBlock = BasicBlockHelper::append($context, 'random_bytes_box_array');
        $objectBlock = BasicBlockHelper::append($context, 'random_bytes_box_object');
        $coerceBlock = BasicBlockHelper::append($context, 'random_bytes_box_coerce');
        $mergeBlock = BasicBlockHelper::append($context, 'random_bytes_box_merge');
        ...
        $errBlock = BasicBlockHelper::append($context, 'random_bytes_box_object_err');
        $afterObject = BasicBlockHelper::append($context, 'random_bytes_box_after_object');
        ...
        $enumErrBlock = BasicBlockHelper::append($context, 'random_bytes_box_enum_err');
        $afterEnum = BasicBlockHelper::append($context, 'random_bytes_box_after_enum');
        ...
        $phi = $context->builder->phi($i64, 'random_bytes_box_phi');
