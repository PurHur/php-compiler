...
/**
 * IncludePathResolver::resolve for compiled JIT/AOT modules (#816, bootstrap-aot-link).
 *
 * SSOT: {@see \PHPCompiler\Web\IncludePathResolver::resolve()}
 */
final class IncludePathResolverJitHelper
{
