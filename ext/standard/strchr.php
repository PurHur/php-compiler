...
final class strchr extends Internal
{
    public function execute(Frame $frame): void
    {
        ...
        $haystackStr = VmString::trimFamilyStringArgForFrame($frame, 0, 'strchr', 0, 'haystack');
        $needleStr = VmString::trimFamilyStringArgForFrame($frame, 1, 'strchr', 1, 'needle');
        $beforeNeedle = false;
        if (3 === $argc) {
    ...
    public function call(Context $context, JITVariable ...$args): Value
    {
        ...
        $hay = $context->callerStrictTypes
            ? JitStringBuiltinArg::lowerStrictOrCoercible($context, $args[0], 'strchr', 0, 'haystack')
            : JitStringBuiltinArg::lowerTrimFamilyString($context, $args[0], 'strchr', 0, 'haystack');
        $needle = $context->callerStrictTypes
            ? JitStringBuiltinArg::lowerStrictOrCoercible($context, $args[1], 'strchr', 1, 'needle')
