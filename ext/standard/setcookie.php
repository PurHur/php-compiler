...
final class setcookie extends Internal
{
    ...
    {
        $parsed = SetcookieOptions::parseArgs('setcookie', $frame->calledArgs, $frame);
        $ok = VmSetcookie::emit(
            $frame,
            'setcookie',
            SetcookieLine::build(
    ...
    public function call(Context $context, JITVariable ...$args): Value
    {
        ...
        if (
            ...
            if ($argc > 3) {
                ...
                BasicBlockHelper::ensureOpenInsertBlock($context, 'setcookie_opts_ace_cont');
        ...
        if ($argc < 1) {
            ...
            BasicBlockHelper::ensureOpenInsertBlock($context, 'setcookie_min_ace_cont');
        ...
        if ($argc > 7) {
            ...
            ExceptionBridge::emitArgumentCountErrorAndAbort(
                $context,
                \sprintf('setcookie() expects at most 7 arguments, %d given', $argc)
            );
            BasicBlockHelper::ensureOpenInsertBlock($context, 'setcookie_max_ace_cont');
        ...
        $namePtr = JitStringBuiltinArg::lowerTrimFamilyString($context, $args[0], 'setcookie', 0, 'name');
