...
/**
 * asinh() for integer or float arguments (ext/standard/math.c parity; issue #9220).
 */
final class asinh extends Internal
{
    public function execute(Frame $frame): void
    {
        // php-src ext/standard/math.c — ArgumentCountError (#30534).
        $this->requireExactArgCount($frame, 'asinh', 1);
    ...
    public function call(Context $context, JITVariable ...$args): Value
    {
        ...
        if (!$this->requireExactJitArgCount($context, $args, 'asinh', 1)) {
