...
final class JitPowIntegerEmitHigh
{
    ...
    public static function tryEmitIntegerPowViaMathFpow(
        ...
        if ('hundredfourth' === $expFold) {
            ...
            // Overflow arms finish in float with one extra ×nF vs **104.
            ...
            if (null === $ov1 || null === $sqVar->longArithOverflowDoubleSlot) {
                throw new \LogicException('pow() **104 expected smul overflow metadata (sq)');
            }
            $sqLong = JITVariable::KIND_VARIABLE === $sqVar->kind
                ? $context->builder->load($sqVar->value)
                : $sqVar->value;
            $ov1Block = BasicBlockHelper::append($context, 'pow_hundredfourth_sq_ov');
            $ok1Block = BasicBlockHelper::append($context, 'pow_hundredfourth_sq_ok');
            $doneBlock = BasicBlockHelper::append($context, 'pow_hundredfourth_done');
            ...
            $hundredfourthFSq = $context->builder->fmul($fortyfourthF, $sqF);
            $hundredfourthFEighth = $context->builder->fmul($hundredfourthFSq, $sqF);
            $hundredfourthF = $context->builder->fmul($hundredfourthFEighth, $sqF);
            $nF = $context->builder->siToFp($n, $f64);
            $hundredfourthF = $context->builder->fmul($hundredfourthF, $nF);
            $hundredfourthF = $context->builder->fmul($hundredfourthF, $nF);
            $hundredfourthF = $context->builder->fmul($hundredfourthF, $nF);
            $hundredfourthF = $context->builder->fmul($hundredfourthF, $nF);
            $hundredfourthF = $context->builder->fmul($hundredfourthF, $nF);
            ...
            if (null === $ov2 || null === $cuVar->longArithOverflowDoubleSlot) {
                throw new \LogicException('pow() **104 expected smul overflow metadata (cu)');
            }
            $cuLong = JITVariable::KIND_VARIABLE === $cuVar->kind
                ? $context->builder->load($cuVar->value)
                : $cuVar->value;
            $ov2Block = BasicBlockHelper::append($context, 'pow_hundredfourth_cu_ov');
            $ok2Block = BasicBlockHelper::append($context, 'pow_hundredfourth_cu_ok');
            ...
            $hundredfourthF2Sq = $context->builder->fmul($fortyfourthF2, $sqF2);
            $hundredfourthF2Eighth = $context->builder->fmul($hundredfourthF2Sq, $sqF2);
            $hundredfourthF2 = $context->builder->fmul($hundredfourthF2Eighth, $sqF2);
            $nF2 = $context->builder->siToFp($n, $f64);
            $hundredfourthF2 = $context->builder->fmul($hundredfourthF2, $nF2);
            $hundredfourthF2 = $context->builder->fmul($hundredfourthF2, $nF2);
            $hundredfourthF2 = $context->builder->fmul($hundredfourthF2, $nF2);
            $hundredfourthF2 = $context->builder->fmul($hundredfourthF2, $nF2);
            $hundredfourthF2 = $context->builder->fmul($hundredfourthF2, $nF2);
            ...
            $hundredfourthF2 = $context->builder->fmul($hundredfourthF2, $nF2);
            $hundredfourthF2 = $context->builder->fmul($hundredfourthF2, $nF2);
            $hundredfourthF2 = $context->builder->fmul($hundredfourthF2, $nF);
            $hundredfourthF2 = $context->builder->fmul($hundredfourthF2, $nF);
            $context->builder->call(
                $context->lookupFunction('__value__writeDouble'),
                $slotPtr,
            ...
            if (null === $ov3 || null === $fifthVar->longArithOverflowDoubleSlot) {
                throw new \LogicException('pow() **104 expected smul overflow metadata (fifth)');
            }
            $fifthLong = JITVariable::KIND_VARIABLE === $fifthVar->kind
                ? $context->builder->load($fifthVar->value)
                : $fifthVar->value;
            $ov3Block = BasicBlockHelper::append($context, 'pow_hundredfourth_fifth_ov');
            $ok3Block = BasicBlockHelper::append($context, 'pow_hundredfourth_fifth_ok');
            ...
            $hundredfourthF3Sq = $context->builder->fmul($fortyfourthF3, $sqF3);
            $hundredfourthF3Eighth = $context->builder->fmul($hundredfourthF3Sq, $sqF3);
            $hundredfourthF3 = $context->builder->fmul($hundredfourthF3Eighth, $sqF3);
            $nF3 = $context->builder->siToFp($n, $f64);
            $hundredfourthF3 = $context->builder->fmul($hundredfourthF3, $nF3);
            $hundredfourthF3 = $context->builder->fmul($hundredfourthF3, $nF3);
            $hundredfourthF3 = $context->builder->fmul($hundredfourthF3, $nF3);
            $hundredfourthF3 = $context->builder->fmul($hundredfourthF3, $nF3);
            $hundredfourthF3 = $context->builder->fmul($hundredfourthF3, $nF3);
            ...
            $hundredfourthF3 = $context->builder->fmul($hundredfourthF3, $nF3);
            $hundredfourthF3 = $context->builder->fmul($hundredfourthF3, $nF3);
            $hundredfourthF3 = $context->builder->fmul($hundredfourthF3, $nF);
            $hundredfourthF3 = $context->builder->fmul($hundredfourthF3, $nF);
            $context->builder->call(
                $context->lookupFunction('__value__writeDouble'),
                $slotPtr,
            ...
            if (null === $ov4 || null === $tenthVar->longArithOverflowDoubleSlot) {
                throw new \LogicException('pow() **104 expected smul overflow metadata (tenth)');
            }
            $tenthLong = JITVariable::KIND_VARIABLE === $tenthVar->kind
                ? $context->builder->load($tenthVar->value)
                : $tenthVar->value;
            $ov4Block = BasicBlockHelper::append($context, 'pow_hundredfourth_tenth_ov');
            $ok4Block = BasicBlockHelper::append($context, 'pow_hundredfourth_tenth_ok');
            ...
            $hundredfourthF4Sq = $context->builder->fmul($fortyfourthF4, $sqF4);
            $hundredfourthF4Eighth = $context->builder->fmul($hundredfourthF4Sq, $sqF4);
            $hundredfourthF4 = $context->builder->fmul($hundredfourthF4Eighth, $sqF4);
            $nF4 = $context->builder->siToFp($n, $f64);
            $hundredfourthF4 = $context->builder->fmul($hundredfourthF4, $nF4);
            $hundredfourthF4 = $context->builder->fmul($hundredfourthF4, $nF4);
            $hundredfourthF4 = $context->builder->fmul($hundredfourthF4, $nF4);
            $hundredfourthF4 = $context->builder->fmul($hundredfourthF4, $nF4);
            $hundredfourthF4 = $context->builder->fmul($hundredfourthF4, $nF4);
            ...
            $hundredfourthF4 = $context->builder->fmul($hundredfourthF4, $nF4);
            $hundredfourthF4 = $context->builder->fmul($hundredfourthF4, $nF4);
            $hundredfourthF4 = $context->builder->fmul($hundredfourthF4, $nF);
            $hundredfourthF4 = $context->builder->fmul($hundredfourthF4, $nF);
            $context->builder->call(
                $context->lookupFunction('__value__writeDouble'),
                $slotPtr,
            ...
            if (null === $ov5 || null === $twentiethVar->longArithOverflowDoubleSlot) {
                throw new \LogicException('pow() **104 expected smul overflow metadata (twentieth)');
            }
            $twentiethLong = JITVariable::KIND_VARIABLE === $twentiethVar->kind
                ? $context->builder->load($twentiethVar->value)
                : $twentiethVar->value;
            $ov5Block = BasicBlockHelper::append($context, 'pow_hundredfourth_twentieth_ov');
            $ok5Block = BasicBlockHelper::append($context, 'pow_hundredfourth_twentieth_ok');
            ...
            $hundredfourthF5Sq = $context->builder->fmul($fortyfourthF5, $sqF5);
            $hundredfourthF5Eighth = $context->builder->fmul($hundredfourthF5Sq, $sqF5);
            $hundredfourthF5 = $context->builder->fmul($hundredfourthF5Eighth, $sqF5);
            $nF5 = $context->builder->siToFp($n, $f64);
            $hundredfourthF5 = $context->builder->fmul($hundredfourthF5, $nF5);
            $hundredfourthF5 = $context->builder->fmul($hundredfourthF5, $nF5);
            $hundredfourthF5 = $context->builder->fmul($hundredfourthF5, $nF5);
            $hundredfourthF5 = $context->builder->fmul($hundredfourthF5, $nF5);
            $hundredfourthF5 = $context->builder->fmul($hundredfourthF5, $nF5);
            ...
            $hundredfourthF5 = $context->builder->fmul($hundredfourthF5, $nF5);
            $hundredfourthF5 = $context->builder->fmul($hundredfourthF5, $nF5);
            $hundredfourthF5 = $context->builder->fmul($hundredfourthF5, $nF);
            $hundredfourthF5 = $context->builder->fmul($hundredfourthF5, $nF);
            $context->builder->call(
                $context->lookupFunction('__value__writeDouble'),
                $slotPtr,
            ...
            if (null === $ov6 || null === $fortiethVar->longArithOverflowDoubleSlot) {
                throw new \LogicException('pow() **104 expected smul overflow metadata (fortieth)');
            }
            $fortiethLong = JITVariable::KIND_VARIABLE === $fortiethVar->kind
                ? $context->builder->load($fortiethVar->value)
                : $fortiethVar->value;
            $ov6Block = BasicBlockHelper::append($context, 'pow_hundredfourth_fortieth_ov');
            $ok6Block = BasicBlockHelper::append($context, 'pow_hundredfourth_fortieth_ok');
            ...
            $hundredfourthF6Sq = $context->builder->fmul($fortyfourthF6, $sqF6);
            $hundredfourthF6Eighth = $context->builder->fmul($hundredfourthF6Sq, $sqF6);
            $hundredfourthF6 = $context->builder->fmul($hundredfourthF6Eighth, $sqF6);
            $nF6 = $context->builder->siToFp($n, $f64);
            $hundredfourthF6 = $context->builder->fmul($hundredfourthF6, $nF6);
            $hundredfourthF6 = $context->builder->fmul($hundredfourthF6, $nF6);
            $hundredfourthF6 = $context->builder->fmul($hundredfourthF6, $nF6);
            $hundredfourthF6 = $context->builder->fmul($hundredfourthF6, $nF6);
            $hundredfourthF6 = $context->builder->fmul($hundredfourthF6, $nF6);
            ...
            $hundredfourthF6 = $context->builder->fmul($hundredfourthF6, $nF6);
            $hundredfourthF6 = $context->builder->fmul($hundredfourthF6, $nF6);
            $hundredfourthF6 = $context->builder->fmul($hundredfourthF6, $nF);
            $hundredfourthF6 = $context->builder->fmul($hundredfourthF6, $nF);
            $context->builder->call(
                $context->lookupFunction('__value__writeDouble'),
                $slotPtr,
            ...
            if (null === $ov7 || null === $fortysecondVar->longArithOverflowDoubleSlot) {
                throw new \LogicException('pow() **104 expected smul overflow metadata (fortysecond)');
            }
            ...
            $ov7Block = BasicBlockHelper::append($context, 'pow_hundredfourth_fortysecond_ov');
            $ok7Block = BasicBlockHelper::append($context, 'pow_hundredfourth_fortysecond_ok');
            ...
            $hundredfourthF7Sq = $context->builder->fmul($fortyfourthF7, $sqF7);
            $hundredfourthF7Eighth = $context->builder->fmul($hundredfourthF7Sq, $sqF7);
            $hundredfourthF7 = $context->builder->fmul($hundredfourthF7Eighth, $sqF7);
            $nF7 = $context->builder->siToFp($n, $f64);
            $hundredfourthF7 = $context->builder->fmul($hundredfourthF7, $nF7);
            $hundredfourthF7 = $context->builder->fmul($hundredfourthF7, $nF7);
            $hundredfourthF7 = $context->builder->fmul($hundredfourthF7, $nF7);
            $hundredfourthF7 = $context->builder->fmul($hundredfourthF7, $nF7);
            $hundredfourthF7 = $context->builder->fmul($hundredfourthF7, $nF7);
            ...
            $hundredfourthF7 = $context->builder->fmul($hundredfourthF7, $nF7);
            $hundredfourthF7 = $context->builder->fmul($hundredfourthF7, $nF7);
            $hundredfourthF7 = $context->builder->fmul($hundredfourthF7, $nF);
            $hundredfourthF7 = $context->builder->fmul($hundredfourthF7, $nF);
            $context->builder->call(
                $context->lookupFunction('__value__writeDouble'),
                $slotPtr,
            ...
            if (null === $ov8 || null === $fortyfourthVar->longArithOverflowDoubleSlot) {
                throw new \LogicException('pow() **104 expected smul overflow metadata (fortyfourth)');
            }
            ...
            $ov8Block = BasicBlockHelper::append($context, 'pow_hundredfourth_fortyfourth_ov');
            $ok8Block = BasicBlockHelper::append($context, 'pow_hundredfourth_fortyfourth_ok');
            ...
            $hundredfourthF8Sq = $context->builder->fmul($fortyfourthF8, $sqF8);
            $hundredfourthF8Eighth = $context->builder->fmul($hundredfourthF8Sq, $sqF8);
            $hundredfourthF8 = $context->builder->fmul($hundredfourthF8Eighth, $sqF8);
            $nF8 = $context->builder->siToFp($n, $f64);
            $hundredfourthF8 = $context->builder->fmul($hundredfourthF8, $nF8);
            $hundredfourthF8 = $context->builder->fmul($hundredfourthF8, $nF8);
            $hundredfourthF8 = $context->builder->fmul($hundredfourthF8, $nF8);
            $hundredfourthF8 = $context->builder->fmul($hundredfourthF8, $nF8);
            $hundredfourthF8 = $context->builder->fmul($hundredfourthF8, $nF8);
            ...
            $hundredfourthF8 = $context->builder->fmul($hundredfourthF8, $nF8);
            $hundredfourthF8 = $context->builder->fmul($hundredfourthF8, $nF8);
            $hundredfourthF8 = $context->builder->fmul($hundredfourthF8, $nF);
            $hundredfourthF8 = $context->builder->fmul($hundredfourthF8, $nF);
            $context->builder->call(
                $context->lookupFunction('__value__writeDouble'),
                $slotPtr,
            ...
            if (null === $ov9 || null === $fortysixthVar->longArithOverflowDoubleSlot) {
                throw new \LogicException('pow() **104 expected smul overflow metadata (fortysixth)');
            }
            $fortysixthLong = JITVariable::KIND_VARIABLE === $fortysixthVar->kind
                ? $context->builder->load($fortysixthVar->value)
                : $fortysixthVar->value;
            $ov9Block = BasicBlockHelper::append($context, 'pow_hundredfourth_fortysixth_ov');
            $ok9Block = BasicBlockHelper::append($context, 'pow_hundredfourth_fortysixth_ok');
            ...
            $hundredfourthF9 = $context->builder->fmul($fortyeighthF9, $sqF9);
            $nF9 = $context->builder->siToFp($n, $f64);
            $hundredfourthF9 = $context->builder->fmul($hundredfourthF9, $nF9);
            $hundredfourthF9 = $context->builder->fmul($hundredfourthF9, $nF9);
            $hundredfourthF9 = $context->builder->fmul($hundredfourthF9, $nF9);
            $hundredfourthF9 = $context->builder->fmul($hundredfourthF9, $nF9);
            $hundredfourthF9 = $context->builder->fmul($hundredfourthF9, $nF9);
            ...
            $hundredfourthF9 = $context->builder->fmul($hundredfourthF9, $nF9);
            $hundredfourthF9 = $context->builder->fmul($hundredfourthF9, $nF9);
            $hundredfourthF9 = $context->builder->fmul($hundredfourthF9, $nF);
            $hundredfourthF9 = $context->builder->fmul($hundredfourthF9, $nF);
            $context->builder->call(
                $context->lookupFunction('__value__writeDouble'),
                $slotPtr,
            ...
            if (null === $ov10 || null === $fortyeighthVar->longArithOverflowDoubleSlot) {
                throw new \LogicException('pow() **104 expected smul overflow metadata (fortyeighth)');
            }
            ...
            $ov10Block = BasicBlockHelper::append($context, 'pow_hundredfourth_fortyeighth_ov');
            $ok10Block = BasicBlockHelper::append($context, 'pow_hundredfourth_fortyeighth_ok');
            ...
            $hundredfourthF10 = $context->builder->fmul($fortyeighthF10, $sqF10);
            $nF10 = $context->builder->siToFp($n, $f64);
            $hundredfourthF10 = $context->builder->fmul($hundredfourthF10, $nF10);
            $hundredfourthF10 = $context->builder->fmul($hundredfourthF10, $nF10);
            $hundredfourthF10 = $context->builder->fmul($hundredfourthF10, $nF10);
            $hundredfourthF10 = $context->builder->fmul($hundredfourthF10, $nF10);
            $hundredfourthF10 = $context->builder->fmul($hundredfourthF10, $nF10);
            ...
            $hundredfourthF10 = $context->builder->fmul($hundredfourthF10, $nF10);
            $hundredfourthF10 = $context->builder->fmul($hundredfourthF10, $nF10);
            $hundredfourthF10 = $context->builder->fmul($hundredfourthF10, $nF);
            $hundredfourthF10 = $context->builder->fmul($hundredfourthF10, $nF);
            $context->builder->call(
                $context->lookupFunction('__value__writeDouble'),
                $slotPtr,
            ...
            if (null === $ov11 || null === $fiftiethVar->longArithOverflowDoubleSlot) {
                throw new \LogicException('pow() **104 expected smul overflow metadata (fiftieth)');
            }
            $fiftiethLong = JITVariable::KIND_VARIABLE === $fiftiethVar->kind
                ? $context->builder->load($fiftiethVar->value)
                : $fiftiethVar->value;
            $ov11Block = BasicBlockHelper::append($context, 'pow_hundredfourth_fiftieth_ov');
            $ok11Block = BasicBlockHelper::append($context, 'pow_hundredfourth_fiftieth_ok');
            ...
            $hundredfourthF11 = $context->builder->fmul($fiftiethF11, $nF11);
            $hundredfourthF11 = $context->builder->fmul($hundredfourthF11, $nF11);
            $hundredfourthF11 = $context->builder->fmul($hundredfourthF11, $nF11);
            $hundredfourthF11 = $context->builder->fmul($hundredfourthF11, $nF11);
            $hundredfourthF11 = $context->builder->fmul($hundredfourthF11, $nF11);
            $hundredfourthF11 = $context->builder->fmul($hundredfourthF11, $nF11);
            ...
            $hundredfourthF11 = $context->builder->fmul($hundredfourthF11, $nF11);
            $hundredfourthF11 = $context->builder->fmul($hundredfourthF11, $nF11);
            $hundredfourthF11 = $context->builder->fmul($hundredfourthF11, $nF);
            $hundredfourthF11 = $context->builder->fmul($hundredfourthF11, $nF);
            $context->builder->call(
                $context->lookupFunction('__value__writeDouble'),
                $slotPtr,
            ...
            if (null === $ov12 || null === $fiftyfirstVar->longArithOverflowDoubleSlot) {
                throw new \LogicException('pow() **104 expected smul overflow metadata (fiftyfirst)');
            }
            $fiftyfirstLong = JITVariable::KIND_VARIABLE === $fiftyfirstVar->kind
                ? $context->builder->load($fiftyfirstVar->value)
                : $fiftyfirstVar->value;
            $ov12Block = BasicBlockHelper::append($context, 'pow_hundredfourth_fiftyfirst_ov');
            $ok12Block = BasicBlockHelper::append($context, 'pow_hundredfourth_fiftyfirst_ok');
            ...
            $hundredfourthF12 = $context->builder->fmul($fiftyfirstF12, $nF12);
            $hundredfourthF12 = $context->builder->fmul($hundredfourthF12, $nF12);
            $hundredfourthF12 = $context->builder->fmul($hundredfourthF12, $nF12);
            $hundredfourthF12 = $context->builder->fmul($hundredfourthF12, $nF12);
            $hundredfourthF12 = $context->builder->fmul($hundredfourthF12, $nF12);
            $hundredfourthF12 = $context->builder->fmul($hundredfourthF12, $nF12);
            ...
            $hundredfourthF12 = $context->builder->fmul($hundredfourthF12, $nF12);
            $hundredfourthF12 = $context->builder->fmul($hundredfourthF12, $nF12);
            $hundredfourthF12 = $context->builder->fmul($hundredfourthF12, $nF);
            $hundredfourthF12 = $context->builder->fmul($hundredfourthF12, $nF);
            $context->builder->call(
                $context->lookupFunction('__value__writeDouble'),
                $slotPtr,
            ...
            if (null === $ov13 || null === $fiftysecondVar->longArithOverflowDoubleSlot) {
                throw new \LogicException('pow() **104 expected smul overflow metadata (fiftysecond)');
            }
            ...
            $ov13Block = BasicBlockHelper::append($context, 'pow_hundredfourth_fiftysecond_ov');
            $ok13Block = BasicBlockHelper::append($context, 'pow_hundredfourth_fiftysecond_ok');
            ...
            $hundredfourthF13 = $context->builder->fmul($fiftysecondF13, $nF13);
            $hundredfourthF13 = $context->builder->fmul($hundredfourthF13, $nF13);
            $hundredfourthF13 = $context->builder->fmul($hundredfourthF13, $nF13);
            $hundredfourthF13 = $context->builder->fmul($hundredfourthF13, $nF13);
            $hundredfourthF13 = $context->builder->fmul($hundredfourthF13, $nF13);
            $hundredfourthF13 = $context->builder->fmul($hundredfourthF13, $nF13);
            ...
            $hundredfourthF13 = $context->builder->fmul($hundredfourthF13, $nF13);
            $hundredfourthF13 = $context->builder->fmul($hundredfourthF13, $nF13);
            $hundredfourthF13 = $context->builder->fmul($hundredfourthF13, $nF);
            $hundredfourthF13 = $context->builder->fmul($hundredfourthF13, $nF);
            $context->builder->call(
                $context->lookupFunction('__value__writeDouble'),
                $slotPtr,
            ...
            if (null === $ov14 || null === $fiftythirdVar->longArithOverflowDoubleSlot) {
                throw new \LogicException('pow() **104 expected smul overflow metadata (fiftythird)');
            }
            $fiftythirdLong = JITVariable::KIND_VARIABLE === $fiftythirdVar->kind
                ? $context->builder->load($fiftythirdVar->value)
                : $fiftythirdVar->value;
            $ov14Block = BasicBlockHelper::append($context, 'pow_hundredfourth_fiftythird_ov');
            $ok14Block = BasicBlockHelper::append($context, 'pow_hundredfourth_fiftythird_ok');
            ...
            $hundredfourthF14 = $context->builder->fmul($fiftythirdF14, $nF14);
            $hundredfourthF14 = $context->builder->fmul($hundredfourthF14, $nF14);
            $hundredfourthF14 = $context->builder->fmul($hundredfourthF14, $nF14);
            $hundredfourthF14 = $context->builder->fmul($hundredfourthF14, $nF14);
            $hundredfourthF14 = $context->builder->fmul($hundredfourthF14, $nF14);
            $hundredfourthF14 = $context->builder->fmul($hundredfourthF14, $nF14);
            ...
            $hundredfourthF14 = $context->builder->fmul($hundredfourthF14, $nF14);
            $hundredfourthF14 = $context->builder->fmul($hundredfourthF14, $nF14);
            $hundredfourthF14 = $context->builder->fmul($hundredfourthF14, $nF);
            $hundredfourthF14 = $context->builder->fmul($hundredfourthF14, $nF);
            $context->builder->call(
                $context->lookupFunction('__value__writeDouble'),
                $slotPtr,
            ...
            if (null === $ov15 || null === $fiftyfourthVar->longArithOverflowDoubleSlot) {
                throw new \LogicException('pow() **104 expected smul overflow metadata (fiftyfourth)');
            }
            ...
            $ov15Block = BasicBlockHelper::append($context, 'pow_hundredfourth_fiftyfourth_ov');
            $ok15Block = BasicBlockHelper::append($context, 'pow_hundredfourth_fiftyfourth_ok');
            ...
            $hundredfourthF15 = $context->builder->fmul($fiftyfourthF15, $nF15);
            $hundredfourthF15 = $context->builder->fmul($hundredfourthF15, $nF15);
            $hundredfourthF15 = $context->builder->fmul($hundredfourthF15, $nF15);
            $hundredfourthF15 = $context->builder->fmul($hundredfourthF15, $nF15);
            $hundredfourthF15 = $context->builder->fmul($hundredfourthF15, $nF15);
            $hundredfourthF15 = $context->builder->fmul($hundredfourthF15, $nF15);
            ...
            $hundredfourthF15 = $context->builder->fmul($hundredfourthF15, $nF15);
            $hundredfourthF15 = $context->builder->fmul($hundredfourthF15, $nF15);
            $hundredfourthF15 = $context->builder->fmul($hundredfourthF15, $nF);
            $hundredfourthF15 = $context->builder->fmul($hundredfourthF15, $nF);
            $context->builder->call(
                $context->lookupFunction('__value__writeDouble'),
                $slotPtr,
            ...
            if (null === $ov16 || null === $fiftyfifthVar->longArithOverflowDoubleSlot) {
                throw new \LogicException('pow() **104 expected smul overflow metadata (fiftyfifth)');
            }
            $fiftyfifthLong = JITVariable::KIND_VARIABLE === $fiftyfifthVar->kind
                ? $context->builder->load($fiftyfifthVar->value)
                : $fiftyfifthVar->value;
            $ov16Block = BasicBlockHelper::append($context, 'pow_hundredfourth_fiftyfifth_ov');
            $ok16Block = BasicBlockHelper::append($context, 'pow_hundredfourth_fiftyfifth_ok');
            ...
            $hundredfourthF16 = $context->builder->fmul($fiftyfifthF16, $nF16);
            $hundredfourthF16 = $context->builder->fmul($hundredfourthF16, $nF16);
            $hundredfourthF16 = $context->builder->fmul($hundredfourthF16, $nF16);
            $hundredfourthF16 = $context->builder->fmul($hundredfourthF16, $nF16);
            $hundredfourthF16 = $context->builder->fmul($hundredfourthF16, $nF16);
                $hundredfourthF16 = $context->builder->fmul($hundredfourthF16, $nF16);
            ...
            $hundredfourthF16 = $context->builder->fmul($hundredfourthF16, $nF16);
            $hundredfourthF16 = $context->builder->fmul($hundredfourthF16, $nF16);
            $hundredfourthF16 = $context->builder->fmul($hundredfourthF16, $nF);
            $hundredfourthF16 = $context->builder->fmul($hundredfourthF16, $nF);
            $context->builder->call(
                $context->lookupFunction('__value__writeDouble'),
                $slotPtr,
            ...
            if (null === $ov17 || null === $fiftysixthVar->longArithOverflowDoubleSlot) {
                throw new \LogicException('pow() **104 expected smul overflow metadata (fiftysixth)');
            }
            $fiftysixthLong = JITVariable::KIND_VARIABLE === $fiftysixthVar->kind
                ? $context->builder->load($fiftysixthVar->value)
                : $fiftysixthVar->value;
            $ov17Block = BasicBlockHelper::append($context, 'pow_hundredfourth_fiftysixth_ov');
            $ok17Block = BasicBlockHelper::append($context, 'pow_hundredfourth_fiftysixth_ok');
            ...
            $hundredfourthF17 = $context->builder->fmul($fiftysixthF17, $nF17);
            $hundredfourthF17 = $context->builder->fmul($hundredfourthF17, $nF17);
            $hundredfourthF17 = $context->builder->fmul($hundredfourthF17, $nF17);
            $hundredfourthF17 = $context->builder->fmul($hundredfourthF17, $nF17);
                $hundredfourthF17 = $context->builder->fmul($hundredfourthF17, $nF17);
                    $hundredfourthF17 = $context->builder->fmul($hundredfourthF17, $nF17);
            ...
            $hundredfourthF17 = $context->builder->fmul($hundredfourthF17, $nF17);
            $hundredfourthF17 = $context->builder->fmul($hundredfourthF17, $nF17);
            $hundredfourthF17 = $context->builder->fmul($hundredfourthF17, $nF);
            $hundredfourthF17 = $context->builder->fmul($hundredfourthF17, $nF);
            $context->builder->call(
                $context->lookupFunction('__value__writeDouble'),
                $slotPtr,
            ...
            if (null === $ov18 || null === $fiftyseventhVar->longArithOverflowDoubleSlot) {
                throw new \LogicException('pow() **104 expected smul overflow metadata (fiftyseventh)');
            }
            ...
            $ov18Block = BasicBlockHelper::append($context, 'pow_hundredfourth_fiftyseventh_ov');
            $ok18Block = BasicBlockHelper::append($context, 'pow_hundredfourth_fiftyseventh_ok');
            ...
            $hundredfourthF18 = $context->builder->fmul($fiftyseventhF18, $nF18);
            $hundredfourthF18 = $context->builder->fmul($hundredfourthF18, $nF18);
            $hundredfourthF18 = $context->builder->fmul($hundredfourthF18, $nF18);
                $hundredfourthF18 = $context->builder->fmul($hundredfourthF18, $nF18);
                    $hundredfourthF18 = $context->builder->fmul($hundredfourthF18, $nF18);
                        $hundredfourthF18 = $context->builder->fmul($hundredfourthF18, $nF18);
            ...
            $hundredfourthF18 = $context->builder->fmul($hundredfourthF18, $nF18);
            $hundredfourthF18 = $context->builder->fmul($hundredfourthF18, $nF18);
            $hundredfourthF18 = $context->builder->fmul($hundredfourthF18, $nF);
            $hundredfourthF18 = $context->builder->fmul($hundredfourthF18, $nF);
            $context->builder->call(
                $context->lookupFunction('__value__writeDouble'),
                $slotPtr,
            ...
            if (null === $ov19 || null === $fiftyeighthVar->longArithOverflowDoubleSlot) {
                throw new \LogicException('pow() **104 expected smul overflow metadata (fiftyeighth)');
            }
            ...
            $ov19Block = BasicBlockHelper::append($context, 'pow_hundredfourth_fiftyeighth_ov');
            $ok19Block = BasicBlockHelper::append($context, 'pow_hundredfourth_fiftyeighth_ok');
            ...
            $hundredfourthF19 = $context->builder->fmul($fiftyeighthF19, $nF19);
            $hundredfourthF19 = $context->builder->fmul($hundredfourthF19, $nF19);
                $hundredfourthF19 = $context->builder->fmul($hundredfourthF19, $nF19);
                    $hundredfourthF19 = $context->builder->fmul($hundredfourthF19, $nF19);
                        $hundredfourthF19 = $context->builder->fmul($hundredfourthF19, $nF19);
                        $hundredfourthF19 = $context->builder->fmul($hundredfourthF19, $nF19);
            ...
            $hundredfourthF19 = $context->builder->fmul($hundredfourthF19, $nF19);
            $hundredfourthF19 = $context->builder->fmul($hundredfourthF19, $nF19);
            $hundredfourthF19 = $context->builder->fmul($hundredfourthF19, $nF);
            $hundredfourthF19 = $context->builder->fmul($hundredfourthF19, $nF);
            $context->builder->call(
                $context->lookupFunction('__value__writeDouble'),
                $slotPtr,
            ...
            if (null === $ov20 || null === $fiftyninthVar->longArithOverflowDoubleSlot) {
                throw new \LogicException('pow() **104 expected smul overflow metadata (fiftyninth)');
            }
            $fiftyninthLong = JITVariable::KIND_VARIABLE === $fiftyninthVar->kind
                ? $context->builder->load($fiftyninthVar->value)
                : $fiftyninthVar->value;
            $ov20Block = BasicBlockHelper::append($context, 'pow_hundredfourth_fiftyninth_ov');
            $ok20Block = BasicBlockHelper::append($context, 'pow_hundredfourth_fiftyninth_ok');
            ...
            $hundredfourthF20 = $context->builder->fmul($fiftyninthF20, $nF20);
                $hundredfourthF20 = $context->builder->fmul($hundredfourthF20, $nF20);
                    $hundredfourthF20 = $context->builder->fmul($hundredfourthF20, $nF20);
                        $hundredfourthF20 = $context->builder->fmul($hundredfourthF20, $nF20);
                        $hundredfourthF20 = $context->builder->fmul($hundredfourthF20, $nF20);
                        $hundredfourthF20 = $context->builder->fmul($hundredfourthF20, $nF20);
            ...
            $hundredfourthF20 = $context->builder->fmul($hundredfourthF20, $nF20);
            $hundredfourthF20 = $context->builder->fmul($hundredfourthF20, $nF20);
            $hundredfourthF20 = $context->builder->fmul($hundredfourthF20, $nF);
            $hundredfourthF20 = $context->builder->fmul($hundredfourthF20, $nF);
            $context->builder->call(
                $context->lookupFunction('__value__writeDouble'),
                $slotPtr,
            ...
            if (null === $ov21 || null === $sixtiethVar->longArithOverflowDoubleSlot) {
                throw new \LogicException('pow() **104 expected smul overflow metadata (sixtieth)');
            }
            $sixtiethLong = JITVariable::KIND_VARIABLE === $sixtiethVar->kind
                ? $context->builder->load($sixtiethVar->value)
                : $sixtiethVar->value;
            $ov21Block = BasicBlockHelper::append($context, 'pow_hundredfourth_sixtieth_ov');
            $ok21Block = BasicBlockHelper::append($context, 'pow_hundredfourth_sixtieth_ok');
            ...
            $hundredfourthF21 = $context->builder->fmul($sixtiethF21, $nF21);
                $hundredfourthF21 = $context->builder->fmul($hundredfourthF21, $nF21);
                    $hundredfourthF21 = $context->builder->fmul($hundredfourthF21, $nF21);
                    $hundredfourthF21 = $context->builder->fmul($hundredfourthF21, $nF21);
                    $hundredfourthF21 = $context->builder->fmul($hundredfourthF21, $nF21);
                    $hundredfourthF21 = $context->builder->fmul($hundredfourthF21, $nF21);
            ...
            $hundredfourthF21 = $context->builder->fmul($hundredfourthF21, $nF21);
            $hundredfourthF21 = $context->builder->fmul($hundredfourthF21, $nF21);
            $hundredfourthF21 = $context->builder->fmul($hundredfourthF21, $nF);
            $hundredfourthF21 = $context->builder->fmul($hundredfourthF21, $nF);
            $context->builder->call(
                $context->lookupFunction('__value__writeDouble'),
                $slotPtr,
            ...
            if (null === $ov22 || null === $sixtyfirstVar->longArithOverflowDoubleSlot) {
                throw new \LogicException('pow() **104 expected smul overflow metadata (sixtyfirst)');
            }
            $sixtyfirstLong = JITVariable::KIND_VARIABLE === $sixtyfirstVar->kind
                ? $context->builder->load($sixtyfirstVar->value)
                : $sixtyfirstVar->value;
            $ov22Block = BasicBlockHelper::append($context, 'pow_hundredfourth_sixtyfirst_ov');
            $ok22Block = BasicBlockHelper::append($context, 'pow_hundredfourth_sixtyfirst_ok');
            ...
            $hundredfourthF22 = $context->builder->fmul($sixtyfirstF22, $nF22);
                $hundredfourthF22 = $context->builder->fmul($hundredfourthF22, $nF22);
                $hundredfourthF22 = $context->builder->fmul($hundredfourthF22, $nF22);
                $hundredfourthF22 = $context->builder->fmul($hundredfourthF22, $nF22);
                $hundredfourthF22 = $context->builder->fmul($hundredfourthF22, $nF22);
                $hundredfourthF22 = $context->builder->fmul($hundredfourthF22, $nF22);
            ...
            $hundredfourthF22 = $context->builder->fmul($hundredfourthF22, $nF22);
            $hundredfourthF22 = $context->builder->fmul($hundredfourthF22, $nF22);
            $hundredfourthF22 = $context->builder->fmul($hundredfourthF22, $nF);
            $hundredfourthF22 = $context->builder->fmul($hundredfourthF22, $nF);
            $context->builder->call(
                $context->lookupFunction('__value__writeDouble'),
                $slotPtr,
            ...
            if (null === $ov23 || null === $sixtysecondVar->longArithOverflowDoubleSlot) {
                throw new \LogicException('pow() **104 expected smul overflow metadata (sixtysecond)');
            }
            ...
            $ov23Block = BasicBlockHelper::append($context, 'pow_hundredfourth_sixtysecond_ov');
            $ok23Block = BasicBlockHelper::append($context, 'pow_hundredfourth_sixtysecond_ok');
            ...
            $hundredfourthF23 = $context->builder->fmul($sixtysecondF23, $nF23);
            $hundredfourthF23 = $context->builder->fmul($hundredfourthF23, $nF23);
            $hundredfourthF23 = $context->builder->fmul($hundredfourthF23, $nF23);
            $hundredfourthF23 = $context->builder->fmul($hundredfourthF23, $nF23);
            $hundredfourthF23 = $context->builder->fmul($hundredfourthF23, $nF23);
            $hundredfourthF23 = $context->builder->fmul($hundredfourthF23, $nF23);
            ...
            $hundredfourthF23 = $context->builder->fmul($hundredfourthF23, $nF23);
            $hundredfourthF23 = $context->builder->fmul($hundredfourthF23, $nF23);
            $hundredfourthF23 = $context->builder->fmul($hundredfourthF23, $nF);
            $hundredfourthF23 = $context->builder->fmul($hundredfourthF23, $nF);
            $context->builder->call(
                $context->lookupFunction('__value__writeDouble'),
                $slotPtr,
            ...
            if (null === $ov24 || null === $sixtythirdVar->longArithOverflowDoubleSlot) {
                throw new \LogicException('pow() **104 expected smul overflow metadata (sixtythird)');
            }
            $sixtythirdLong = JITVariable::KIND_VARIABLE === $sixtythirdVar->kind
                ? $context->builder->load($sixtythirdVar->value)
                : $sixtythirdVar->value;
            $ov24Block = BasicBlockHelper::append($context, 'pow_hundredfourth_sixtythird_ov');
            $ok24Block = BasicBlockHelper::append($context, 'pow_hundredfourth_sixtythird_ok');
            ...
            $hundredfourthF24 = $context->builder->fmul($sixtythirdF24, $nF24);
            $hundredfourthF24 = $context->builder->fmul($hundredfourthF24, $nF24);
            $hundredfourthF24 = $context->builder->fmul($hundredfourthF24, $nF24);
            $hundredfourthF24 = $context->builder->fmul($hundredfourthF24, $nF24);
            $hundredfourthF24 = $context->builder->fmul($hundredfourthF24, $nF24);
            $hundredfourthF24 = $context->builder->fmul($hundredfourthF24, $nF24);
            ...
            $hundredfourthF24 = $context->builder->fmul($hundredfourthF24, $nF24);
            $hundredfourthF24 = $context->builder->fmul($hundredfourthF24, $nF24);
            $hundredfourthF24 = $context->builder->fmul($hundredfourthF24, $nF);
            $hundredfourthF24 = $context->builder->fmul($hundredfourthF24, $nF);
            $context->builder->call(
                $context->lookupFunction('__value__writeDouble'),
                $slotPtr,
            ...
            if (null === $ov25 || null === $sixtyfourthVar->longArithOverflowDoubleSlot) {
                throw new \LogicException('pow() **104 expected smul overflow metadata (sixtyfourth)');
            }
            ...
            $ov25Block = BasicBlockHelper::append($context, 'pow_hundredfourth_sixtyfourth_ov');
            $ok25Block = BasicBlockHelper::append($context, 'pow_hundredfourth_sixtyfourth_ok');
            ...
            $hundredfourthF25 = $context->builder->fmul($sixtyfourthF25, $nF25);
            $hundredfourthF25 = $context->builder->fmul($hundredfourthF25, $nF25);
            $hundredfourthF25 = $context->builder->fmul($hundredfourthF25, $nF25);
            $hundredfourthF25 = $context->builder->fmul($hundredfourthF25, $nF25);
            $hundredfourthF25 = $context->builder->fmul($hundredfourthF25, $nF25);
            $hundredfourthF25 = $context->builder->fmul($hundredfourthF25, $nF25);
            ...
            $hundredfourthF25 = $context->builder->fmul($hundredfourthF25, $nF25);
            $hundredfourthF25 = $context->builder->fmul($hundredfourthF25, $nF25);
            $hundredfourthF25 = $context->builder->fmul($hundredfourthF25, $nF);
            $hundredfourthF25 = $context->builder->fmul($hundredfourthF25, $nF);
            $context->builder->call(
                $context->lookupFunction('__value__writeDouble'),
                $slotPtr,
            ...
            if (null === $ov26 || null === $sixtyfifthVar->longArithOverflowDoubleSlot) {
                throw new \LogicException('pow() **104 expected smul overflow metadata (sixtyfifth)');
            }
            $sixtyfifthLong = JITVariable::KIND_VARIABLE === $sixtyfifthVar->kind
                ? $context->builder->load($sixtyfifthVar->value)
                : $sixtyfifthVar->value;
            $ov26Block = BasicBlockHelper::append($context, 'pow_hundredfourth_sixtyfifth_ov');
            $ok26Block = BasicBlockHelper::append($context, 'pow_hundredfourth_sixtyfifth_ok');
            ...
            $hundredfourthF26 = $context->builder->fmul($sixtyfifthF26, $nF26);
            $hundredfourthF26 = $context->builder->fmul($hundredfourthF26, $nF26);
            $hundredfourthF26 = $context->builder->fmul($hundredfourthF26, $nF26);
            $hundredfourthF26 = $context->builder->fmul($hundredfourthF26, $nF26);
            $hundredfourthF26 = $context->builder->fmul($hundredfourthF26, $nF26);
            $hundredfourthF26 = $context->builder->fmul($hundredfourthF26, $nF26);
            ...
            $hundredfourthF26 = $context->builder->fmul($hundredfourthF26, $nF26);
            $hundredfourthF26 = $context->builder->fmul($hundredfourthF26, $nF26);
            $hundredfourthF26 = $context->builder->fmul($hundredfourthF26, $nF);
            $hundredfourthF26 = $context->builder->fmul($hundredfourthF26, $nF);
            $context->builder->call(
                $context->lookupFunction('__value__writeDouble'),
                $slotPtr,
            ...
            if (null === $ov27 || null === $sixtysixthVar->longArithOverflowDoubleSlot) {
                throw new \LogicException('pow() **104 expected smul overflow metadata (sixtysixth)');
            }
            $sixtysixthLong = JITVariable::KIND_VARIABLE === $sixtysixthVar->kind
                ? $context->builder->load($sixtysixthVar->value)
                : $sixtysixthVar->value;
            $ov27Block = BasicBlockHelper::append($context, 'pow_hundredfourth_sixtysixth_ov');
            $ok27Block = BasicBlockHelper::append($context, 'pow_hundredfourth_sixtysixth_ok');
            ...
            $hundredfourthF27 = $context->builder->fmul($sixtysixthF27, $nF27);
            $hundredfourthF27 = $context->builder->fmul($hundredfourthF27, $nF27);
            $hundredfourthF27 = $context->builder->fmul($hundredfourthF27, $nF27);
            $hundredfourthF27 = $context->builder->fmul($hundredfourthF27, $nF27);
            $hundredfourthF27 = $context->builder->fmul($hundredfourthF27, $nF27);
            $hundredfourthF27 = $context->builder->fmul($hundredfourthF27, $nF27);
            ...
            $hundredfourthF27 = $context->builder->fmul($hundredfourthF27, $nF27);
            $hundredfourthF27 = $context->builder->fmul($hundredfourthF27, $nF27);
            $hundredfourthF27 = $context->builder->fmul($hundredfourthF27, $nF);
            $hundredfourthF27 = $context->builder->fmul($hundredfourthF27, $nF);
            $context->builder->call(
                $context->lookupFunction('__value__writeDouble'),
                $slotPtr,
            ...
            if (null === $ov28 || null === $sixtyseventhVar->longArithOverflowDoubleSlot) {
                throw new \LogicException('pow() **104 expected smul overflow metadata (sixtyseventh)');
            }
            ...
            $ov28Block = BasicBlockHelper::append($context, 'pow_hundredfourth_sixtyseventh_ov');
            $ok28Block = BasicBlockHelper::append($context, 'pow_hundredfourth_sixtyseventh_ok');
            ...
            $hundredfourthF28 = $context->builder->fmul($sixtyseventhF28, $nF28);
            $hundredfourthF28 = $context->builder->fmul($hundredfourthF28, $nF28);
            $hundredfourthF28 = $context->builder->fmul($hundredfourthF28, $nF28);
            $hundredfourthF28 = $context->builder->fmul($hundredfourthF28, $nF28);
            $hundredfourthF28 = $context->builder->fmul($hundredfourthF28, $nF28);
            $hundredfourthF28 = $context->builder->fmul($hundredfourthF28, $nF28);
            ...
            $hundredfourthF28 = $context->builder->fmul($hundredfourthF28, $nF28);
            $hundredfourthF28 = $context->builder->fmul($hundredfourthF28, $nF28);
            $hundredfourthF28 = $context->builder->fmul($hundredfourthF28, $nF);
            $hundredfourthF28 = $context->builder->fmul($hundredfourthF28, $nF);
            $context->builder->call(
                $context->lookupFunction('__value__writeDouble'),
                $slotPtr,
            ...
            if (null === $ov29 || null === $sixtyeighthVar->longArithOverflowDoubleSlot) {
                throw new \LogicException('pow() **104 expected smul overflow metadata (sixtyeighth)');
            }
            ...
            $ov29Block = BasicBlockHelper::append($context, 'pow_hundredfourth_sixtyeighth_ov');
            $ok29Block = BasicBlockHelper::append($context, 'pow_hundredfourth_sixtyeighth_ok');
            ...
            $hundredfourthF29 = $context->builder->fmul($sixtyeighthF29, $nF29);
            $hundredfourthF29 = $context->builder->fmul($hundredfourthF29, $nF29);
            $hundredfourthF29 = $context->builder->fmul($hundredfourthF29, $nF29);
            $hundredfourthF29 = $context->builder->fmul($hundredfourthF29, $nF29);
            $hundredfourthF29 = $context->builder->fmul($hundredfourthF29, $nF29);
            $hundredfourthF29 = $context->builder->fmul($hundredfourthF29, $nF29);
            ...
            $hundredfourthF29 = $context->builder->fmul($hundredfourthF29, $nF29);
            $hundredfourthF29 = $context->builder->fmul($hundredfourthF29, $nF29);
            $hundredfourthF29 = $context->builder->fmul($hundredfourthF29, $nF);
            $hundredfourthF29 = $context->builder->fmul($hundredfourthF29, $nF);
            $context->builder->call(
                $context->lookupFunction('__value__writeDouble'),
                $slotPtr,
            ...
            if (null === $ov30 || null === $sixtyninthVar->longArithOverflowDoubleSlot) {
                throw new \LogicException('pow() **104 expected smul overflow metadata (sixtyninth)');
            }
            $sixtyninthLong = JITVariable::KIND_VARIABLE === $sixtyninthVar->kind
                ? $context->builder->load($sixtyninthVar->value)
                : $sixtyninthVar->value;
            $ov30Block = BasicBlockHelper::append($context, 'pow_hundredfourth_sixtyninth_ov');
            $ok30Block = BasicBlockHelper::append($context, 'pow_hundredfourth_sixtyninth_ok');
            ...
            $hundredfourthF30 = $context->builder->fmul($sixtyninthF30, $nF30);
            $hundredfourthF30 = $context->builder->fmul($hundredfourthF30, $nF30);
            $hundredfourthF30 = $context->builder->fmul($hundredfourthF30, $nF30);
            $hundredfourthF30 = $context->builder->fmul($hundredfourthF30, $nF30);
            $hundredfourthF30 = $context->builder->fmul($hundredfourthF30, $nF30);
            $hundredfourthF30 = $context->builder->fmul($hundredfourthF30, $nF30);
            ...
            $hundredfourthF30 = $context->builder->fmul($hundredfourthF30, $nF30);
            $hundredfourthF30 = $context->builder->fmul($hundredfourthF30, $nF30);
            $hundredfourthF30 = $context->builder->fmul($hundredfourthF30, $nF);
            $hundredfourthF30 = $context->builder->fmul($hundredfourthF30, $nF);
            $context->builder->call(
                $context->lookupFunction('__value__writeDouble'),
                $slotPtr,
            ...
            if (null === $ov31 || null === $seventiethVar->longArithOverflowDoubleSlot) {
                throw new \LogicException('pow() **104 expected smul overflow metadata (seventieth)');
            }
            $seventiethLong = JITVariable::KIND_VARIABLE === $seventiethVar->kind
                ? $context->builder->load($seventiethVar->value)
                : $seventiethVar->value;
            $ov31Block = BasicBlockHelper::append($context, 'pow_hundredfourth_seventieth_ov');
            $ok31Block = BasicBlockHelper::append($context, 'pow_hundredfourth_seventieth_ok');
            ...
            $hundredfourthF31 = $context->builder->fmul($seventiethF31, $nF31);
            $hundredfourthF31 = $context->builder->fmul($hundredfourthF31, $nF31);
            $hundredfourthF31 = $context->builder->fmul($hundredfourthF31, $nF31);
            $hundredfourthF31 = $context->builder->fmul($hundredfourthF31, $nF31);
            $hundredfourthF31 = $context->builder->fmul($hundredfourthF31, $nF31);
            $hundredfourthF31 = $context->builder->fmul($hundredfourthF31, $nF31);
            ...
            $hundredfourthF31 = $context->builder->fmul($hundredfourthF31, $nF31);
            $hundredfourthF31 = $context->builder->fmul($hundredfourthF31, $nF31);
            $hundredfourthF31 = $context->builder->fmul($hundredfourthF31, $nF);
            $hundredfourthF31 = $context->builder->fmul($hundredfourthF31, $nF);
            $context->builder->call(
                $context->lookupFunction('__value__writeDouble'),
                $slotPtr,
            ...
            if (null === $ov32 || null === $seventyfirstVar->longArithOverflowDoubleSlot) {
                throw new \LogicException('pow() **104 expected smul overflow metadata (seventyfirst)');
            }
            ...
            $ov32Block = BasicBlockHelper::append($context, 'pow_hundredfourth_seventyfirst_ov');
            $ok32Block = BasicBlockHelper::append($context, 'pow_hundredfourth_seventyfirst_ok');
            ...
            $hundredfourthF32 = $context->builder->fmul($seventyfirstF32, $nF32);
            $hundredfourthF32 = $context->builder->fmul($hundredfourthF32, $nF32);
            $hundredfourthF32 = $context->builder->fmul($hundredfourthF32, $nF32);
            $hundredfourthF32 = $context->builder->fmul($hundredfourthF32, $nF32);
            $hundredfourthF32 = $context->builder->fmul($hundredfourthF32, $nF32);
            $hundredfourthF32 = $context->builder->fmul($hundredfourthF32, $nF32);
            ...
            $hundredfourthF32 = $context->builder->fmul($hundredfourthF32, $nF32);
            $hundredfourthF32 = $context->builder->fmul($hundredfourthF32, $nF32);
            $hundredfourthF32 = $context->builder->fmul($hundredfourthF32, $nF);
            $hundredfourthF32 = $context->builder->fmul($hundredfourthF32, $nF);
            $context->builder->call(
                $context->lookupFunction('__value__writeDouble'),
                $slotPtr,
            ...
            if (null === $ov33 || null === $seventysecondVar->longArithOverflowDoubleSlot) {
                throw new \LogicException('pow() **104 expected smul overflow metadata (seventysecond)');
            }
            ...
            $ov33Block = BasicBlockHelper::append($context, 'pow_hundredfourth_seventysecond_ov');
            $ok33Block = BasicBlockHelper::append($context, 'pow_hundredfourth_seventysecond_ok');
            ...
            $hundredfourthF33 = $context->builder->fmul($seventysecondF33, $nF33);
            $hundredfourthF33 = $context->builder->fmul($seventysecondF33, $nF33);
            $hundredfourthF33 = $context->builder->fmul($hundredfourthF33, $nF33);
            $hundredfourthF33 = $context->builder->fmul($hundredfourthF33, $nF33);
            $hundredfourthF33 = $context->builder->fmul($hundredfourthF33, $nF33);
            $hundredfourthF33 = $context->builder->fmul($hundredfourthF33, $nF33);
            $hundredfourthF33 = $context->builder->fmul($hundredfourthF33, $nF33);
            ...
            $hundredfourthF33 = $context->builder->fmul($hundredfourthF33, $nF33);
            $hundredfourthF33 = $context->builder->fmul($hundredfourthF33, $nF33);
            $hundredfourthF33 = $context->builder->fmul($hundredfourthF33, $nF);
            $hundredfourthF33 = $context->builder->fmul($hundredfourthF33, $nF);
            $context->builder->call(
                $context->lookupFunction('__value__writeDouble'),
                $slotPtr,
            ...
            if (null === $ov34 || null === $seventythirdVar->longArithOverflowDoubleSlot) {
                throw new \LogicException('pow() **104 expected smul overflow metadata (seventythird)');
            }
            ...
            $ov34Block = BasicBlockHelper::append($context, 'pow_hundredfourth_seventythird_ov');
            $ok34Block = BasicBlockHelper::append($context, 'pow_hundredfourth_seventythird_ok');
            ...
            $hundredfourthF34 = $context->builder->fmul($seventythirdF34, $nF34);
            $hundredfourthF34 = $context->builder->fmul($hundredfourthF34, $nF34);
            $hundredfourthF34 = $context->builder->fmul($hundredfourthF34, $nF34);
            $hundredfourthF34 = $context->builder->fmul($hundredfourthF34, $nF34);
            $hundredfourthF34 = $context->builder->fmul($hundredfourthF34, $nF34);
            $hundredfourthF34 = $context->builder->fmul($hundredfourthF34, $nF34);
            ...
            $hundredfourthF34 = $context->builder->fmul($hundredfourthF34, $nF34);
            $hundredfourthF34 = $context->builder->fmul($hundredfourthF34, $nF34);
            $hundredfourthF34 = $context->builder->fmul($hundredfourthF34, $nF);
            $hundredfourthF34 = $context->builder->fmul($hundredfourthF34, $nF);
            $context->builder->call(
                $context->lookupFunction('__value__writeDouble'),
                $slotPtr,
            ...
            if (null === $ov35 || null === $seventyfourthVar->longArithOverflowDoubleSlot) {
                throw new \LogicException('pow() **104 expected smul overflow metadata (seventyfourth)');
            }
            ...
            $ov35Block = BasicBlockHelper::append($context, 'pow_hundredfourth_seventyfourth_ov');
            $ok35Block = BasicBlockHelper::append($context, 'pow_hundredfourth_seventyfourth_ok');
            ...
            $hundredfourthF35 = $context->builder->fmul($seventyfourthF35, $nF35);
            $hundredfourthF35 = $context->builder->fmul($seventyfourthF35, $nF35);
            $hundredfourthF35 = $context->builder->fmul($hundredfourthF35, $nF35);
            $hundredfourthF35 = $context->builder->fmul($hundredfourthF35, $nF35);
            $hundredfourthF35 = $context->builder->fmul($hundredfourthF35, $nF35);
            $hundredfourthF35 = $context->builder->fmul($hundredfourthF35, $nF35);
            $hundredfourthF35 = $context->builder->fmul($hundredfourthF35, $nF35);
            ...
            $hundredfourthF35 = $context->builder->fmul($hundredfourthF35, $nF35);
            $hundredfourthF35 = $context->builder->fmul($hundredfourthF35, $nF35);
            $hundredfourthF35 = $context->builder->fmul($hundredfourthF35, $nF);
            $hundredfourthF35 = $context->builder->fmul($hundredfourthF35, $nF);
            $context->builder->call(
                $context->lookupFunction('__value__writeDouble'),
                $slotPtr,
            ...
            if (null === $ov36 || null === $seventyfifthVar->longArithOverflowDoubleSlot) {
                throw new \LogicException('pow() **104 expected smul overflow metadata (seventyfifth)');
            }
            ...
            $ov36Block = BasicBlockHelper::append($context, 'pow_hundredfourth_seventyfifth_ov');
            $ok36Block = BasicBlockHelper::append($context, 'pow_hundredfourth_seventyfifth_ok');
            ...
            $hundredfourthF36 = $context->builder->fmul($seventyfifthF36, $nF36);
            $hundredfourthF36 = $context->builder->fmul($hundredfourthF36, $nF36);
            $hundredfourthF36 = $context->builder->fmul($hundredfourthF36, $nF36);
            $hundredfourthF36 = $context->builder->fmul($hundredfourthF36, $nF36);
            $hundredfourthF36 = $context->builder->fmul($hundredfourthF36, $nF36);
            $hundredfourthF36 = $context->builder->fmul($hundredfourthF36, $nF36);
            ...
            $hundredfourthF36 = $context->builder->fmul($hundredfourthF36, $nF36);
            $hundredfourthF36 = $context->builder->fmul($hundredfourthF36, $nF36);
            $hundredfourthF36 = $context->builder->fmul($hundredfourthF36, $nF);
            $hundredfourthF36 = $context->builder->fmul($hundredfourthF36, $nF);
            $context->builder->call(
                $context->lookupFunction('__value__writeDouble'),
                $slotPtr,
            ...
            if (null === $ov37 || null === $seventysixthVar->longArithOverflowDoubleSlot) {
                throw new \LogicException('pow() **104 expected smul overflow metadata (seventysixth)');
            }
            ...
            $ov37Block = BasicBlockHelper::append($context, 'pow_hundredfourth_seventysixth_ov');
            $ok37Block = BasicBlockHelper::append($context, 'pow_hundredfourth_seventysixth_ok');
            ...
            $hundredfourthF37 = $context->builder->fmul($seventysixthF37, $nF37);
            $hundredfourthF37 = $context->builder->fmul($hundredfourthF37, $nF37);
            $hundredfourthF37 = $context->builder->fmul($hundredfourthF37, $nF37);
            $hundredfourthF37 = $context->builder->fmul($hundredfourthF37, $nF37);
            $hundredfourthF37 = $context->builder->fmul($hundredfourthF37, $nF37);
            $hundredfourthF37 = $context->builder->fmul($hundredfourthF37, $nF37);
            ...
            $hundredfourthF37 = $context->builder->fmul($hundredfourthF37, $nF37);
            $hundredfourthF37 = $context->builder->fmul($hundredfourthF37, $nF37);
            $hundredfourthF37 = $context->builder->fmul($hundredfourthF37, $nF);
            $hundredfourthF37 = $context->builder->fmul($hundredfourthF37, $nF);
            $context->builder->call(
                $context->lookupFunction('__value__writeDouble'),
                $slotPtr,
            ...
            if (null === $ov38 || null === $seventyseventhVar->longArithOverflowDoubleSlot) {
                throw new \LogicException('pow() **104 expected smul overflow metadata (seventyseventh)');
            }
            ...
            $ov38Block = BasicBlockHelper::append($context, 'pow_hundredfourth_seventyseventh_ov');
            $ok38Block = BasicBlockHelper::append($context, 'pow_hundredfourth_seventyseventh_ok');
            ...
            $hundredfourthF38 = $context->builder->fmul($seventyseventhF38, $nF38);
            $hundredfourthF38 = $context->builder->fmul($seventyseventhF38, $nF38);
            $hundredfourthF38 = $context->builder->fmul($hundredfourthF38, $nF38);
            $hundredfourthF38 = $context->builder->fmul($hundredfourthF38, $nF38);
            $hundredfourthF38 = $context->builder->fmul($hundredfourthF38, $nF38);
            $hundredfourthF38 = $context->builder->fmul($hundredfourthF38, $nF38);
            $hundredfourthF38 = $context->builder->fmul($hundredfourthF38, $nF38);
            ...
            $hundredfourthF38 = $context->builder->fmul($hundredfourthF38, $nF38);
            $hundredfourthF38 = $context->builder->fmul($hundredfourthF38, $nF38);
            $hundredfourthF38 = $context->builder->fmul($hundredfourthF38, $nF);
            $hundredfourthF38 = $context->builder->fmul($hundredfourthF38, $nF);
            $context->builder->call(
                $context->lookupFunction('__value__writeDouble'),
                $slotPtr,
            ...
            if (null === $ov39 || null === $seventyeighthVar->longArithOverflowDoubleSlot) {
                throw new \LogicException('pow() **104 expected smul overflow metadata (seventyeighth)');
            }
            ...
            $ov39Block = BasicBlockHelper::append($context, 'pow_hundredfourth_seventyeighth_ov');
            $ok39Block = BasicBlockHelper::append($context, 'pow_hundredfourth_seventyeighth_ok');
            ...
            $hundredfourthF39 = $context->builder->fmul($seventyeighthF39, $nF39);
            $hundredfourthF39 = $context->builder->fmul($hundredfourthF39, $nF39);
            $hundredfourthF39 = $context->builder->fmul($hundredfourthF39, $nF39);
            $hundredfourthF39 = $context->builder->fmul($hundredfourthF39, $nF39);
            $hundredfourthF39 = $context->builder->fmul($hundredfourthF39, $nF39);
            $hundredfourthF39 = $context->builder->fmul($hundredfourthF39, $nF39);
            ...
            if (null === $ov40 || null === $seventyninthVar->longArithOverflowDoubleSlot) {
                throw new \LogicException('pow() **104 expected smul overflow metadata (seventyninth)');
            }
            ...
            $ov40Block = BasicBlockHelper::append($context, 'pow_hundredfourth_seventyninth_ov');
            $ok40Block = BasicBlockHelper::append($context, 'pow_hundredfourth_seventyninth_ok');
            ...
            $hundredfourthF40 = $context->builder->fmul($seventyninthF40, $nF40);
            $hundredfourthF40 = $context->builder->fmul($hundredfourthF40, $nF40);
            $hundredfourthF40 = $context->builder->fmul($hundredfourthF40, $nF40);
            $hundredfourthF40 = $context->builder->fmul($hundredfourthF40, $nF40);
            $hundredfourthF40 = $context->builder->fmul($hundredfourthF40, $nF40);
            $hundredfourthF40 = $context->builder->fmul($hundredfourthF40, $nF40);
            ...
            if (null === $ov41 || null === $eightiethVar->longArithOverflowDoubleSlot) {
                throw new \LogicException('pow() **104 expected smul overflow metadata (eightieth)');
            }
            $eightiethLong = JITVariable::KIND_VARIABLE === $eightiethVar->kind
                ? $context->builder->load($eightiethVar->value)
                : $eightiethVar->value;
            $ov41Block = BasicBlockHelper::append($context, 'pow_hundredfourth_eightieth_ov');
            $ok41Block = BasicBlockHelper::append($context, 'pow_hundredfourth_eightieth_ok');
            ...
            $hundredfourthF41 = $context->builder->fmul($eightiethF41, $nF41);
            $hundredfourthF41 = $context->builder->fmul($hundredfourthF41, $nF41);
            $hundredfourthF41 = $context->builder->fmul($hundredfourthF41, $nF41);
            $hundredfourthF41 = $context->builder->fmul($hundredfourthF41, $nF41);
            $hundredfourthF41 = $context->builder->fmul($hundredfourthF41, $nF41);
            $hundredfourthF41 = $context->builder->fmul($hundredfourthF41, $nF41);
            ...
            if (null === $ov42 || null === $eightyfirstVar->longArithOverflowDoubleSlot) {
                throw new \LogicException('pow() **104 expected smul overflow metadata (eightyfirst)');
            }
            ...
            $ov42Block = BasicBlockHelper::append($context, 'pow_hundredfourth_eightyfirst_ov');
            $ok42Block = BasicBlockHelper::append($context, 'pow_hundredfourth_eightyfirst_ok');
            ...
            $hundredfourthF42 = $context->builder->fmul($eightyfirstF42, $nF42);
            $hundredfourthF42 = $context->builder->fmul($hundredfourthF42, $nF42);
            $hundredfourthF42 = $context->builder->fmul($hundredfourthF42, $nF42);
            $hundredfourthF42 = $context->builder->fmul($hundredfourthF42, $nF42);
            $hundredfourthF42 = $context->builder->fmul($hundredfourthF42, $nF42);
            $hundredfourthF42 = $context->builder->fmul($hundredfourthF42, $nF42);
            ...
            if (null === $ov43 || null === $eightysecondVar->longArithOverflowDoubleSlot) {
                throw new \LogicException('pow() **104 expected smul overflow metadata (eightysecond)');
            }
            ...
            $ov43Block = BasicBlockHelper::append($context, 'pow_hundredfourth_eightysecond_ov');
            $ok43Block = BasicBlockHelper::append($context, 'pow_hundredfourth_eightysecond_ok');
            ...
            $hundredfourthF43 = $context->builder->fmul($eightysecondF43, $nF43);
            $hundredfourthF43 = $context->builder->fmul($eightysecondF43, $nF43);
            $hundredfourthF43 = $context->builder->fmul($eightysecondF43, $nF43);
            $hundredfourthF43 = $context->builder->fmul($eightysecondF43, $nF43);
            $hundredfourthF43 = $context->builder->fmul($eightysecondF43, $nF43);
            $hundredfourthF43 = $context->builder->fmul($hundredfourthF43, $nF43);
            $hundredfourthF43 = $context->builder->fmul($hundredfourthF43, $nF43);
            $hundredfourthF43 = $context->builder->fmul($hundredfourthF43, $nF43);
            $hundredfourthF43 = $context->builder->fmul($hundredfourthF43, $nF43);
            $hundredfourthF43 = $context->builder->fmul($hundredfourthF43, $nF43);
            ...
            if (null === $ov44 || null === $eightythirdVar->longArithOverflowDoubleSlot) {
                throw new \LogicException('pow() **104 expected smul overflow metadata (eightythird)');
            }
            ...
            $ov44Block = BasicBlockHelper::append($context, 'pow_hundredfourth_eightythird_ov');
            $ok44Block = BasicBlockHelper::append($context, 'pow_hundredfourth_eightythird_ok');
            ...
            $hundredfourthF44 = $context->builder->fmul($eightythirdF44, $nF44);
            $hundredfourthF44 = $context->builder->fmul($eightythirdF44, $nF44);
            $hundredfourthF44 = $context->builder->fmul($eightythirdF44, $nF44);
            $hundredfourthF44 = $context->builder->fmul($eightythirdF44, $nF44);
            $hundredfourthF44 = $context->builder->fmul($hundredfourthF44, $nF44);
            $hundredfourthF44 = $context->builder->fmul($hundredfourthF44, $nF44);
            $hundredfourthF44 = $context->builder->fmul($hundredfourthF44, $nF44);
            $hundredfourthF44 = $context->builder->fmul($hundredfourthF44, $nF44);
            $hundredfourthF44 = $context->builder->fmul($hundredfourthF44, $nF44);
            ...
            if (null === $ov45 || null === $eightyfourthVar->longArithOverflowDoubleSlot) {
                throw new \LogicException('pow() **104 expected smul overflow metadata (eightyfourth)');
            }
            ...
            $ov45Block = BasicBlockHelper::append($context, 'pow_hundredfourth_eightyfourth_ov');
            $ok45Block = BasicBlockHelper::append($context, 'pow_hundredfourth_eightyfourth_ok');
            ...
            $hundredfourthF45 = $context->builder->fmul($eightyfourthF45, $nF45);
            $hundredfourthF45 = $context->builder->fmul($eightyfourthF45, $nF45);
            $hundredfourthF45 = $context->builder->fmul($eightyfourthF45, $nF45);
            $hundredfourthF45 = $context->builder->fmul($hundredfourthF45, $nF45);
            $hundredfourthF45 = $context->builder->fmul($hundredfourthF45, $nF45);
            $hundredfourthF45 = $context->builder->fmul($hundredfourthF45, $nF45);
            $hundredfourthF45 = $context->builder->fmul($hundredfourthF45, $nF45);
            $hundredfourthF45 = $context->builder->fmul($hundredfourthF45, $nF45);
            ...
            if (null === $ov46 || null === $eightyfifthVar->longArithOverflowDoubleSlot) {
                throw new \LogicException('pow() **104 expected smul overflow metadata (eightyfifth)');
            }
            ...
            $ov46Block = BasicBlockHelper::append($context, 'pow_hundredfourth_eightyfifth_ov');
            $ok46Block = BasicBlockHelper::append($context, 'pow_hundredfourth_eightyfifth_ok');
            ...
            $hundredfourthF46 = $context->builder->fmul($eightyfifthF46, $nF46);
            $hundredfourthF46 = $context->builder->fmul($eightyfifthF46, $nF46);
            $hundredfourthF46 = $context->builder->fmul($hundredfourthF46, $nF46);
            $hundredfourthF46 = $context->builder->fmul($hundredfourthF46, $nF46);
            $hundredfourthF46 = $context->builder->fmul($hundredfourthF46, $nF46);
            $hundredfourthF46 = $context->builder->fmul($hundredfourthF46, $nF46);
            $hundredfourthF46 = $context->builder->fmul($hundredfourthF46, $nF46);
            ...
            if (null === $ov47 || null === $eightysixthVar->longArithOverflowDoubleSlot) {
                throw new \LogicException('pow() **104 expected smul overflow metadata (eightysixth)');
            }
            ...
            $ov47Block = BasicBlockHelper::append($context, 'pow_hundredfourth_eightysixth_ov');
            $ok47Block = BasicBlockHelper::append($context, 'pow_hundredfourth_eightysixth_ok');
            ...
            $hundredfourthF47 = $context->builder->fmul($eightysixthF47, $nF47);
            $hundredfourthF47 = $context->builder->fmul($hundredfourthF47, $nF47);
            $hundredfourthF47 = $context->builder->fmul($hundredfourthF47, $nF47);
            $hundredfourthF47 = $context->builder->fmul($hundredfourthF47, $nF47);
            $hundredfourthF47 = $context->builder->fmul($hundredfourthF47, $nF47);
            $hundredfourthF47 = $context->builder->fmul($hundredfourthF47, $nF47);
            ...
            if (null === $ov48 || null === $eightyseventhVar->longArithOverflowDoubleSlot) {
                throw new \LogicException('pow() **104 expected smul overflow metadata (eightyseventh)');
            }
            ...
            $ov48Block = BasicBlockHelper::append($context, 'pow_hundredfourth_eightyseventh_ov');
            $ok48Block = BasicBlockHelper::append($context, 'pow_hundredfourth_eightyseventh_ok');
            ...
            $hundredfourthF48 = $context->builder->fmul($eightyseventhF48, $nF48);
            $hundredfourthF48 = $context->builder->fmul($eightyseventhF48, $nF48);
            $hundredfourthF48 = $context->builder->fmul($hundredfourthF48, $nF48);
            $hundredfourthF48 = $context->builder->fmul($hundredfourthF48, $nF48);
            $hundredfourthF48 = $context->builder->fmul($hundredfourthF48, $nF48);
            $hundredfourthF48 = $context->builder->fmul($hundredfourthF48, $nF48);
            $hundredfourthF48 = $context->builder->fmul($hundredfourthF48, $nF48);
            ...
            if (null === $ov49 || null === $eightyeighthVar->longArithOverflowDoubleSlot) {
                throw new \LogicException('pow() **104 expected smul overflow metadata (eightyeighth)');
            }
            ...
            $ov49Block = BasicBlockHelper::append($context, 'pow_hundredfourth_eightyeighth_ov');
            $ok49Block = BasicBlockHelper::append($context, 'pow_hundredfourth_eightyeighth_ok');
            ...
            $hundredfourthF49 = $context->builder->fmul($eightyeighthF49, $nF49);
            $hundredfourthF49 = $context->builder->fmul($hundredfourthF49, $nF49);
            $hundredfourthF49 = $context->builder->fmul($hundredfourthF49, $nF49);
            $hundredfourthF49 = $context->builder->fmul($hundredfourthF49, $nF49);
            $hundredfourthF49 = $context->builder->fmul($hundredfourthF49, $nF49);
            $hundredfourthF49 = $context->builder->fmul($hundredfourthF49, $nF49);
            ...
            if (null === $ov50 || null === $eightyninthVar->longArithOverflowDoubleSlot) {
                throw new \LogicException('pow() **104 expected smul overflow metadata (eightyninth)');
            }
            ...
            $ov50Block = BasicBlockHelper::append($context, 'pow_hundredfourth_eightyninth_ov');
            $ok50Block = BasicBlockHelper::append($context, 'pow_hundredfourth_eightyninth_ok');
            ...
            $hundredfourthF50 = $context->builder->fmul($eightyninthF50, $nF50);
            $hundredfourthF50 = $context->builder->fmul($hundredfourthF50, $nF50);
            $hundredfourthF50 = $context->builder->fmul($hundredfourthF50, $nF50);
            $hundredfourthF50 = $context->builder->fmul($hundredfourthF50, $nF50);
            $hundredfourthF50 = $context->builder->fmul($hundredfourthF50, $nF50);
            $hundredfourthF50 = $context->builder->fmul($hundredfourthF50, $nF50);
            ...
            if (null === $ov51 || null === $ninetiethVar->longArithOverflowDoubleSlot) {
                throw new \LogicException('pow() **104 expected smul overflow metadata (ninetieth)');
            }
            $ninetiethLong = JITVariable::KIND_VARIABLE === $ninetiethVar->kind
                ? $context->builder->load($ninetiethVar->value)
                : $ninetiethVar->value;
            $ov51Block = BasicBlockHelper::append($context, 'pow_hundredfourth_ninetieth_ov');
            $ok51Block = BasicBlockHelper::append($context, 'pow_hundredfourth_ninetieth_ok');
            ...
            $hundredfourthF51 = $context->builder->fmul($ninetiethF51, $nF51);
            $hundredfourthF51 = $context->builder->fmul($hundredfourthF51, $nF51);
            $hundredfourthF51 = $context->builder->fmul($hundredfourthF51, $nF51);
            $hundredfourthF51 = $context->builder->fmul($hundredfourthF51, $nF51);
            $hundredfourthF51 = $context->builder->fmul($hundredfourthF51, $nF51);
            $hundredfourthF51 = $context->builder->fmul($hundredfourthF51, $nF51);
            ...
            if (null === $ov52 || null === $ninetyfirstVar->longArithOverflowDoubleSlot) {
                throw new \LogicException('pow() **104 expected smul overflow metadata (ninetyfirst)');
            }
            ...
            $ov52Block = BasicBlockHelper::append($context, 'pow_hundredfourth_ninetyfirst_ov');
            $ok52Block = BasicBlockHelper::append($context, 'pow_hundredfourth_ninetyfirst_ok');
            ...
            $hundredfourthF52 = $context->builder->fmul($ninetyfirstF52, $nF52);
            $hundredfourthF52 = $context->builder->fmul($hundredfourthF52, $nF52);
            $hundredfourthF52 = $context->builder->fmul($hundredfourthF52, $nF52);
            $hundredfourthF52 = $context->builder->fmul($hundredfourthF52, $nF52);
            $hundredfourthF52 = $context->builder->fmul($hundredfourthF52, $nF52);
            $hundredfourthF52 = $context->builder->fmul($hundredfourthF52, $nF52);
            ...
            if (null === $ov53 || null === $ninetysecondVar->longArithOverflowDoubleSlot) {
                throw new \LogicException('pow() **104 expected smul overflow metadata (ninetysecond)');
            }
            ...
            $ov53Block = BasicBlockHelper::append($context, 'pow_hundredfourth_ninetysecond_ov');
            $ok53Block = BasicBlockHelper::append($context, 'pow_hundredfourth_ninetysecond_ok');
            ...
            $hundredfourthF53 = $context->builder->fmul($ninetysecondF53, $nF53);
            $hundredfourthF53 = $context->builder->fmul($hundredfourthF53, $nF53);
            $hundredfourthF53 = $context->builder->fmul($hundredfourthF53, $nF53);
            $hundredfourthF53 = $context->builder->fmul($hundredfourthF53, $nF53);
            $hundredfourthF53 = $context->builder->fmul($hundredfourthF53, $nF53);
            $hundredfourthF53 = $context->builder->fmul($hundredfourthF53, $nF53);
            ...
            if (null === $ov54 || null === $ninetythirdVar->longArithOverflowDoubleSlot) {
                throw new \LogicException('pow() **104 expected smul overflow metadata (ninetythird)');
            }
            ...
            $ov54Block = BasicBlockHelper::append($context, 'pow_hundredfourth_ninetythird_ov');
            $ok54Block = BasicBlockHelper::append($context, 'pow_hundredfourth_ninetythird_ok');
            ...
            $hundredfourthF54 = $context->builder->fmul($ninetythirdF54, $nF54);
            $hundredfourthF54 = $context->builder->fmul($hundredfourthF54, $nF54);
            $hundredfourthF54 = $context->builder->fmul($hundredfourthF54, $nF54);
            $hundredfourthF54 = $context->builder->fmul($hundredfourthF54, $nF54);
            $hundredfourthF54 = $context->builder->fmul($hundredfourthF54, $nF54);
            $hundredfourthF54 = $context->builder->fmul($hundredfourthF54, $nF54);
            ...
            if (null === $ov55 || null === $ninetyfourthVar->longArithOverflowDoubleSlot) {
                throw new \LogicException('pow() **104 expected smul overflow metadata (ninetyfourth)');
            }
            ...
            $ov55Block = BasicBlockHelper::append($context, 'pow_hundredfourth_ninetyfourth_ov');
            $ok55Block = BasicBlockHelper::append($context, 'pow_hundredfourth_ninetyfourth_ok');
            ...
            $hundredfourthF55 = $context->builder->fmul($ninetyfourthF55, $nF55);
            $hundredfourthF55 = $context->builder->fmul($hundredfourthF55, $nF55);
            $hundredfourthF55 = $context->builder->fmul($hundredfourthF55, $nF55);
            $hundredfourthF55 = $context->builder->fmul($hundredfourthF55, $nF55);
            $hundredfourthF55 = $context->builder->fmul($hundredfourthF55, $nF55);
            $hundredfourthF55 = $context->builder->fmul($hundredfourthF55, $nF55);
            ...
            if (null === $ov56 || null === $ninetyfifthVar->longArithOverflowDoubleSlot) {
                throw new \LogicException('pow() **104 expected smul overflow metadata (ninetyfifth)');
            }
            ...
            $ov56Block = BasicBlockHelper::append($context, 'pow_hundredfourth_ninetyfifth_ov');
            $ok56Block = BasicBlockHelper::append($context, 'pow_hundredfourth_ninetyfifth_ok');
            ...
            $hundredfourthF56 = $context->builder->fmul($ninetyfifthF56, $nF56);
            $hundredfourthF56 = $context->builder->fmul($hundredfourthF56, $nF56);
            $hundredfourthF56 = $context->builder->fmul($hundredfourthF56, $nF56);
            $hundredfourthF56 = $context->builder->fmul($hundredfourthF56, $nF56);
            $hundredfourthF56 = $context->builder->fmul($hundredfourthF56, $nF56);
            $context->builder->call(
            ...
            if (null === $ov57 || null === $ninetysixthVar->longArithOverflowDoubleSlot) {
                throw new \LogicException('pow() **104 expected smul overflow metadata (ninetysixth)');
            }
            ...
            $ov57Block = BasicBlockHelper::append($context, 'pow_hundredfourth_ninetysixth_ov');
            $ok57Block = BasicBlockHelper::append($context, 'pow_hundredfourth_ninetysixth_ok');
            ...
            $hundredfourthF57 = $context->builder->fmul($ninetysixthF57, $nF57);
            $hundredfourthF57 = $context->builder->fmul($hundredfourthF57, $nF57);
            $hundredfourthF57 = $context->builder->fmul($hundredfourthF57, $nF57);
            $hundredfourthF57 = $context->builder->fmul($hundredfourthF57, $nF57);
            $hundredfourthF57 = $context->builder->fmul($hundredfourthF57, $nF57);
            $context->builder->call(
            ...
            if (null === $ov58 || null === $ninetyseventhVar->longArithOverflowDoubleSlot) {
                throw new \LogicException('pow() **104 expected smul overflow metadata (ninetyseventh)');
            }
            ...
            $ov58Block = BasicBlockHelper::append($context, 'pow_hundredfourth_ninetyseventh_ov');
            $ok58Block = BasicBlockHelper::append($context, 'pow_hundredfourth_ninetyseventh_ok');
            ...
            $hundredfourthF58 = $context->builder->fmul($ninetyseventhF58, $nF58);
            $hundredfourthF58 = $context->builder->fmul($hundredfourthF58, $nF58);
            $hundredfourthF58 = $context->builder->fmul($hundredfourthF58, $nF58);
            $hundredfourthF58 = $context->builder->fmul($hundredfourthF58, $nF58);
            $hundredfourthF58 = $context->builder->fmul($hundredfourthF58, $nF58);
            $context->builder->call(
            ...
            if (null === $ov59 || null === $ninetyeighthVar->longArithOverflowDoubleSlot) {
                throw new \LogicException('pow() **104 expected smul overflow metadata (ninetyeighth)');
            }
            ...
            $ov59Block = BasicBlockHelper::append($context, 'pow_hundredfourth_ninetyeighth_ov');
            $ok59Block = BasicBlockHelper::append($context, 'pow_hundredfourth_ninetyeighth_ok');
            ...
            $hundredfourthF59 = $context->builder->fmul($ninetyeighthF59, $nF59);
            $hundredfourthF59 = $context->builder->fmul($hundredfourthF59, $nF59);
            $hundredfourthF59 = $context->builder->fmul($hundredfourthF59, $nF59);
            $hundredfourthF59 = $context->builder->fmul($hundredfourthF59, $nF59);
            $hundredfourthF59 = $context->builder->fmul($hundredfourthF59, $nF59);
            $context->builder->call(
            ...
            if (null === $ov60 || null === $ninetyninthVar->longArithOverflowDoubleSlot) {
                throw new \LogicException('pow() **104 expected smul overflow metadata (ninetyninth)');
            }
            ...
            $ov60Block = BasicBlockHelper::append($context, 'pow_hundredfourth_ninetyninth_ov');
            $ok60Block = BasicBlockHelper::append($context, 'pow_hundredfourth_ninetyninth_ok');
            ...
            $hundredfourthF60 = $context->builder->fmul($ninetyninthF60, $nF60);
            $hundredfourthF60 = $context->builder->fmul($hundredfourthF60, $nF60);
            $hundredfourthF60 = $context->builder->fmul($hundredfourthF60, $nF60);
            $hundredfourthF60 = $context->builder->fmul($hundredfourthF60, $nF60);
            $hundredfourthF60 = $context->builder->fmul($hundredfourthF60, $nF60);
            $context->builder->call(
            ...
            if (null === $ov61 || null === $hundredthVar->longArithOverflowDoubleSlot) {
                throw new \LogicException('pow() **104 expected smul overflow metadata (hundredth)');
            }
            $hundredthLong = JITVariable::KIND_VARIABLE === $hundredthVar->kind
                ? $context->builder->load($hundredthVar->value)
                : $hundredthVar->value;
            $ov61Block = BasicBlockHelper::append($context, 'pow_hundredfourth_hundredth_ov');
            $ok61Block = BasicBlockHelper::append($context, 'pow_hundredfourth_hundredth_ok');
            ...
            $hundredfourthF61 = $context->builder->fmul($hundredthF61, $nF61);
            $hundredfourthF61 = $context->builder->fmul($hundredfourthF61, $nF61);
            $hundredfourthF61 = $context->builder->fmul($hundredfourthF61, $nF61);
            $hundredfourthF61 = $context->builder->fmul($hundredfourthF61, $nF61);
            $context->builder->call(
                $context->lookupFunction('__value__writeDouble'),
            ...
            if (null === $ov62 || null === $hundredfirstVar->longArithOverflowDoubleSlot) {
                throw new \LogicException('pow() **104 expected smul overflow metadata (hundredfirst)');
            }
            ...
            $ov62Block = BasicBlockHelper::append($context, 'pow_hundredfourth_hundredfirst_ov');
            $ok62Block = BasicBlockHelper::append($context, 'pow_hundredfourth_hundredfirst_ok');
            ...
            $hundredfourthF62 = $context->builder->fmul($hundredfirstF62, $nF62);
            $hundredfourthF62 = $context->builder->fmul($hundredfourthF62, $nF62);
            $hundredfourthF62 = $context->builder->fmul($hundredfourthF62, $nF62);
            $context->builder->call(
                $context->lookupFunction('__value__writeDouble'),
                $slotPtr,
            ...
            if (null === $ov63 || null === $hundredsecondVar->longArithOverflowDoubleSlot) {
                throw new \LogicException('pow() **104 expected smul overflow metadata (hundredsecond)');
            }
            ...
            $ov63Block = BasicBlockHelper::append($context, 'pow_hundredfourth_hundredsecond_ov');
            $ok63Block = BasicBlockHelper::append($context, 'pow_hundredfourth_hundredsecond_ok');
            ...
            $hundredfourthF63 = $context->builder->fmul($hundredsecondF63, $nF63);
            $hundredfourthF63 = $context->builder->fmul($hundredfourthF63, $nF63);
            $context->builder->call(
                $context->lookupFunction('__value__writeDouble'),
                $slotPtr,
                $hundredfourthF63
            ...
            if (null === $ov64 || null === $hundredthirdVar->longArithOverflowDoubleSlot) {
                throw new \LogicException('pow() **104 expected smul overflow metadata (hundredthird)');
            }
            ...
            $ov64Block = BasicBlockHelper::append($context, 'pow_hundredfourth_hundredthird_ov');
            $ok64Block = BasicBlockHelper::append($context, 'pow_hundredfourth_hundredthird_ok');
            ...
            $hundredfourthF64 = $context->builder->fmul($hundredthirdF64, $nF64);
            $context->builder->call(
                $context->lookupFunction('__value__writeDouble'),
                $slotPtr,
                $hundredfourthF64
