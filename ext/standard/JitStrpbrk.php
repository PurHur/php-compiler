...
final class JitStrpbrk
{
     ...
     */
    public static function find(Context $context, Value $haystack, Value $charList): Value
    {
        ...
        $listPtr = $context->builder->structGep($charList, $map['value']);
        ...
        $slice = string_trim::jitCopySlice($context, $haystack, $hayPtr, $pos, $lenAfter, 'pb'.$id);
