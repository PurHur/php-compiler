...
/** gzrewind() — rewind gzip stream (ext/zlib/zlib.c, #14585). */
final class gzrewind extends Internal
{
    public function __construct()
    {
        parent::__construct('gzrewind');
    }
    ...
    public function execute(Frame $frame): void
    {
        ...
        $frame->returnVar->bool(VmGzStream::gzrewind($handle));
    }
    ...
    public function call(Context $context, JITVariable ...$args): Value
    {
        ...
        return JitGzrewind::invoke($context, $handle);
    }
}
