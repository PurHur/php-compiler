...
/** gztell() — tell position in gzip stream (ext/zlib/zlib.c, #14585). */
final class gztell extends Internal
{
    public function __construct()
    {
        parent::__construct('gztell');
    }
    ...
    public function call(Context $context, JITVariable ...$args): Value
    {
        ...
        return JitGztell::invoke($context, $handle);
    }
}
