...
/**
 * Non-crypto hash() digests for NestedJIT/AOT (#34828, php-in-PHP).
 *
 * libcrypto EVP_get_digestbyname rejects crc32/crc32b/crc32c/adler32/fnv* — route
 * here from {@see HashCryptoJitHelper::hash} before the EVP leaf (#21026).
 *
