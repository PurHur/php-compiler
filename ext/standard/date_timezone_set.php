...
/**
 * date_timezone_set() — procedural DateTime::setTimezone wrapper (ext/date/php_date.c, #9219).
 *
...
final class date_timezone_set extends Internal
{
    ...
    {
        throw new \LogicException('date_timezone_set() is VM-only in this compiler build (issue #9219)');
    }
}
