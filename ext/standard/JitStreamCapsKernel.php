...
/**
 * JIT/AOT link for stream capability ABI via StreamCapsJitHelper PHP (#11413, #19772, #23012, #33148, #33150, #33151).
 *
 ...
 * `__compiler_stream_is_local_uri` module-locally (getNamedFunction first in
 * {@see implementSingleArgBridge} / {@see implementIfMissing}). Do not re-add empty
 * always-on shells in Type — leftover decls mint stream_isatty.1 / stream_is_local.1 /
 * stream_is_local_uri.1 (#31894 / #32122). Type::initialize still StreamCaps::ensureLinked.
 *
