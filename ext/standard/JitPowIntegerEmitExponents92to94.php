 ...
 * for ninetysecond … ninetyfourth (#36387 / #36386).
 *
 * Extracted from {@see JitPowIntegerEmitHigh} so gen-0 spine gets another TU
 * (High retains ninetyfifth … ninetyeighth).
 *
 ...
 */
final class JitPowIntegerEmitExponents92to94
{
    /**
     * @return bool true when {@code $expFold} was a 92–94 exponent and emit ran
     */
...
if ('ninetyfourth' === $expFold) {
        ...
        throw new \LogicException('JitPowIntegerEmitExponents92to94: unhandled expFold '.$expFold);
    }
}
