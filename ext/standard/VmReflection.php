...
final class VmReflection
{
     ...
     *
     * Z_PARAM_BOOL — caller strict_types → TypeError on null; else null→false + E_DEPRECATED (#31443).
     * Do not read Frame::$func for the message: builtin frames may leave it unset.
     */
