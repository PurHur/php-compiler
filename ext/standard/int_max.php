...
/**
 * max() with exactly two integer or float arguments (subset of PHP standard library).
 */
final class int_max extends Internal
{
    ...
    public function execute(Frame $frame): void
    {
        ...
        throw new \LogicException('max() only supports two integers or floats in this compiler build');
    }
