...
{
    /** @return Value __value__* (long bytes written, or boolean false on failure) */
    public static function invoke(Context $context, Value $handleLong): Value
    {
        $bytes = $context->builder->call($context->lookupFunction('__compiler_fpassthru'), $handleLong);
        $i64 = $context->getTypeFromString('int64');
        $failed = $context->builder->icmp(Builder::INT_EQ, $bytes, $i64->constInt(-1, true));
