...
/**
 * get_error_handler() — introspect active error handler (PHP 8.5, ext/standard/basic_functions.c; #17644).
 *
...
final class get_error_handler_ extends Internal
{
    ...
    public function execute(Frame $frame): void
    {
        ...
        $this->requireExactArgCount($frame, 'get_error_handler', 0);
    ...
    public function call(Context $context, JITVariable ...$args): Value
    {
        ...
        if (!$this->requireExactJitArgCount($context, $args, 'get_error_handler', 0)) {
