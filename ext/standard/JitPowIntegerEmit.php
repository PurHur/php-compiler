 ...
 * Exponents80to85/Exponents86to88/Exponents80to91/Exponents92to95/Exponents96to99/Exponents100to104/High are sibling TUs (#36387).
 *
...
require_once __DIR__.'/JitPowIntegerEmitExponents100to104.php';
...
final class JitPowIntegerEmit
{
    ...
    public static function emitIntegerPowViaMathFpow(
        ...
        if (JitPowIntegerEmitExponents96to99::tryEmitIntegerPowViaMathFpow(
            $context,
            $slotPtr,
            $base,
            $exp,
        ...
        if (JitPowIntegerEmitExponents100to104::tryEmitIntegerPowViaMathFpow(
            $context,
            $slotPtr,
            $base,
            $exp,
