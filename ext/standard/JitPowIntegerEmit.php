 ...
 * Exponents80to85/Exponents86to88/Exponents80to91/Exponents92to94/High are sibling TUs (#36387).
 *
...
require_once __DIR__.'/JitPowIntegerEmitExponents92to94.php';
...
final class JitPowIntegerEmit
{
    ...
    public static function emitIntegerPowViaMathFpow(
        ...
        if (JitPowIntegerEmitExponents92to94::tryEmitIntegerPowViaMathFpow(
            $context,
            $slotPtr,
            $base,
            $exp,
