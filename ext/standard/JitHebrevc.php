...
use PHPCompiler\JIT\Builtin\Hebrevc as HebrevcBuiltin;
...
/** LLVM lowering for hebrevc() — HebrevJitHelper in-module, no C runtime (#17183). */
final class JitHebrevc
{
    public static function invoke(Context $context, JITVariable ...$args): Value
    {
        ...
        HebrevcBuiltin::ensureLinked($context);
        $resultStr = $context->builder->call(
            HebrevcBuiltin::helperFunction($context),
            $str,
            $max
        );
