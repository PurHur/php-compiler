...
/**
 * shuffle() — Fisher–Yates on packed list arrays (subset of PHP; issue #2310).
 *
 * VM: homogeneous packed string or integer lists. JIT/AOT: in-place via ArrayBuiltinHelper.
 */
