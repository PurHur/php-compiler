...
final class fileperms extends Internal
{
    public function execute(Frame $frame): void
    {
        ...
        $path = VmString::coerceTypedStringBuiltinArg($frame->calledArgs[0], 'fileperms', 0, 'filename');
    ...
    public function call(Context $context, JITVariable ...$args): Value
    {
        ...
        $path = JitStringBuiltinArg::lowerTypedString($context, $args[0], 'fileperms', 0, 'filename');
