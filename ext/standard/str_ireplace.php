        ...
        if ($subjectIsStringish) {
            if (self::isArrayReplaceArg($args[0]) || self::isArrayReplaceArg($args[1])) {
                ...
                if (null !== $folded) {
                    ...
                    $search = JitStringBuiltinArg::lower($context, $args[0], 'str_ireplace', 0, 'search', 'array|string');
                    $replace = JitStringBuiltinArg::lower($context, $args[1], 'str_ireplace', 1, 'replace', 'array|string');
                    $subject = JitStringBuiltinArg::lower($context, $args[2], 'str_ireplace', 2, 'subject', 'array|string', null, false);
