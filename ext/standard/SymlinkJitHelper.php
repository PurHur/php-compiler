...
/**
 * symlink() for compiled JIT/AOT modules (php-in-PHP, #15544 / #33417).
 *
 * Leaf is `@symlink` → NestedJIT whitelist {@see symlink_} →
 * {@see \PHPCompiler\JIT\Builtin\StringSymlink::invokeNestedLeaf} (no kernel).
