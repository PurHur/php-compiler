...
/**
 * LLVM lowering for flock() via __compiler_flock (issue #3141; soft-null $operation #31462; Type always-on drop #33104).
 *
 * Compile-time null: soft DEP + catchable ValueError (null→0 is not LOCK_*); strict TypeError.
 * ABI owned by {@see StreamReadRuntime} / {@see JitStreamReadBridgeKernel}.
