...
/**
 * LLVM ABI bridges for stream read runtime via NestedJIT StreamReadJitHelper (#18672, #20982, #33155).
 *
 ...
 *
 * Owns `__compiler_ftruncate` module-locally (getNamedFunction first in
 * {@see implementI32Bridge}). Do not re-add empty always-on shells in Type —
 * leftover decls mint ftruncate.1 (#31894 / #32122).
 *
