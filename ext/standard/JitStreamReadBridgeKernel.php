...
/**
 * LLVM ABI bridges for stream read runtime via NestedJIT StreamReadJitHelper (#18672, #20982, #33155, #33164, #33166, #33168).
 *
 ...
 * module-locally (getNamedFunction first in {@see implementI32Bridge} / {@see implementI64Bridge} /
 * {@see implementNullableStringBridge}). Do not re-add empty always-on shells in Type —
 * leftover decls mint ftruncate.1 / ftell.1 / fgetc.1 / fgets.1 (#31894 / #32122).
 *
