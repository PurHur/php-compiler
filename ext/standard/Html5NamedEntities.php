...
/** HTML5 named character references (php-src ext/standard/html_tables.h ent_ht_html5). */
final class Html5NamedEntities
{
    ...
    private const MAP = [
        ...
        "NotEqualTilde" => "\xe2\x89\x82",
        "NotExists" => "\xe2\x88\x84",
        "NotGreater" => "\xe2\x89\xaf",
        "NotGreaterEqual" => "\xe2\x89\xb1",
        "NotGreaterFullEqual" => "\xe2\x89\xa7",
        "NotGreaterGreater" => "\xe2\x89\xab",
        "NotGreaterLess" => "\xe2\x89\xb9",
        "NotGreaterSlantEqual" => "\xe2\xa9\xbe",
        "NotGreaterTilde" => "\xe2\x89\xb5",
        "NotHumpDownHump" => "\xe2\x89\x8e",
        "NotHumpEqual" => "\xe2\x89\x8f",
        "NotLeftTriangle" => "\xe2\x8b\xaa",
        "NotLeftTriangleBar" => "\xe2\xa7\x8f",
        "NotLeftTriangleEqual" => "\xe2\x8b\xac",
        "NotLess" => "\xe2\x89\xae",
        "NotLessEqual" => "\xe2\x89\xb0",
        "NotLessGreater" => "\xe2\x89\xb8",
        "NotLessLess" => "\xe2\x89\xaa",
        "NotLessSlantEqual" => "\xe2\xa9\xbd",
        "NotLessTilde" => "\xe2\x89\xb4",
        "NotNestedGreaterGreater" => "\xe2\xaa\xa2",
        "NotNestedLessLess" => "\xe2\xaa\xa1",
        ...
        "NotRightTriangleBar" => "\xe2\xa7\x90",
        "NotRightTriangleEqual" => "\xe2\x8b\xad",
        "NotSquareSubset" => "\xe2\x8a\x8f",
        "NotSquareSubsetEqual" => "\xe2\x8b\xa2",
        "NotSquareSuperset" => "\xe2\x8a\x90",
        "NotSquareSupersetEqual" => "\xe2\x8b\xa3",
        "NotSubset" => "\xe2\x8a\x82",
        "NotSubsetEqual" => "\xe2\x8a\x88",
        "NotSucceeds" => "\xe2\x8a\x81",
        "NotSucceedsEqual" => "\xe2\xaa\xb0",
        "NotSucceedsSlantEqual" => "\xe2\x8b\xa1",
        "NotSucceedsTilde" => "\xe2\x89\xbf",
        "NotSuperset" => "\xe2\x8a\x83",
