...
/**
 * VM zlib builtins via pure PHP core (ext/zlib/zlib.c parity, issue #3194, #8837).
 *
 * JIT/AOT use {@see \PHPCompiler\JIT\Builtin\ZlibRuntime} → {@see ZlibJitHelper}; VM uses {@see VmZlibCore}.
 */
final class VmZlib
{
    ...
    {
        return VmZlibCore::gzuncompress($data, $maxLength);
    }
