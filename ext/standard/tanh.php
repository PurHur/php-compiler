...
use PHPCompiler\JIT\Builtin\MathTanh;
...
final class tanh extends Internal
{
    public function execute(Frame $frame): void
    {
        ...
        $this->requireExactArgCount($frame, 'tanh', 1);
        ...
        $frame->returnVar->float(VmMath::tanh($num));
    }
    ...
    public function call(Context $context, JITVariable ...$args): Value
    {
        ...
        if (!$this->requireExactJitArgCount($context, $args, 'tanh', 1)) {
            return $context->getTypeFromString('double')->constReal(0.0);
        }
        $asFloat = JitFdiv::lowerSingleOperand($context, $args[0], 1, 'num', 'tanh', 'float');

        return MathTanh::invoke($context, $asFloat);
    }
