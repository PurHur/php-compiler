...
/**
 * urlencode()/rawurlencode() for compiled JIT/AOT modules (#14724, #35057, php-in-PHP).
 *
 * Self-contained NestedJIT helper — must not NestedJIT {@see VmString} (thin AOT
 * segfaults when UrlencodeJitHelper only forwards; peer {@see Base64JitHelper} #35051 /
 * {@see StripslashesJitHelper} #35045 / {@see Bin2hexJitHelper} #20452).
 *
 * Length via `\strlen`; byte ordinal / emit via match tables (no native ord()/chr()).
