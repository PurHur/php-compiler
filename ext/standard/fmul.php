...
/**
 * fmul() — IEEE-754 float multiplication (PHP 8.4, ext/standard/math.c / zend_fmul).
 */
final class fmul extends Internal
{
    private const FUNCTION = 'fmul';
    ...
    public function execute(Frame $frame): void
    {
        ...
        $frame->returnVar->float(VmMath::fmul($num1, $num2));
    }
