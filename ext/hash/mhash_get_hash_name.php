...
/**
 * mhash_get_hash_name() — mhash algorithm display name
...
final class mhash_get_hash_name extends Internal
{
    ...
    public function call(Context $context, JITVariable ...$args): Value
    {
        if (1 !== \count($args)) {
            throw new \ArgumentCountError(
                \sprintf('mhash_get_hash_name() expects exactly 1 argument, %d given', \count($args))
            );
        }

        return JitMhash::getHashName($context, $args[0]);
    }
}
