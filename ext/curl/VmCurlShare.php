...
/**
 * CurlShareHandle lifecycle — PHP-owned share pool (php-src ext/curl/curl_share.c; #6322).
 *
...
final class VmCurlShare
{
    ...
    /** @var array<int, array{closed: bool, shared: array<int, true>}> */
    ...
    public static function init(Context $ctx): Variable
    {
        ...
        self::$state[$object->id] = ['closed' => false, 'shared' => []];
        $var->object($object);
    ...
    public static function setopt(ObjectEntry $share, int $option, Variable $value, Frame $frame): bool
    {
        ...
        return match ($option) {
            CurlConstants::CURLSHOPT_SHARE => self::share($share, $lockData),
            CurlConstants::CURLSHOPT_UNSHARE => self::unshare($share, $lockData),
    ...
    private static function share(ObjectEntry $share, int $lockData): bool
    {
    ...
    private static function unshare(ObjectEntry $share, int $lockData): bool
    {
