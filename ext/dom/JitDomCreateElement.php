...
final class JitDomCreateElement
{
    ...
    public static function invoke(Context $context, JITVariable ...$args): Value
    {
        ...
        if (JitDomDocumentMethodKernel::shouldUse($context)) {
            // New element is not a loadXML child-edge — drop stale firstChild attr stamps
            // so setIdAttribute cannot register a prior sibling's id (#34050 / #29257).
    ...
    private static function ensureElementPropertyLayout(
        ...
        // Public for createComment/text/CDATA/PI/entity-ref/DocumentType stand-ins that later hit appendChild (#33546/#33556/#33559/#33565).
        self::ensureDomElementStandInLayout($objectType, $classId);
    }
    ...
    public static function ensureDomElementStandInLayout(
        ...
        foreach ([
            ...
            // JitDomLiveMutationKernel::syncElementNavSlots (appendChild path).
