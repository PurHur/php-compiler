...
final class VmDomInstanceInvoke
{
    ...
    private static function dispatch(Variable $receiver, string $methodLc, Variable ...$extra): Variable
    {
        ...
        return match ($methodLc) {
            ...
            // DOMDocument::saveHTMLFile — compose saveHTML + write (#35549 / #18268).
            'savehtmlfile' => VmDomJitDispatch::saveHTMLFile($self, $extra),
            ...
            'insertadjacentelement' => VmDomJitDispatch::insertAdjacentElement($ctx, $self, $extra),
            'insertadjacenttext' => VmDomJitDispatch::insertAdjacentText($ctx, $self, $extra),
            'insertadjacenthtml' => VmDomJitDispatch::insertAdjacentHTML($ctx, $self, $extra),
            ...
            'haschildnodes' => VmDomJitDispatch::hasChildNodes($self, $extra),
            ...
            'setattributens' => VmDomJitDispatch::setAttributeNS($ctx, $self, $extra),
            'removeattribute' => VmDomJitDispatch::removeAttribute($ctx, $self, $extra),
            'removeattributens' => VmDomJitDispatch::removeAttributeNS($ctx, $self, $extra),
            ...
            'validate' => VmDomJitDispatch::validate($ctx, $self, $extra),
            'schemavalidate' => VmDomJitDispatch::schemaValidate($ctx, $self, $extra),
            'schemavalidatesource' => VmDomJitDispatch::schemaValidateSource($ctx, $self, $extra),
            'relaxngvalidate' => VmDomJitDispatch::relaxNGValidate($ctx, $self, $extra),
            'relaxngvalidatesource' => VmDomJitDispatch::relaxNGValidateSource($ctx, $self, $extra),
            'xinclude' => VmDomJitDispatch::xinclude($ctx, $self, $extra),
            'registernodeclass' => VmDomJitDispatch::registerNodeClass($ctx, $self, $extra),
            ...
            'replacedata' => VmDomJitDispatch::replaceData($self, $extra),
