...
final class JitDomAppendChildUserScript
{
    ...
    /**
     * True when {@code $node} is an Element stand-in safe to install as documentElement.
     *
     ...
     * PI / entity-ref use Zend-shaped {@code nodeName} (target / entity name) with
     * discriminator {@code tagName} {@code #pi}/{@code #entity-ref} (#33556).
     * Full stand-in layouts (#33546/#33556) make {@code tagName} safe to read.
     */
