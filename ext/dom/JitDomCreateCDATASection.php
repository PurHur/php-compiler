...
/**
 * User-script AOT materialization for DOMCdataSection (#32327).
 *
...
{
    /** Compile-time data of the last materialized CDATA stand-in (#35871 / #35098). */
    ...
    public static function invoke(Context $context, JITVariable ...$args): Value
    {
        ...
        if ($context->callerStrictTypes && JITVariable::TYPE_NULL === $args[1]->type) {
            ...
            \PHPCompiler\JIT\ExceptionBridge::emitTypeErrorAndAbort(
                $context,
                'DOMDocument::createCDATASection(): Argument #1 ($data) must be of type string, null given'
            );
    ...
    private static function ensurePropertyLayout(
        ...
        // allocate() leaves CDATA objects undersized and firstChild/documentElement empty.
