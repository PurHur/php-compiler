...
/** locale_get_primary_language() — BCP-47 language subtag (php-src ext/intl/locale/locale_methods.c; #5125). */
final class locale_get_primary_language extends Internal
{
    public function execute(Frame $frame): void
    {
        if (1 !== \count($frame->calledArgs)) {
            throw new \ArgumentCountError(
                'locale_get_primary_language() expects exactly 1 argument, '.\count($frame->calledArgs).' given'
            );
        }
