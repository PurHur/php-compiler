 ...
 * PHP implementations stay compiled in-tree but are withheld from function_exists() until
 * {@see ModuleRegistry::extensionLoaded}('intl') is true (full ext/intl parity, #11472).
 */
