...
/** locale_get_display_name() — php-src alias of Locale::getDisplayName (#20835). */
final class locale_get_display_name extends Internal
{
    public function execute(Frame $frame): void
    {
        ...
        if ($argc < 1) {
            throw new \ArgumentCountError(
                'locale_get_display_name() expects at least 1 argument, '.$argc.' given'
            );
        }
        if ($argc > 2) {
            throw new \ArgumentCountError(
