...
/**
 * intlcal_get_time() — procedural IntlCalendar alias
 * (php-src calendar_methods.c / calendar.stub.php; #20836).
 */
final class intlcal_get_time extends Internal
{
    public function __construct()
    {
        parent::__construct('intlcal_get_time');
    }
    ...
    public function execute(Frame $frame): void
    {
        ...
        if (1 !== $argc) {
            throw new \ArgumentCountError(\sprintf(
                'intlcal_get_time() expects exactly 1 argument, %d given',
                $argc
            ));
        }
        ...
        $result = VmIntlCalendar::getTime($cal);
    ...
    {
        throw new \Error('intlcal_get_time() is not implemented for JIT in this compiler build (issue #20836)');
    }
}
