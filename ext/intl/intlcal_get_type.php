...
/**
 * intlcal_get_type() — procedural IntlCalendar alias
 * (php-src calendar_methods.c / calendar.stub.php; #20836).
 */
final class intlcal_get_type extends Internal
{
    public function __construct()
    {
        parent::__construct('intlcal_get_type');
    }
    ...
    public function execute(Frame $frame): void
    {
        ...
        if (1 !== $argc) {
            throw new \ArgumentCountError(\sprintf(
                'intlcal_get_type() expects exactly 1 argument, %d given',
                $argc
            ));
        }
        ...
        $type = VmIntlCalendar::getType($cal);
    ...
    {
        throw new \Error('intlcal_get_type() is not implemented for JIT in this compiler build (issue #20836)');
    }
}
