...
/**
 * intlcal_equals() — procedural IntlCalendar alias
 * (php-src calendar_methods.c / calendar.stub.php; #20836).
 */
final class intlcal_equals extends Internal
{
    public function __construct()
    {
        parent::__construct('intlcal_equals');
    }
    ...
    public function execute(Frame $frame): void
    {
        ...
        if (2 !== $argc) {
            throw new \ArgumentCountError(\sprintf(
                'intlcal_equals() expects exactly 2 arguments, %d given',
                $argc
            ));
        }
        ...
        if (Variable::TYPE_OBJECT !== $other->type
            ...
            throw new \TypeError(\sprintf(
                'intlcal_equals(): Argument #2 ($other) must be of type IntlCalendar, %s given',
        ...
        $frame->returnVar->bool(VmIntlCalendar::equals($cal, $other->toObject()));
    }

    public function call(Context $context, JITVariable ...$args): Value
    {
        throw new \Error('intlcal_equals() is not implemented for JIT in this compiler build (issue #20836)');
    }
}
