...
/**
 * mb_detect_order() — encoding detection order (php-src ext/mbstring/mbstring.c; #13100, #29920, #35278, #35280).
 *
 * JIT/AOT via {@see JitMbDetectOrder}: omitted/null getter; compile-time string/array setter (#35278);
 * NestedJIT runtime string setter + packed module global (#35280).
 */
final class mb_detect_order extends Internal
{
    ...
    {
        return JitMbDetectOrder::invoke($context, $args);
    }
}
