 ...
 *
 * NestedJIT-safe peel (peer {@see MbStrcutJitHelper} / {@see Base64JitHelper}):
 * - No VmMbstring / MimeHeaderConvert call (those TUs miscompile under NestedJIT).
 * - No assoc arrays / foreach / preg / native base64_* / sprintf.
 * - Byte length via isset; Base64 via {@see \PHPCompiler\ext\standard\Base64JitHelper}.
 *
