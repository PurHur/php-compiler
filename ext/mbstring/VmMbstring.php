...
final class VmMbstring
{
    ...
    public static function strPad(
        ...
        // php-src mbstring.c PHP_FUNCTION(mb_str_pad) — same pad_string wording as str_pad (#29755 / #29422)
        if ('' === $padString) {
            throw new \ValueError(VmString::strPadEmptyPadStringValueErrorMessage('mb_str_pad'));
        }
    ...
    public static function encodeMimeheader(
        ...
        return MimeHeaderConvert::encode($str, $charset, $base64, $linefeed, $indent);
    }
    ...
    {
        return MimeHeaderConvert::decode($str);
    }
