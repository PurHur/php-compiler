...
final class mb_strimwidth extends Internal
{
    ...
    public function execute(Frame $frame): void
    {
        ...
        $string = VmString::trimFamilyStringArgForFrame($frame, 0, 'mb_strimwidth', 0, 'string');
        ...
        $trimmarker = isset($frame->calledArgs[3])
            ? VmString::coerceStringBuiltinArg($frame->calledArgs[3], 'mb_strimwidth', 3, 'trim_marker')
            : '';
