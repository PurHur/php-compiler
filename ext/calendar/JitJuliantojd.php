...
use PHPCompiler\JIT\Builtin\JuliantojdRuntime;
use PHPCompiler\JIT\Context;
use PHPCompiler\JIT\Variable as JITVariable;
use PHPLLVM\Value;

/** LLVM lowering for juliantojd() via JuliantojdRuntime (#27384). */
final class JitJuliantojd
{
    public static function invoke(Context $context, JITVariable ...$args): Value
    {
        ...
        $month = JitChr::lowerZParamLongArg($context, $args[0], 'juliantojd', 1, 'month');
        $day = JitChr::lowerZParamLongArg($context, $args[1], 'juliantojd', 2, 'day');
        $year = JitChr::lowerZParamLongArg($context, $args[2], 'juliantojd', 3, 'year');

        return JuliantojdRuntime::invoke($context, $month, $day, $year);
    }
    ...
    private static function tryFoldCompileTime(Context $context, array $args): ?Value
    {
        ...
        $jd = JuliantojdJitHelper::juliantojdArgv($month, $day, $year);
    ...
    private static function compileTimeLongArg(
        ...
        if (self::isCompileTimeNull($arg)) {
            ...
            JitIntdiv::emitNullIntDeprecation($context, 'juliantojd', $userArgIndex, $paramName);
