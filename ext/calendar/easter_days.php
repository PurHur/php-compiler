...
final class easter_days extends Internal
{
    ...
    {
        parent::__construct('easter_days');
    }
    ...
    public function execute(Frame $frame): void
    {
        ...
        if ($argc > 2) {
            throw new \ArgumentCountError('easter_days() accepts at most 2 arguments, '.$argc.' given');
        }
    ...
    private static function resolveYear(Frame $frame): int
    {
        ...
        if (Variable::TYPE_INTEGER !== $var->type) {
            throw new \TypeError(\sprintf(
                'easter_days(): Argument #1 ($year) must be of type ?int, %s given',
