...
use PHPCompiler\JIT\Builtin\JdtogregorianRuntime;
use PHPCompiler\JIT\Context;
use PHPCompiler\JIT\Variable as JITVariable;
use PHPLLVM\Value;

/** LLVM lowering for jdtogregorian() via JdtogregorianRuntime (#27355). */
final class JitJdtogregorian
{
    public static function invoke(Context $context, JITVariable ...$args): Value
    {
        ...
        $julday = JitChr::lowerZParamLongArg($context, $args[0], 'jdtogregorian', 1, 'julian_day');

        return JdtogregorianRuntime::invoke($context, $julday);
    }
    ...
    private static function tryFoldCompileTime(Context $context, JITVariable $arg): ?Value
    {
        ...
        $result = JdtogregorianJitHelper::jdtogregorianArgv($julday);
    ...
    private static function compileTimeLongArg(Context $context, JITVariable $arg): ?int
    {
        if (self::isCompileTimeNull($arg)) {
            ...
            JitIntdiv::emitNullIntDeprecation($context, 'jdtogregorian', 1, 'julian_day');
