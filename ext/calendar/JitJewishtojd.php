...
use PHPCompiler\JIT\Builtin\JewishtojdRuntime;
use PHPCompiler\JIT\Context;
use PHPCompiler\JIT\Variable as JITVariable;
use PHPLLVM\Value;

/** LLVM lowering for jewishtojd() via JewishtojdRuntime (#27357). */
final class JitJewishtojd
{
    public static function invoke(Context $context, JITVariable ...$args): Value
    {
        ...
        $month = JitChr::lowerZParamLongArg($context, $args[0], 'jewishtojd', 1, 'month');
        $day = JitChr::lowerZParamLongArg($context, $args[1], 'jewishtojd', 2, 'day');
        $year = JitChr::lowerZParamLongArg($context, $args[2], 'jewishtojd', 3, 'year');

        return JewishtojdRuntime::invoke($context, $month, $day, $year);
    }
    ...
    private static function tryFoldCompileTime(Context $context, array $args): ?Value
    {
        ...
        $jd = JewishtojdJitHelper::jewishtojdArgv($month, $day, $year);
    ...
    private static function compileTimeLongArg(
        ...
        if (self::isCompileTimeNull($arg)) {
            ...
            JitIntdiv::emitNullIntDeprecation($context, 'jewishtojd', $userArgIndex, $paramName);
