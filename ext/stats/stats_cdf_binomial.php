...
/** stats_cdf_binomial() — PECL stats CDF (#29648). */
final class stats_cdf_binomial extends StatsFunction
{
    public function __construct()
    {
        parent::__construct('stats_cdf_binomial');
    }
    ...
    protected function compute(Frame $frame): float|int|bool
    {
        ...
        if (4 !== $argc) {
            throw new \ArgumentCountError(
                'stats_cdf_binomial() expects exactly 4 arguments, '.$argc.' given'
            );
        }
