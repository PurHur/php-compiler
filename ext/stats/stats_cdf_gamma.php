...
/** stats_cdf_gamma() — PECL stats CDF (#29588). */
final class stats_cdf_gamma extends StatsFunction
{
    public function __construct()
    {
        parent::__construct('stats_cdf_gamma');
    }
    ...
    protected function compute(Frame $frame): float|int|bool
    {
        ...
        if (4 !== $argc) {
            throw new \ArgumentCountError(
                'stats_cdf_gamma() expects exactly 4 arguments, '.$argc.' given'
            );
        }
