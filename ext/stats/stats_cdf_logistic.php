...
/** stats_cdf_logistic() — PECL stats CDF (#29648). */
final class stats_cdf_logistic extends StatsFunction
{
    public function __construct()
    {
        parent::__construct('stats_cdf_logistic');
    }
    ...
    protected function compute(Frame $frame): float|int|bool
    {
        ...
        if (4 !== $argc) {
            throw new \ArgumentCountError(
                'stats_cdf_logistic() expects exactly 4 arguments, '.$argc.' given'
            );
        }
