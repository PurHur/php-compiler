...
/** stats_cdf_t() — PECL stats CDF (#29588). */
final class stats_cdf_t extends StatsFunction
{
    public function __construct()
    {
        parent::__construct('stats_cdf_t');
    }
    ...
    protected function compute(Frame $frame): float|int|bool
    {
        ...
        if (3 !== $argc) {
            throw new \ArgumentCountError(
                'stats_cdf_t() expects exactly 3 arguments, '.$argc.' given'
            );
        }
