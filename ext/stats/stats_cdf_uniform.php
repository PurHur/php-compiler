...
/** stats_cdf_uniform() — PECL stats CDF (#29648). */
final class stats_cdf_uniform extends StatsFunction
{
    public function __construct()
    {
        parent::__construct('stats_cdf_uniform');
    }
    ...
    protected function compute(Frame $frame): float|int|bool
    {
        ...
        if (4 !== $argc) {
            throw new \ArgumentCountError(
                'stats_cdf_uniform() expects exactly 4 arguments, '.$argc.' given'
            );
        }
