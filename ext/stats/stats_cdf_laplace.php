...
/** stats_cdf_laplace() — PECL stats CDF (#29648). */
final class stats_cdf_laplace extends StatsFunction
{
    public function __construct()
    {
        parent::__construct('stats_cdf_laplace');
    }
    ...
    protected function compute(Frame $frame): float|int|bool
    {
        ...
        if (4 !== $argc) {
            throw new \ArgumentCountError(
                'stats_cdf_laplace() expects exactly 4 arguments, '.$argc.' given'
            );
        }
