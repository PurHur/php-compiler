...
/** stats_cdf_beta() — PECL stats CDF (#29621). */
final class stats_cdf_beta extends StatsFunction
{
    public function __construct()
    {
        parent::__construct('stats_cdf_beta');
    }
    ...
    protected function compute(Frame $frame): float|int|bool
    {
        ...
        if (4 !== $argc) {
            throw new \ArgumentCountError(
                'stats_cdf_beta() expects exactly 4 arguments, '.$argc.' given'
            );
        }
