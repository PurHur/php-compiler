...
/** stats_cdf_f() — PECL stats CDF (#29621). */
final class stats_cdf_f extends StatsFunction
{
    public function __construct()
    {
        parent::__construct('stats_cdf_f');
    }
    ...
    protected function compute(Frame $frame): float|int|bool
    {
        ...
        if (4 !== $argc) {
            throw new \ArgumentCountError(
                'stats_cdf_f() expects exactly 4 arguments, '.$argc.' given'
            );
        }
