...
/**
 * openssl_x509_export() — export certificate PEM (php-src ext/openssl/openssl.c; #20273 VM, JIT/AOT #32557).
 */
final class openssl_x509_export extends Internal
{
    ...
    public function call(Context $context, JITVariable ...$args): Value
    {
        ...
        return JitOpensslX509::export($context, $args[0], $args[1], $args[2] ?? null);
    }
}
