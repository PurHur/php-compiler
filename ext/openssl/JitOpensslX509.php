 ...
 * openssl_pkey_derive() (#32852 leftover of #15428),
 * openssl_spki_verify() (#32776 leftover of #8690),
 * openssl_spki_export() (#32787 leftover of #6423),
 * openssl_spki_export_challenge() (#32792 leftover of #6423), and
 ...
 * php-src: ext/openssl/openssl.c — PHP_FUNCTION(openssl_spki_new) / NETSCAPE_SPKI_new + NETSCAPE_SPKI_sign
 *
...
final class JitOpensslX509
{
     ...
     * NETSCAPE_SPKI_new + NETSCAPE_SPKI_sign
     * Private key must be a compile-time PEM string (OpenSSLAsymmetricKey objects stay VM-only).
     * Optional digest defaults to OPENSSL_ALGO_MD5 (php-src).
     */
    public static function spkiNew(
        ...
        if (null !== $digestAlgo) {
            ...
            if (null !== $algoInt) {
                ...
                if (null === $algoStr) {
                    throw new \LogicException(
                        'openssl_spki_new() digest_algo must be a compile-time int|string '
                        .'for JIT/AOT in this compiler build (issue #32892)'
                    );
                }
                $algorithm = $algoStr;
