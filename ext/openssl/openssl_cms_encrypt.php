...
/**
 * openssl_cms_encrypt() — CMS/S/MIME encrypt (php-src ext/openssl/openssl.c; #6592 VM, JIT/AOT #33472).
 */
final class openssl_cms_encrypt extends Internal
{
    ...
    public function call(Context $context, JITVariable ...$args): Value
    {
        if (\count($args) < 4) {
            throw new \ArgumentCountError(
                'openssl_cms_encrypt() expects at least 4 arguments, '.\count($args).' given'
            );
        }
