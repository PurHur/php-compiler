...
/**
 * openssl_public_decrypt() — asymmetric public-key decryption (php-src ext/openssl/xp.c; #6666).
 */
final class openssl_public_decrypt extends Internal
{
    ...
    public function call(Context $context, JITVariable ...$args): Value
    {
        throw new \LogicException(
            'openssl_public_decrypt() is not implemented for JIT in this compiler build (issue #6666)'
        );
    }
}
