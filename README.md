...
**Snapshot (2026-09-04, from [`docs/status-snapshot.json`](docs/status-snapshot.json)):** self-host spine **8149** / **8149** · capability matrix **4054** rows (VM yes **4021**, JIT **1885**, AOT **1739**) · differential cases **277** · apps corpus **1**/**12** ready · VM driver probe target ~**20**ms
