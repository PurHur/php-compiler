...
**Snapshot (2026-09-07, from [`docs/status-snapshot.json`](docs/status-snapshot.json)):** self-host spine **8382** / **8382** · capability matrix **4054** rows (VM yes **4021**, JIT **1883**, AOT **1737**) · differential cases **347** · apps corpus **1**/**12** ready · VM driver probe target ~**20**ms · local CI streak **4**d ([#36401](https://github.com/PurHur/php-compiler/issues/36401))
