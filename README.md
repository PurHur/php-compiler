...
| Self-host **M0–M1** | ✅ |
| Self-host **M2** spine | 🚧 **595** / 603 units ([#1492](https://github.com/PurHur/php-compiler/issues/1492), [#1922](https://github.com/PurHur/php-compiler/issues/1922)) |
...
| [005-SessionsWeb](examples/005-SessionsWeb/) | ✅ `phpc serve` + session smoke ([#1881](https://github.com/PurHur/php-compiler/issues/1881), [#1887](https://github.com/PurHur/php-compiler/issues/1887)) | ✅ `phpc build` ([#1891](https://github.com/PurHur/php-compiler/issues/1891)) | ✅ AOT execute (`SESSIONS_WEB_AOT_SMOKE_GATE=1`, [#1891](https://github.com/PurHur/php-compiler/issues/1891)) | 📋 deploy ([#1893](https://github.com/PurHur/php-compiler/issues/1893)) |
...
| **M2 — Full top-level `lib/` + spine** | All **14** top-level `lib/*.php` lint ✅; **`compiler_lib_spine_smoke`** (**595** / **603** inventory units) native link ✅; grow toward full `bin/vm.php` path | 🚧 ~99% of inventory |
...
| Gate | Command | Status |
|------|---------|--------|
| Phase A inventory | `php script/bootstrap-inventory.php --check` | ✅ **603** files; **0** blockers |
