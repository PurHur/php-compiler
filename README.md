...
| Self-host **M0–M1** | ✅ |
| Self-host **M2** spine | 🚧 **661** / 664 units ([#1492](https://github.com/PurHur/php-compiler/issues/1492), [#2126](https://github.com/PurHur/php-compiler/issues/2126)) |
...
| **M2 — Full top-level `lib/` + spine** | All **14** top-level `lib/*.php` lint ✅; **`compiler_lib_spine_smoke`** (**661** / **664** inventory units; 3 deferred) native link ✅; grow toward full `bin/vm.php` path | 🚧 100% inventory coverage (cli shim substitutes) |
