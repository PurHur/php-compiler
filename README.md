...
**Snapshot (2026-09-04, from [`docs/status-snapshot.json`](docs/status-snapshot.json)):** self-host spine **8149** / **8149** · capability matrix **4054** rows (VM yes **4021**, JIT **1885**, AOT **1739**) · differential cases **278** · apps corpus **1**/**12** ready · VM driver probe target ~**20**ms · local CI streak **1**d ([#36401](https://github.com/PurHur/php-compiler/issues/36401))
...
| **M2** | ✅ **8149** / **8149** | Full Phase A inventory in spine smoke |
