...
**Snapshot (Jul 2026, `master` — v1.1.0 prep):** VM + AOT for shipped examples ✅ · examples web smoke ✅ · self-host spine **8040** / **8040** · **1555** builtins · M5 fast ✅ / strict 🚧 · M3/M4 emit = blob copy ([#21860](https://github.com/PurHur/php-compiler/issues/21860)) · VM probe ~**20ms**
...
| **Self-host north star** | 🚧 ~65% | M3/M4 emit paths are blob copies ([#21860](https://github.com/PurHur/php-compiler/issues/21860)); `--strict` red; spine **8040** / **8040**; vendor prelink **7410/7412** ([#1492](https://github.com/PurHur/php-compiler/issues/1492)) |
...
| **M2** | ✅ **8040** / **8040** | Full Phase A inventory in spine smoke; native link + lint ✅ |
