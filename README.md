...
**Snapshot (2026-09-09, from [`docs/status-snapshot.json`](docs/status-snapshot.json)):** self-host spine **8585** / **8585** · capability matrix **4054** rows (VM yes **4021**, JIT **1472**, AOT **1326**) · differential cases **446** · apps corpus **1**/**12** ready · VM driver probe target ~**20**ms · local CI streak **6**d ([#36401](https://github.com/PurHur/php-compiler/issues/36401))
...
| **M2** | ✅ **8585** / **8585** | Full Phase A inventory in spine smoke |
