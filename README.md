...
| Self-host **M0–M1** | ✅ |
| Self-host **M2** spine | 🚧 **594** / 606 units ([#1492](https://github.com/PurHur/php-compiler/issues/1492), [#1922](https://github.com/PurHur/php-compiler/issues/1922)) |
...
| [006-FileUploadWeb](examples/006-FileUploadWeb/) | ✅ `phpc serve` + multipart smoke ([#1999](https://github.com/PurHur/php-compiler/issues/1999), [#2009](https://github.com/PurHur/php-compiler/issues/2009)) | ✅ opt-in `FILE_UPLOAD_WEB_AOT_LINK_GATE=1` | ✅ opt-in `FILE_UPLOAD_WEB_AOT_SMOKE_GATE=1` | — |
...
| **M2 — Full top-level `lib/` + spine** | All **14** top-level `lib/*.php` lint ✅; **`compiler_lib_spine_smoke`** (**594** / **606** inventory units) native link ✅; grow toward full `bin/vm.php` path | 🚧 ~99% of inventory |
