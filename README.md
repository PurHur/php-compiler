...
**Snapshot (2026-09-06, from [`docs/status-snapshot.json`](docs/status-snapshot.json)):** self-host spine **8334** / **8334** · capability matrix **4054** rows (VM yes **4021**, JIT **1883**, AOT **1737**) · differential cases **342** · apps corpus **1**/**12** ready · VM driver probe target ~**20**ms · local CI streak **3**d ([#36401](https://github.com/PurHur/php-compiler/issues/36401))
...
| **M2** | ✅ **8334** / **8334** | Full Phase A inventory in spine smoke |
