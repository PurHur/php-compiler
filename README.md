...
./phpc init --profile sessionsweb my-app  # Session flash flat layout (see examples/005-SessionsWeb/)
...
| `phpc init` | Scaffold `phpc.json`; `--profile miniwebapp` or `sessionsweb` ([#632](https://github.com/PurHur/php-compiler/issues/632), [#1886](https://github.com/PurHur/php-compiler/issues/1886)) |
