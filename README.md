...
| Bundled compiler native | `./script/bootstrap-selfhost-link.sh` | ❌ LLVM segfault in JIT of `Block::findSlot` (array `scopeOperandBySlot` / `__value__`); [#552](https://github.com/PurHur/php-compiler/pull/552) |
