...
| **M2 — Full top-level `lib/` + spine** | All **14** top-level `lib/*.php` lint ✅; **`compiler_lib_spine_smoke`** (**440** / **586** inventory units) native link ✅; grow toward full `bin/vm.php` path | 🚧 ~75% of inventory |
