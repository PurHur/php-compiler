...
| **M2 — Full top-level `lib/` + spine** | All **14** top-level `lib/*.php` lint ✅; **`compiler_lib_spine_smoke`** (**579** / **586** inventory units) native link ✅; grow toward full `bin/vm.php` path | 🚧 ~99% of inventory |
