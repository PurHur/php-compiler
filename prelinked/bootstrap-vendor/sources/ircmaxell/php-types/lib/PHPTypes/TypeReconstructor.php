...
class TypeReconstructor
{
    ...
    protected function resolveOp_Expr_ArrowFunction(Operand $var, Op\Expr\ArrowFunction $op, SplObjectStorage $resolved)
    {
        return [new Type(Type::TYPE_OBJECT, [], 'Closure')];
    }
