...
interface illvm {}
class llvm {
    const SOFILE = '/usr/lib/llvm-9/lib/libLLVM-9.so.1';
...
';
    ...
    // typedefenum LLVMUnnamedAddr
    const LLVMNoUnnamedAddr = (0) + 0;
    const LLVMLocalUnnamedAddr = (0) + 1;
    const LLVMGlobalUnnamedAddr = (0) + 2;
    ...
    const LLVMGHCCallConv = (10) + 0;
    const LLVMHiPECallConv = (11) + 0;
    const LLVMWebKitJSCallConv = (12) + 0;
    const LLVMAnyRegCallConv = (13) + 0;
    const LLVMPreserveMostCallConv = (14) + 0;
    const LLVMPreserveAllCallConv = (15) + 0;
    const LLVMSwiftCallConv = (16) + 0;
    const LLVMCXXFASTTLSCallConv = (17) + 0;
    const LLVMX86StdcallCallConv = (64) + 0;
    const LLVMX86FastcallCallConv = (65) + 0;
    const LLVMARMAPCSCallConv = (66) + 0;
    const LLVMARMAAPCSCallConv = (67) + 0;
    const LLVMARMAAPCSVFPCallConv = (68) + 0;
    const LLVMMSP430INTRCallConv = (69) + 0;
    const LLVMX86ThisCallCallConv = (70) + 0;
    const LLVMPTXKernelCallConv = (71) + 0;
    const LLVMPTXDeviceCallConv = (72) + 0;
    const LLVMSPIRFUNCCallConv = (75) + 0;
    const LLVMSPIRKERNELCallConv = (76) + 0;
    const LLVMIntelOCLBICallConv = (77) + 0;
    const LLVMX8664SysVCallConv = (78) + 0;
    const LLVMWin64CallConv = (79) + 0;
    const LLVMX86VectorCallCallConv = (80) + 0;
    const LLVMHHVMCallConv = (81) + 0;
    const LLVMHHVMCCallConv = (82) + 0;
    const LLVMX86INTRCallConv = (83) + 0;
    const LLVMAVRINTRCallConv = (84) + 0;
    const LLVMAVRSIGNALCallConv = (85) + 0;
    const LLVMAVRBUILTINCallConv = (86) + 0;
    const LLVMAMDGPUVSCallConv = (87) + 0;
    const LLVMAMDGPUGSCallConv = (88) + 0;
    const LLVMAMDGPUPSCallConv = (89) + 0;
    const LLVMAMDGPUCSCallConv = (90) + 0;
    const LLVMAMDGPUKERNELCallConv = (91) + 0;
    const LLVMX86RegCallCallConv = (92) + 0;
    const LLVMAMDGPUHSCallConv = (93) + 0;
    const LLVMMSP430BUILTINCallConv = (94) + 0;
    const LLVMAMDGPULSCallConv = (95) + 0;
    const LLVMAMDGPUESCallConv = (96) + 0;
    ...
    // typedefenum LLVMInlineAsmDialect
    const LLVMInlineAsmDialectATT = (0) + 0;
    const LLVMInlineAsmDialectIntel = (0) + 1;
    // typedefenum LLVMModuleFlagBehavior
    const LLVMModuleFlagBehaviorError = (0) + 0;
    const LLVMModuleFlagBehaviorWarning = (0) + 1;
    const LLVMModuleFlagBehaviorRequire = (0) + 2;
    const LLVMModuleFlagBehaviorOverride = (0) + 3;
    const LLVMModuleFlagBehaviorAppend = (0) + 4;
    const LLVMModuleFlagBehaviorAppendUnique = (0) + 5;
    ...
    public function LLVMContextShouldDiscardValueNames(?LLVMContextRef $p0): ?int {
        $result = $this->ffi->LLVMContextShouldDiscardValueNames($p0 === null ? null : $p0->getData());
        return $result;
    }
    public function LLVMContextSetDiscardValueNames(?LLVMContextRef $p0, ?int $p1): void {
        $this->ffi->LLVMContextSetDiscardValueNames($p0 === null ? null : $p0->getData(), $p1);
    }
    ...
    public function LLVMGetStringAttributeKind(?LLVMAttributeRef $p0, ?int_ptr $p1): ?string_ {
        $result = $this->ffi->LLVMGetStringAttributeKind($p0 === null ? null : $p0->getData(), $p1 === null ? null : $p1->getData());
        return $result === null ? null : new string_($result);
    }
    public function LLVMGetStringAttributeValue(?LLVMAttributeRef $p0, ?int_ptr $p1): ?string_ {
    ...
    public function LLVMGetSourceFileName(?LLVMModuleRef $p0, ?int_ptr $p1): ?string_ {
    ...
    public function LLVMGetDataLayoutStr(?LLVMModuleRef $p0): ?string_ {
        $result = $this->ffi->LLVMGetDataLayoutStr($p0 === null ? null : $p0->getData());
        return $result === null ? null : new string_($result);
    }
    public function LLVMGetDataLayout(?LLVMModuleRef $p0): ?string_ {
    ...
    public function LLVMGetTarget(?LLVMModuleRef $p0): ?string_ {
    ...
    public function LLVMDisposeModuleFlagsMetadata(?LLVMModuleFlagEntry_ptr $p0): void {
        $this->ffi->LLVMDisposeModuleFlagsMetadata($p0 === null ? null : $p0->getData());
    }
    public function LLVMModuleFlagEntriesGetFlagBehavior(?LLVMModuleFlagEntry_ptr $p0, ?int $p1): ?int {
        $result = $this->ffi->LLVMModuleFlagEntriesGetFlagBehavior($p0 === null ? null : $p0->getData(), $p1);
        return $result;
    }
    public function LLVMModuleFlagEntriesGetKey(?LLVMModuleFlagEntry_ptr $p0, ?int $p1, ?int_ptr $p2): ?string_ {
        $result = $this->ffi->LLVMModuleFlagEntriesGetKey($p0 === null ? null : $p0->getData(), $p1, $p2 === null ? null : $p2->getData());
        return $result === null ? null : new string_($result);
    }
    public function LLVMModuleFlagEntriesGetMetadata(?LLVMModuleFlagEntry_ptr $p0, ?int $p1): ?LLVMMetadataRef {
    ...
    public function LLVMGetModuleInlineAsm(?LLVMModuleRef $p0, ?int_ptr $p1): ?string_ {
    ...
    public function LLVMGetFirstNamedMetadata(?LLVMModuleRef $p0): ?LLVMNamedMDNodeRef {
        $result = $this->ffi->LLVMGetFirstNamedMetadata($p0 === null ? null : $p0->getData());
        return $result === null ? null : new LLVMNamedMDNodeRef($result);
    }
    public function LLVMGetLastNamedMetadata(?LLVMModuleRef $p0): ?LLVMNamedMDNodeRef {
        $result = $this->ffi->LLVMGetLastNamedMetadata($p0 === null ? null : $p0->getData());
        return $result === null ? null : new LLVMNamedMDNodeRef($result);
    }
    public function LLVMGetNextNamedMetadata(?LLVMNamedMDNodeRef $p0): ?LLVMNamedMDNodeRef {
        $result = $this->ffi->LLVMGetNextNamedMetadata($p0 === null ? null : $p0->getData());
        return $result === null ? null : new LLVMNamedMDNodeRef($result);
    }
    public function LLVMGetPreviousNamedMetadata(?LLVMNamedMDNodeRef $p0): ?LLVMNamedMDNodeRef {
    ...
    public function LLVMGetNamedMetadataName(?LLVMNamedMDNodeRef $p0, ?int_ptr $p1): ?string_ {
    ...
    public function LLVMGetDebugLocDirectory(?LLVMValueRef $p0, ?int_ptr $p1): ?string_ {
        $result = $this->ffi->LLVMGetDebugLocDirectory($p0 === null ? null : $p0->getData(), $p1 === null ? null : $p1->getData());
        return $result === null ? null : new string_($result);
    }
    public function LLVMGetDebugLocFilename(?LLVMValueRef $p0, ?int_ptr $p1): ?string_ {
        $result = $this->ffi->LLVMGetDebugLocFilename($p0 === null ? null : $p0->getData(), $p1 === null ? null : $p1->getData());
        return $result === null ? null : new string_($result);
    }
    public function LLVMGetDebugLocLine(?LLVMValueRef $p0): ?int {
        $result = $this->ffi->LLVMGetDebugLocLine($p0 === null ? null : $p0->getData());
        return $result;
    }
    public function LLVMGetDebugLocColumn(?LLVMValueRef $p0): ?int {
        $result = $this->ffi->LLVMGetDebugLocColumn($p0 === null ? null : $p0->getData());
        return $result;
    }
    ...
    public function LLVMGetStructName(?LLVMTypeRef $p0): ?string_ {
    ...
    public function LLVMIsLiteralStruct(?LLVMTypeRef $p0): ?int {
        $result = $this->ffi->LLVMIsLiteralStruct($p0 === null ? null : $p0->getData());
        return $result;
    }
    ...
    public function LLVMGetSubtypes(?LLVMTypeRef $p0, ?LLVMTypeRef_ptr $p1): void {
        $this->ffi->LLVMGetSubtypes($p0 === null ? null : $p0->getData(), $p1 === null ? null : $p1->getData());
    }
    public function LLVMGetNumContainedTypes(?LLVMTypeRef $p0): ?int {
        $result = $this->ffi->LLVMGetNumContainedTypes($p0 === null ? null : $p0->getData());
        return $result;
    }
    ...
    public function LLVMTokenTypeInContext(?LLVMContextRef $p0): ?LLVMTypeRef {
        $result = $this->ffi->LLVMTokenTypeInContext($p0 === null ? null : $p0->getData());
        return $result === null ? null : new LLVMTypeRef($result);
    }
    public function LLVMMetadataTypeInContext(?LLVMContextRef $p0): ?LLVMTypeRef {
        $result = $this->ffi->LLVMMetadataTypeInContext($p0 === null ? null : $p0->getData());
        return $result === null ? null : new LLVMTypeRef($result);
    }
    ...
    public function LLVMGetValueName2(?LLVMValueRef $p0, ?int_ptr $p1): ?string_ {
    ...
    public function LLVMIsAGlobalIFunc(?LLVMValueRef $p0): ?LLVMValueRef {
        $result = $this->ffi->LLVMIsAGlobalIFunc($p0 === null ? null : $p0->getData());
        return $result === null ? null : new LLVMValueRef($result);
    }
    ...
    public function LLVMIsADbgVariableIntrinsic(?LLVMValueRef $p0): ?LLVMValueRef {
        $result = $this->ffi->LLVMIsADbgVariableIntrinsic($p0 === null ? null : $p0->getData());
        return $result === null ? null : new LLVMValueRef($result);
    }
    ...
    public function LLVMIsADbgLabelInst(?LLVMValueRef $p0): ?LLVMValueRef {
        $result = $this->ffi->LLVMIsADbgLabelInst($p0 === null ? null : $p0->getData());
        return $result === null ? null : new LLVMValueRef($result);
    }
    ...
    public function LLVMGetValueName(?LLVMValueRef $p0): ?string_ {
    ...
    public function LLVMGetAsString(?LLVMValueRef $p0, ?int_ptr $p1): ?string_ {
    ...
    public function LLVMGetSection(?LLVMValueRef $p0): ?string_ {
    ...
    public function LLVMGetUnnamedAddress(?LLVMValueRef $p0): ?int {
        $result = $this->ffi->LLVMGetUnnamedAddress($p0 === null ? null : $p0->getData());
        return $result;
    }
    public function LLVMSetUnnamedAddress(?LLVMValueRef $p0, ?int $p1): void {
        $this->ffi->LLVMSetUnnamedAddress($p0 === null ? null : $p0->getData(), $p1);
    }
    public function LLVMGlobalGetValueType(?LLVMValueRef $p0): ?LLVMTypeRef {
        $result = $this->ffi->LLVMGlobalGetValueType($p0 === null ? null : $p0->getData());
        return $result === null ? null : new LLVMTypeRef($result);
    }
    ...
    public function LLVMGlobalSetMetadata(?LLVMValueRef $p0, ?int $p1, ?LLVMMetadataRef $p2): void {
        $this->ffi->LLVMGlobalSetMetadata($p0 === null ? null : $p0->getData(), $p1, $p2 === null ? null : $p2->getData());
    }
    public function LLVMGlobalEraseMetadata(?LLVMValueRef $p0, ?int $p1): void {
        $this->ffi->LLVMGlobalEraseMetadata($p0 === null ? null : $p0->getData(), $p1);
    }
    ...
    public function LLVMDisposeValueMetadataEntries(?LLVMValueMetadataEntry_ptr $p0): void {
        $this->ffi->LLVMDisposeValueMetadataEntries($p0 === null ? null : $p0->getData());
    }
    public function LLVMValueMetadataEntriesGetKind(?LLVMValueMetadataEntry_ptr $p0, ?int $p1): ?int {
        $result = $this->ffi->LLVMValueMetadataEntriesGetKind($p0 === null ? null : $p0->getData(), $p1);
        return $result;
    }
    public function LLVMValueMetadataEntriesGetMetadata(?LLVMValueMetadataEntry_ptr $p0, ?int $p1): ?LLVMMetadataRef {
        $result = $this->ffi->LLVMValueMetadataEntriesGetMetadata($p0 === null ? null : $p0->getData(), $p1);
        return $result === null ? null : new LLVMMetadataRef($result);
    }
    ...
    public function LLVMGetFirstGlobalAlias(?LLVMModuleRef $p0): ?LLVMValueRef {
        $result = $this->ffi->LLVMGetFirstGlobalAlias($p0 === null ? null : $p0->getData());
        return $result === null ? null : new LLVMValueRef($result);
    }
    public function LLVMGetLastGlobalAlias(?LLVMModuleRef $p0): ?LLVMValueRef {
        $result = $this->ffi->LLVMGetLastGlobalAlias($p0 === null ? null : $p0->getData());
        return $result === null ? null : new LLVMValueRef($result);
    }
    public function LLVMGetNextGlobalAlias(?LLVMValueRef $p0): ?LLVMValueRef {
        $result = $this->ffi->LLVMGetNextGlobalAlias($p0 === null ? null : $p0->getData());
        return $result === null ? null : new LLVMValueRef($result);
    }
    public function LLVMGetPreviousGlobalAlias(?LLVMValueRef $p0): ?LLVMValueRef {
        $result = $this->ffi->LLVMGetPreviousGlobalAlias($p0 === null ? null : $p0->getData());
        return $result === null ? null : new LLVMValueRef($result);
    }
    public function LLVMAliasGetAliasee(?LLVMValueRef $p0): ?LLVMValueRef {
        $result = $this->ffi->LLVMAliasGetAliasee($p0 === null ? null : $p0->getData());
        return $result === null ? null : new LLVMValueRef($result);
    }
    public function LLVMAliasSetAliasee(?LLVMValueRef $p0, ?LLVMValueRef $p1): void {
        $this->ffi->LLVMAliasSetAliasee($p0 === null ? null : $p0->getData(), $p1 === null ? null : $p1->getData());
    }
    ...
    public function LLVMIntrinsicGetName(?int $p0, ?int_ptr $p1): ?string_ {
        $result = $this->ffi->LLVMIntrinsicGetName($p0, $p1 === null ? null : $p1->getData());
        return $result === null ? null : new string_($result);
    }
    public function LLVMIntrinsicCopyOverloadedName(?int $p0, ?LLVMTypeRef_ptr $p1, ?int $p2, ?int_ptr $p3): ?string_ {
    ...
    public function LLVMIntrinsicIsOverloaded(?int $p0): ?int {
        $result = $this->ffi->LLVMIntrinsicIsOverloaded($p0);
        return $result;
    }
    ...
    public function LLVMGetGC(?LLVMValueRef $p0): ?string_ {
    ...
    public function LLVMGetFirstGlobalIFunc(?LLVMModuleRef $p0): ?LLVMValueRef {
        $result = $this->ffi->LLVMGetFirstGlobalIFunc($p0 === null ? null : $p0->getData());
        return $result === null ? null : new LLVMValueRef($result);
    }
    public function LLVMGetLastGlobalIFunc(?LLVMModuleRef $p0): ?LLVMValueRef {
        $result = $this->ffi->LLVMGetLastGlobalIFunc($p0 === null ? null : $p0->getData());
        return $result === null ? null : new LLVMValueRef($result);
    }
    public function LLVMGetNextGlobalIFunc(?LLVMValueRef $p0): ?LLVMValueRef {
        $result = $this->ffi->LLVMGetNextGlobalIFunc($p0 === null ? null : $p0->getData());
        return $result === null ? null : new LLVMValueRef($result);
    }
    public function LLVMGetPreviousGlobalIFunc(?LLVMValueRef $p0): ?LLVMValueRef {
        $result = $this->ffi->LLVMGetPreviousGlobalIFunc($p0 === null ? null : $p0->getData());
        return $result === null ? null : new LLVMValueRef($result);
    }
    public function LLVMGetGlobalIFuncResolver(?LLVMValueRef $p0): ?LLVMValueRef {
        $result = $this->ffi->LLVMGetGlobalIFuncResolver($p0 === null ? null : $p0->getData());
        return $result === null ? null : new LLVMValueRef($result);
    }
    public function LLVMSetGlobalIFuncResolver(?LLVMValueRef $p0, ?LLVMValueRef $p1): void {
        $this->ffi->LLVMSetGlobalIFuncResolver($p0 === null ? null : $p0->getData(), $p1 === null ? null : $p1->getData());
    }
    public function LLVMEraseGlobalIFunc(?LLVMValueRef $p0): void {
        $this->ffi->LLVMEraseGlobalIFunc($p0 === null ? null : $p0->getData());
    }
    public function LLVMRemoveGlobalIFunc(?LLVMValueRef $p0): void {
        $this->ffi->LLVMRemoveGlobalIFunc($p0 === null ? null : $p0->getData());
    }
    ...
    public function LLVMMetadataAsValue(?LLVMContextRef $p0, ?LLVMMetadataRef $p1): ?LLVMValueRef {
        $result = $this->ffi->LLVMMetadataAsValue($p0 === null ? null : $p0->getData(), $p1 === null ? null : $p1->getData());
        return $result === null ? null : new LLVMValueRef($result);
    }
    public function LLVMValueAsMetadata(?LLVMValueRef $p0): ?LLVMMetadataRef {
        $result = $this->ffi->LLVMValueAsMetadata($p0 === null ? null : $p0->getData());
        return $result === null ? null : new LLVMMetadataRef($result);
    }
    public function LLVMGetMDString(?LLVMValueRef $p0, ?int_ptr $p1): ?string_ {
    ...
    public function LLVMGetBasicBlockName(?LLVMBasicBlockRef $p0): ?string_ {
    ...
    public function LLVMInsertExistingBasicBlockAfterInsertBlock(?LLVMBuilderRef $p0, ?LLVMBasicBlockRef $p1): void {
        $this->ffi->LLVMInsertExistingBasicBlockAfterInsertBlock($p0 === null ? null : $p0->getData(), $p1 === null ? null : $p1->getData());
    }
    public function LLVMAppendExistingBasicBlock(?LLVMValueRef $p0, ?LLVMBasicBlockRef $p1): void {
        $this->ffi->LLVMAppendExistingBasicBlock($p0 === null ? null : $p0->getData(), $p1 === null ? null : $p1->getData());
    }
    public function LLVMCreateBasicBlockInContext(?LLVMContextRef $p0, ?string $p1): ?LLVMBasicBlockRef {
        $result = $this->ffi->LLVMCreateBasicBlockInContext($p0 === null ? null : $p0->getData(), $p1);
        return $result === null ? null : new LLVMBasicBlockRef($result);
    }
    ...
    public function LLVMGetCalledFunctionType(?LLVMValueRef $p0): ?LLVMTypeRef {
        $result = $this->ffi->LLVMGetCalledFunctionType($p0 === null ? null : $p0->getData());
        return $result === null ? null : new LLVMTypeRef($result);
    }
    ...
    public function LLVMGetCurrentDebugLocation2(?LLVMBuilderRef $p0): ?LLVMMetadataRef {
        $result = $this->ffi->LLVMGetCurrentDebugLocation2($p0 === null ? null : $p0->getData());
        return $result === null ? null : new LLVMMetadataRef($result);
    }
    public function LLVMSetCurrentDebugLocation2(?LLVMBuilderRef $p0, ?LLVMMetadataRef $p1): void {
        $this->ffi->LLVMSetCurrentDebugLocation2($p0 === null ? null : $p0->getData(), $p1 === null ? null : $p1->getData());
    }
    ...
    public function LLVMBuildInvoke2(?LLVMBuilderRef $p0, ?LLVMTypeRef $p1, ?LLVMValueRef $p2, ?LLVMValueRef_ptr $p3, ?int $p4, ?LLVMBasicBlockRef $p5, ?LLVMBasicBlockRef $p6, ?string $p7): ?LLVMValueRef {
        $result = $this->ffi->LLVMBuildInvoke2($p0 === null ? null : $p0->getData(), $p1 === null ? null : $p1->getData(), $p2 === null ? null : $p2->getData(), $p3 === null ? null : $p3->getData(), $p4, $p5 === null ? null : $p5->getData(), $p6 === null ? null : $p6->getData(), $p7);
        return $result === null ? null : new LLVMValueRef($result);
    }
    ...
    public function LLVMBuildCleanupRet(?LLVMBuilderRef $p0, ?LLVMValueRef $p1, ?LLVMBasicBlockRef $p2): ?LLVMValueRef {
        $result = $this->ffi->LLVMBuildCleanupRet($p0 === null ? null : $p0->getData(), $p1 === null ? null : $p1->getData(), $p2 === null ? null : $p2->getData());
        return $result === null ? null : new LLVMValueRef($result);
    }
    public function LLVMBuildCatchRet(?LLVMBuilderRef $p0, ?LLVMValueRef $p1, ?LLVMBasicBlockRef $p2): ?LLVMValueRef {
        $result = $this->ffi->LLVMBuildCatchRet($p0 === null ? null : $p0->getData(), $p1 === null ? null : $p1->getData(), $p2 === null ? null : $p2->getData());
        return $result === null ? null : new LLVMValueRef($result);
    }
    public function LLVMBuildCatchPad(?LLVMBuilderRef $p0, ?LLVMValueRef $p1, ?LLVMValueRef_ptr $p2, ?int $p3, ?string $p4): ?LLVMValueRef {
        $result = $this->ffi->LLVMBuildCatchPad($p0 === null ? null : $p0->getData(), $p1 === null ? null : $p1->getData(), $p2 === null ? null : $p2->getData(), $p3, $p4);
        return $result === null ? null : new LLVMValueRef($result);
    }
    public function LLVMBuildCleanupPad(?LLVMBuilderRef $p0, ?LLVMValueRef $p1, ?LLVMValueRef_ptr $p2, ?int $p3, ?string $p4): ?LLVMValueRef {
        $result = $this->ffi->LLVMBuildCleanupPad($p0 === null ? null : $p0->getData(), $p1 === null ? null : $p1->getData(), $p2 === null ? null : $p2->getData(), $p3, $p4);
        return $result === null ? null : new LLVMValueRef($result);
    }
    public function LLVMBuildCatchSwitch(?LLVMBuilderRef $p0, ?LLVMValueRef $p1, ?LLVMBasicBlockRef $p2, ?int $p3, ?string $p4): ?LLVMValueRef {
        $result = $this->ffi->LLVMBuildCatchSwitch($p0 === null ? null : $p0->getData(), $p1 === null ? null : $p1->getData(), $p2 === null ? null : $p2->getData(), $p3, $p4);
        return $result === null ? null : new LLVMValueRef($result);
    }
    ...
    public function LLVMAddHandler(?LLVMValueRef $p0, ?LLVMBasicBlockRef $p1): void {
        $this->ffi->LLVMAddHandler($p0 === null ? null : $p0->getData(), $p1 === null ? null : $p1->getData());
    }
    public function LLVMGetNumHandlers(?LLVMValueRef $p0): ?int {
        $result = $this->ffi->LLVMGetNumHandlers($p0 === null ? null : $p0->getData());
        return $result;
    }
    public function LLVMGetHandlers(?LLVMValueRef $p0, ?LLVMBasicBlockRef_ptr $p1): void {
        $this->ffi->LLVMGetHandlers($p0 === null ? null : $p0->getData(), $p1 === null ? null : $p1->getData());
    }
    public function LLVMGetArgOperand(?LLVMValueRef $p0, ?int $p1): ?LLVMValueRef {
        $result = $this->ffi->LLVMGetArgOperand($p0 === null ? null : $p0->getData(), $p1);
        return $result === null ? null : new LLVMValueRef($result);
    }
    public function LLVMSetArgOperand(?LLVMValueRef $p0, ?int $p1, ?LLVMValueRef $p2): void {
        $this->ffi->LLVMSetArgOperand($p0 === null ? null : $p0->getData(), $p1, $p2 === null ? null : $p2->getData());
    }
    public function LLVMGetParentCatchSwitch(?LLVMValueRef $p0): ?LLVMValueRef {
        $result = $this->ffi->LLVMGetParentCatchSwitch($p0 === null ? null : $p0->getData());
        return $result === null ? null : new LLVMValueRef($result);
    }
    public function LLVMSetParentCatchSwitch(?LLVMValueRef $p0, ?LLVMValueRef $p1): void {
        $this->ffi->LLVMSetParentCatchSwitch($p0 === null ? null : $p0->getData(), $p1 === null ? null : $p1->getData());
    }
    ...
    public function LLVMBuildMemSet(?LLVMBuilderRef $p0, ?LLVMValueRef $p1, ?LLVMValueRef $p2, ?LLVMValueRef $p3, ?int $p4): ?LLVMValueRef {
        $result = $this->ffi->LLVMBuildMemSet($p0 === null ? null : $p0->getData(), $p1 === null ? null : $p1->getData(), $p2 === null ? null : $p2->getData(), $p3 === null ? null : $p3->getData(), $p4);
        return $result === null ? null : new LLVMValueRef($result);
    }
    public function LLVMBuildMemCpy(?LLVMBuilderRef $p0, ?LLVMValueRef $p1, ?int $p2, ?LLVMValueRef $p3, ?int $p4, ?LLVMValueRef $p5): ?LLVMValueRef {
        $result = $this->ffi->LLVMBuildMemCpy($p0 === null ? null : $p0->getData(), $p1 === null ? null : $p1->getData(), $p2, $p3 === null ? null : $p3->getData(), $p4, $p5 === null ? null : $p5->getData());
        return $result === null ? null : new LLVMValueRef($result);
    }
    public function LLVMBuildMemMove(?LLVMBuilderRef $p0, ?LLVMValueRef $p1, ?int $p2, ?LLVMValueRef $p3, ?int $p4, ?LLVMValueRef $p5): ?LLVMValueRef {
        $result = $this->ffi->LLVMBuildMemMove($p0 === null ? null : $p0->getData(), $p1 === null ? null : $p1->getData(), $p2, $p3 === null ? null : $p3->getData(), $p4, $p5 === null ? null : $p5->getData());
        return $result === null ? null : new LLVMValueRef($result);
    }
    ...
    public function LLVMBuildLoad2(?LLVMBuilderRef $p0, ?LLVMTypeRef $p1, ?LLVMValueRef $p2, ?string $p3): ?LLVMValueRef {
        $result = $this->ffi->LLVMBuildLoad2($p0 === null ? null : $p0->getData(), $p1 === null ? null : $p1->getData(), $p2 === null ? null : $p2->getData(), $p3);
        return $result === null ? null : new LLVMValueRef($result);
    }
    ...
    public function LLVMBuildGEP2(?LLVMBuilderRef $p0, ?LLVMTypeRef $p1, ?LLVMValueRef $p2, ?LLVMValueRef_ptr $p3, ?int $p4, ?string $p5): ?LLVMValueRef {
        $result = $this->ffi->LLVMBuildGEP2($p0 === null ? null : $p0->getData(), $p1 === null ? null : $p1->getData(), $p2 === null ? null : $p2->getData(), $p3 === null ? null : $p3->getData(), $p4, $p5);
        return $result === null ? null : new LLVMValueRef($result);
    }
    public function LLVMBuildInBoundsGEP2(?LLVMBuilderRef $p0, ?LLVMTypeRef $p1, ?LLVMValueRef $p2, ?LLVMValueRef_ptr $p3, ?int $p4, ?string $p5): ?LLVMValueRef {
        $result = $this->ffi->LLVMBuildInBoundsGEP2($p0 === null ? null : $p0->getData(), $p1 === null ? null : $p1->getData(), $p2 === null ? null : $p2->getData(), $p3 === null ? null : $p3->getData(), $p4, $p5);
        return $result === null ? null : new LLVMValueRef($result);
    }
    public function LLVMBuildStructGEP2(?LLVMBuilderRef $p0, ?LLVMTypeRef $p1, ?LLVMValueRef $p2, ?int $p3, ?string $p4): ?LLVMValueRef {
        $result = $this->ffi->LLVMBuildStructGEP2($p0 === null ? null : $p0->getData(), $p1 === null ? null : $p1->getData(), $p2 === null ? null : $p2->getData(), $p3, $p4);
        return $result === null ? null : new LLVMValueRef($result);
    }
    ...
    public function LLVMBuildIntCast2(?LLVMBuilderRef $p0, ?LLVMValueRef $p1, ?LLVMTypeRef $p2, ?int $p3, ?string $p4): ?LLVMValueRef {
        $result = $this->ffi->LLVMBuildIntCast2($p0 === null ? null : $p0->getData(), $p1 === null ? null : $p1->getData(), $p2 === null ? null : $p2->getData(), $p3, $p4);
        return $result === null ? null : new LLVMValueRef($result);
    }
    ...
    public function LLVMBuildCall2(?LLVMBuilderRef $p0, ?LLVMTypeRef $p1, ?LLVMValueRef $p2, ?LLVMValueRef_ptr $p3, ?int $p4, ?string $p5): ?LLVMValueRef {
        $result = $this->ffi->LLVMBuildCall2($p0 === null ? null : $p0->getData(), $p1 === null ? null : $p1->getData(), $p2 === null ? null : $p2->getData(), $p3 === null ? null : $p3->getData(), $p4, $p5);
        return $result === null ? null : new LLVMValueRef($result);
    }
    ...
    public function LLVMGetBufferStart(?LLVMMemoryBufferRef $p0): ?string_ {
    ...
    public function LLVMInitializeWebAssemblyTargetInfo(): void {
        $this->ffi->LLVMInitializeWebAssemblyTargetInfo();
    }
    ...
    public function LLVMInitializeAVRTargetInfo(): void {
        $this->ffi->LLVMInitializeAVRTargetInfo();
    }
    ...
    public function LLVMInitializeWebAssemblyTarget(): void {
        $this->ffi->LLVMInitializeWebAssemblyTarget();
    }
    ...
    public function LLVMInitializeAVRTarget(): void {
        $this->ffi->LLVMInitializeAVRTarget();
    }
    ...
    public function LLVMInitializeWebAssemblyTargetMC(): void {
        $this->ffi->LLVMInitializeWebAssemblyTargetMC();
    }
    ...
    public function LLVMInitializeAVRTargetMC(): void {
        $this->ffi->LLVMInitializeAVRTargetMC();
    }
    ...
    public function LLVMInitializeWebAssemblyAsmPrinter(): void {
        $this->ffi->LLVMInitializeWebAssemblyAsmPrinter();
    }
    ...
    public function LLVMInitializeAVRAsmPrinter(): void {
        $this->ffi->LLVMInitializeAVRAsmPrinter();
    }
    ...
    public function LLVMInitializeBPFAsmParser(): void {
        $this->ffi->LLVMInitializeBPFAsmParser();
    }
    ...
    public function LLVMInitializeMSP430AsmParser(): void {
        $this->ffi->LLVMInitializeMSP430AsmParser();
    }
    ...
    public function LLVMInitializeWebAssemblyAsmParser(): void {
        $this->ffi->LLVMInitializeWebAssemblyAsmParser();
    }
    public function LLVMInitializeX86AsmParser(): void {
        $this->ffi->LLVMInitializeX86AsmParser();
    }
    public function LLVMInitializeAVRAsmParser(): void {
        $this->ffi->LLVMInitializeAVRAsmParser();
    }
    ...
    public function LLVMInitializeMSP430Disassembler(): void {
        $this->ffi->LLVMInitializeMSP430Disassembler();
    }
    ...
    public function LLVMInitializeWebAssemblyDisassembler(): void {
        $this->ffi->LLVMInitializeWebAssemblyDisassembler();
    }
    ...
    public function LLVMInitializeAVRDisassembler(): void {
        $this->ffi->LLVMInitializeAVRDisassembler();
    }
    ...
    const LLVMRelocROPI = (0) + 4;
    const LLVMRelocRWPI = (0) + 5;
    const LLVMRelocROPI_RWPI = (0) + 6;
    // typedefenum LLVMCodeModel
    const LLVMCodeModelDefault = (0) + 0;
    const LLVMCodeModelJITDefault = (0) + 1;
    const LLVMCodeModelTiny = (0) + 2;
    const LLVMCodeModelSmall = (0) + 3;
    const LLVMCodeModelKernel = (0) + 4;
    const LLVMCodeModelMedium = (0) + 5;
    const LLVMCodeModelLarge = (0) + 6;
    ...
    public function LLVMGetTargetName(?LLVMTargetRef $p0): ?string_ {
        $result = $this->ffi->LLVMGetTargetName($p0 === null ? null : $p0->getData());
        return $result === null ? null : new string_($result);
    }
    public function LLVMGetTargetDescription(?LLVMTargetRef $p0): ?string_ {
    ...
    public function LLVMNormalizeTargetTriple(?string $p0): ?string_ {
        $result = $this->ffi->LLVMNormalizeTargetTriple($p0);
        return $result === null ? null : new string_($result);
    }
    public function LLVMGetHostCPUName(): ?string_ {
        $result = $this->ffi->LLVMGetHostCPUName();
        return $result === null ? null : new string_($result);
    }
    public function LLVMGetHostCPUFeatures(): ?string_ {
        $result = $this->ffi->LLVMGetHostCPUFeatures();
        return $result === null ? null : new string_($result);
    }
    ...
    public function LLVMCreateGDBRegistrationListener(): ?LLVMJITEventListenerRef {
        $result = $this->ffi->LLVMCreateGDBRegistrationListener();
        return $result === null ? null : new LLVMJITEventListenerRef($result);
    }
    public function LLVMCreateIntelJITEventListener(): ?LLVMJITEventListenerRef {
        $result = $this->ffi->LLVMCreateIntelJITEventListener();
        return $result === null ? null : new LLVMJITEventListenerRef($result);
    }
    public function LLVMCreateOProfileJITEventListener(): ?LLVMJITEventListenerRef {
        $result = $this->ffi->LLVMCreateOProfileJITEventListener();
        return $result === null ? null : new LLVMJITEventListenerRef($result);
    }
    public function LLVMCreatePerfJITEventListener(): ?LLVMJITEventListenerRef {
        $result = $this->ffi->LLVMCreatePerfJITEventListener();
        return $result === null ? null : new LLVMJITEventListenerRef($result);
    }
    ...
    // typedefenum LLVMBinaryType
    const LLVMBinaryTypeArchive = (0) + 0;
    const LLVMBinaryTypeMachOUniversalBinary = (0) + 1;
    const LLVMBinaryTypeCOFFImportFile = (0) + 2;
    const LLVMBinaryTypeIR = (0) + 3;
    const LLVMBinaryTypeWinRes = (0) + 4;
    const LLVMBinaryTypeCOFF = (0) + 5;
    const LLVMBinaryTypeELF32L = (0) + 6;
    const LLVMBinaryTypeELF32B = (0) + 7;
    const LLVMBinaryTypeELF64L = (0) + 8;
    const LLVMBinaryTypeELF64B = (0) + 9;
    const LLVMBinaryTypeMachO32L = (0) + 10;
    const LLVMBinaryTypeMachO32B = (0) + 11;
    const LLVMBinaryTypeMachO64L = (0) + 12;
    const LLVMBinaryTypeMachO64B = (0) + 13;
    const LLVMBinaryTypeWasm = (0) + 14;
    public function LLVMCreateBinary(?LLVMMemoryBufferRef $p0, ?LLVMContextRef $p1, ?string_ptr $p2): ?LLVMBinaryRef {
        $result = $this->ffi->LLVMCreateBinary($p0 === null ? null : $p0->getData(), $p1 === null ? null : $p1->getData(), $p2 === null ? null : $p2->getData());
        return $result === null ? null : new LLVMBinaryRef($result);
    }
    public function LLVMDisposeBinary(?LLVMBinaryRef $p0): void {
        $this->ffi->LLVMDisposeBinary($p0 === null ? null : $p0->getData());
    }
    public function LLVMBinaryCopyMemoryBuffer(?LLVMBinaryRef $p0): ?LLVMMemoryBufferRef {
        $result = $this->ffi->LLVMBinaryCopyMemoryBuffer($p0 === null ? null : $p0->getData());
        return $result === null ? null : new LLVMMemoryBufferRef($result);
    }
    public function LLVMBinaryGetType(?LLVMBinaryRef $p0): ?int {
        $result = $this->ffi->LLVMBinaryGetType($p0 === null ? null : $p0->getData());
        return $result;
    }
    public function LLVMObjectFileCopySectionIterator(?LLVMBinaryRef $p0): ?LLVMSectionIteratorRef {
        $result = $this->ffi->LLVMObjectFileCopySectionIterator($p0 === null ? null : $p0->getData());
        return $result === null ? null : new LLVMSectionIteratorRef($result);
    }
    public function LLVMObjectFileIsSectionIteratorAtEnd(?LLVMBinaryRef $p0, ?LLVMSectionIteratorRef $p1): ?int {
        $result = $this->ffi->LLVMObjectFileIsSectionIteratorAtEnd($p0 === null ? null : $p0->getData(), $p1 === null ? null : $p1->getData());
        return $result;
    }
    public function LLVMObjectFileCopySymbolIterator(?LLVMBinaryRef $p0): ?LLVMSymbolIteratorRef {
        $result = $this->ffi->LLVMObjectFileCopySymbolIterator($p0 === null ? null : $p0->getData());
        return $result === null ? null : new LLVMSymbolIteratorRef($result);
    }
    public function LLVMObjectFileIsSymbolIteratorAtEnd(?LLVMBinaryRef $p0, ?LLVMSymbolIteratorRef $p1): ?int {
        $result = $this->ffi->LLVMObjectFileIsSymbolIteratorAtEnd($p0 === null ? null : $p0->getData(), $p1 === null ? null : $p1->getData());
        return $result;
    }
    ...
    public function LLVMGetSectionName(?LLVMSectionIteratorRef $p0): ?string_ {
    ...
    public function LLVMGetSectionContents(?LLVMSectionIteratorRef $p0): ?string_ {
    ...
    public function LLVMGetSymbolName(?LLVMSymbolIteratorRef $p0): ?string_ {
    ...
    public function LLVMGetRelocationTypeName(?LLVMRelocationIteratorRef $p0): ?string_ {
        $result = $this->ffi->LLVMGetRelocationTypeName($p0 === null ? null : $p0->getData());
        return $result === null ? null : new string_($result);
    }
    public function LLVMGetRelocationValueString(?LLVMRelocationIteratorRef $p0): ?string_ {
    ...
    public function LLVMAddLoopUnrollAndJamPass(?LLVMPassManagerRef $p0): void {
        $this->ffi->LLVMAddLoopUnrollAndJamPass($p0 === null ? null : $p0->getData());
    }
    ...
    public function LLVMAddLowerAtomicPass(?LLVMPassManagerRef $p0): void {
        $this->ffi->LLVMAddLowerAtomicPass($p0 === null ? null : $p0->getData());
    }
    ...
    public function LLVMAddUnifyFunctionExitNodesPass(?LLVMPassManagerRef $p0): void {
        $this->ffi->LLVMAddUnifyFunctionExitNodesPass($p0 === null ? null : $p0->getData());
    }
    ...
    public function LLVMAddCalledValuePropagationPass(?LLVMPassManagerRef $p0): void {
        $this->ffi->LLVMAddCalledValuePropagationPass($p0 === null ? null : $p0->getData());
    }
...
class LLVMMetadataRef implements illvm {
    private FFI\CData $data;
    public function __construct(FFI\CData $data) { $this->data = $data; }
    public function getData(): FFI\CData { return $this->data; }
    public function equals(LLVMMetadataRef $other): bool { return $this->data == $other->data; }
    public function addr(): LLVMMetadataRef_ptr { return new LLVMMetadataRef_ptr(FFI::addr($this->data)); }
    public static function getType(): string { return 'LLVMMetadataRef'; }
}
class LLVMMetadataRef_ptr implements illvm {
    private FFI\CData $data;
    public function __construct(FFI\CData $data) { $this->data = $data; }
    public function getData(): FFI\CData { return $this->data; }
    public function equals(LLVMMetadataRef_ptr $other): bool { return $this->data == $other->data; }
    public function addr(): LLVMMetadataRef_ptr_ptr { return new LLVMMetadataRef_ptr_ptr(FFI::addr($this->data)); }
    public function deref(int $n = 0): LLVMMetadataRef { return new LLVMMetadataRef($this->data[$n]); }
    public static function getType(): string { return 'LLVMMetadataRef*'; }
}
class LLVMMetadataRef_ptr_ptr implements illvm {
    private FFI\CData $data;
    public function __construct(FFI\CData $data) { $this->data = $data; }
    public function getData(): FFI\CData { return $this->data; }
    public function equals(LLVMMetadataRef_ptr_ptr $other): bool { return $this->data == $other->data; }
    public function addr(): LLVMMetadataRef_ptr_ptr_ptr { return new LLVMMetadataRef_ptr_ptr_ptr(FFI::addr($this->data)); }
    public function deref(int $n = 0): LLVMMetadataRef_ptr { return new LLVMMetadataRef_ptr($this->data[$n]); }
    public static function getType(): string { return 'LLVMMetadataRef**'; }
}
class LLVMMetadataRef_ptr_ptr_ptr implements illvm {
    private FFI\CData $data;
    public function __construct(FFI\CData $data) { $this->data = $data; }
    public function getData(): FFI\CData { return $this->data; }
    public function equals(LLVMMetadataRef_ptr_ptr_ptr $other): bool { return $this->data == $other->data; }
    public function addr(): LLVMMetadataRef_ptr_ptr_ptr_ptr { return new LLVMMetadataRef_ptr_ptr_ptr_ptr(FFI::addr($this->data)); }
    public function deref(int $n = 0): LLVMMetadataRef_ptr_ptr { return new LLVMMetadataRef_ptr_ptr($this->data[$n]); }
    public static function getType(): string { return 'LLVMMetadataRef***'; }
}
class LLVMMetadataRef_ptr_ptr_ptr_ptr implements illvm {
    private FFI\CData $data;
    public function __construct(FFI\CData $data) { $this->data = $data; }
    public function getData(): FFI\CData { return $this->data; }
    public function equals(LLVMMetadataRef_ptr_ptr_ptr_ptr $other): bool { return $this->data == $other->data; }
    public function addr(): LLVMMetadataRef_ptr_ptr_ptr_ptr_ptr { return new LLVMMetadataRef_ptr_ptr_ptr_ptr_ptr(FFI::addr($this->data)); }
    public function deref(int $n = 0): LLVMMetadataRef_ptr_ptr_ptr { return new LLVMMetadataRef_ptr_ptr_ptr($this->data[$n]); }
    public static function getType(): string { return 'LLVMMetadataRef****'; }
}
class LLVMNamedMDNodeRef implements illvm {
    private FFI\CData $data;
    public function __construct(FFI\CData $data) { $this->data = $data; }
    public function getData(): FFI\CData { return $this->data; }
    public function equals(LLVMNamedMDNodeRef $other): bool { return $this->data == $other->data; }
    public function addr(): LLVMNamedMDNodeRef_ptr { return new LLVMNamedMDNodeRef_ptr(FFI::addr($this->data)); }
    public static function getType(): string { return 'LLVMNamedMDNodeRef'; }
}
class LLVMNamedMDNodeRef_ptr implements illvm {
    private FFI\CData $data;
    public function __construct(FFI\CData $data) { $this->data = $data; }
    public function getData(): FFI\CData { return $this->data; }
    public function equals(LLVMNamedMDNodeRef_ptr $other): bool { return $this->data == $other->data; }
    public function addr(): LLVMNamedMDNodeRef_ptr_ptr { return new LLVMNamedMDNodeRef_ptr_ptr(FFI::addr($this->data)); }
    public function deref(int $n = 0): LLVMNamedMDNodeRef { return new LLVMNamedMDNodeRef($this->data[$n]); }
    public static function getType(): string { return 'LLVMNamedMDNodeRef*'; }
}
class LLVMNamedMDNodeRef_ptr_ptr implements illvm {
    private FFI\CData $data;
    public function __construct(FFI\CData $data) { $this->data = $data; }
    public function getData(): FFI\CData { return $this->data; }
    public function equals(LLVMNamedMDNodeRef_ptr_ptr $other): bool { return $this->data == $other->data; }
    public function addr(): LLVMNamedMDNodeRef_ptr_ptr_ptr { return new LLVMNamedMDNodeRef_ptr_ptr_ptr(FFI::addr($this->data)); }
    public function deref(int $n = 0): LLVMNamedMDNodeRef_ptr { return new LLVMNamedMDNodeRef_ptr($this->data[$n]); }
    public static function getType(): string { return 'LLVMNamedMDNodeRef**'; }
}
class LLVMNamedMDNodeRef_ptr_ptr_ptr implements illvm {
    private FFI\CData $data;
    public function __construct(FFI\CData $data) { $this->data = $data; }
    public function getData(): FFI\CData { return $this->data; }
    public function equals(LLVMNamedMDNodeRef_ptr_ptr_ptr $other): bool { return $this->data == $other->data; }
    public function addr(): LLVMNamedMDNodeRef_ptr_ptr_ptr_ptr { return new LLVMNamedMDNodeRef_ptr_ptr_ptr_ptr(FFI::addr($this->data)); }
    public function deref(int $n = 0): LLVMNamedMDNodeRef_ptr_ptr { return new LLVMNamedMDNodeRef_ptr_ptr($this->data[$n]); }
    public static function getType(): string { return 'LLVMNamedMDNodeRef***'; }
}
class LLVMNamedMDNodeRef_ptr_ptr_ptr_ptr implements illvm {
    private FFI\CData $data;
    public function __construct(FFI\CData $data) { $this->data = $data; }
    public function getData(): FFI\CData { return $this->data; }
    public function equals(LLVMNamedMDNodeRef_ptr_ptr_ptr_ptr $other): bool { return $this->data == $other->data; }
    public function addr(): LLVMNamedMDNodeRef_ptr_ptr_ptr_ptr_ptr { return new LLVMNamedMDNodeRef_ptr_ptr_ptr_ptr_ptr(FFI::addr($this->data)); }
    public function deref(int $n = 0): LLVMNamedMDNodeRef_ptr_ptr_ptr { return new LLVMNamedMDNodeRef_ptr_ptr_ptr($this->data[$n]); }
    public static function getType(): string { return 'LLVMNamedMDNodeRef****'; }
}
class LLVMValueMetadataEntry implements illvm {
    private FFI\CData $data;
    public function __construct(FFI\CData $data) { $this->data = $data; }
    public function getData(): FFI\CData { return $this->data; }
    public function equals(LLVMValueMetadataEntry $other): bool { return $this->data == $other->data; }
    public function addr(): LLVMValueMetadataEntry_ptr { return new LLVMValueMetadataEntry_ptr(FFI::addr($this->data)); }
    public static function getType(): string { return 'LLVMValueMetadataEntry'; }
}
class LLVMValueMetadataEntry_ptr implements illvm {
    private FFI\CData $data;
    public function __construct(FFI\CData $data) { $this->data = $data; }
    public function getData(): FFI\CData { return $this->data; }
    public function equals(LLVMValueMetadataEntry_ptr $other): bool { return $this->data == $other->data; }
    public function addr(): LLVMValueMetadataEntry_ptr_ptr { return new LLVMValueMetadataEntry_ptr_ptr(FFI::addr($this->data)); }
    public function deref(int $n = 0): LLVMValueMetadataEntry { return new LLVMValueMetadataEntry($this->data[$n]); }
    public static function getType(): string { return 'LLVMValueMetadataEntry*'; }
}
class LLVMValueMetadataEntry_ptr_ptr implements illvm {
    private FFI\CData $data;
    public function __construct(FFI\CData $data) { $this->data = $data; }
    public function getData(): FFI\CData { return $this->data; }
    public function equals(LLVMValueMetadataEntry_ptr_ptr $other): bool { return $this->data == $other->data; }
    public function addr(): LLVMValueMetadataEntry_ptr_ptr_ptr { return new LLVMValueMetadataEntry_ptr_ptr_ptr(FFI::addr($this->data)); }
    public function deref(int $n = 0): LLVMValueMetadataEntry_ptr { return new LLVMValueMetadataEntry_ptr($this->data[$n]); }
    public static function getType(): string { return 'LLVMValueMetadataEntry**'; }
}
class LLVMValueMetadataEntry_ptr_ptr_ptr implements illvm {
    private FFI\CData $data;
    public function __construct(FFI\CData $data) { $this->data = $data; }
    public function getData(): FFI\CData { return $this->data; }
    public function equals(LLVMValueMetadataEntry_ptr_ptr_ptr $other): bool { return $this->data == $other->data; }
    public function addr(): LLVMValueMetadataEntry_ptr_ptr_ptr_ptr { return new LLVMValueMetadataEntry_ptr_ptr_ptr_ptr(FFI::addr($this->data)); }
    public function deref(int $n = 0): LLVMValueMetadataEntry_ptr_ptr { return new LLVMValueMetadataEntry_ptr_ptr($this->data[$n]); }
    public static function getType(): string { return 'LLVMValueMetadataEntry***'; }
}
class LLVMValueMetadataEntry_ptr_ptr_ptr_ptr implements illvm {
    private FFI\CData $data;
    public function __construct(FFI\CData $data) { $this->data = $data; }
    public function getData(): FFI\CData { return $this->data; }
    public function equals(LLVMValueMetadataEntry_ptr_ptr_ptr_ptr $other): bool { return $this->data == $other->data; }
    public function addr(): LLVMValueMetadataEntry_ptr_ptr_ptr_ptr_ptr { return new LLVMValueMetadataEntry_ptr_ptr_ptr_ptr_ptr(FFI::addr($this->data)); }
    public function deref(int $n = 0): LLVMValueMetadataEntry_ptr_ptr_ptr { return new LLVMValueMetadataEntry_ptr_ptr_ptr($this->data[$n]); }
    public static function getType(): string { return 'LLVMValueMetadataEntry****'; }
}
...
class LLVMDIBuilderRef implements illvm {
    private FFI\CData $data;
    public function __construct(FFI\CData $data) { $this->data = $data; }
    public function getData(): FFI\CData { return $this->data; }
    public function equals(LLVMDIBuilderRef $other): bool { return $this->data == $other->data; }
    public function addr(): LLVMDIBuilderRef_ptr { return new LLVMDIBuilderRef_ptr(FFI::addr($this->data)); }
    public static function getType(): string { return 'LLVMDIBuilderRef'; }
}
class LLVMDIBuilderRef_ptr implements illvm {
    private FFI\CData $data;
    public function __construct(FFI\CData $data) { $this->data = $data; }
    public function getData(): FFI\CData { return $this->data; }
    public function equals(LLVMDIBuilderRef_ptr $other): bool { return $this->data == $other->data; }
    public function addr(): LLVMDIBuilderRef_ptr_ptr { return new LLVMDIBuilderRef_ptr_ptr(FFI::addr($this->data)); }
    public function deref(int $n = 0): LLVMDIBuilderRef { return new LLVMDIBuilderRef($this->data[$n]); }
    public static function getType(): string { return 'LLVMDIBuilderRef*'; }
}
class LLVMDIBuilderRef_ptr_ptr implements illvm {
    private FFI\CData $data;
    public function __construct(FFI\CData $data) { $this->data = $data; }
    public function getData(): FFI\CData { return $this->data; }
    public function equals(LLVMDIBuilderRef_ptr_ptr $other): bool { return $this->data == $other->data; }
    public function addr(): LLVMDIBuilderRef_ptr_ptr_ptr { return new LLVMDIBuilderRef_ptr_ptr_ptr(FFI::addr($this->data)); }
    public function deref(int $n = 0): LLVMDIBuilderRef_ptr { return new LLVMDIBuilderRef_ptr($this->data[$n]); }
    public static function getType(): string { return 'LLVMDIBuilderRef**'; }
}
class LLVMDIBuilderRef_ptr_ptr_ptr implements illvm {
    private FFI\CData $data;
    public function __construct(FFI\CData $data) { $this->data = $data; }
    public function getData(): FFI\CData { return $this->data; }
    public function equals(LLVMDIBuilderRef_ptr_ptr_ptr $other): bool { return $this->data == $other->data; }
    public function addr(): LLVMDIBuilderRef_ptr_ptr_ptr_ptr { return new LLVMDIBuilderRef_ptr_ptr_ptr_ptr(FFI::addr($this->data)); }
    public function deref(int $n = 0): LLVMDIBuilderRef_ptr_ptr { return new LLVMDIBuilderRef_ptr_ptr($this->data[$n]); }
    public static function getType(): string { return 'LLVMDIBuilderRef***'; }
}
class LLVMDIBuilderRef_ptr_ptr_ptr_ptr implements illvm {
    private FFI\CData $data;
    public function __construct(FFI\CData $data) { $this->data = $data; }
    public function getData(): FFI\CData { return $this->data; }
    public function equals(LLVMDIBuilderRef_ptr_ptr_ptr_ptr $other): bool { return $this->data == $other->data; }
    public function addr(): LLVMDIBuilderRef_ptr_ptr_ptr_ptr_ptr { return new LLVMDIBuilderRef_ptr_ptr_ptr_ptr_ptr(FFI::addr($this->data)); }
    public function deref(int $n = 0): LLVMDIBuilderRef_ptr_ptr_ptr { return new LLVMDIBuilderRef_ptr_ptr_ptr($this->data[$n]); }
    public static function getType(): string { return 'LLVMDIBuilderRef****'; }
}
...
class LLVMComdatRef implements illvm {
    private FFI\CData $data;
    public function __construct(FFI\CData $data) { $this->data = $data; }
    public function getData(): FFI\CData { return $this->data; }
    public function equals(LLVMComdatRef $other): bool { return $this->data == $other->data; }
    public function addr(): LLVMComdatRef_ptr { return new LLVMComdatRef_ptr(FFI::addr($this->data)); }
    public static function getType(): string { return 'LLVMComdatRef'; }
}
class LLVMComdatRef_ptr implements illvm {
    private FFI\CData $data;
    public function __construct(FFI\CData $data) { $this->data = $data; }
    public function getData(): FFI\CData { return $this->data; }
    public function equals(LLVMComdatRef_ptr $other): bool { return $this->data == $other->data; }
    public function addr(): LLVMComdatRef_ptr_ptr { return new LLVMComdatRef_ptr_ptr(FFI::addr($this->data)); }
    public function deref(int $n = 0): LLVMComdatRef { return new LLVMComdatRef($this->data[$n]); }
    public static function getType(): string { return 'LLVMComdatRef*'; }
}
class LLVMComdatRef_ptr_ptr implements illvm {
    private FFI\CData $data;
    public function __construct(FFI\CData $data) { $this->data = $data; }
    public function getData(): FFI\CData { return $this->data; }
    public function equals(LLVMComdatRef_ptr_ptr $other): bool { return $this->data == $other->data; }
    public function addr(): LLVMComdatRef_ptr_ptr_ptr { return new LLVMComdatRef_ptr_ptr_ptr(FFI::addr($this->data)); }
    public function deref(int $n = 0): LLVMComdatRef_ptr { return new LLVMComdatRef_ptr($this->data[$n]); }
    public static function getType(): string { return 'LLVMComdatRef**'; }
}
class LLVMComdatRef_ptr_ptr_ptr implements illvm {
    private FFI\CData $data;
    public function __construct(FFI\CData $data) { $this->data = $data; }
    public function getData(): FFI\CData { return $this->data; }
    public function equals(LLVMComdatRef_ptr_ptr_ptr $other): bool { return $this->data == $other->data; }
    public function addr(): LLVMComdatRef_ptr_ptr_ptr_ptr { return new LLVMComdatRef_ptr_ptr_ptr_ptr(FFI::addr($this->data)); }
    public function deref(int $n = 0): LLVMComdatRef_ptr_ptr { return new LLVMComdatRef_ptr_ptr($this->data[$n]); }
    public static function getType(): string { return 'LLVMComdatRef***'; }
}
class LLVMComdatRef_ptr_ptr_ptr_ptr implements illvm {
    private FFI\CData $data;
    public function __construct(FFI\CData $data) { $this->data = $data; }
    public function getData(): FFI\CData { return $this->data; }
    public function equals(LLVMComdatRef_ptr_ptr_ptr_ptr $other): bool { return $this->data == $other->data; }
    public function addr(): LLVMComdatRef_ptr_ptr_ptr_ptr_ptr { return new LLVMComdatRef_ptr_ptr_ptr_ptr_ptr(FFI::addr($this->data)); }
    public function deref(int $n = 0): LLVMComdatRef_ptr_ptr_ptr { return new LLVMComdatRef_ptr_ptr_ptr($this->data[$n]); }
    public static function getType(): string { return 'LLVMComdatRef****'; }
}
class LLVMModuleFlagEntry implements illvm {
    private FFI\CData $data;
    public function __construct(FFI\CData $data) { $this->data = $data; }
    public function getData(): FFI\CData { return $this->data; }
    public function equals(LLVMModuleFlagEntry $other): bool { return $this->data == $other->data; }
    public function addr(): LLVMModuleFlagEntry_ptr { return new LLVMModuleFlagEntry_ptr(FFI::addr($this->data)); }
    public static function getType(): string { return 'LLVMModuleFlagEntry'; }
}
class LLVMModuleFlagEntry_ptr implements illvm {
    private FFI\CData $data;
    public function __construct(FFI\CData $data) { $this->data = $data; }
    public function getData(): FFI\CData { return $this->data; }
    public function equals(LLVMModuleFlagEntry_ptr $other): bool { return $this->data == $other->data; }
    public function addr(): LLVMModuleFlagEntry_ptr_ptr { return new LLVMModuleFlagEntry_ptr_ptr(FFI::addr($this->data)); }
    public function deref(int $n = 0): LLVMModuleFlagEntry { return new LLVMModuleFlagEntry($this->data[$n]); }
    public static function getType(): string { return 'LLVMModuleFlagEntry*'; }
}
class LLVMModuleFlagEntry_ptr_ptr implements illvm {
    private FFI\CData $data;
    public function __construct(FFI\CData $data) { $this->data = $data; }
    public function getData(): FFI\CData { return $this->data; }
    public function equals(LLVMModuleFlagEntry_ptr_ptr $other): bool { return $this->data == $other->data; }
    public function addr(): LLVMModuleFlagEntry_ptr_ptr_ptr { return new LLVMModuleFlagEntry_ptr_ptr_ptr(FFI::addr($this->data)); }
    public function deref(int $n = 0): LLVMModuleFlagEntry_ptr { return new LLVMModuleFlagEntry_ptr($this->data[$n]); }
    public static function getType(): string { return 'LLVMModuleFlagEntry**'; }
}
class LLVMModuleFlagEntry_ptr_ptr_ptr implements illvm {
    private FFI\CData $data;
    public function __construct(FFI\CData $data) { $this->data = $data; }
    public function getData(): FFI\CData { return $this->data; }
    public function equals(LLVMModuleFlagEntry_ptr_ptr_ptr $other): bool { return $this->data == $other->data; }
    public function addr(): LLVMModuleFlagEntry_ptr_ptr_ptr_ptr { return new LLVMModuleFlagEntry_ptr_ptr_ptr_ptr(FFI::addr($this->data)); }
    public function deref(int $n = 0): LLVMModuleFlagEntry_ptr_ptr { return new LLVMModuleFlagEntry_ptr_ptr($this->data[$n]); }
    public static function getType(): string { return 'LLVMModuleFlagEntry***'; }
}
class LLVMModuleFlagEntry_ptr_ptr_ptr_ptr implements illvm {
    private FFI\CData $data;
    public function __construct(FFI\CData $data) { $this->data = $data; }
    public function getData(): FFI\CData { return $this->data; }
    public function equals(LLVMModuleFlagEntry_ptr_ptr_ptr_ptr $other): bool { return $this->data == $other->data; }
    public function addr(): LLVMModuleFlagEntry_ptr_ptr_ptr_ptr_ptr { return new LLVMModuleFlagEntry_ptr_ptr_ptr_ptr_ptr(FFI::addr($this->data)); }
    public function deref(int $n = 0): LLVMModuleFlagEntry_ptr_ptr_ptr { return new LLVMModuleFlagEntry_ptr_ptr_ptr($this->data[$n]); }
    public static function getType(): string { return 'LLVMModuleFlagEntry****'; }
}
class LLVMJITEventListenerRef implements illvm {
    private FFI\CData $data;
    public function __construct(FFI\CData $data) { $this->data = $data; }
    public function getData(): FFI\CData { return $this->data; }
    public function equals(LLVMJITEventListenerRef $other): bool { return $this->data == $other->data; }
    public function addr(): LLVMJITEventListenerRef_ptr { return new LLVMJITEventListenerRef_ptr(FFI::addr($this->data)); }
    public static function getType(): string { return 'LLVMJITEventListenerRef'; }
}
class LLVMJITEventListenerRef_ptr implements illvm {
    private FFI\CData $data;
    public function __construct(FFI\CData $data) { $this->data = $data; }
    public function getData(): FFI\CData { return $this->data; }
    public function equals(LLVMJITEventListenerRef_ptr $other): bool { return $this->data == $other->data; }
    public function addr(): LLVMJITEventListenerRef_ptr_ptr { return new LLVMJITEventListenerRef_ptr_ptr(FFI::addr($this->data)); }
    public function deref(int $n = 0): LLVMJITEventListenerRef { return new LLVMJITEventListenerRef($this->data[$n]); }
    public static function getType(): string { return 'LLVMJITEventListenerRef*'; }
}
class LLVMJITEventListenerRef_ptr_ptr implements illvm {
    private FFI\CData $data;
    public function __construct(FFI\CData $data) { $this->data = $data; }
    public function getData(): FFI\CData { return $this->data; }
    public function equals(LLVMJITEventListenerRef_ptr_ptr $other): bool { return $this->data == $other->data; }
    public function addr(): LLVMJITEventListenerRef_ptr_ptr_ptr { return new LLVMJITEventListenerRef_ptr_ptr_ptr(FFI::addr($this->data)); }
    public function deref(int $n = 0): LLVMJITEventListenerRef_ptr { return new LLVMJITEventListenerRef_ptr($this->data[$n]); }
    public static function getType(): string { return 'LLVMJITEventListenerRef**'; }
}
class LLVMJITEventListenerRef_ptr_ptr_ptr implements illvm {
    private FFI\CData $data;
    public function __construct(FFI\CData $data) { $this->data = $data; }
    public function getData(): FFI\CData { return $this->data; }
    public function equals(LLVMJITEventListenerRef_ptr_ptr_ptr $other): bool { return $this->data == $other->data; }
    public function addr(): LLVMJITEventListenerRef_ptr_ptr_ptr_ptr { return new LLVMJITEventListenerRef_ptr_ptr_ptr_ptr(FFI::addr($this->data)); }
    public function deref(int $n = 0): LLVMJITEventListenerRef_ptr_ptr { return new LLVMJITEventListenerRef_ptr_ptr($this->data[$n]); }
    public static function getType(): string { return 'LLVMJITEventListenerRef***'; }
}
class LLVMJITEventListenerRef_ptr_ptr_ptr_ptr implements illvm {
    private FFI\CData $data;
    public function __construct(FFI\CData $data) { $this->data = $data; }
    public function getData(): FFI\CData { return $this->data; }
    public function equals(LLVMJITEventListenerRef_ptr_ptr_ptr_ptr $other): bool { return $this->data == $other->data; }
    public function addr(): LLVMJITEventListenerRef_ptr_ptr_ptr_ptr_ptr { return new LLVMJITEventListenerRef_ptr_ptr_ptr_ptr_ptr(FFI::addr($this->data)); }
    public function deref(int $n = 0): LLVMJITEventListenerRef_ptr_ptr_ptr { return new LLVMJITEventListenerRef_ptr_ptr_ptr($this->data[$n]); }
    public static function getType(): string { return 'LLVMJITEventListenerRef****'; }
}
class LLVMBinaryRef implements illvm {
    private FFI\CData $data;
    public function __construct(FFI\CData $data) { $this->data = $data; }
    public function getData(): FFI\CData { return $this->data; }
    public function equals(LLVMBinaryRef $other): bool { return $this->data == $other->data; }
    public function addr(): LLVMBinaryRef_ptr { return new LLVMBinaryRef_ptr(FFI::addr($this->data)); }
    public static function getType(): string { return 'LLVMBinaryRef'; }
}
class LLVMBinaryRef_ptr implements illvm {
    private FFI\CData $data;
    public function __construct(FFI\CData $data) { $this->data = $data; }
    public function getData(): FFI\CData { return $this->data; }
    public function equals(LLVMBinaryRef_ptr $other): bool { return $this->data == $other->data; }
    public function addr(): LLVMBinaryRef_ptr_ptr { return new LLVMBinaryRef_ptr_ptr(FFI::addr($this->data)); }
    public function deref(int $n = 0): LLVMBinaryRef { return new LLVMBinaryRef($this->data[$n]); }
    public static function getType(): string { return 'LLVMBinaryRef*'; }
}
class LLVMBinaryRef_ptr_ptr implements illvm {
    private FFI\CData $data;
    public function __construct(FFI\CData $data) { $this->data = $data; }
    public function getData(): FFI\CData { return $this->data; }
    public function equals(LLVMBinaryRef_ptr_ptr $other): bool { return $this->data == $other->data; }
    public function addr(): LLVMBinaryRef_ptr_ptr_ptr { return new LLVMBinaryRef_ptr_ptr_ptr(FFI::addr($this->data)); }
    public function deref(int $n = 0): LLVMBinaryRef_ptr { return new LLVMBinaryRef_ptr($this->data[$n]); }
    public static function getType(): string { return 'LLVMBinaryRef**'; }
}
class LLVMBinaryRef_ptr_ptr_ptr implements illvm {
    private FFI\CData $data;
    public function __construct(FFI\CData $data) { $this->data = $data; }
    public function getData(): FFI\CData { return $this->data; }
    public function equals(LLVMBinaryRef_ptr_ptr_ptr $other): bool { return $this->data == $other->data; }
    public function addr(): LLVMBinaryRef_ptr_ptr_ptr_ptr { return new LLVMBinaryRef_ptr_ptr_ptr_ptr(FFI::addr($this->data)); }
    public function deref(int $n = 0): LLVMBinaryRef_ptr_ptr { return new LLVMBinaryRef_ptr_ptr($this->data[$n]); }
    public static function getType(): string { return 'LLVMBinaryRef***'; }
}
class LLVMBinaryRef_ptr_ptr_ptr_ptr implements illvm {
    private FFI\CData $data;
    public function __construct(FFI\CData $data) { $this->data = $data; }
    public function getData(): FFI\CData { return $this->data; }
    public function equals(LLVMBinaryRef_ptr_ptr_ptr_ptr $other): bool { return $this->data == $other->data; }
    public function addr(): LLVMBinaryRef_ptr_ptr_ptr_ptr_ptr { return new LLVMBinaryRef_ptr_ptr_ptr_ptr_ptr(FFI::addr($this->data)); }
    public function deref(int $n = 0): LLVMBinaryRef_ptr_ptr_ptr { return new LLVMBinaryRef_ptr_ptr_ptr($this->data[$n]); }
    public static function getType(): string { return 'LLVMBinaryRef****'; }
}
