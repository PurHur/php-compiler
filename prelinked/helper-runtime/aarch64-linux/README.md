...
- env / error / ini / execution (10): EnvLocal / EnvironMirrorNative / ErrorLast /
  ErrorLog / ErrorSilence / ExecutionLimits / IniIntrospection / IniParseQuantity /
  ParseIniNative / ProcNice
...
- apache / highlight / headers / phpinfo / readonly / request body / scope / upload / net lookup (10):
  ApacheNote / Highlight / PendingHeaders / Phpinfo / ReadonlyRaise /
...
- remaining mbstring + first iconv (10):
  ...
  Iconv / IconvString
  (MbGetInfo / MbMimeheader not on x86_64-linux yet)
- finish iconv + compress/encode/strerror (10):
  IconvMime / Bcmath / Bz2 / Bz2Stream / Gettext / ExifImagetype /
  FinfoFile / CurlStrerror / CurlShareStrerror / Lzf
  (deferred: Curl handle/transfer; Dom* / Intl* / Openssl* / Soap* / Sockets*)
- sodium / SPL snapshots / libxml / lz4 / stats / xmlrpc / ftp-close (10):
...
- first Dom create/query helpers (10):
  ...
  DomImportNode
- Dom load/save/HTML/XML helpers (10):
  ...
  (deferred: remaining Dom* save/XML/id/xpath; Intl* / Openssl* / Soap* / Sockets*)
